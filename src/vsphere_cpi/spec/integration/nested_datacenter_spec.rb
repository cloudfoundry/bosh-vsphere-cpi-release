...
describe 'nested datacenters', nested_datacenter: true  do
  ...
  before(:all) do
    ...
    verify_cluster(@nested_datacenter_cpi_options, @nested_datacenter_cluster_name, 'BOSH_VSPHERE_CPI_NESTED_DATACENTER_CLUSTER')
    verify_datastore_within_cluster(
      @nested_datacenter_cpi_options,
      'BOSH_VSPHERE_CPI_NESTED_DATACENTER_DATASTORE_PATTERN',
      @nested_datacenter_datastore_pattern,
      @nested_datacenter_cluster_name
    )

    verify_resource_pool(@nested_datacenter_cpi_options, @nested_datacenter_cluster_name, @nested_datacenter_resource_pool_name, 'BOSH_VSPHERE_CPI_NESTED_DATACENTER_DATASTORE_PATTERN')
