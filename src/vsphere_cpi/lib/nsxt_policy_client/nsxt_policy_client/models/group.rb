  ...
  class Group
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'group_type')
        if (value = attributes[:'group_type']).is_a?(Array)
