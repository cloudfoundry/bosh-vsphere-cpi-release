...
module NSXTPolicy
  ...
  class ExternalIDExpression
    ...
    def valid?
      ...
      member_type_validator = EnumAttributeValidator.new('String', ['VirtualMachine', 'VirtualNetworkInterface', 'CloudNativeServiceInstance', 'BareMetalServer', 'BareMetalServerInterface'])
    ...
    def member_type=(member_type)
      validator = EnumAttributeValidator.new('String', ['VirtualMachine', 'VirtualNetworkInterface', 'CloudNativeServiceInstance', 'BareMetalServer', 'BareMetalServerInterface'])
