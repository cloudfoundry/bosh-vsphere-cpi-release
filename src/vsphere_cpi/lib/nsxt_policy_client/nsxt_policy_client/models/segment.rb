...
module NSXTPolicy
  ...
  class Segment
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, type, ls_id, subnets, domain_name, overlay_id, l2_extension, connectivity_path, vlan_ids, transport_zone_path, advanced_config, federation_config, metadata_proxy_paths, dhcp_config_path, bridge_profiles, address_bindings, admin_state, extra_configs, mac_pool_id, replication_mode, evpn_tenant_config_path, evpn_segment].hash
    end
