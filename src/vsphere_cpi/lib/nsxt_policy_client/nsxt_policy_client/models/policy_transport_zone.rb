...
module NSXTPolicy
  ...
  class PolicyTransportZone
    ...
    # Flag to indicate if the transport zone is the default one. Only one transport zone can be the default one for a given transport zone type. This is  allowed only when the system created default transport zone has the  flag is_default set to true for a given transport zone type which is being requested. 
    attr_accessor :is_default

    # Policy Transport Zone Profile paths
    attr_accessor :transport_zone_profile_paths
    ...
    # Transport Zone Forwarding Mode, must be one of either IPV4_ONLY or IPV6_ONLY or IPV4_AND_IPV6. Default is IPV4_ONLY. 
    attr_accessor :forwarding_mode
    ...
    attr_accessor :authorized_vlans
    ...
    def self.swagger_types
      {
        ...
        :'tz_type' => :'String',
        :'is_default' => :'BOOLEAN',
        :'transport_zone_profile_paths' => :'Array<String>',
        :'uplink_teaming_policy_names' => :'Array<String>',
        :'nested_nsx' => :'BOOLEAN',
        :'origin_id' => :'String',
        :'forwarding_mode' => :'String',
        :'authorized_vlans' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'transport_zone_profile_paths')
        if (value = attributes[:'transport_zone_profile_paths']).is_a?(Array)
          self.transport_zone_profile_paths = value
        end
      end
      ...
      if attributes.has_key?(:'forwarding_mode')
        self.forwarding_mode = attributes[:'forwarding_mode']
      end

      if attributes.has_key?(:'authorized_vlans')
        if (value = attributes[:'authorized_vlans']).is_a?(Array)
          self.authorized_vlans = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tz_type.nil?
        invalid_properties.push('invalid value for "tz_type", tz_type cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tz_type.nil?
      tz_type_validator = EnumAttributeValidator.new('String', ['OVERLAY_STANDARD', 'OVERLAY_ENS', 'VLAN_BACKED', 'OVERLAY_BACKED', 'UNKNOWN'])
      return false unless tz_type_validator.valid?(@tz_type)
      forwarding_mode_validator = EnumAttributeValidator.new('String', ['IPV4_ONLY', 'IPV6_ONLY', 'IPV4_AND_IPV6'])
      return false unless forwarding_mode_validator.valid?(@forwarding_mode)
      true
    end
    ...
    def tz_type=(tz_type)
      validator = EnumAttributeValidator.new('String', ['OVERLAY_STANDARD', 'OVERLAY_ENS', 'VLAN_BACKED', 'OVERLAY_BACKED', 'UNKNOWN'])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] forwarding_mode Object to be assigned
    def forwarding_mode=(forwarding_mode)
      validator = EnumAttributeValidator.new('String', ['IPV4_ONLY', 'IPV6_ONLY', 'IPV4_AND_IPV6'])
      unless validator.valid?(forwarding_mode)
        fail ArgumentError, 'invalid value for "forwarding_mode", must be one of #{validator.allowable_values}.'
      end
      @forwarding_mode = forwarding_mode
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transport_zone_profile_paths == o.transport_zone_profile_paths &&
          uplink_teaming_policy_names == o.uplink_teaming_policy_names &&
          nested_nsx == o.nested_nsx &&
          origin_id == o.origin_id &&
          forwarding_mode == o.forwarding_mode &&
          authorized_vlans == o.authorized_vlans
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, nsx_id, tz_type, is_default, transport_zone_profile_paths, uplink_teaming_policy_names, nested_nsx, origin_id, forwarding_mode, authorized_vlans].hash
    end
