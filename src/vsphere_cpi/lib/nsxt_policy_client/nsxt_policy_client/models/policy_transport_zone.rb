...
module NSXTPolicy
  ...
  class PolicyTransportZone
    ...
    def valid?
      ...
      tz_type_validator = EnumAttributeValidator.new('String', ['OVERLAY_STANDARD', 'OVERLAY_ENS', 'VLAN_BACKED', 'UNKNOWN', 'OVERLAY_BACKED'])
    ...
    def tz_type=(tz_type)
      validator = EnumAttributeValidator.new('String', ['OVERLAY_STANDARD', 'OVERLAY_ENS', 'VLAN_BACKED', 'UNKNOWN', 'OVERLAY_BACKED'])
