...
module NSXTPolicy
  class VirtualMachine
    ...
    def self.swagger_types
      {
        ...
        :'runtime_info' => :'VirtualMachineRuntimeInfo'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'uptv2_enabled')
        self.uptv2_enabled = attributes[:'uptv2_enabled']
      end

      if attributes.has_key?(:'runtime_info')
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['EDGE', 'SERVICE', 'REGULAR', 'MP', 'INTELLIGENCE', 'VC_SYSTEM', 'UNKNOWN'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['EDGE', 'SERVICE', 'REGULAR', 'MP', 'INTELLIGENCE', 'VC_SYSTEM', 'UNKNOWN'])
    ...
    def hash
      [_self, _links, _schema, resource_type, _last_sync_time, display_name, description, tags, scope, host_id, source, external_id, power_state, local_id_on_host, compute_ids, type, guest_info, uptv2_enabled, runtime_info].hash
    end
