...
module NSXTPolicy
  ...
  class PolicyResourceReferenceForEP
    ...
    # This is a UUID generated by the system for knowing who owns this resource. This is used in NSX+. 
    attr_accessor :owner_id

    # Project scope of policy resource
    attr_accessor :project_scope

    # This is a UUID generated by the system for knowing which site owns this group. This is used in NSX+. 
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'project_scope')
        if (value = attributes[:'project_scope']).is_a?(Array)
          self.project_scope = value
        end
      end
    ...
    def hash
      [target_id, target_display_name, target_type, is_valid, path, owner_id, project_scope, origin_site_id, remote_path].hash
    end
