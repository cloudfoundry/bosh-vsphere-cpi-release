...
module NSXTPolicy
  class VirtualNetworkInterface
    ...
    def hash
      [_self, _links, _schema, resource_type, _last_sync_time, display_name, description, tags, scope, external_id, owner_vm_id, owner_vm_type, host_id, vm_local_id_on_host, device_key, device_name, mac_address, lport_attachment_id, ip_address_info, uptv2_enabled].hash
    end
