...
module NSXTPolicy
  ...
  class Condition
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'scope_operator')
        self.scope_operator = attributes[:'scope_operator']
      end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['Condition', 'ConjunctionOperator', 'NestedExpression', 'IPAddressExpression', 'MACAddressExpression', 'ExternalIDExpression', 'PathExpression', 'IdentityGroupExpression', 'GeoLocationExpression'])
      return false unless resource_type_validator.valid?(@resource_type)
      return false if !@display_name.nil? && @display_name.to_s.length > 255
      return false if !@description.nil? && @description.to_s.length > 1024
      return false if @member_type.nil?
      member_type_validator = EnumAttributeValidator.new('String', ['IPSet', 'VirtualMachine', 'LogicalPort', 'LogicalSwitch', 'Segment', 'SegmentPort', 'Pod', 'Service', 'Namespace', 'TransportNode', 'Group', 'DVPG', 'DVPort', 'IPAddress', 'VpcSubnet', 'KubernetesCluster', 'KubernetesNamespace', 'AntreaEgress', 'AntreaIPPool', 'KubernetesIngress', 'KubernetesGateway', 'KubernetesService', 'KubernetesNode', 'VpcSubnetPort', 'BareMetalServer', 'BareMetalServerInterface'])
      return false unless member_type_validator.valid?(@member_type)
      return false if @key.nil?
      key_validator = EnumAttributeValidator.new('String', ['Tag', 'Name', 'OSName', 'ComputerName', 'NodeType', 'GroupType', 'ALL', 'IPAddress', 'PodCidr', 'ManagementInterface', 'OSVersion'])
      return false unless key_validator.valid?(@key)
      operator_validator = EnumAttributeValidator.new('String', ['EQUALS', 'CONTAINS', 'STARTSWITH', 'ENDSWITH', 'NOTEQUALS', 'NOTIN', 'MATCHES', 'IN'])
      return false unless operator_validator.valid?(@operator)
      scope_operator_validator = EnumAttributeValidator.new('String', ['EQUALS', 'NOTEQUALS'])
      return false unless scope_operator_validator.valid?(@scope_operator)
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['Condition', 'ConjunctionOperator', 'NestedExpression', 'IPAddressExpression', 'MACAddressExpression', 'ExternalIDExpression', 'PathExpression', 'IdentityGroupExpression', 'GeoLocationExpression'])
    ...
    def member_type=(member_type)
      validator = EnumAttributeValidator.new('String', ['IPSet', 'VirtualMachine', 'LogicalPort', 'LogicalSwitch', 'Segment', 'SegmentPort', 'Pod', 'Service', 'Namespace', 'TransportNode', 'Group', 'DVPG', 'DVPort', 'IPAddress', 'VpcSubnet', 'KubernetesCluster', 'KubernetesNamespace', 'AntreaEgress', 'AntreaIPPool', 'KubernetesIngress', 'KubernetesGateway', 'KubernetesService', 'KubernetesNode', 'VpcSubnetPort', 'BareMetalServer', 'BareMetalServerInterface'])
    ...
    def key=(key)
      validator = EnumAttributeValidator.new('String', ['Tag', 'Name', 'OSName', 'ComputerName', 'NodeType', 'GroupType', 'ALL', 'IPAddress', 'PodCidr', 'ManagementInterface', 'OSVersion'])
    ...
    def operator=(operator)
      validator = EnumAttributeValidator.new('String', ['EQUALS', 'CONTAINS', 'STARTSWITH', 'ENDSWITH', 'NOTEQUALS', 'NOTIN', 'MATCHES', 'IN'])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] scope_operator Object to be assigned
    def scope_operator=(scope_operator)
      validator = EnumAttributeValidator.new('String', ['EQUALS', 'NOTEQUALS'])
      unless validator.valid?(scope_operator)
        fail ArgumentError, 'invalid value for "scope_operator", must be one of #{validator.allowable_values}.'
      end
      @scope_operator = scope_operator
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          key == o.key &&
          operator == o.operator &&
          scope_operator == o.scope_operator &&
          value == o.value &&
          exclude == o.exclude
    end
