...
module NSXTPolicy
  ...
  class SegmentPort
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, attachment, address_bindings, source_site_id, admin_state, extra_configs, ignored_address_bindings, init_state, origin_id, tofu_version].hash
    end
