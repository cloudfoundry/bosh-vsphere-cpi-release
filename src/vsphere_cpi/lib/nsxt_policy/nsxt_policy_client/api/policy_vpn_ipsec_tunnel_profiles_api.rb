...
module NSXTPolicyClient
  class PolicyVpnIpsecTunnelProfilesApi
    ...
    def create_or_patch_ip_sec_vpn_tunnel_profile_with_http_info(tunnel_profile_id, ip_sec_vpn_tunnel_profile, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyVpnIpsecTunnelProfilesApi.create_or_patch_ip_sec_vpn_tunnel_profile ...'
      end
      # verify the required parameter 'tunnel_profile_id' is set
      if @api_client.config.client_side_validation && tunnel_profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'tunnel_profile_id' when calling PolicyVpnIpsecTunnelProfilesApi.create_or_patch_ip_sec_vpn_tunnel_profile"
      end
      ...
      if @api_client.config.client_side_validation && ip_sec_vpn_tunnel_profile.nil?
        fail ArgumentError, "Missing the required parameter 'ip_sec_vpn_tunnel_profile' when calling PolicyVpnIpsecTunnelProfilesApi.create_or_patch_ip_sec_vpn_tunnel_profile"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyVpnIpsecTunnelProfilesApi#create_or_patch_ip_sec_vpn_tunnel_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def create_or_update_ip_sec_vpn_tunnel_profile_with_http_info(tunnel_profile_id, ip_sec_vpn_tunnel_profile, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyVpnIpsecTunnelProfilesApi.create_or_update_ip_sec_vpn_tunnel_profile ...'
      end
      # verify the required parameter 'tunnel_profile_id' is set
      if @api_client.config.client_side_validation && tunnel_profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'tunnel_profile_id' when calling PolicyVpnIpsecTunnelProfilesApi.create_or_update_ip_sec_vpn_tunnel_profile"
      end
      # verify the required parameter 'ip_sec_vpn_tunnel_profile' is set
      if @api_client.config.client_side_validation && ip_sec_vpn_tunnel_profile.nil?
        fail ArgumentError, "Missing the required parameter 'ip_sec_vpn_tunnel_profile' when calling PolicyVpnIpsecTunnelProfilesApi.create_or_update_ip_sec_vpn_tunnel_profile"
      end
      # resource path
      local_var_path = '/infra/ipsec-vpn-tunnel-profiles/{tunnel-profile-id}'.sub('{' + 'tunnel-profile-id' + '}', tunnel_profile_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyVpnIpsecTunnelProfilesApi#create_or_update_ip_sec_vpn_tunnel_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_ip_sec_vpn_tunnel_profile_with_http_info(tunnel_profile_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyVpnIpsecTunnelProfilesApi.delete_ip_sec_vpn_tunnel_profile ...'
      end
      # verify the required parameter 'tunnel_profile_id' is set
      if @api_client.config.client_side_validation && tunnel_profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'tunnel_profile_id' when calling PolicyVpnIpsecTunnelProfilesApi.delete_ip_sec_vpn_tunnel_profile"
      end
      # resource path
      local_var_path = '/infra/ipsec-vpn-tunnel-profiles/{tunnel-profile-id}'.sub('{' + 'tunnel-profile-id' + '}', tunnel_profile_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyVpnIpsecTunnelProfilesApi#delete_ip_sec_vpn_tunnel_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_ip_sec_vpn_tunnel_profile_with_http_info(tunnel_profile_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyVpnIpsecTunnelProfilesApi.get_ip_sec_vpn_tunnel_profile ...'
      end
      # verify the required parameter 'tunnel_profile_id' is set
      if @api_client.config.client_side_validation && tunnel_profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'tunnel_profile_id' when calling PolicyVpnIpsecTunnelProfilesApi.get_ip_sec_vpn_tunnel_profile"
      end
      # resource path
      local_var_path = '/infra/ipsec-vpn-tunnel-profiles/{tunnel-profile-id}'.sub('{' + 'tunnel-profile-id' + '}', tunnel_profile_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'IPSecVpnTunnelProfile')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyVpnIpsecTunnelProfilesApi#get_ip_sec_vpn_tunnel_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_ip_sec_vpn_tunnel_profiles_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyVpnIpsecTunnelProfilesApi.list_ip_sec_vpn_tunnel_profiles ...'
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling PolicyVpnIpsecTunnelProfilesApi.list_ip_sec_vpn_tunnel_profiles, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling PolicyVpnIpsecTunnelProfilesApi.list_ip_sec_vpn_tunnel_profiles, must be greater than or equal to 0.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyVpnIpsecTunnelProfilesApi#list_ip_sec_vpn_tunnel_profiles\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
