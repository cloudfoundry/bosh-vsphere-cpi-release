  ...
  class PolicyGlobalConfigApi
    ...
    def patch_global_config_with_http_info(global_config, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGlobalConfigApi.patch_global_config ...'
      end
      # verify the required parameter 'global_config' is set
      if @api_client.config.client_side_validation && global_config.nil?
        fail ArgumentError, "Missing the required parameter 'global_config' when calling PolicyGlobalConfigApi.patch_global_config"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGlobalConfigApi#patch_global_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def read_global_config_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGlobalConfigApi.read_global_config ...'
      end
      # resource path
      local_var_path = '/infra/global-config'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGlobalConfigApi#read_global_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update the global configuration
    ...
    def update_global_config_with_http_info(global_config, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGlobalConfigApi.update_global_config ...'
      end
      # verify the required parameter 'global_config' is set
      if @api_client.config.client_side_validation && global_config.nil?
        fail ArgumentError, "Missing the required parameter 'global_config' when calling PolicyGlobalConfigApi.update_global_config"
      end
      # resource path
      local_var_path = '/infra/global-config'
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'GlobalConfig')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGlobalConfigApi#update_global_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
