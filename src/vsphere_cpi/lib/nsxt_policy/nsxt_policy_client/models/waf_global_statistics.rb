...
module NSXTPolicyClient
  ...
  class WAFGlobalStatistics
    # Number of HTTP requests denied by WAF
    attr_accessor :requests_denied

    # Number of HTTP requests detected by WAF
    attr_accessor :requests_detected

    # If a global exception prevents WAF evaluation for an HTTP request, then it is not counted. 
    attr_accessor :requests_inspected
    ...
    def self.swagger_types
      {
        :'requests_denied' => :'Integer',
        :'requests_detected' => :'Integer',
        :'requests_inspected' => :'Integer',
        :'time_start' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'requests_denied')
        self.requests_denied = attributes[:'requests_denied']
      end

      if attributes.has_key?(:'requests_detected')
        self.requests_detected = attributes[:'requests_detected']
      end

      if attributes.has_key?(:'requests_inspected')
        self.requests_inspected = attributes[:'requests_inspected']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          requests_denied == o.requests_denied &&
          requests_detected == o.requests_detected &&
          requests_inspected == o.requests_inspected &&
    ...
    def hash
      [requests_denied, requests_detected, requests_inspected, time_start].hash
    end
