...
module NSXTPolicyClient
  class VmToolsInfo
    ...
    def hash
      [_links, _schema, _self, _last_sync_time, description, display_name, resource_type, tags, external_id, file_agent_version, host_local_id, network_agent_version, source, tools_version, vm_type].hash
    end
