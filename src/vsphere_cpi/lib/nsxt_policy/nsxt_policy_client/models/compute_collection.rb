...
module NSXTPolicyClient
  class ComputeCollection
    ...
    def hash
      [_links, _schema, _self, _last_sync_time, description, display_name, resource_type, tags, cm_local_id, external_id, origin_id, origin_properties, origin_type, owner_id].hash
    end
