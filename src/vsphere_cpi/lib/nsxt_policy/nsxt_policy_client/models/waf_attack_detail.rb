...
module NSXTPolicyClient
  # Attack detail in WAF transaction log including rule and category information. For the HTTP transaction with attack behavior, it contains a list of rules that matched in this transaction. 
  class WAFAttackDetail
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rule_display_name')
    ...
    def hash
      [anomaly_score, category_name, rule_display_name, rule_id].hash
    end
