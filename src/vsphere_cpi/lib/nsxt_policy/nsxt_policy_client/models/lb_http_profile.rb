...
module NSXTPolicyClient
  ...
  class LBHttpProfile
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, parent_path, path, relative_path, children, marked_for_delete, http_redirect_to, http_redirect_to_https, idle_timeout, ntlm, request_body_size, request_header_size, response_header_size, response_timeout, x_forwarded_for].hash
    end
