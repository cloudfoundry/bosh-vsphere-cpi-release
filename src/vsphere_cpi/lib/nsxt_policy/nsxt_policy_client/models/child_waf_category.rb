...
module NSXTPolicyClient
  ...
  class ChildWAFCategory
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'WAFCategory')
        self.waf_category = attributes[:'WAFCategory']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @waf_category.nil?
        invalid_properties.push('invalid value for "waf_category", waf_category cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @waf_category.nil?
      true
    end
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, marked_for_delete, waf_category].hash
    end
