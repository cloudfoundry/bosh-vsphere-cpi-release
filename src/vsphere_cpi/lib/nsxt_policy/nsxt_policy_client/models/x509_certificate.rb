...
module NSXTPolicyClient
  class X509Certificate
    ...
    def hash
      [dsa_public_key_g, dsa_public_key_p, dsa_public_key_q, dsa_public_key_y, ecdsa_curve_name, ecdsa_ec_field, ecdsa_ec_field_f2mks, ecdsa_ec_field_f2mm, ecdsa_ec_field_f2mrp, ecdsa_ec_field_f2pp, ecdsa_public_key_a, ecdsa_public_key_b, ecdsa_public_key_cofactor, ecdsa_public_key_generator_x, ecdsa_public_key_generator_y, ecdsa_public_key_order, ecdsa_public_key_seed, is_ca, is_valid, issuer, issuer_cn, not_after, not_before, public_key_algo, public_key_length, rsa_public_key_exponent, rsa_public_key_modulus, serial_number, signature, signature_algorithm, subject, subject_cn, version].hash
    end
