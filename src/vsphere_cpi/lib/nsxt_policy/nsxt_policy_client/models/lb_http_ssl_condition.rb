...
module NSXTPolicyClient
  ...
  class LBHttpSslCondition
    ...
    def hash
      [inverse, type, client_certificate_issuer_dn, client_certificate_subject_dn, client_supported_ssl_ciphers, session_reused, used_protocol, used_ssl_cipher].hash
    end
