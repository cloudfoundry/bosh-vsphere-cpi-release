...
module NSXTPolicyClient
  class VirtualNetworkInterface
    ...
    def hash
      [_links, _schema, _self, _last_sync_time, description, display_name, resource_type, tags, device_key, device_name, external_id, host_id, ip_address_info, lport_attachment_id, mac_address, owner_vm_id, owner_vm_type, vm_local_id_on_host].hash
    end
