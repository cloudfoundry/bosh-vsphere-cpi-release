...
module NSXTPolicyClient
  ...
  class ContainerNetworkPolicy
    ...
    def hash
      [_links, _schema, _self, _last_sync_time, description, display_name, resource_type, tags, container_cluster_id, container_project_id, external_id, origin_properties, policy_type, spec].hash
    end
