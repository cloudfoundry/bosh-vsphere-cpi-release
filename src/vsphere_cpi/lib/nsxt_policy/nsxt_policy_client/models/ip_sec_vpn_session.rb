...
module NSXTPolicyClient
  ...
  class IPSecVpnSession
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, parent_path, path, relative_path, children, marked_for_delete, authentication_mode, compliance_suite, connection_initiation_mode, dpd_profile_path, enabled, ike_profile_path, local_endpoint_path, peer_address, peer_id, psk, tcp_mss_clamping, tunnel_profile_path].hash
    end
