...
module NSXTPolicyClient
  ...
  class LBServiceUsage
    ...
    def hash
      [alarm, enforcement_point_path, resource_type, current_pool_count, current_pool_member_count, current_virtual_server_count, last_update_timestamp, pool_capacity, pool_member_capacity, service_path, service_size, severity, usage_percentage, virtual_server_capacity].hash
    end
