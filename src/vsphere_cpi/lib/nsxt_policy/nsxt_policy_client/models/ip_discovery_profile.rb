...
module NSXTPolicyClient
  ...
  class IPDiscoveryProfile
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, parent_path, path, relative_path, children, marked_for_delete, arp_nd_binding_timeout, duplicate_ip_detection, ip_v4_discovery_options, ip_v6_discovery_options, tofu_enabled].hash
    end
