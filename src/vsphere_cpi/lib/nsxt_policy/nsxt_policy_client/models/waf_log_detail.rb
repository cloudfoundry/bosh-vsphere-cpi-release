...
module NSXTPolicyClient
  # Detail of WAF transaction log. Transaction log consists of multiple independent sections. Each section has a name and corresponding value. 
  class WAFLogDetail
    # Specifies section name in transaction log
    attr_accessor :section_name

    # Log value of the section
    attr_accessor :section_value
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'section_name')
        self.section_name = attributes[:'section_name']
      end

      if attributes.has_key?(:'section_value')
        self.section_value = attributes[:'section_value']
      end
    end
    ...
    def hash
      [section_name, section_value].hash
    end
