...
module NSXTPolicyClient
  ...
  class BgpRoutingConfig
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, parent_path, path, relative_path, children, marked_for_delete, ecmp, enabled, graceful_restart, graceful_restart_config, inter_sr_ibgp, local_as_num, multipath_relax, route_aggregations].hash
    end
