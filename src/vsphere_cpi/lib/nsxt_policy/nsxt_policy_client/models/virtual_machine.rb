...
module NSXTPolicyClient
  class VirtualMachine
    ...
    def hash
      [_links, _schema, _self, _last_sync_time, description, display_name, resource_type, tags, compute_ids, external_id, guest_info, host_id, local_id_on_host, power_state, source, type].hash
    end
