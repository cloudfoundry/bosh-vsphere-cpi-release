...
module NSXTPolicyClient
  ...
  class TaskProperties
    ...
    def hash
      [_links, _schema, _self, async_response_available, cancelable, description, end_time, id, message, progress, request_method, request_uri, start_time, status, user].hash
    end
