...
module NSXTPolicyClient
  ...
  class LBClientSslProfile
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, parent_path, path, relative_path, children, marked_for_delete, cipher_group_label, ciphers, is_fips, is_secure, prefer_server_ciphers, protocols, session_cache_enabled, session_cache_timeout].hash
    end
