...
module NSXTPolicyClient
  ...
  class ChildWAFRule
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'WAFRule')
        self.waf_rule = attributes[:'WAFRule']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @waf_rule.nil?
        invalid_properties.push('invalid value for "waf_rule", waf_rule cannot be nil.')
      end
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, marked_for_delete, waf_rule].hash
    end
