...
module NSXTPolicyClient
  ...
  class LabelValueConfiguration
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, datasources, drilldown_id, footer, icons, is_drilldown, legend, shared, weight, layout, navigation, properties, sub_type].hash
    end
