...
module NSXTPolicyClient
  ...
  class ContainerApplication
    ...
    def hash
      [_links, _schema, _self, _last_sync_time, description, display_name, resource_type, tags, container_cluster_id, container_project_id, external_id, labels, origin_properties, status].hash
    end
