...
module NSXTPolicyClient
  class RuleStatistics
    ...
    def hash
      [_links, _schema, _self, byte_count, hit_count, internal_rule_id, lr_path, max_popularity_index, max_session_count, packet_count, popularity_index, rule, session_count, total_session_count].hash
    end
