...
module NSXTPolicyClient
  ...
  class IPSecVpnSessionStatusNsxT
    ...
    def hash
      [alarm, enforcement_point_path, resource_type, aggregate_traffic_counters, failed_tunnels, ike_status, last_update_timestamp, negotiated_tunnels, runtime_status, total_tunnels].hash
    end
