...
module NSXTPolicyClient
  ...
  class L2VpnPerSegmentTrafficStatistics
    ...
    def hash
      [bum_bytes_in, bum_bytes_out, bum_packets_in, bum_packets_out, bytes_in, bytes_out, packets_in, packets_out, packets_receive_error, packets_sent_error, segment_path].hash
    end
