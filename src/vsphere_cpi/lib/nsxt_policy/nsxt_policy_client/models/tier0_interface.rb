...
module NSXTPolicyClient
  ...
  class Tier0Interface
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, parent_path, path, relative_path, children, marked_for_delete, subnets, edge_cluster_member_index, edge_path, ipv6_profile_paths, ls_id, mtu, segment_path, type].hash
    end
