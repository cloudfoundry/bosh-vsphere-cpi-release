...
module NSXTPolicyClient
  class DiscoveredNode
    ...
    def hash
      [_links, _schema, _self, _last_sync_time, description, display_name, resource_type, tags, certificate, cm_local_id, external_id, hardware_id, ip_addresses, node_type, origin_id, origin_properties, os_type, os_version, parent_compute_collection, stateless].hash
    end
