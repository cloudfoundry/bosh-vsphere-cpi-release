...
module NSXTPolicyClient
  class LogicalRouterState
    ...
    def valid?
      state_validator = EnumAttributeValidator.new('String', ['pending', 'in_progress', 'success', 'failed', 'partial_success', 'orphaned', 'unknown', 'error'])
    ...
    def hash
      [details, failure_code, failure_message, state].hash
    end
