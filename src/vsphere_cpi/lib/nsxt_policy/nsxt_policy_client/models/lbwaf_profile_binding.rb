...
module NSXTPolicyClient
  ...
  class LBWAFProfileBinding
    ...
    # In DETECTION mode, WAF will detect and only report to log what it considers an attack, but will not reject the requests. In PROTECTION mode, WAF will detect and reject the requests if the requests match the rules. IN DISABLED mode, WAF will be disabled. 
    attr_accessor :operational_mode

    # WAF Profile path
    attr_accessor :waf_profile_path
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'waf_profile_path')
        self.waf_profile_path = attributes[:'waf_profile_path']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @waf_profile_path.nil?
        invalid_properties.push('invalid value for "waf_profile_path", waf_profile_path cannot be nil.')
      end
    ...
    def valid?
      ...
      operational_mode_validator = EnumAttributeValidator.new('String', ['DETECTION', 'PROTECTION', 'DISABLED'])
      return false unless operational_mode_validator.valid?(@operational_mode)
      return false if @waf_profile_path.nil?
      true
    end
    ...
    def operational_mode=(operational_mode)
      validator = EnumAttributeValidator.new('String', ['DETECTION', 'PROTECTION', 'DISABLED'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          waf_profile_path == o.waf_profile_path
    end
    ...
    def hash
      [debug_log_level, operational_mode, waf_profile_path].hash
    end
