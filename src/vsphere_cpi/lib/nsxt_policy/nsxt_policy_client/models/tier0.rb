...
module NSXTPolicyClient
  ...
  class Tier0
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, parent_path, path, relative_path, children, marked_for_delete, default_rule_logging, dhcp_config_paths, disable_firewall, failover_mode, force_whitelisting, ha_mode, internal_transit_subnets, ipv6_profile_paths, transit_subnets].hash
    end
