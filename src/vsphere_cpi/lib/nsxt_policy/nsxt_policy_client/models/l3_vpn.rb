...
module NSXTPolicyClient
  ...
  class L3Vpn
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, parent_path, path, relative_path, children, marked_for_delete, dh_groups, enable_perfect_forward_secrecy, enabled, ike_digest_algorithms, ike_encryption_algorithms, ike_version, l3vpn_session, local_address, passphrases, remote_private_address, remote_public_address, tunnel_digest_algorithms, tunnel_encryption_algorithms].hash
    end
