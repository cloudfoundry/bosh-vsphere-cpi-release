...
module NSXTPolicyClient
  ...
  class LBServiceUsageSummary
    ...
    def hash
      [current_pool_count, current_pool_member_count, current_virtual_server_count, pool_capacity, pool_member_capacity, pool_member_severity, pool_member_usage_percentage, pool_severity, pool_usage_percentage, service_counts, service_usages, virtual_server_capacity, virtual_server_severity, virtual_server_usage_percentage].hash
    end
