...
module NSXTPolicyClient
  ...
  class PolicyDraft
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, parent_path, path, relative_path, children, marked_for_delete, is_auto_draft, lock_comments, lock_modified_by, lock_modified_time, locked, ref_draft_path, system_area, user_area].hash
    end
