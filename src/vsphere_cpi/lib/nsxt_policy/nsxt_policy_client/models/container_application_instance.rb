...
module NSXTPolicyClient
  ...
  class ContainerApplicationInstance
    ...
    def hash
      [_links, _schema, _self, _last_sync_time, description, display_name, resource_type, tags, cluster_node_id, container_application_ids, container_cluster_id, container_project_id, external_id, labels, origin_properties, status].hash
    end
