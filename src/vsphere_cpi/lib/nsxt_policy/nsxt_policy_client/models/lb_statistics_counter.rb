...
module NSXTPolicyClient
  class LBStatisticsCounter
    ...
    def hash
      [bytes_in, bytes_in_rate, bytes_out, bytes_out_rate, current_session_rate, current_sessions, http_request_rate, http_requests, max_sessions, packets_in, packets_in_rate, packets_out, packets_out_rate, source_ip_persistence_entry_size, total_sessions].hash
    end
