...
module NSXTPolicyClient
  ...
  class CustomPolicyLbVirtualServer
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, parent_path, path, relative_path, children, marked_for_delete, access_log_enabled, ip_address, lb_persistence_profile, ports, router_path, traffic_source, insert_client_ip_header, app_protocol, client_ssl_certificate_ids, client_ssl_settings, default_client_ssl_certificate_id, server_auth_ca_certificate_ids, server_ssl_settings].hash
    end
