...
module NSXTPolicyClient
  ...
  class PolicyServiceInstance
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, parent_path, path, relative_path, children, marked_for_delete, deployment_mode, partner_service_name, transport_type, attributes, compute_id, context_id, deployment_spec_name, deployment_template_name, failure_policy, primary_interface_mgmt_ip, primary_interface_network, secondary_interface_mgmt_ip, secondary_interface_network, storage_id].hash
    end
