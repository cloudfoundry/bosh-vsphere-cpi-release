...
module NSXTPolicyClient
  ...
  class RealizedLogicalSwitch
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, parent_path, path, relative_path, alarms, intent_reference, realization_api, realization_specific_identifier, runtime_error, runtime_status, state, logical_switch_id, transport_zone_id].hash
    end
