...
module NSXTPolicyClient
  ...
  class ChildWAFRuleset
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'WAFRuleset')
        self.waf_ruleset = attributes[:'WAFRuleset']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @waf_ruleset.nil?
        invalid_properties.push('invalid value for "waf_ruleset", waf_ruleset cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @waf_ruleset.nil?
      true
    end
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, marked_for_delete, waf_ruleset].hash
    end
