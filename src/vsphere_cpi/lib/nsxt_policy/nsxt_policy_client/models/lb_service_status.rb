...
module NSXTPolicyClient
  class LBServiceStatus
    ...
    def hash
      [alarm, enforcement_point_path, resource_type, active_transport_nodes, cpu_usage, error_message, last_update_timestamp, memory_usage, pools, service_path, service_status, standby_transport_nodes, virtual_servers].hash
    end
