...
module NSXTPolicyClient
  ...
  class BgpNeighborConfig
    ...
    # Specify path of prefix-list or route map to filter routes for IN direction. This property is deprecated, use route_filtering instead. Both properties cannot be used together. 
    ...
    # Specify path of prefix-list or route map to filter routes for OUT direction. When not specified, a built-in prefix-list named 'prefixlist-out-default' is automatically applied. This property is deprecated, use route_filtering instead. Both properties cannot be used together. 
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, parent_path, path, relative_path, children, marked_for_delete, allow_as_in, bfd, graceful_restart_mode, hold_down_time, in_route_filters, keep_alive_time, maximum_hop_limit, neighbor_address, out_route_filters, password, remote_as_num, route_filtering, source_addresses].hash
    end
