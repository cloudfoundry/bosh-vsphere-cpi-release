...
module NSXTPolicyClient
  ...
  class ServiceDefinition
    ...
    def hash
      [_links, _schema, _self, _revision, _create_time, _create_user, _last_modified_time, _last_modified_user, _protection, _system_owned, description, display_name, id, resource_type, tags, attachment_point, functionalities, implementations, on_failure_policy, service_capability, service_deployment_spec, service_manager_id, transports, vendor_id].hash
    end
