...
module NSXTPolicyClient
  ...
  class LBEdgeNodeUsage
    ...
    def hash
      [node_path, resource_type, current_large_load_balancer_count, current_load_balancer_credits, current_medium_load_balancer_count, current_pool_count, current_pool_member_count, current_small_load_balancer_count, current_virtual_server_count, edge_cluster_path, form_factor, load_balancer_credit_capacity, pool_member_capacity, remaining_large_load_balancer_count, remaining_medium_load_balancer_count, remaining_small_load_balancer_count, severity, usage_percentage].hash
    end
