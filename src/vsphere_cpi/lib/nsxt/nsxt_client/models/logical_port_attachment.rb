...
module NSXT
  ...
  class LogicalPortAttachment
    ...
    def valid?
      attachment_type_validator = EnumAttributeValidator.new('String', ["VIF", "LOGICALROUTER", "BRIDGEENDPOINT", "DHCP_SERVICE", "METADATA_PROXY"])
    ...
    def attachment_type=(attachment_type)
      validator = EnumAttributeValidator.new('String', ["VIF", "LOGICALROUTER", "BRIDGEENDPOINT", "DHCP_SERVICE", "METADATA_PROXY"])
