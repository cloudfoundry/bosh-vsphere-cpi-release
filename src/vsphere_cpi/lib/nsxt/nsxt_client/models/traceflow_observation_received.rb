...
module NSXT
  ...
  class TraceflowObservationReceived
    ...
    def hash
      [resource_type, component_type, transport_node_id, timestamp, transport_node_name, sequence_no, timestamp_micro, component_name, vtep_label, uplink_name, local_ip_address, remote_ip_address].hash
    end
