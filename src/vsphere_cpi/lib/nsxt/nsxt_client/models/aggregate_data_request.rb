...
module NSXT
  # Request parameters for the primary and the related resource types
  class AggregateDataRequest
    # Request parameters for the primary type
    attr_accessor :primary

    # Request parameters for the related type
    ...
    def self.swagger_types
      {
        ...
        :'related' => :'Array<RelatedDataRequest>'
      }
    end
