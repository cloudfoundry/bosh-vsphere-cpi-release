...
module NSXT
  ...
  class MetadataProxy
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, secret, metadata_server_ca_ids, edge_cluster_member_indexes, crypto_protocols, metadata_server_url, attached_logical_port_id, edge_cluster_id].hash
    end
