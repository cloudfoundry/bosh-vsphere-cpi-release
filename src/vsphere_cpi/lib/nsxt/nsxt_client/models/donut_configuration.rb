...
module NSXT
  ...
  class DonutConfiguration
    ...
    # Supported visualization types are LabelValueConfiguration, DonutConfiguration, MultiWidgetConfiguration and ContainerConfiguration.
    ...
    # Defaults to false. Set to true to publish the widgetconfiguration to other users.
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ["LabelValueConfiguration", "DonutConfiguration", "MultiWidgetConfiguration", "ContainerConfiguration"])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ["LabelValueConfiguration", "DonutConfiguration", "MultiWidgetConfiguration", "ContainerConfiguration"])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, datasources, weight, footer, shared, navigation, display_count, sections, label].hash
    end
