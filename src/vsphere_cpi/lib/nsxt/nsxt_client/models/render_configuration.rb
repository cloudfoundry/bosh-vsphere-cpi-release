...
module NSXT
  ...
  class RenderConfiguration
    ...
    # Text to be shown on tooltip while hovering over the UI element if the condition is met.
    ...
    def valid?
      color_validator = EnumAttributeValidator.new('String', ["GREY", "SKY_BLUE", "BLUE", "GREEN", "YELLOW", "RED"])
    ...
    def color=(color)
      validator = EnumAttributeValidator.new('String', ["GREY", "SKY_BLUE", "BLUE", "GREEN", "YELLOW", "RED"])
