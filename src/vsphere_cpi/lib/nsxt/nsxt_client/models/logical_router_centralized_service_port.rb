...
module NSXT
  ...
  class LogicalRouterCentralizedServicePort
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, logical_router_id, service_bindings, enable_netx, linked_logical_switch_port_id, urpf_mode, subnets].hash
    end
