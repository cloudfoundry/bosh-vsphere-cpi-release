...
module NSXT
  ...
  class LbHttpProfile
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, idle_timeout, ntlm, request_header_size, http_redirect_to_https, x_forwarded_for, http_redirect_to].hash
    end
