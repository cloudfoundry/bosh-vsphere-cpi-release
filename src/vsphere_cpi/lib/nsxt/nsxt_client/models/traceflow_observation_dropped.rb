...
module NSXT
  ...
  class TraceflowObservationDropped
    ...
    def valid?
      ...
      reason_validator = EnumAttributeValidator.new('String', ["ARP_FAIL", "BFD", "DHCP", "FW_RULE", "GENEVE", "GRE", "IFACE", "IP", "IP_REASS", "IPSEC", "IPSEC_VTI", "L2VPN", "L4PORT", "LB", "LROUTER", "LSERVICE", "LSWITCH", "MD_PROXY", "NAT", "NEIGH", "NO_ROUTE", "SERVICE_INSERT", "TTL_ZERO", "TUNNEL", "VXLAN", "VXSTT", "UNKNOWN"])
    ...
    def reason=(reason)
      validator = EnumAttributeValidator.new('String', ["ARP_FAIL", "BFD", "DHCP", "FW_RULE", "GENEVE", "GRE", "IFACE", "IP", "IP_REASS", "IPSEC", "IPSEC_VTI", "L2VPN", "L4PORT", "LB", "LROUTER", "LSERVICE", "LSWITCH", "MD_PROXY", "NAT", "NEIGH", "NO_ROUTE", "SERVICE_INSERT", "TTL_ZERO", "TUNNEL", "VXLAN", "VXSTT", "UNKNOWN"])
