...
module NSXT
  ...
  class LogicalPort
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, logical_switch_id, init_state, switching_profile_ids, attachment, admin_state, extra_configs, address_bindings].hash
    end
