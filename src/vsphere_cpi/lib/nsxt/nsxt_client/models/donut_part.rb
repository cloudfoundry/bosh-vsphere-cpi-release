...
module NSXT
  # Represents an entity or portion to be plotted on a donut chart
  class DonutPart
    # A numerical value that represents the portion or entity of the donut chart.
    attr_accessor :field
    ...
    # If a section 'template' holds this donut part, then the label is auto-generated from the fetched field values after applying the template.
    attr_accessor :label
    ...
    def hash
      [field, render_configuration, tooltip, label].hash
    end
