...
module NSXT
  ...
  class HostNode
    ...
    def valid?
      ...
      os_type_validator = EnumAttributeValidator.new('String', ["ESXI", "RHELKVM", "UBUNTUKVM", "HYPERV"])
    ...
    def os_type=(os_type)
      validator = EnumAttributeValidator.new('String', ["ESXI", "RHELKVM", "UBUNTUKVM", "HYPERV"])
