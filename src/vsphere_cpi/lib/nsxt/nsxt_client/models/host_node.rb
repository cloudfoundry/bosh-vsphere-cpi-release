...
module NSXT
  ...
  class HostNode
    ...
    def valid?
      ...
      os_type_validator = EnumAttributeValidator.new('String', ["ESXI", "RHELKVM", "UBUNTUKVM", "HYPERV", "RHELCONTAINER", "RHELSERVER", "UBUNTUSERVER", "CENTOSSERVER", "CENTOSKVM"])
    ...
    def os_type=(os_type)
      validator = EnumAttributeValidator.new('String', ["ESXI", "RHELKVM", "UBUNTUKVM", "HYPERV", "RHELCONTAINER", "RHELSERVER", "UBUNTUSERVER", "CENTOSSERVER", "CENTOSKVM"])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, discovered_ip_addresses, ip_addresses, external_id, fqdn, os_version, os_type, managed_by_server, host_credential, discovered_node_id].hash
    end
