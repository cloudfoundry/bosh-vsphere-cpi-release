...
module NSXT
  ...
  class TraceflowObservationDelivered
    ...
    def hash
      [resource_type, component_type, transport_node_id, timestamp, transport_node_name, sequence_no, timestamp_micro, component_name, lport_name, vlan_id, lport_id].hash
    end
