...
module NSXT
  ...
  class PBRRule
    ...
    def valid?
      ...
      action_validator = EnumAttributeValidator.new('String', ["ROUTE_TO_UNDERLAY_NAT", "ROUTE_TO_OVERLAY_NAT", "ROUTE_TO_UNDERLAY", "ROUTE_TO_OVERLAY"])
    ...
    def action=(action)
      validator = EnumAttributeValidator.new('String', ["ROUTE_TO_UNDERLAY_NAT", "ROUTE_TO_OVERLAY_NAT", "ROUTE_TO_UNDERLAY", "ROUTE_TO_OVERLAY"])
