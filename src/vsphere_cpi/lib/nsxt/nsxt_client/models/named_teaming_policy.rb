...
module NSXT
  ...
  class NamedTeamingPolicy
    ...
    def valid?
      ...
      policy_validator = EnumAttributeValidator.new('String', ["FAILOVER_ORDER", "LOADBALANCE_SRCID"])
    ...
    def policy=(policy)
      validator = EnumAttributeValidator.new('String', ["FAILOVER_ORDER", "LOADBALANCE_SRCID"])
