...
module NSXT
  ...
  class LogicalRouterLinkPortOnTIER1
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, logical_router_id, service_bindings, mac_address, subnets, linked_logical_router_port_id, edge_cluster_member_index].hash
    end
