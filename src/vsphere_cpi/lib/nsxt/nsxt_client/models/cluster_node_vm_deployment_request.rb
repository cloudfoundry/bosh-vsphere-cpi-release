...
module NSXT
  ...
  class ClusterNodeVMDeploymentRequest
    ...
    # Username and password settings for the cluster node VM. Note: These settings will be honored only during VM deployment. Post-deployment, CLI must be used for changing the user settings and changes to these parameters will not have any effect. 
    ...
    def valid?
      ...
      form_factor_validator = EnumAttributeValidator.new('String', ["SMALL", "MEDIUM", "MEDIUM_LARGE", "LARGE"])
    ...
    def form_factor=(form_factor)
      validator = EnumAttributeValidator.new('String', ["SMALL", "MEDIUM", "MEDIUM_LARGE", "LARGE"])
