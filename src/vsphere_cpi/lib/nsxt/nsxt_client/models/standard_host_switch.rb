...
module NSXT
  ...
  class StandardHostSwitch
    ...
    # CPU configuration specifies number of Logical cpu cores (Lcores) per Non Uniform Memory Access (NUMA) node dedicated to Enhnaced Networking Stack enabled HostSwitch to get the best performance.
    ...
    def hash
      [pnics, host_switch_name, ip_assignment_spec, cpu_config, host_switch_profile_ids].hash
    end
