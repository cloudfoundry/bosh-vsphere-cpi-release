...
module NSXT
  ...
  class FirewallStats
    ...
    # Aggregated number of sessions processed by the all firewall rules
    ...
    def hash
      [_self, _links, _schema, packet_count, byte_count, rule_id, total_session_count, session_count].hash
    end
