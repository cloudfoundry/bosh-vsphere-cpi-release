  ...
  class PrincipalIdentity
    ...
    def list_invalid_properties
      ...
      if @permission_group.nil?
        invalid_properties.push("invalid value for 'permission_group', permission_group cannot be nil.")
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, permission_group, node_id, name, is_protected, certificate_id].hash
    end
