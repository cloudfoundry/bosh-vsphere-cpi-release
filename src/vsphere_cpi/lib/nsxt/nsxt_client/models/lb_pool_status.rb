...
module NSXT
  ...
  class LbPoolStatus
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ["UP", "PARTIALLY_UP", "PRIMARY_DOWN", "DOWN", "DETACHED"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["UP", "PARTIALLY_UP", "PRIMARY_DOWN", "DOWN", "DETACHED"])
