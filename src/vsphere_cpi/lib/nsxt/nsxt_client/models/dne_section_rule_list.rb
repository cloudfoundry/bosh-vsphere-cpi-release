...
module NSXT
  ...
  class DneSectionRuleList
    ...
    def valid?
      ...
      section_type_validator = EnumAttributeValidator.new('String', ["LAYER3"])
    ...
    def section_type=(section_type)
      validator = EnumAttributeValidator.new('String', ["LAYER3"])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, is_default, rule_count, section_type, rules].hash
    end
