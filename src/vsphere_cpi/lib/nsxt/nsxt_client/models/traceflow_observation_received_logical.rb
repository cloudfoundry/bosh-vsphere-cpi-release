...
module NSXT
  ...
  class TraceflowObservationReceivedLogical
    ...
    def valid?
      ...
      src_component_type_validator = EnumAttributeValidator.new('String', ["PHYSICAL", "LR", "LS", "DFW", "BRIDGE", "EDGE_TUNNEL", "EDGE_HOSTSWITCH", "UNKNOWN"])
    ...
    def hash
      [resource_type, component_type, transport_node_id, timestamp, transport_node_name, sequence_no, timestamp_micro, component_name, src_component_id, component_id, lport_id, src_component_type, lport_name, src_component_name, vni].hash
    end
