...
module NSXT
  ...
  class LogicalRouterUpLinkPort
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ["LogicalRouterUpLinkPort", "LogicalRouterDownLinkPort", "LogicalRouterLinkPortOnTIER0", "LogicalRouterLinkPortOnTIER1", "LogicalRouterLoopbackPort"])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ["LogicalRouterUpLinkPort", "LogicalRouterDownLinkPort", "LogicalRouterLinkPortOnTIER0", "LogicalRouterLinkPortOnTIER1", "LogicalRouterLoopbackPort"])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, logical_router_id, service_bindings, mac_address, subnets, urpf_mode, linked_logical_switch_port_id, edge_cluster_member_index].hash
    end
