...
module NSXT
  ...
  class RedistributionRule
    ...
    def valid?
      ...
      destination_validator = EnumAttributeValidator.new('String', ["STATIC", "NSX_CONNECTED", "NSX_STATIC", "TIER0_NAT", "TIER1_NAT", "TIER1_LB_VIP", "TIER1_LB_SNAT", "BGP"])
    ...
    def destination=(destination)
      validator = EnumAttributeValidator.new('String', ["STATIC", "NSX_CONNECTED", "NSX_STATIC", "TIER0_NAT", "TIER1_NAT", "TIER1_LB_VIP", "TIER1_LB_SNAT", "BGP"])
    ...
    def hash
      [sources, destination, route_map_id, description, display_name].hash
    end
