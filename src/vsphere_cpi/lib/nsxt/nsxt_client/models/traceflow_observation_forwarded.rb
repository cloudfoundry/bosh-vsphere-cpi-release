...
module NSXT
  ...
  class TraceflowObservationForwarded
    ...
    def hash
      [resource_type, component_type, transport_node_id, timestamp, transport_node_name, sequence_no, timestamp_micro, component_name, uplink_name, vtep_label, remote_ip_address, context, local_ip_address, dst_transport_node_id, dst_transport_node_name].hash
    end
