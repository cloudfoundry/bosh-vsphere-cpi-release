...
module NSXT
  ...
  class CertificateReservationParameters
    # Service type
    ...
    def valid?
      ...
      service_type_validator = EnumAttributeValidator.new('String', ["MGMT_CLUSTER", "MGMT_PLANE", "API"])
    ...
    def service_type=(service_type)
      validator = EnumAttributeValidator.new('String', ["MGMT_CLUSTER", "MGMT_PLANE", "API"])
