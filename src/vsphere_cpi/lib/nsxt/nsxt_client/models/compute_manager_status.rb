...
module NSXT
  ...
  class ComputeManagerStatus
    ...
    def valid?
      connection_status_validator = EnumAttributeValidator.new('String', ["UP", "DOWN"])
      return false unless connection_status_validator.valid?(@connection_status)
      registration_status_validator = EnumAttributeValidator.new('String', ["REGISTERED", "UNREGISTERED"])
