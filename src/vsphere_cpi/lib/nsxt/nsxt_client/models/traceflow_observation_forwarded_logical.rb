...
module NSXT
  ...
  class TraceflowObservationForwardedLogical
    ...
    def valid?
      ...
      dst_component_type_validator = EnumAttributeValidator.new('String', ["PHYSICAL", "LR", "LS", "DFW", "BRIDGE", "EDGE_TUNNEL", "EDGE_HOSTSWITCH", "UNKNOWN"])
    ...
    def hash
      [timestamp_micro, component_sub_type, resource_type, component_type, transport_node_name, timestamp, transport_node_id, sequence_no, transport_node_type, component_name, lport_name, component_id, dst_component_type, lport_id, dst_component_id, acl_rule_id, vni, dst_component_name].hash
    end
