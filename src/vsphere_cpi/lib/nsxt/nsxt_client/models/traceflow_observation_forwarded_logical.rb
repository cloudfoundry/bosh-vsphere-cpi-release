...
module NSXT
  ...
  class TraceflowObservationForwardedLogical
    ...
    def hash
      [resource_type, component_type, transport_node_id, timestamp, transport_node_name, sequence_no, timestamp_micro, component_name, lport_name, component_id, dst_component_type, lport_id, dst_component_id, acl_rule_id, vni, dst_component_name].hash
    end
