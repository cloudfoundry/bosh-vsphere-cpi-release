...
module NSXT
  ...
  class CommunicationEntry
    ...
    attr_accessor :communication_profile_path
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'communication_profile_path')
        self.communication_profile_path = attributes[:'communication_profile_path']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          communication_profile_path == o.communication_profile_path &&
          logged == o.logged &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, relative_path, communication_profile_path, logged, destination_groups, sequence_number, source_groups].hash
    end
