...
module NSXT
  ...
  class DnsForwarder
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, conditional_forwarders, log_level, logical_router_id, cache_size, default_forwarder, listener_ip].hash
    end
