...
module NSXT
  ...
  class VirtualMachine
    ...
    def hash
      [_self, _links, _schema, _last_sync_time, display_name, description, resource_type, tags, source, local_id_on_host, type, power_state, compute_ids, host_id, external_id].hash
    end
