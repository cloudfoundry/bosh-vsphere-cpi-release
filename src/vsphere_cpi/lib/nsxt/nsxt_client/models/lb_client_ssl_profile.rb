  ...
  class LbClientSslProfile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'prefer_server_ciphers')
        ...
        self.prefer_server_ciphers = false
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, session_cache_enabled, session_cache_timeout, prefer_server_ciphers, is_secure, ciphers, protocols].hash
    end
