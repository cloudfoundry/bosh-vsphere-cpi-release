...
module NSXT
  ...
  class DirectoryDomainSyncStats
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, prev_sync_status, avg_full_sync_time, prev_sync_type, num_full_sync, current_state_begin_time, avg_delta_sync_time, current_state, num_delta_sync, prev_sync_end_time].hash
    end
