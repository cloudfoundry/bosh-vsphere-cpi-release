...
module NSXT
  ...
  class WidgetItem
    # Id of the widget configuration that is held by a multi-widget or a container.
    attr_accessor :widget_id

    # Applicable for 'DonutConfiguration' reports only. If label is not specified, then it defaults to the label of the donut report.
    attr_accessor :label
