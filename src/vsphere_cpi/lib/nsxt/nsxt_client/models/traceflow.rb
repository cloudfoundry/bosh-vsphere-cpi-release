...
module NSXT
  ...
  class Traceflow
    ...
    def valid?
      ...
      request_status_validator = EnumAttributeValidator.new('String', ["SUCCESS", "TIMEOUT", "SOURCE_PORT_NOT_FOUND", "DATA_PATH_NOT_READY", "CONNECTION_ERROR"])
    ...
    def request_status=(request_status)
      validator = EnumAttributeValidator.new('String', ["SUCCESS", "TIMEOUT", "SOURCE_PORT_NOT_FOUND", "DATA_PATH_NOT_READY", "CONNECTION_ERROR"])
