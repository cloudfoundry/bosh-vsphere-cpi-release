...
module NSXT
  ...
  class SnmpCommunity
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'community_string')
    ...
    def list_invalid_properties
      ...
      if @community_string.nil?
        invalid_properties.push("invalid value for 'community_string', community_string cannot be nil.")
      end
    ...
    def valid?
      access_validator = EnumAttributeValidator.new('String', ["read_only"])
      return false unless access_validator.valid?(@access)
      return false if @community_string.nil?
      return true
    end
    ...
    def access=(access)
      validator = EnumAttributeValidator.new('String', ["read_only"])
