...
module NSXT
  ...
  class RealizedFirewalls
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, relative_path, intent_reference, realization_specific_identifier, state, alarms, realized_firewalls].hash
    end
