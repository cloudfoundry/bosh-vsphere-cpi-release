...
module NSXT
  ...
  class UcMessage
    ...
    def valid?
      ...
      client_type_validator = EnumAttributeValidator.new('String', ["HOST", "EDGE", "CCP", "CCP_MPA", "PCG", "NSX_AGENT"])
    ...
    def client_type=(client_type)
      validator = EnumAttributeValidator.new('String', ["HOST", "EDGE", "CCP", "CCP_MPA", "PCG", "NSX_AGENT"])
    ...
    def hash
      [application_name, correlation_id, client_type, payload, type_id].hash
    end
