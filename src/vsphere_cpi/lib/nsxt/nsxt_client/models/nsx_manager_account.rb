...
module NSXT
  ...
  class NsxManagerAccount
    ...
    # This field can be used for using one time access token for Nsx Manager registration. 
    attr_accessor :token
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, username, public_ip, token, private_ip, thumbprint, tenant_id, password, fqdn].hash
    end
