...
module NSXT
  ...
  class Icon
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["ERROR", "WARNING", "INFO", "INPROGRESS", "SUCCESS", "DETAIL", "NOT_AVAILABLE"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["ERROR", "WARNING", "INFO", "INPROGRESS", "SUCCESS", "DETAIL", "NOT_AVAILABLE"])
