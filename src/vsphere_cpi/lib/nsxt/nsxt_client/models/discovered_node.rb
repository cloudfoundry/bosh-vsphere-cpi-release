...
module NSXT
  ...
  class DiscoveredNode
    ...
    def hash
      [_self, _links, _schema, _last_sync_time, display_name, description, resource_type, tags, stateless, certificate, origin_id, ip_addresses, hardware_id, os_version, node_type, parent_compute_collection, os_type, origin_properties, external_id, cm_local_id].hash
    end
