...
module NSXT
  ...
  class UpgradeSummary
    ...
    def valid?
      upgrade_status_validator = EnumAttributeValidator.new('String', ["SUCCESS", "FAILED", "IN_PROGRESS", "NOT_STARTED", "PAUSED"])
    ...
    def hash
      [target_version, upgrade_coordinator_version, upgrade_status, component_target_versions, system_version, upgrade_bundle_file_name].hash
    end
