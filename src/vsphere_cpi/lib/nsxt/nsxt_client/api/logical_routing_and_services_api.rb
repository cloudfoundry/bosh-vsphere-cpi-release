...
module NSXT
  class LogicalRoutingAndServicesApi
    ...
    def create_bgp_community_list_with_http_info(logical_router_id, bgp_community_list, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: LogicalRoutingAndServicesApi.create_bgp_community_list ..."
      end
      # verify the required parameter 'logical_router_id' is set
      if @api_client.config.client_side_validation && logical_router_id.nil?
        fail ArgumentError, "Missing the required parameter 'logical_router_id' when calling LogicalRoutingAndServicesApi.create_bgp_community_list"
      end
      ...
      if @api_client.config.client_side_validation && bgp_community_list.nil?
        fail ArgumentError, "Missing the required parameter 'bgp_community_list' when calling LogicalRoutingAndServicesApi.create_bgp_community_list"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LogicalRoutingAndServicesApi#create_bgp_community_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_bgp_community_list_with_http_info(logical_router_id, community_list_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: LogicalRoutingAndServicesApi.delete_bgp_community_list ..."
      end
      # verify the required parameter 'logical_router_id' is set
      if @api_client.config.client_side_validation && logical_router_id.nil?
        fail ArgumentError, "Missing the required parameter 'logical_router_id' when calling LogicalRoutingAndServicesApi.delete_bgp_community_list"
      end
      # verify the required parameter 'community_list_id' is set
      if @api_client.config.client_side_validation && community_list_id.nil?
        fail ArgumentError, "Missing the required parameter 'community_list_id' when calling LogicalRoutingAndServicesApi.delete_bgp_community_list"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LogicalRoutingAndServicesApi#delete_bgp_community_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_bgp_community_lists_with_http_info(logical_router_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: LogicalRoutingAndServicesApi.list_bgp_community_lists ..."
      end
      # verify the required parameter 'logical_router_id' is set
      if @api_client.config.client_side_validation && logical_router_id.nil?
        fail ArgumentError, "Missing the required parameter 'logical_router_id' when calling LogicalRoutingAndServicesApi.list_bgp_community_lists"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling LogicalRoutingAndServicesApi.list_bgp_community_lists, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling LogicalRoutingAndServicesApi.list_bgp_community_lists, must be greater than or equal to 0.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LogicalRoutingAndServicesApi#list_bgp_community_lists\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def re_allocate_service_routers_reallocate_with_http_info(logical_router_id, service_router_allocation_config, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: LogicalRoutingAndServicesApi.re_allocate_service_routers_reallocate ..."
      end
      # verify the required parameter 'logical_router_id' is set
      if @api_client.config.client_side_validation && logical_router_id.nil?
        fail ArgumentError, "Missing the required parameter 'logical_router_id' when calling LogicalRoutingAndServicesApi.re_allocate_service_routers_reallocate"
      end
      ...
      if @api_client.config.client_side_validation && service_router_allocation_config.nil?
        fail ArgumentError, "Missing the required parameter 'service_router_allocation_config' when calling LogicalRoutingAndServicesApi.re_allocate_service_routers_reallocate"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'LogicalRouter')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LogicalRoutingAndServicesApi#re_allocate_service_routers_reallocate\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def read_bgp_community_list_with_http_info(logical_router_id, community_list_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: LogicalRoutingAndServicesApi.read_bgp_community_list ..."
      end
      # verify the required parameter 'logical_router_id' is set
      if @api_client.config.client_side_validation && logical_router_id.nil?
        fail ArgumentError, "Missing the required parameter 'logical_router_id' when calling LogicalRoutingAndServicesApi.read_bgp_community_list"
      end
      # verify the required parameter 'community_list_id' is set
      if @api_client.config.client_side_validation && community_list_id.nil?
        fail ArgumentError, "Missing the required parameter 'community_list_id' when calling LogicalRoutingAndServicesApi.read_bgp_community_list"
      end
      # resource path
      local_var_path = "/logical-routers/{logical-router-id}/routing/bgp/community-lists/{community-list-id}".sub('{' + 'logical-router-id' + '}', logical_router_id.to_s).sub('{' + 'community-list-id' + '}', community_list_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'BGPCommunityList')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LogicalRoutingAndServicesApi#read_bgp_community_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def read_bgp_neighbor_with_password_show_sensitive_data_with_http_info(logical_router_id, id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: LogicalRoutingAndServicesApi.read_bgp_neighbor_with_password_show_sensitive_data ..."
      end
      # verify the required parameter 'logical_router_id' is set
      if @api_client.config.client_side_validation && logical_router_id.nil?
        fail ArgumentError, "Missing the required parameter 'logical_router_id' when calling LogicalRoutingAndServicesApi.read_bgp_neighbor_with_password_show_sensitive_data"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling LogicalRoutingAndServicesApi.read_bgp_neighbor_with_password_show_sensitive_data"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'BgpNeighbor')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LogicalRoutingAndServicesApi#read_bgp_neighbor_with_password_show_sensitive_data\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_bgp_community_list_with_http_info(logical_router_id, community_list_id, bgp_community_list, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: LogicalRoutingAndServicesApi.update_bgp_community_list ..."
      end
      # verify the required parameter 'logical_router_id' is set
      if @api_client.config.client_side_validation && logical_router_id.nil?
        fail ArgumentError, "Missing the required parameter 'logical_router_id' when calling LogicalRoutingAndServicesApi.update_bgp_community_list"
      end
      # verify the required parameter 'community_list_id' is set
      if @api_client.config.client_side_validation && community_list_id.nil?
        fail ArgumentError, "Missing the required parameter 'community_list_id' when calling LogicalRoutingAndServicesApi.update_bgp_community_list"
      end
      # verify the required parameter 'bgp_community_list' is set
      if @api_client.config.client_side_validation && bgp_community_list.nil?
        fail ArgumentError, "Missing the required parameter 'bgp_community_list' when calling LogicalRoutingAndServicesApi.update_bgp_community_list"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'BGPCommunityList')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LogicalRoutingAndServicesApi#update_bgp_community_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
