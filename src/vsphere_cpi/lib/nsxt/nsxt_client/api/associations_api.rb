...
module NSXT
  class AssociationsApi
    ...
    def get_associations_with_http_info(associated_resource_type, resource_id, resource_type, opts = {})
      ...
      # verify enum value
      if @api_client.config.client_side_validation && !['NSGroup', 'IPSet', 'MACSet', 'LogicalSwitch', 'LogicalPort', 'VirtualMachine', 'DirectoryGroup'].include?(resource_type)
        fail ArgumentError, "invalid value for 'resource_type', must be one of NSGroup, IPSet, MACSet, LogicalSwitch, LogicalPort, VirtualMachine, DirectoryGroup"
      end
