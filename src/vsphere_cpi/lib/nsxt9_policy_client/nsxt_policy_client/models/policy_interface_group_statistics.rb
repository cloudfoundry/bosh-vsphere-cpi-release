...
module Nsxt9PolicyClient
  ...
  class PolicyInterfaceGroupStatistics
    ...
    def self.swagger_types
      {
        :'members' => :'Array<LogicalRouterPortStatistics>',
        :'summary' => :'AggregatedLogicalRouterPortCounters'
      }
    end
