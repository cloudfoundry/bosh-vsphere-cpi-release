...
module Nsxt9PolicyClient
  ...
  class VpcServiceProfile
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'is_default' => :'BOOLEAN',
        :'dhcp_config' => :'VpcProfileDhcpConfig',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ip_discovery_profile')
        self.ip_discovery_profile = attributes[:'ip_discovery_profile']
      end

      if attributes.has_key?(:'mac_discovery_profile')
        self.mac_discovery_profile = attributes[:'mac_discovery_profile']
      end
      ...
      if attributes.has_key?(:'security_profile')
        self.security_profile = attributes[:'security_profile']
      end

      if attributes.has_key?(:'spoof_guard_profile')
        self.spoof_guard_profile = attributes[:'spoof_guard_profile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @dhcp_config.nil?
        invalid_properties.push('invalid value for "dhcp_config", dhcp_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @dhcp_config.nil?
      true
    end
