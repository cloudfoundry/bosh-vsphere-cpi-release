...
module Nsxt9PolicyClient
  # Sub-cluster is a grouping of discovered nodes under a compute collection. This grouping facilitates applying TransportNodeProfile sub-configurations for these grouped hosts. 
  class SubCluster
    attr_accessor :_self
    ...
    # Compute collection ID under which sub-cluster is created. Maximum number of sub-clusters that can be created under a compute collection is 16. 
    attr_accessor :compute_collection_id

    attr_accessor :sub_cluster_info
    ...
    def self.attribute_map
      {
        ...
        :'sub_cluster_info' => :'sub_cluster_info'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'sub_cluster_info' => :'SubClusterInfo'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sub_cluster_info')
        self.sub_cluster_info = attributes[:'sub_cluster_info']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @sub_cluster_info.nil?
        invalid_properties.push('invalid value for "sub_cluster_info", sub_cluster_info cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @sub_cluster_info.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sub_cluster_info == o.sub_cluster_info
    end
