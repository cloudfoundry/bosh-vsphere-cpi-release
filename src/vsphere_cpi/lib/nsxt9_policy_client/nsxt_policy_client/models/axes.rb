...
module Nsxt9PolicyClient
  ...
  class Axes
    ...
    attr_accessor :y_axis_unit_labels
    ...
    def self.swagger_types
      {
        :'x_labels' => :'Array<Label>',
        :'x_label' => :'Label',
        :'y_label' => :'Label',
        :'y_labels' => :'Array<Label>',
        :'y_axis_units' => :'Array<AxisUnit>',
        :'y_axis_unit_labels' => :'Array<Label>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'x_labels')
        if (value = attributes[:'x_labels']).is_a?(Array)
          self.x_labels = value
        end
      end
      ...
      if attributes.has_key?(:'y_labels')
        if (value = attributes[:'y_labels']).is_a?(Array)
          self.y_labels = value
        end
      end

      if attributes.has_key?(:'y_axis_units')
        if (value = attributes[:'y_axis_units']).is_a?(Array)
          self.y_axis_units = value
        end
      end

      if attributes.has_key?(:'y_axis_unit_labels')
        if (value = attributes[:'y_axis_unit_labels']).is_a?(Array)
          self.y_axis_unit_labels = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          y_label == o.y_label &&
          y_labels == o.y_labels &&
          y_axis_units == o.y_axis_units &&
          y_axis_unit_labels == o.y_axis_unit_labels
    end
    ...
    def hash
      [x_labels, x_label, y_label, y_labels, y_axis_units, y_axis_unit_labels].hash
    end
