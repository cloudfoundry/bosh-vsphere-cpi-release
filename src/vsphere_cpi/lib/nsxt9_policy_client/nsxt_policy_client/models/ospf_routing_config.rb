...
module Nsxt9PolicyClient
  ...
  class OspfRoutingConfig
    ...
    # Flag to activate/deactivate advertisement of default route into OSPF domain. The default route should be present in the edge only then it redistributes the same into OSPF domain only if this flag is set to TRUE. 
    attr_accessor :default_originate
    ...
    attr_accessor :summary_addresses
    ...
    def self.swagger_types
      {
        ...
        :'summary_addresses' => :'Array<OspfSummaryAddressConfig>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'default_originate')
        self.default_originate = attributes[:'default_originate']
      else
      ...
      if attributes.has_key?(:'summary_addresses')
        if (value = attributes[:'summary_addresses']).is_a?(Array)
          self.summary_addresses = value
        end
      end
    end
    ...
    def valid?
      ...
      graceful_restart_mode_validator = EnumAttributeValidator.new('String', ['DISABLE', 'HELPER_ONLY'])
    ...
    def graceful_restart_mode=(graceful_restart_mode)
      validator = EnumAttributeValidator.new('String', ['DISABLE', 'HELPER_ONLY'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enabled == o.enabled &&
          ecmp == o.ecmp &&
          default_originate == o.default_originate &&
          graceful_restart_mode == o.graceful_restart_mode &&
          summary_addresses == o.summary_addresses
    end
