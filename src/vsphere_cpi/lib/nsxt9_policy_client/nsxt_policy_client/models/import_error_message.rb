...
module Nsxt9PolicyClient
  ...
  class ImportErrorMessage
    ...
    attr_accessor :network_policy_id
    ...
    def self.swagger_types
      {
        ...
        :'errors' => :'Array<ImportErrorMessageDetail>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'network_policy_id')
        self.network_policy_id = attributes[:'network_policy_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          network_policy_id == o.network_policy_id &&
          errors == o.errors
    end
