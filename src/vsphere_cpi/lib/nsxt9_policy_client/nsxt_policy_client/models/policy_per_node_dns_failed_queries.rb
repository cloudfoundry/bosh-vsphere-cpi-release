...
module Nsxt9PolicyClient
  ...
  class PolicyPerNodeDnsFailedQueries
    attr_accessor :_self
    ...
    # equivalent policy path for the edge node 
    ...
    def hash
      [_self, _links, _schema, result_count, sort_by, sort_ascending, cursor, node_id, timestamp, results, edge_node_path].hash
    end
