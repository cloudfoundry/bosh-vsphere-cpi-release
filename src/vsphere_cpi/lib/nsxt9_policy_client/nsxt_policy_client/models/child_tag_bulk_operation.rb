...
module Nsxt9PolicyClient
  ...
  class ChildTagBulkOperation
    ...
    attr_accessor :tag_bulk_operation
    ...
    def self.attribute_map
      {
        ...
        :'tag_bulk_operation' => :'TagBulkOperation'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TagBulkOperation')
        self.tag_bulk_operation = attributes[:'TagBulkOperation']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tag_bulk_operation.nil?
        invalid_properties.push('invalid value for "tag_bulk_operation", tag_bulk_operation cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tag_bulk_operation.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tag_bulk_operation == o.tag_bulk_operation
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, tag_bulk_operation].hash
    end
