...
module Nsxt9PolicyClient
  ...
  class Site
    ...
    # The site_type property identifies type of current site.
    ...
    def valid?
      ...
      site_type_validator = EnumAttributeValidator.new('String', ['ONPREM_LM', 'SDDC_LM'])
    ...
    def site_type=(site_type)
      validator = EnumAttributeValidator.new('String', ['ONPREM_LM', 'SDDC_LM'])
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, site_connection_info, maximum_rtt, fail_if_rtt_exceeded, fail_if_rtep_misconfigured, federation_config, site_number, site_type].hash
    end
