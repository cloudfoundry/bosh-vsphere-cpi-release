...
module Nsxt9PolicyClient
  ...
  class GroupScopeExpression
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'scope_type')
        self.scope_type = attributes[:'scope_type']
      end

      if attributes.has_key?(:'scope_path')
        self.scope_path = attributes[:'scope_path']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @scope_path.nil?
        invalid_properties.push('invalid value for "scope_path", scope_path cannot be nil.')
      end
    ...
    def valid?
      ...
      scope_type_validator = EnumAttributeValidator.new('String', ['PROJECT', 'VPC'])
      return false unless scope_type_validator.valid?(@scope_type)
      return false if @scope_path.nil?
      true
    end
    ...
    def scope_type=(scope_type)
      validator = EnumAttributeValidator.new('String', ['PROJECT', 'VPC'])
