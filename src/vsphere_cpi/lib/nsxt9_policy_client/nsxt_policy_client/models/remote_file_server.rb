...
module Nsxt9PolicyClient
  ...
  class RemoteFileServer
    ...
    def list_invalid_properties
      ...
      if @directory_path !~ Regexp.new(/^\/[\w\-\.\+~\/]+$/)
        invalid_properties.push('invalid value for "directory_path", must conform to the pattern /^/[\\w\\-.\\+~/]+$/.')
      end
    ...
    def valid?
      ...
      return false if @directory_path !~ Regexp.new(/^\/[\w\-\.\+~\/]+$/)
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] directory_path Value to be assigned
    def directory_path=(directory_path)
      if directory_path.nil?
        fail ArgumentError, 'directory_path cannot be nil'
      end

      if directory_path !~ Regexp.new(/^\/[\w\-\.\+~\/]+$/)
        fail ArgumentError, 'invalid value for "directory_path", must conform to the pattern /^/[\\w\\-.\\+~/]+$/.'
      end
    ...
    def hash
      [server, port, protocol, directory_path].hash
    end
