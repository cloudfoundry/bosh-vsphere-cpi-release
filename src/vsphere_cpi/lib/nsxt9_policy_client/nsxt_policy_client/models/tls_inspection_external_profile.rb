...
module Nsxt9PolicyClient
  ...
  class TlsInspectionExternalProfile
    attr_accessor :_self
    ...
    attr_accessor :invalid_cert_action
    ...
    attr_accessor :proxy_trusted_ca_cert

    # Proxy untrusted ca cert and key used to issue invalid ca certificate
    attr_accessor :proxy_untrusted_ca_cert
    ...
    def self.attribute_map
      {
        ...
        :'invalid_cert_action' => :'invalid_cert_action',
        ...
        :'proxy_trusted_ca_cert' => :'proxy_trusted_ca_cert',
        :'proxy_untrusted_ca_cert' => :'proxy_untrusted_ca_cert',
    ...
    def self.swagger_types
      {
        ...
        :'proxy_trusted_ca_cert' => :'String',
        :'proxy_untrusted_ca_cert' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'invalid_cert_action')
        self.invalid_cert_action = attributes[:'invalid_cert_action']
      else
        self.invalid_cert_action = 'ALLOW'
      end
      ...
      if attributes.has_key?(:'proxy_trusted_ca_cert')
        self.proxy_trusted_ca_cert = attributes[:'proxy_trusted_ca_cert']
      end

      if attributes.has_key?(:'proxy_untrusted_ca_cert')
        self.proxy_untrusted_ca_cert = attributes[:'proxy_untrusted_ca_cert']
      end
    ...
    def list_invalid_properties
      ...
      if @proxy_trusted_ca_cert.nil?
        invalid_properties.push('invalid value for "proxy_trusted_ca_cert", proxy_trusted_ca_cert cannot be nil.')
      end

      if @proxy_untrusted_ca_cert.nil?
        invalid_properties.push('invalid value for "proxy_untrusted_ca_cert", proxy_untrusted_ca_cert cannot be nil.')
      end
    ...
    def valid?
      ...
      invalid_cert_action_validator = EnumAttributeValidator.new('String', ['BLOCK', 'ALLOW'])
      return false unless invalid_cert_action_validator.valid?(@invalid_cert_action)
      ...
      return false if @proxy_trusted_ca_cert.nil?
      return false if @proxy_untrusted_ca_cert.nil?
      true
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] invalid_cert_action Object to be assigned
    def invalid_cert_action=(invalid_cert_action)
      validator = EnumAttributeValidator.new('String', ['BLOCK', 'ALLOW'])
      unless validator.valid?(invalid_cert_action)
        fail ArgumentError, 'invalid value for "invalid_cert_action", must be one of #{validator.allowable_values}.'
      end
      @invalid_cert_action = invalid_cert_action
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          invalid_cert_action == o.invalid_cert_action &&
          ...
          proxy_trusted_ca_cert == o.proxy_trusted_ca_cert &&
          proxy_untrusted_ca_cert == o.proxy_untrusted_ca_cert &&
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, attention, trusted_ca_bundles, crls, idle_connection_timeout, tls_config_setting, invalid_cert_action, decryption_fail_action, crypto_enforcement, client_min_tls_version, client_max_tls_version, server_min_tls_version, server_max_tls_version, client_cipher_suite, server_cipher_suite, proxy_trusted_ca_cert, proxy_untrusted_ca_cert, ocsp_must_staple].hash
    end
