...
module Nsxt9PolicyClient
  class RAConfig
    ...
    attr_accessor :router_preference
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'router_preference')
        self.router_preference = attributes[:'router_preference']
      else
        self.router_preference = 'MEDIUM'
      end
    ...
    def valid?
      router_preference_validator = EnumAttributeValidator.new('String', ['LOW', 'MEDIUM', 'HIGH', 'RESERVED'])
      return false unless router_preference_validator.valid?(@router_preference)
    ...
    # @param [Object] router_preference Object to be assigned
    def router_preference=(router_preference)
      validator = EnumAttributeValidator.new('String', ['LOW', 'MEDIUM', 'HIGH', 'RESERVED'])
      unless validator.valid?(router_preference)
        fail ArgumentError, 'invalid value for "router_preference", must be one of #{validator.allowable_values}.'
      end
      @router_preference = router_preference
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          router_preference == o.router_preference &&
    ...
    def hash
      [router_preference, ra_interval, hop_limit, router_lifetime, prefix_lifetime, prefix_preferred_time].hash
    end
