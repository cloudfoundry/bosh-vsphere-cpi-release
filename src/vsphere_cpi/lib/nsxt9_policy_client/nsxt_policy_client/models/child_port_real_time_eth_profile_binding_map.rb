...
module Nsxt9PolicyClient
  ...
  class ChildPortRealTimeEthProfileBindingMap
    attr_accessor :_self
    ...
    attr_accessor :port_real_time_eth_profile_binding_map
    ...
    def self.attribute_map
      {
        ...
        :'port_real_time_eth_profile_binding_map' => :'PortRealTimeEthProfileBindingMap'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PortRealTimeEthProfileBindingMap')
        self.port_real_time_eth_profile_binding_map = attributes[:'PortRealTimeEthProfileBindingMap']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @port_real_time_eth_profile_binding_map.nil?
        invalid_properties.push('invalid value for "port_real_time_eth_profile_binding_map", port_real_time_eth_profile_binding_map cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @port_real_time_eth_profile_binding_map.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          port_real_time_eth_profile_binding_map == o.port_real_time_eth_profile_binding_map
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, port_real_time_eth_profile_binding_map].hash
    end
