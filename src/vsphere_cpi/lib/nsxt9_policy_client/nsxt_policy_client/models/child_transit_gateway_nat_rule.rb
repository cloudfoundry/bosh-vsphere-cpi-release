...
module Nsxt9PolicyClient
  ...
  class ChildTransitGatewayNatRule
    attr_accessor :_self
    ...
    attr_accessor :transit_gateway_nat_rule
    ...
    def self.attribute_map
      {
        ...
        :'transit_gateway_nat_rule' => :'TransitGatewayNatRule'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TransitGatewayNatRule')
        self.transit_gateway_nat_rule = attributes[:'TransitGatewayNatRule']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @transit_gateway_nat_rule.nil?
        invalid_properties.push('invalid value for "transit_gateway_nat_rule", transit_gateway_nat_rule cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @transit_gateway_nat_rule.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transit_gateway_nat_rule == o.transit_gateway_nat_rule
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, transit_gateway_nat_rule].hash
    end
