...
module Nsxt9PolicyClient
  ...
  class IPSecVpnSessionStatusNsxT
    ...
    def hash
      [enforcement_point_path, alarm, resource_type, runtime_status, ike_status, total_tunnels, negotiated_tunnels, failed_tunnels, aggregate_traffic_counters, last_update_timestamp, display_name].hash
    end
