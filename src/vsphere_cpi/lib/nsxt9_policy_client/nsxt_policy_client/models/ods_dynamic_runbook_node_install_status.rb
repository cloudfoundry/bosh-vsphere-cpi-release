...
module Nsxt9PolicyClient
  ...
  class OdsDynamicRunbookNodeInstallStatus
    # Identifier of transport node, Edge node or appliance node. 
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ['NONE', 'REQUESTING', 'REQUESTED', 'COMPATIBLE_VERSION_NOT_FOUND', 'NODE_TYPE_UNSUPPORTED', 'REQUEST_TIMEOUT', 'INSTALLING', 'INSTALL_TIMEOUT', 'INSTALL_FAILED', 'INSTALL_FINISHED', 'UNINSTALLING', 'UNINSTALL_TIMEOUT'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['NONE', 'REQUESTING', 'REQUESTED', 'COMPATIBLE_VERSION_NOT_FOUND', 'NODE_TYPE_UNSUPPORTED', 'REQUEST_TIMEOUT', 'INSTALLING', 'INSTALL_TIMEOUT', 'INSTALL_FAILED', 'INSTALL_FINISHED', 'UNINSTALLING', 'UNINSTALL_TIMEOUT'])
    ...
    def hash
      [node_id, node_name, version, status, error_detail].hash
    end
