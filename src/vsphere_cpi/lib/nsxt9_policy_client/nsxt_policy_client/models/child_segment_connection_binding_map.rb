...
module Nsxt9PolicyClient
  ...
  class ChildSegmentConnectionBindingMap
    attr_accessor :_self
    ...
    attr_accessor :segment_connection_binding_map
    ...
    def self.attribute_map
      {
        ...
        :'segment_connection_binding_map' => :'SegmentConnectionBindingMap'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SegmentConnectionBindingMap')
        self.segment_connection_binding_map = attributes[:'SegmentConnectionBindingMap']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @segment_connection_binding_map.nil?
        invalid_properties.push('invalid value for "segment_connection_binding_map", segment_connection_binding_map cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @segment_connection_binding_map.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          segment_connection_binding_map == o.segment_connection_binding_map
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, segment_connection_binding_map].hash
    end
