...
module Nsxt9PolicyClient
  # Provides the following traffic statistics for IPSec VPN tunnels since the time the tunnels are UP:  - Incoming packet count. - Outgoing packet count. - Dropped packet count. 
  class IPSecVpnTrafficCounters
    # The total number of packets received on the inbound security association. 
    attr_accessor :packets_in

    # The total number of packets sent on the outbound security association. 
    attr_accessor :packets_out

    # The total number of traffic bytes received on the inbound security association. 
    attr_accessor :bytes_in

    # The total number of traffic bytes sent on the outbound security association. 
    ...
    def hash
      [packets_in, packets_out, bytes_in, bytes_out, dropped_packets_in, dropped_packets_out].hash
    end
