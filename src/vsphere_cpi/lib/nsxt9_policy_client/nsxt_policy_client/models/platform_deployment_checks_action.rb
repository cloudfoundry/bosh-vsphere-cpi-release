...
module Nsxt9PolicyClient
  ...
  class PlatformDeploymentChecksAction
    ...
    def valid?
      ...
      action_validator = EnumAttributeValidator.new('String', ['PRE_CHECKS', 'POST_CHECKS', 'ABORT_CHECKS'])
    ...
    def action=(action)
      validator = EnumAttributeValidator.new('String', ['PRE_CHECKS', 'POST_CHECKS', 'ABORT_CHECKS'])
