...
module Nsxt9PolicyClient
  ...
  class IdsThresholdConfig
    ...
    def self.swagger_types
      {
        ...
        :'rate_filter' => :'IdsSignatureRateFilter'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rate_filter')
        self.rate_filter = attributes[:'rate_filter']
      end
    end
