...
module Nsxt9PolicyClient
  ...
  class ChildIdentityFirewallStore
    attr_accessor :_self
    ...
    attr_accessor :identity_firewall_store
    ...
    def self.attribute_map
      {
        ...
        :'identity_firewall_store' => :'IdentityFirewallStore'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IdentityFirewallStore')
        self.identity_firewall_store = attributes[:'IdentityFirewallStore']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @identity_firewall_store.nil?
        invalid_properties.push('invalid value for "identity_firewall_store", identity_firewall_store cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @identity_firewall_store.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          identity_firewall_store == o.identity_firewall_store
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, identity_firewall_store].hash
    end
