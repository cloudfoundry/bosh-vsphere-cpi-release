...
module Nsxt9PolicyClient
  ...
  class OpenLdapIdentitySource
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, domain_name, alternative_domain_names, base_dn, ldap_servers].hash
    end
