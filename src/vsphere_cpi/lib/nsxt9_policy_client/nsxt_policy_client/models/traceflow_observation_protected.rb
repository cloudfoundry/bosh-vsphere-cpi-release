...
module Nsxt9PolicyClient
  class TraceflowObservationProtected
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'original_type')
    ...
    def list_invalid_properties
      ...
      if @original_type.nil?
        invalid_properties.push('invalid value for "original_type", original_type cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @original_type.nil?
      original_type_validator = EnumAttributeValidator.new('String', ['TraceflowObservationForwarded', 'TraceflowObservationDropped', 'TraceflowObservationDelivered', 'TraceflowObservationReceived', 'TraceflowObservationForwardedLogical', 'TraceflowObservationDroppedLogical', 'TraceflowObservationReceivedLogical', 'TraceflowObservationReplicationLogical', 'TraceflowObservationRelayedLogical', 'TraceflowObservationProtected'])
      return false unless original_type_validator.valid?(@original_type)
      true
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] original_type Object to be assigned
    def original_type=(original_type)
      validator = EnumAttributeValidator.new('String', ['TraceflowObservationForwarded', 'TraceflowObservationDropped', 'TraceflowObservationDelivered', 'TraceflowObservationReceived', 'TraceflowObservationForwardedLogical', 'TraceflowObservationDroppedLogical', 'TraceflowObservationReceivedLogical', 'TraceflowObservationReplicationLogical', 'TraceflowObservationRelayedLogical', 'TraceflowObservationProtected'])
      unless validator.valid?(original_type)
        fail ArgumentError, 'invalid value for "original_type", must be one of #{validator.allowable_values}.'
      end
      @original_type = original_type
    end
    ...
    def hash
      [resource_type, sequence_no, transport_node_id, transport_node_name, transport_node_type, timestamp, timestamp_micro, component_type, component_sub_type, component_name, site_path, is_ens, original_type].hash
    end
