...
module Nsxt9PolicyClient
  ...
  class Icon
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'size_unit')
        self.size_unit = attributes[:'size_unit']
      end
    ...
    def valid?
      ...
      size_unit_validator = EnumAttributeValidator.new('String', ['px', 'rem', 'pc'])
      return false unless size_unit_validator.valid?(@size_unit)
      true
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] size_unit Object to be assigned
    def size_unit=(size_unit)
      validator = EnumAttributeValidator.new('String', ['px', 'rem', 'pc'])
      unless validator.valid?(size_unit)
        fail ArgumentError, 'invalid value for "size_unit", must be one of #{validator.allowable_values}.'
      end
      @size_unit = size_unit
    end
    ...
    def hash
      [type, placement, tooltip, size, size_unit, color].hash
    end
