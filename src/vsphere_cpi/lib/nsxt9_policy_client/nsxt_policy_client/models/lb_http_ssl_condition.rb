...
module Nsxt9PolicyClient
  ...
  class LBHttpSslCondition
    ...
    def hash
      [type, inverse, client_supported_ssl_ciphers, client_certificate_issuer_dn, client_certificate_subject_dn, used_ssl_cipher, used_protocol, session_reused].hash
    end
