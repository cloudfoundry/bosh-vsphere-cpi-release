...
module Nsxt9PolicyClient
  # Child wrapper object for PolicyFailureDomain, used in hierarchical API.
  class ChildPolicyFailureDomain
    attr_accessor :_self
    ...
    attr_accessor :policy_failure_domain
    ...
    def self.attribute_map
      {
        ...
        :'policy_failure_domain' => :'PolicyFailureDomain'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyFailureDomain')
        self.policy_failure_domain = attributes[:'PolicyFailureDomain']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_failure_domain.nil?
        invalid_properties.push('invalid value for "policy_failure_domain", policy_failure_domain cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_failure_domain.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_failure_domain == o.policy_failure_domain
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, policy_failure_domain].hash
    end
