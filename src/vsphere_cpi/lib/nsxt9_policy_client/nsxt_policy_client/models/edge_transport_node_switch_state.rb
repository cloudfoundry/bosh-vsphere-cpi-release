...
module Nsxt9PolicyClient
  ...
  class EdgeTransportNodeSwitchState
    ...
    attr_accessor :remote_tunnel_endpoints
    ...
    def self.attribute_map
      {
        ...
        :'remote_tunnel_endpoints' => :'remote_tunnel_endpoints'
      }
    end
    ...
    def self.swagger_types
      {
        :'switch_name' => :'String',
        :'tunnel_endpoints' => :'Array<EdgeTnTunnelEndpointState>',
        :'remote_tunnel_endpoints' => :'Array<EdgeTnRemoteTunnelEndpointState>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'remote_tunnel_endpoints')
        if (value = attributes[:'remote_tunnel_endpoints']).is_a?(Array)
          self.remote_tunnel_endpoints = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          remote_tunnel_endpoints == o.remote_tunnel_endpoints
    end
    ...
    def hash
      [switch_name, tunnel_endpoints, remote_tunnel_endpoints].hash
    end
