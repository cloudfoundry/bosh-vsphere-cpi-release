...
module Nsxt9PolicyClient
  ...
  class ClusterRestoreStatus
    ...
    def self.swagger_types
      {
        ...
        :'not_allowed_actions' => :'Array<String>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'not_allowed_actions')
        if (value = attributes[:'not_allowed_actions']).is_a?(Array)
          self.not_allowed_actions = value
        end
      end

      if attributes.has_key?(:'allowed_actions')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          not_allowed_actions == o.not_allowed_actions &&
    ...
    def hash
      [id, backup_timestamp, restore_start_time, restore_end_time, step, status, total_steps, endpoints, instructions, not_allowed_actions, allowed_actions].hash
    end
