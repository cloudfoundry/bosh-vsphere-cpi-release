...
module Nsxt9PolicyClient
  ...
  class OspfRouteNextHopResult
    ...
    attr_accessor :directly_attached
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'directly_attached')
        self.directly_attached = attributes[:'directly_attached']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          directly_attached == o.directly_attached
    end
    ...
    def hash
      [neighbor_address, interface_name, directly_attached].hash
    end
