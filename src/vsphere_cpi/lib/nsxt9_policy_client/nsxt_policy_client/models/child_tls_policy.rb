...
module Nsxt9PolicyClient
  ...
  class ChildTlsPolicy
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TlsPolicy')
        self.tls_policy = attributes[:'TlsPolicy']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tls_policy.nil?
        invalid_properties.push('invalid value for "tls_policy", tls_policy cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tls_policy.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, tls_policy].hash
    end
