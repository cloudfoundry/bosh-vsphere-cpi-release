...
module Nsxt9PolicyClient
  ...
  class PolicyLatencyStatProfile
    attr_accessor :_self
    ...
    # Activate or Deactivate pnic latency. 
    attr_accessor :pnic_latency_enabled
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pnic_latency_enabled')
        self.pnic_latency_enabled = attributes[:'pnic_latency_enabled']
      else
        self.pnic_latency_enabled = false
      end
    ...
    def list_invalid_properties
      ...
      if !@sampling_rate.nil? && @sampling_rate > 1000000
        invalid_properties.push('invalid value for "sampling_rate", must be smaller than or equal to 1000000.')
      end

      if !@sampling_rate.nil? && @sampling_rate < 100
        invalid_properties.push('invalid value for "sampling_rate", must be greater than or equal to 100.')
      end

      if !@sampling_interval.nil? && @sampling_interval > 1000000
        invalid_properties.push('invalid value for "sampling_interval", must be smaller than or equal to 1000000.')
      end
    ...
    def valid?
      ...
      return false if !@sampling_rate.nil? && @sampling_rate > 1000000
      return false if !@sampling_rate.nil? && @sampling_rate < 100
      return false if !@sampling_interval.nil? && @sampling_interval > 1000000
    ...
    def sampling_rate=(sampling_rate)
      if !sampling_rate.nil? && sampling_rate > 1000000
        fail ArgumentError, 'invalid value for "sampling_rate", must be smaller than or equal to 1000000.'
      end

      if !sampling_rate.nil? && sampling_rate < 100
        fail ArgumentError, 'invalid value for "sampling_rate", must be greater than or equal to 100.'
      end
    ...
    def sampling_interval=(sampling_interval)
      if !sampling_interval.nil? && sampling_interval > 1000000
        fail ArgumentError, 'invalid value for "sampling_interval", must be smaller than or equal to 1000000.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          pnic_latency_enabled == o.pnic_latency_enabled &&
