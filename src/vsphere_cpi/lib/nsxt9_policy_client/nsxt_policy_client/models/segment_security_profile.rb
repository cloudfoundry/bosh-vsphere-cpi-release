...
module Nsxt9PolicyClient
  ...
  class SegmentSecurityProfile
    ...
    # Filters DHCP server and/or client traffic. DHCP server blocking is activated and client blocking is deactivated by default. 
    ...
    # Filters DHCP server and/or client IPv6 traffic. DHCP server blocking is enabled and client blocking is deactivated by default. 
    attr_accessor :dhcp_server_block_v6_enabled

    # Filters DHCP server and/or client IPv6 traffic. DHCP server blocking is enabled and client blocking is deactivated by default. 
    attr_accessor :dhcp_client_block_v6_enabled

    # Activate or deactivate Router Advertisement Guard. 
    attr_accessor :ra_guard_enabled

    # Activate or deactivate Rate Limits 
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, bpdu_filter_enable, bpdu_filter_allow, dhcp_server_block_enabled, dhcp_client_block_enabled, non_ip_traffic_block_enabled, dhcp_server_block_v6_enabled, dhcp_client_block_v6_enabled, ra_guard_enabled, rate_limits_enabled, rate_limits].hash
    end
