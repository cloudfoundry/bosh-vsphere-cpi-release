...
module Nsxt9PolicyClient
  ...
  class BackupOperationStatus
    ...
    def valid?
      ...
      error_code_validator = EnumAttributeValidator.new('String', ['BACKUP_NOT_RUN_ON_MASTER', 'BACKUP_SERVER_UNREACHABLE', 'BACKUP_AUTHENTICATION_FAILURE', 'BACKUP_PERMISSION_ERROR', 'BACKUP_TIMEOUT', 'BACKUP_BAD_FINGERPRINT', 'BACKUP_GENERIC_ERROR', 'UPGRADE_IN_PROGRESS', 'CERTIFICATE_ROTATION_IN_PROGRESS'])
    ...
    def error_code=(error_code)
      validator = EnumAttributeValidator.new('String', ['BACKUP_NOT_RUN_ON_MASTER', 'BACKUP_SERVER_UNREACHABLE', 'BACKUP_AUTHENTICATION_FAILURE', 'BACKUP_PERMISSION_ERROR', 'BACKUP_TIMEOUT', 'BACKUP_BAD_FINGERPRINT', 'BACKUP_GENERIC_ERROR', 'UPGRADE_IN_PROGRESS', 'CERTIFICATE_ROTATION_IN_PROGRESS'])
    ...
    def hash
      [backup_id, start_time, end_time, success, error_code, error_message].hash
    end
