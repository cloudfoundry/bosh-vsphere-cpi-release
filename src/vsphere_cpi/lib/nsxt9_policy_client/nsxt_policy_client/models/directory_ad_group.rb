...
module Nsxt9PolicyClient
  class DirectoryAdGroup
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, domain_id, domain_name, domain_sync_node_id, distinguished_name, is_global, secure_id, object_guid].hash
    end
