...
module Nsxt9PolicyClient
  ...
  class VpcIpAddressBlock
    ...
    attr_accessor :allocated_by_vpc
    ...
    def self.attribute_map
      {
        ...
        :'allocated_by_vpc' => :'allocated_by_vpc'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'visibility' => :'String',
        :'allocated_by_vpc' => :'AllocatedByVpc'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'allocated_by_vpc')
        self.allocated_by_vpc = attributes[:'allocated_by_vpc']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          allocated_by_vpc == o.allocated_by_vpc
    end
    ...
    def hash
      [path, cidr, total, available, percentage_used, visibility, allocated_by_vpc].hash
    end
