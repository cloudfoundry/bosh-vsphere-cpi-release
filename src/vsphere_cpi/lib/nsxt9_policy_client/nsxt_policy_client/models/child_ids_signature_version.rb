...
module Nsxt9PolicyClient
  ...
  class ChildIdsSignatureVersion
    attr_accessor :_self
    ...
    attr_accessor :ids_signature_version
    ...
    def self.attribute_map
      {
        ...
        :'ids_signature_version' => :'IdsSignatureVersion'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IdsSignatureVersion')
        self.ids_signature_version = attributes[:'IdsSignatureVersion']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ids_signature_version.nil?
        invalid_properties.push('invalid value for "ids_signature_version", ids_signature_version cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ids_signature_version.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ids_signature_version == o.ids_signature_version
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, ids_signature_version].hash
    end
