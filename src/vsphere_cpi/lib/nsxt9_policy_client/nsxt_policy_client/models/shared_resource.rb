...
module Nsxt9PolicyClient
  ...
  class SharedResource
    ...
    attr_accessor :resource_objects

    # Read only field. Shows sharing strategy used in Share. 
    attr_accessor :share_sharing_strategy

    # Read only field. Shows subset (shared-with-me API context) of sharedWith used in Share. 
    attr_accessor :share_shared_with
    ...
    def self.attribute_map
      {
        ...
        :'share_sharing_strategy' => :'share_sharing_strategy',
        :'share_shared_with' => :'share_shared_with'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'resource_objects' => :'Array<ResourceObject>',
        :'share_sharing_strategy' => :'String',
        :'share_shared_with' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'resource_objects')
        if (value = attributes[:'resource_objects']).is_a?(Array)
          self.resource_objects = value
        end
      end

      if attributes.has_key?(:'share_sharing_strategy')
        self.share_sharing_strategy = attributes[:'share_sharing_strategy']
      end

      if attributes.has_key?(:'share_shared_with')
        if (value = attributes[:'share_shared_with']).is_a?(Array)
          self.share_shared_with = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @resource_objects.nil?
        invalid_properties.push('invalid value for "resource_objects", resource_objects cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @resource_objects.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          resource_objects == o.resource_objects &&
          share_sharing_strategy == o.share_sharing_strategy &&
          share_shared_with == o.share_shared_with
    end
