...
module Nsxt9PolicyClient
  ...
  class OdsDynamicRunbookInstance
    attr_accessor :_self
    ...
    attr_accessor :applied_to_nodes
    ...
    def self.attribute_map
      {
        ...
        :'applied_to_nodes' => :'applied_to_nodes',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'applied_to_nodes')
        if (value = attributes[:'applied_to_nodes']).is_a?(Array)
          self.applied_to_nodes = value
        end
      end
      ...
      if attributes.has_key?(:'applied_to_all_appliances')
        ...
        self.applied_to_all_appliances = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          applied_to_nodes == o.applied_to_nodes &&
