...
module Nsxt9PolicyClient
  # Represents Geo location expressions in the form of an array, to support geo location in a group. 
  class GeoLocationExpression
    attr_accessor :_self
    ...
    # This contain country code for System created GeoIP Groups. 
    attr_accessor :country_code

    # This array consists of Default System GeoIP group paths. 
    attr_accessor :member_group_paths
    ...
    def self.attribute_map
      {
        ...
        :'member_group_paths' => :'member_group_paths',
        :'exclude' => :'exclude'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'country_code' => :'String',
        :'member_group_paths' => :'Array<String>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'member_group_paths')
        if (value = attributes[:'member_group_paths']).is_a?(Array)
          self.member_group_paths = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @member_group_paths.nil?
        invalid_properties.push('invalid value for "member_group_paths", member_group_paths cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @member_group_paths.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          member_group_paths == o.member_group_paths &&
          exclude == o.exclude
    end
