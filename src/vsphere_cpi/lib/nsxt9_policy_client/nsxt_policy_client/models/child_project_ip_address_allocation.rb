...
module Nsxt9PolicyClient
  ...
  class ChildProjectIpAddressAllocation
    attr_accessor :_self
    ...
    attr_accessor :project_ip_address_allocation
    ...
    def self.attribute_map
      {
        ...
        :'project_ip_address_allocation' => :'ProjectIpAddressAllocation'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ProjectIpAddressAllocation')
        self.project_ip_address_allocation = attributes[:'ProjectIpAddressAllocation']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @project_ip_address_allocation.nil?
        invalid_properties.push('invalid value for "project_ip_address_allocation", project_ip_address_allocation cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @project_ip_address_allocation.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          project_ip_address_allocation == o.project_ip_address_allocation
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, project_ip_address_allocation].hash
    end
