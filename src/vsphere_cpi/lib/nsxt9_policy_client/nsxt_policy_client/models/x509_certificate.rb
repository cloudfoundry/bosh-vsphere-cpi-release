...
module Nsxt9PolicyClient
  class X509Certificate
    ...
    # The public key for the EC certificate.
    attr_accessor :ecdsa_pub_key
    ...
    def self.attribute_map
      {
        ...
        :'is_ca' => :'is_ca',
        :'is_valid' => :'is_valid',
        :'sha_256_thumbprint' => :'sha_256_thumbprint',
        :'parsed_pem_encoding' => :'parsed_pem_encoding',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ecdsa_pub_key')
        self.ecdsa_pub_key = attributes[:'ecdsa_pub_key']
      end
      ...
      if attributes.has_key?(:'ecdsa_pub')
        self.ecdsa_pub = attributes[:'ecdsa_pub']
      end
      ...
      if attributes.has_key?(:'sha_256_thumbprint')
        self.sha_256_thumbprint = attributes[:'sha_256_thumbprint']
      end

      if attributes.has_key?(:'parsed_pem_encoding')
        self.parsed_pem_encoding = attributes[:'parsed_pem_encoding']
      end

      if attributes.has_key?(:'subject_alt_names')
        self.subject_alt_names = attributes[:'subject_alt_names']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ecdsa_pub == o.ecdsa_pub &&
          is_ca == o.is_ca &&
          is_valid == o.is_valid &&
          sha_256_thumbprint == o.sha_256_thumbprint &&
          parsed_pem_encoding == o.parsed_pem_encoding &&
          subject_alt_names == o.subject_alt_names
    end
    ...
    def hash
      [subject_cn, issuer_cn, version, serial_number, signature_algorithm, signature, not_before, not_after, issuer, subject, public_key_algo, public_key_length, rsa_public_key_modulus, rsa_public_key_exponent, dsa_public_key_g, dsa_public_key_p, dsa_public_key_q, dsa_public_key_y, ecdsa_curve_name, ecdsa_pub_key, ecdsa_ec_field, ecdsa_ec_field_f2mm, ecdsa_ec_field_f2mrp, ecdsa_ec_field_f2mks, ecdsa_ec_field_f2pp, ecdsa_public_key_a, ecdsa_public_key_b, ecdsa_public_key_seed, ecdsa_public_key_generator_x, ecdsa_public_key_generator_y, ecdsa_public_key_order, ecdsa_public_key_cofactor, ecdsa_pub, is_ca, is_valid, sha_256_thumbprint, parsed_pem_encoding, subject_alt_names].hash
    end
