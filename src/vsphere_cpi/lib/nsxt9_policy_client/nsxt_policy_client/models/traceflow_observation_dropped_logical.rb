...
module Nsxt9PolicyClient
  class TraceflowObservationDroppedLogical
    ...
    def hash
      [resource_type, sequence_no, transport_node_id, transport_node_name, transport_node_type, timestamp, timestamp_micro, component_type, component_sub_type, component_name, site_path, is_ens, reason, lport_id, lport_name, acl_rule_id, arp_fail_reason, nat_rule_id, jumpto_rule_id, l2_rule_id, ipsec_fail_reason, component_id, service_path_index].hash
    end
