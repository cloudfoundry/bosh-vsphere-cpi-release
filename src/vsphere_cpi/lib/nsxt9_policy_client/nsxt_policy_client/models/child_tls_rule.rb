...
module Nsxt9PolicyClient
  ...
  class ChildTlsRule
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TlsRule')
        self.tls_rule = attributes[:'TlsRule']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tls_rule.nil?
        invalid_properties.push('invalid value for "tls_rule", tls_rule cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, tls_rule].hash
    end
