...
module Nsxt9PolicyClient
  class DistributedFloodProtectionProfile
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, udp_active_flow_limit, icmp_active_flow_limit, tcp_half_open_conn_limit, other_active_conn_limit, enable_syncache, enable_rst_spoofing].hash
    end
