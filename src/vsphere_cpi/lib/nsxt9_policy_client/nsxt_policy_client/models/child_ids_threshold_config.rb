...
module Nsxt9PolicyClient
  ...
  class ChildIdsThresholdConfig
    ...
    attr_accessor :ids_threshold_config
    ...
    def self.attribute_map
      {
        ...
        :'ids_threshold_config' => :'IdsThresholdConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IdsThresholdConfig')
        self.ids_threshold_config = attributes[:'IdsThresholdConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ids_threshold_config.nil?
        invalid_properties.push('invalid value for "ids_threshold_config", ids_threshold_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ids_threshold_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ids_threshold_config == o.ids_threshold_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, ids_threshold_config].hash
    end
