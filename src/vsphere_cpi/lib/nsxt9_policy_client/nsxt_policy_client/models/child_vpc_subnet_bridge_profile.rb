...
module Nsxt9PolicyClient
  ...
  class ChildVpcSubnetBridgeProfile
    attr_accessor :_self
    ...
    attr_accessor :vpc_subnet_bridge_profile
    ...
    def self.attribute_map
      {
        ...
        :'vpc_subnet_bridge_profile' => :'VpcSubnetBridgeProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'VpcSubnetBridgeProfile')
        self.vpc_subnet_bridge_profile = attributes[:'VpcSubnetBridgeProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @vpc_subnet_bridge_profile.nil?
        invalid_properties.push('invalid value for "vpc_subnet_bridge_profile", vpc_subnet_bridge_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vpc_subnet_bridge_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vpc_subnet_bridge_profile == o.vpc_subnet_bridge_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, vpc_subnet_bridge_profile].hash
    end
