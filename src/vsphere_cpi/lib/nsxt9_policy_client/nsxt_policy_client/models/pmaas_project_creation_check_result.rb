...
module Nsxt9PolicyClient
  # Project creation status on Pmaas 
  class PmaasProjectCreationCheckResult
    attr_accessor :_self
    ...
    # project status Status remains PENDING after the onboarding prechecks have passed and before the onboarding is complete.  The client should continue to intermittently re-read to determine when the status is FAILED or SUCCESS. 
    attr_accessor :project_status

    # When the project creation FAILED on pmaas, this field will contain appropriate information or error message. 
    attr_accessor :error_message

    # siteId of Lm where the project should be spanned 
    attr_accessor :site_uuid

    # id of the project to be created on Pmaas 
    attr_accessor :project_id

    # short id of the project to be created on Pmaas 
    attr_accessor :project_short_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'project_status')
      ...
      if attributes.has_key?(:'project_short_id')
        self.project_short_id = attributes[:'project_short_id']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @site_uuid.nil?
        invalid_properties.push('invalid value for "site_uuid", site_uuid cannot be nil.')
      end
    ...
    def valid?
      ...
      project_status_validator = EnumAttributeValidator.new('String', ['SUCCESS', 'PENDING', 'FAILURE', 'INPROGRESS'])
      return false unless project_status_validator.valid?(@project_status)
      return false if @site_uuid.nil?
    ...
    # @param [Object] project_status Object to be assigned
    def project_status=(project_status)
      validator = EnumAttributeValidator.new('String', ['SUCCESS', 'PENDING', 'FAILURE', 'INPROGRESS'])
      unless validator.valid?(project_status)
        fail ArgumentError, 'invalid value for "project_status", must be one of #{validator.allowable_values}.'
      end
      @project_status = project_status
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          project_short_id == o.project_short_id
    end
