...
module Nsxt9PolicyClient
  class PolicyBgpNeighborStatus
    ...
    # Inter-Sr neighbor edge node policy path
    attr_accessor :neighbor_edge_node
    ...
    def self.attribute_map
      {
        ...
        :'neighbor_edge_node' => :'neighbor_edge_node'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'neighbor_edge_node')
        self.neighbor_edge_node = attributes[:'neighbor_edge_node']
      end
    end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['INTER_SR', 'USER'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['INTER_SR', 'USER'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          neighbor_edge_node == o.neighbor_edge_node
    end
    ...
    def hash
      [edge_path, source_address, local_port, neighbor_address, remote_port, remote_as_number, connection_state, messages_received, messages_sent, time_since_established, total_in_prefix_count, total_out_prefix_count, address_families, connection_drop_count, established_connection_count, hold_time, keep_alive_interval, graceful_restart_mode, announced_capabilities, negotiated_capability, neighbor_router_id, remote_site, tier0_path, type, last_update_timestamp, neighbor_edge_node].hash
    end
