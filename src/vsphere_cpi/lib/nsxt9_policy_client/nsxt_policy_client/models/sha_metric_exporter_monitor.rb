...
module Nsxt9PolicyClient
  # SHA METRIC_EXPORTER monitor specification
  class ShaMetricExporterMonitor
    attr_accessor :_self
    ...
    # The supported running node types for this monitor. 
    attr_accessor :supported_node_types

    # The pre-req conditions to run this monitor. 
    attr_accessor :pre_req_conditions

    # List of Sha SUB_METRIC_EXPORTER monitor
    attr_accessor :sub_monitors

    attr_accessor :exported_metric_spec
    ...
    def self.attribute_map
      {
        ...
        :'pre_req_conditions' => :'pre_req_conditions',
        :'sub_monitors' => :'sub_monitors',
        :'exported_metric_spec' => :'exported_metric_spec'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'monitor_id' => :'String',
        :'type' => :'String',
        :'supported_node_types' => :'Array<String>',
        :'pre_req_conditions' => :'Array<String>',
        :'sub_monitors' => :'Array<ShaSubMetricExporterMonitor>',
        :'exported_metric_spec' => :'ShaMonitorExportedMetricSpec'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'monitor_id')
      ...
      if attributes.has_key?(:'supported_node_types')
        if (value = attributes[:'supported_node_types']).is_a?(Array)
          self.supported_node_types = value
        end
      end

      if attributes.has_key?(:'pre_req_conditions')
        if (value = attributes[:'pre_req_conditions']).is_a?(Array)
          self.pre_req_conditions = value
        end
      end

      if attributes.has_key?(:'sub_monitors')
        if (value = attributes[:'sub_monitors']).is_a?(Array)
          self.sub_monitors = value
        end
      end

      if attributes.has_key?(:'exported_metric_spec')
        self.exported_metric_spec = attributes[:'exported_metric_spec']
      end
    end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['ShaStandardMonitor', 'ShaMetricExporterMonitor', 'ShaSubMetricExporterMonitor'])
      return false unless resource_type_validator.valid?(@resource_type)
      return false if !@display_name.nil? && @display_name.to_s.length > 255
      return false if !@description.nil? && @description.to_s.length > 1024
      type_validator = EnumAttributeValidator.new('String', ['UNKNOWN', 'METRIC_EXPORTER', 'SUB_METRIC_EXPORTER', 'STANDARD'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['ShaStandardMonitor', 'ShaMetricExporterMonitor', 'ShaSubMetricExporterMonitor'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['UNKNOWN', 'METRIC_EXPORTER', 'SUB_METRIC_EXPORTER', 'STANDARD'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          type == o.type &&
          supported_node_types == o.supported_node_types &&
          pre_req_conditions == o.pre_req_conditions &&
          sub_monitors == o.sub_monitors &&
          exported_metric_spec == o.exported_metric_spec
    end
