...
module Nsxt9PolicyClient
  ...
  class ChildBridgeFirewallPolicy
    attr_accessor :_self
    ...
    attr_accessor :bridge_firewall_policy
    ...
    def self.attribute_map
      {
        ...
        :'bridge_firewall_policy' => :'BridgeFirewallPolicy'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'BridgeFirewallPolicy')
        self.bridge_firewall_policy = attributes[:'BridgeFirewallPolicy']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @bridge_firewall_policy.nil?
        invalid_properties.push('invalid value for "bridge_firewall_policy", bridge_firewall_policy cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @bridge_firewall_policy.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bridge_firewall_policy == o.bridge_firewall_policy
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, bridge_firewall_policy].hash
    end
