...
module Nsxt9PolicyClient
  # Provides the following traffic statistics of an L2VPN stretched segment since the time the segment is associated with the L2VPN session:  - Incoming packet count. - Outgoing packet count. - Dropped packet count. 
  class L2VPNTrafficStatisticsPerSegment
    ...
    # The total number of outgoing packets on an L2VPN segment. 
    attr_accessor :packets_out

    # The total number of traffic bytes sent on an L2VPN segment. 
    attr_accessor :bytes_out

    # The total number of incoming packets on an L2VPN segment. 
    attr_accessor :packets_in

    # The total number of traffic bytes received on an L2VPN segment. 
    attr_accessor :bytes_in

    # The total number of incoming packets dropped on an L2VPN segment. 
    attr_accessor :packets_receive_error

    # The total number of outgoing packets dropped on an L2VPN segment 
    attr_accessor :packets_sent_error

    # Total number of incoming Broadcast, Unknown unicast and Multicast (BUM) packets. Note: BUM statistics are not supported. 
    attr_accessor :bum_packets_in

    # Total number of incoming Broadcast, Unknown unicast and Multicast (BUM) bytes. Note: BUM statistics are not supported. 
    attr_accessor :bum_bytes_in

    # Total number of outgoing Broadcast, Unknown unicast and Multicast (BUM) packets. Note: BUM statistics are not supported. 
    attr_accessor :bum_packets_out

    # Total number of outgoing Broadcast, Unknown unicast and Multicast (BUM) bytes. Note: BUM statistics are not supported. 
    ...
    def hash
      [segment_path, packets_out, bytes_out, packets_in, bytes_in, packets_receive_error, packets_sent_error, bum_packets_in, bum_bytes_in, bum_packets_out, bum_bytes_out].hash
    end
