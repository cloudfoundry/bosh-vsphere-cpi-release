...
module Nsxt9PolicyClient
  ...
  class PolicyDraft
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, is_auto_draft, system_area, system_area_store_id, user_area, user_area_store_id, ref_draft_path, locked, lock_modified_by, lock_comments, lock_modified_time].hash
    end
