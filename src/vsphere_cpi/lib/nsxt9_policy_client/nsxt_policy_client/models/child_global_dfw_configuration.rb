...
module Nsxt9PolicyClient
  ...
  class ChildGlobalDfwConfiguration
    attr_accessor :_self
    ...
    attr_accessor :global_dfw_configuration
    ...
    def self.attribute_map
      {
        ...
        :'global_dfw_configuration' => :'GlobalDfwConfiguration'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'GlobalDfwConfiguration')
        self.global_dfw_configuration = attributes[:'GlobalDfwConfiguration']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @global_dfw_configuration.nil?
        invalid_properties.push('invalid value for "global_dfw_configuration", global_dfw_configuration cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @global_dfw_configuration.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          global_dfw_configuration == o.global_dfw_configuration
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, global_dfw_configuration].hash
    end
