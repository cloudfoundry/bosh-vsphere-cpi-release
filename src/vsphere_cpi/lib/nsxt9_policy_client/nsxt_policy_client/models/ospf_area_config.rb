...
module Nsxt9PolicyClient
  ...
  class OspfAreaConfig
    ...
    def self.swagger_types
      {
        ...
        :'area_id' => :'String',
        :'area_type' => :'String',
        :'authentication' => :'OspfAuthenticationConfig'
      }
    end
    ...
    def valid?
      ...
      area_type_validator = EnumAttributeValidator.new('String', ['NORMAL', 'NSSA'])
      return false unless area_type_validator.valid?(@area_type)
      true
    end
    ...
    # @param [Object] area_type Object to be assigned
    def area_type=(area_type)
      validator = EnumAttributeValidator.new('String', ['NORMAL', 'NSSA'])
      unless validator.valid?(area_type)
        fail ArgumentError, 'invalid value for "area_type", must be one of #{validator.allowable_values}.'
      end
      @area_type = area_type
    end
