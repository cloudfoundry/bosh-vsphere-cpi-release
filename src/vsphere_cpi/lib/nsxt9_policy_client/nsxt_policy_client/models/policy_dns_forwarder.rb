...
module Nsxt9PolicyClient
  ...
  class PolicyDnsForwarder
    ...
    def list_invalid_properties
      ...
      if !@cache_size.nil? && @cache_size < 0
        invalid_properties.push('invalid value for "cache_size", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@cache_size.nil? && @cache_size < 0
      true
    end
    ...
    def cache_size=(cache_size)
      ...
      if !cache_size.nil? && cache_size < 0
        fail ArgumentError, 'invalid value for "cache_size", must be greater than or equal to 0.'
      end
