...
module Nsxt9PolicyClient
  ...
  class VpcAttachment
    ...
    # VPC Connectivity Profile policy path 
    ...
    def self.attribute_map
      {
        ...
        :'vpc_connectivity_profile' => :'vpc_connectivity_profile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vpc_connectivity_profile')
        self.vpc_connectivity_profile = attributes[:'vpc_connectivity_profile']
      end
    end
