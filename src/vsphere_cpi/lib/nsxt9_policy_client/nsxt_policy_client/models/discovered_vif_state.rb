...
module Nsxt9PolicyClient
  ...
  class DiscoveredVifState
    ...
    def valid?
      ...
      state_validator = EnumAttributeValidator.new('String', ['PENDING', 'ATTACHMENT_IN_PROGRESS', 'ATTACHMENT_SUCCESS', 'ATTACHMENT_FAILED'])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ['PENDING', 'ATTACHMENT_IN_PROGRESS', 'ATTACHMENT_SUCCESS', 'ATTACHMENT_FAILED'])
    ...
    def hash
      [id, segment_port_path, segment_path, state, error_msg].hash
    end
