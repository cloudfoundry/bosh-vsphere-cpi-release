...
module Nsxt9PolicyClient
  ...
  class ChildIPReputationSiteMapping
    attr_accessor :_self
    ...
    attr_accessor :ip_reputation_site_mapping
    ...
    def self.attribute_map
      {
        ...
        :'ip_reputation_site_mapping' => :'IPReputationSiteMapping'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IPReputationSiteMapping')
        self.ip_reputation_site_mapping = attributes[:'IPReputationSiteMapping']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ip_reputation_site_mapping.nil?
        invalid_properties.push('invalid value for "ip_reputation_site_mapping", ip_reputation_site_mapping cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ip_reputation_site_mapping.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ip_reputation_site_mapping == o.ip_reputation_site_mapping
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, ip_reputation_site_mapping].hash
    end
