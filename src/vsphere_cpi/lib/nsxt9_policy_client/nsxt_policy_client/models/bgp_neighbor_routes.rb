...
module Nsxt9PolicyClient
  ...
  class BgpNeighborRoutes
    ...
    attr_accessor :edge_node_routes
    ...
    def self.swagger_types
      {
        ...
        :'edge_node_routes' => :'Array<RoutesPerTransportNode>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'edge_node_routes')
        if (value = attributes[:'edge_node_routes']).is_a?(Array)
          self.edge_node_routes = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          edge_node_routes == o.edge_node_routes
    end
    ...
    def hash
      [neighbor_path, enforcement_point_path, edge_node_routes].hash
    end
