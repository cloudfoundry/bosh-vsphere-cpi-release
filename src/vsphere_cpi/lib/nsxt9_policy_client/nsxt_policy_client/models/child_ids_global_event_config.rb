...
module Nsxt9PolicyClient
  ...
  class ChildIdsGlobalEventConfig
    attr_accessor :_self
    ...
    attr_accessor :ids_global_event_config
    ...
    def self.attribute_map
      {
        ...
        :'ids_global_event_config' => :'IdsGlobalEventConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IdsGlobalEventConfig')
        self.ids_global_event_config = attributes[:'IdsGlobalEventConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ids_global_event_config.nil?
        invalid_properties.push('invalid value for "ids_global_event_config", ids_global_event_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ids_global_event_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ids_global_event_config == o.ids_global_event_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, ids_global_event_config].hash
    end
