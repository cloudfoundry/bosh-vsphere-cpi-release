...
module Nsxt9PolicyClient
  ...
  class ChildTransitGatewayNat
    ...
    attr_accessor :transit_gateway_nat
    ...
    def self.attribute_map
      {
        ...
        :'transit_gateway_nat' => :'TransitGatewayNat'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TransitGatewayNat')
        self.transit_gateway_nat = attributes[:'TransitGatewayNat']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @transit_gateway_nat.nil?
        invalid_properties.push('invalid value for "transit_gateway_nat", transit_gateway_nat cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @transit_gateway_nat.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transit_gateway_nat == o.transit_gateway_nat
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, transit_gateway_nat].hash
    end
