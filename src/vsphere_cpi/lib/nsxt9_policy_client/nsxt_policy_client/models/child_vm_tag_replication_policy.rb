...
module Nsxt9PolicyClient
  ...
  class ChildVMTagReplicationPolicy
    attr_accessor :_self
    ...
    attr_accessor :vm_tag_replication_policy
    ...
    def self.attribute_map
      {
        ...
        :'vm_tag_replication_policy' => :'VMTagReplicationPolicy'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'VMTagReplicationPolicy')
        self.vm_tag_replication_policy = attributes[:'VMTagReplicationPolicy']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @vm_tag_replication_policy.nil?
        invalid_properties.push('invalid value for "vm_tag_replication_policy", vm_tag_replication_policy cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vm_tag_replication_policy.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vm_tag_replication_policy == o.vm_tag_replication_policy
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, vm_tag_replication_policy].hash
    end
