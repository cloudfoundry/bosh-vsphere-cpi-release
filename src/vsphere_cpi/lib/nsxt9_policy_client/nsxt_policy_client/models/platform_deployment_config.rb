...
module Nsxt9PolicyClient
  ...
  class PlatformDeploymentConfig
    ...
    attr_accessor :deployment_action

    # Unique id to identify kubernetes guest cluster.
    attr_accessor :cluster_id

    # From factor is use for deployment.
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'kubeconf_info' => :'KubeconfigInfo',
        :'version' => :'String',
        :'storage_class' => :'String',
        :'deployment_action' => :'CloudNativeDeploymentAction',
        :'cluster_id' => :'String',
        :'form_factor' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'kubeconf_info')
        self.kubeconf_info = attributes[:'kubeconf_info']
      end
      ...
      if attributes.has_key?(:'deployment_action')
        self.deployment_action = attributes[:'deployment_action']
      end
      ...
      if attributes.has_key?(:'service_config')
    ...
    def valid?
      ...
      form_factor_validator = EnumAttributeValidator.new('String', ['standard', 'advanced', 'evaluation'])
    ...
    def form_factor=(form_factor)
      validator = EnumAttributeValidator.new('String', ['standard', 'advanced', 'evaluation'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          kubeconf_info == o.kubeconf_info &&
          version == o.version &&
          storage_class == o.storage_class &&
          deployment_action == o.deployment_action &&
