...
module Nsxt9PolicyClient
  # Information on a performed step in the invocation of an Online Diagnostic System Runbook. 
  class OdsRunbookInvocationStepInfo
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'step_id')
        self.step_id = attributes[:'step_id']
      end

      if attributes.has_key?(:'action_summary')
        self.action_summary = attributes[:'action_summary']
      end

      if attributes.has_key?(:'action_result')
    ...
    def hash
      [step_id, action_summary, action_result, artifacts].hash
    end
