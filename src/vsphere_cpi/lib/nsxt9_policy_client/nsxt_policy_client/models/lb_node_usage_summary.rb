...
module Nsxt9PolicyClient
  ...
  class LBNodeUsageSummary
    ...
    def hash
      [enforcement_point_path, alarm, current_load_balancer_credits, load_balancer_credit_capacity, current_pool_member_count, pool_member_capacity, usage_percentage, severity, node_counts, node_usages].hash
    end
