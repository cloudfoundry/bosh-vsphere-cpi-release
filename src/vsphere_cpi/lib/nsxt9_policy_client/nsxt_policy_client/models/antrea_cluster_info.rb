...
module Nsxt9PolicyClient
  ...
  class AntreaClusterInfo
    ...
    attr_accessor :mp_adapter_status

    attr_accessor :ccp_adapter_status
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'controller_status' => :'AntreaControllerStatus',
        :'mp_adapter_status' => :'AntreaAdapterStatus',
        :'ccp_adapter_status' => :'AntreaAdapterStatus',
        :'agent_info' => :'AntreaAgentsInfo',
        :'status' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'controller_status')
        self.controller_status = attributes[:'controller_status']
      end

      if attributes.has_key?(:'mp_adapter_status')
        self.mp_adapter_status = attributes[:'mp_adapter_status']
      end

      if attributes.has_key?(:'ccp_adapter_status')
        self.ccp_adapter_status = attributes[:'ccp_adapter_status']
      end

      if attributes.has_key?(:'agent_info')
        self.agent_info = attributes[:'agent_info']
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['HEALTHY', 'DEGRADED', 'FAILED', 'UNKNOWN'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['HEALTHY', 'DEGRADED', 'FAILED', 'UNKNOWN'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          mp_adapter_status == o.mp_adapter_status &&
          ccp_adapter_status == o.ccp_adapter_status &&
          agent_info == o.agent_info &&
          status == o.status
    end
