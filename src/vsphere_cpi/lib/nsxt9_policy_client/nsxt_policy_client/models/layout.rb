...
module Nsxt9PolicyClient
  ...
  class Layout
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['HORIZONTAL', 'VERTICAL', 'GRID', 'AUTO'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['HORIZONTAL', 'VERTICAL', 'GRID', 'AUTO'])
