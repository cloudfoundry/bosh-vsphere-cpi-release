...
module Nsxt9PolicyClient
  ...
  class PolicyServiceInstance
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, partner_service_name, deployment_mode, transport_type, context_id, compute_id, storage_id, primary_portgroup_id, primary_interface_network, primary_gateway_address, primary_subnet_mask, primary_interface_mgmt_ip, secondary_portgroup_id, secondary_interface_network, secondary_gateway_address, secondary_subnet_mask, secondary_interface_mgmt_ip, deployment_spec_name, failure_policy, deployment_template_name, attributes].hash
    end
