...
module Nsxt9PolicyClient
  # Details of the kubernetes services belonging to a policy Group 
  class PolicyGroupKubernetesServiceList
    ...
    def self.swagger_types
      {
        :'clusters' => :'Array<PolicyGroupKubernetesServiceCluster>'
      }
    end
