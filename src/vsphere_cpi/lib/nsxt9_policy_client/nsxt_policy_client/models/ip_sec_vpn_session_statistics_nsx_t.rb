...
module Nsxt9PolicyClient
  ...
  class IPSecVpnSessionStatisticsNsxT
    ...
    def hash
      [enforcement_point_path, alarm, resource_type, ike_status, ike_traffic_statistics, policy_statistics, aggregate_traffic_counters, last_update_timestamp, display_name].hash
    end
