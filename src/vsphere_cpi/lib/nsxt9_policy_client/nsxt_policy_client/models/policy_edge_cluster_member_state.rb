...
module Nsxt9PolicyClient
  # Policy Edge Cluster Members State Info 
  class PolicyEdgeClusterMemberState
    ...
    # Edge transport node ,  which is the member of edge cluster. 
    ...
    def hash
      [sub_system_id, sub_system_type, sub_system_address, sub_system_name, state, failure_message, failure_code, policy_edge_node_path, edge_transport_node_path].hash
    end
