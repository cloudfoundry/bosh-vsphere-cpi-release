...
module Nsxt9PolicyClient
  # Security profile helps configure security settings for the VPC. All VPCs within a project are implicitly associated with the pre-created default profile defined at the project level. Note: Currently, users are not allowed to create new security profiles. 
  class VpcSecurityProfile
    attr_accessor :_self
    ...
    # This flag indicates whether this security profile is a default system created profile. All VPCs within a project are implicitly associated with the pre-created default profile defined at the project level. Default profiles can be modified by users but cannot be deleted. 
    attr_accessor :is_default

    attr_accessor :north_south_firewall
    ...
    def self.attribute_map
      {
        ...
        :'north_south_firewall' => :'north_south_firewall'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'is_default' => :'BOOLEAN',
        :'north_south_firewall' => :'NorthSouthFirewall'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'north_south_firewall')
        self.north_south_firewall = attributes[:'north_south_firewall']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @north_south_firewall.nil?
        invalid_properties.push('invalid value for "north_south_firewall", north_south_firewall cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @north_south_firewall.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          north_south_firewall == o.north_south_firewall
    end
