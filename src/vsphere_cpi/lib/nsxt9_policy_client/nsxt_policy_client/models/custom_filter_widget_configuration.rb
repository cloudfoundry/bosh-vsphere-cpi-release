...
module Nsxt9PolicyClient
  ...
  class CustomFilterWidgetConfiguration
    attr_accessor :_self
    ...
    def list_invalid_properties
      ...
      if @ui_component_identifier.nil?
        invalid_properties.push('invalid value for "ui_component_identifier", ui_component_identifier cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ui_component_identifier.nil?
      true
    end
