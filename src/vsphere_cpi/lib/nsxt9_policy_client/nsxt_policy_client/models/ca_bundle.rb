...
module Nsxt9PolicyClient
  ...
  class CaBundle
    ...
    def self.swagger_types
      {
        ...
        :'not_after_list' => :'Array<Integer>',
        :'earliest_not_after' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'not_after_list')
        if (value = attributes[:'not_after_list']).is_a?(Array)
          self.not_after_list = value
        end
      end

      if attributes.has_key?(:'earliest_not_after')
        self.earliest_not_after = attributes[:'earliest_not_after']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          not_after_list == o.not_after_list &&
          earliest_not_after == o.earliest_not_after
    end
