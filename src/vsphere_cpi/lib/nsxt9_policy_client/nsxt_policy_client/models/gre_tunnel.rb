...
module Nsxt9PolicyClient
  ...
  class GreTunnel
    ...
    # Indicates Resource type of tunnel, GreTunnel - Resource type as GreTunnel will be used to configure P2P GRE Tunnel. 
    ...
    # Specify list of IP address per every edge node for tunnel interface. Supports both IPv4 and IPv6 address. 
    attr_accessor :tunnel_address

    # Maximum transmission unit(MTU) in bytes specifies the size of the largest packet that a tunnel can transmit. 
    attr_accessor :mtu

    # Destination IP address of P2P GRE Tunnel. The IP address that the NSX Edge will connect to. 
    attr_accessor :destination_address

    attr_accessor :tunnel_keepalive
    ...
    def self.attribute_map
      {
        ...
        :'tunnel_keepalive' => :'tunnel_keepalive'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'enabled' => :'BOOLEAN',
        :'tunnel_address' => :'Array<TunnelAddress>',
        :'mtu' => :'Integer',
        :'destination_address' => :'String',
        :'tunnel_keepalive' => :'TunnelKeepAlive'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'tunnel_address')
        if (value = attributes[:'tunnel_address']).is_a?(Array)
          self.tunnel_address = value
        end
      end
      ...
      if attributes.has_key?(:'tunnel_keepalive')
        self.tunnel_keepalive = attributes[:'tunnel_keepalive']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tunnel_address.nil?
        invalid_properties.push('invalid value for "tunnel_address", tunnel_address cannot be nil.')
      end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['GreTunnel'])
      return false unless resource_type_validator.valid?(@resource_type)
      return false if !@display_name.nil? && @display_name.to_s.length > 255
      return false if !@description.nil? && @description.to_s.length > 1024
      return false if @tunnel_address.nil?
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['GreTunnel'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enabled == o.enabled &&
          tunnel_address == o.tunnel_address &&
          mtu == o.mtu &&
          destination_address == o.destination_address &&
          tunnel_keepalive == o.tunnel_keepalive
    end
