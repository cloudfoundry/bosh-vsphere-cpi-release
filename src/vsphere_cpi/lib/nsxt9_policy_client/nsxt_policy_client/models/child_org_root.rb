...
module Nsxt9PolicyClient
  ...
  class ChildOrgRoot
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'OrgRoot')
        self.org_root = attributes[:'OrgRoot']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @org_root.nil?
        invalid_properties.push('invalid value for "org_root", org_root cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, org_root].hash
    end
