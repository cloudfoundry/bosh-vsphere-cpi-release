...
module Nsxt9PolicyClient
  # IDS custom signature version
  class IdsCustomSignatureVersion
    attr_accessor :_self
    ...
    # Flag which tells whether the Signature version is come via auto update mechanism. It can be via auto update periodic task or via update now mechanism. 
    attr_accessor :auto_update

    # Contains the path of sites that has been mapped with the Signature Version. 
    attr_accessor :sites

    # Time when the custom signature was published. 
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['VALIDATION_PENDING', 'PUBLISH_PENDING', 'PUBLISHED', 'IN_PROGRESS'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['VALIDATION_PENDING', 'PUBLISH_PENDING', 'PUBLISHED', 'IN_PROGRESS'])
