...
module Nsxt9PolicyClient
  ...
  class ChildIpAddressPool
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, ip_address_pool].hash
    end
