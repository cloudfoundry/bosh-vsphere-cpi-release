    ...
    def self.swagger_types
      {
        ...
        :'host_infra_traffic_res' => :'Array<PolicyPolicyResourceAllocation>',
        :'enabled' => :'BOOLEAN'
      }
    end
