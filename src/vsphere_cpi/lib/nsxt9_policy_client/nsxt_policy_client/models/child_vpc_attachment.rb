...
module Nsxt9PolicyClient
  ...
  class ChildVpcAttachment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'VpcAttachment')
        self.vpc_attachment = attributes[:'VpcAttachment']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @vpc_attachment.nil?
        invalid_properties.push('invalid value for "vpc_attachment", vpc_attachment cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vpc_attachment.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vpc_attachment == o.vpc_attachment
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, vpc_attachment].hash
    end
