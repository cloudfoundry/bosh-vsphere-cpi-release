...
module Nsxt9PolicyClient
  ...
  class PolicyIpsecVpnIkeServiceSummary
    ...
    def hash
      [session_summary, aggregate_traffic_counters, traffic_summary_per_session, last_update_timestamp, enforcement_point_path, ipsec_vpn_service_path, display_name].hash
    end
