...
module Nsxt9PolicyClient
  ...
  class PolicyHighPerformanceHostSwitchProfile
    attr_accessor :_self
    ...
    def self.attribute_map
      {
        ...
        :'high_performance_configs' => :'high_performance_configs',
    ...
    def self.swagger_types
      {
        ...
        :'high_performance_configs' => :'Array<HighPerformanceConfig>',
        :'auto_config' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'high_performance_configs')
        if (value = attributes[:'high_performance_configs']).is_a?(Array)
          self.high_performance_configs = value
        end
      end

      if attributes.has_key?(:'auto_config')
    ...
    def list_invalid_properties
      ...
      if !@auto_config.nil? && @auto_config > 1
        invalid_properties.push('invalid value for "auto_config", must be smaller than or equal to 1.')
      end

      if !@auto_config.nil? && @auto_config < 0
        invalid_properties.push('invalid value for "auto_config", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@auto_config.nil? && @auto_config > 1
      return false if !@auto_config.nil? && @auto_config < 0
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] auto_config Value to be assigned
    def auto_config=(auto_config)
      if !auto_config.nil? && auto_config > 1
        fail ArgumentError, 'invalid value for "auto_config", must be smaller than or equal to 1.'
      end

      if !auto_config.nil? && auto_config < 0
        fail ArgumentError, 'invalid value for "auto_config", must be greater than or equal to 0.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          high_performance_configs == o.high_performance_configs &&
