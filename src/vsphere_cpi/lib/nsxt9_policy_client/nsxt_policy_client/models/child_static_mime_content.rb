...
module Nsxt9PolicyClient
  ...
  class ChildStaticMimeContent
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TlsProfile')
        self.tls_profile = attributes[:'TlsProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tls_profile.nil?
        invalid_properties.push('invalid value for "tls_profile", tls_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tls_profile.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, tls_profile].hash
    end
