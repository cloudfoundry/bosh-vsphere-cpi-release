...
module Nsxt9PolicyClient
  ...
  class AntreaTraceflowTcpHeader
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dstPort')
        self.dst_port = attributes[:'dstPort']
      end

      if attributes.has_key?(:'srcPort')
        self.src_port = attributes[:'srcPort']
      end

      if attributes.has_key?(:'tcpFlags')
        self.tcp_flags = attributes[:'tcpFlags']
      end
    end
    ...
    def hash
      [dst_port, src_port, tcp_flags].hash
    end
