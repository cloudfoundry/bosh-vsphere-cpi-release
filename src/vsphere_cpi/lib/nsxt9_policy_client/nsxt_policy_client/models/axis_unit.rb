...
module Nsxt9PolicyClient
  ...
  class AxisUnit
    ...
    def valid?
      unit_validator = EnumAttributeValidator.new('String', ['COUNT', 'PERCENT', 'BYTES', 'MILLISECONDS', 'SECONDS', 'MINUTE', 'HOUR', 'DAY', 'KILO_BYTES', 'MEGA_BYTES', 'GIGA_BYTES'])
    ...
    def unit=(unit)
      validator = EnumAttributeValidator.new('String', ['COUNT', 'PERCENT', 'BYTES', 'MILLISECONDS', 'SECONDS', 'MINUTE', 'HOUR', 'DAY', 'KILO_BYTES', 'MEGA_BYTES', 'GIGA_BYTES'])
