...
module Nsxt9PolicyClient
  # This holds the state of Edge Cluster. If there are errors in realizing edge cluster, it gives details of the components and specific errors. 
  class PolicyEdgeClusterState
    ...
    def self.swagger_types
      {
        :'state' => :'String',
        :'details' => :'Array<PolicyEdgeClusterMemberState>',
    ...
    def hash
      [state, details, failure_message, failure_code, edge_cluster_name, pending_change_list].hash
    end
