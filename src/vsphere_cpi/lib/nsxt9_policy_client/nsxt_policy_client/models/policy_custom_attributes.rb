...
module Nsxt9PolicyClient
  ...
  class PolicyCustomAttributes
    ...
    def valid?
      ...
      key_validator = EnumAttributeValidator.new('String', ['DOMAIN_NAME', 'CUSTOM_URL'])
      ...
      attribute_source_validator = EnumAttributeValidator.new('String', ['CUSTOM', 'SYSTEM'])
    ...
    def key=(key)
      validator = EnumAttributeValidator.new('String', ['DOMAIN_NAME', 'CUSTOM_URL'])
