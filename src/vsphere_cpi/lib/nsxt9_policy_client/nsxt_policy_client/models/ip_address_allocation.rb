...
module Nsxt9PolicyClient
  ...
  class IpAddressAllocation
    ...
    # Represents IP Address that is allocated from a pool in a NSX+ instance.
    attr_accessor :allocated_ip
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'allocated_ip')
        self.allocated_ip = attributes[:'allocated_ip']
      end
