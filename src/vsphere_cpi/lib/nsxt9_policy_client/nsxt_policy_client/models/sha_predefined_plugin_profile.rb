...
module Nsxt9PolicyClient
  ...
  class ShaPredefinedPluginProfile
    attr_accessor :_self
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'plugin_path')
        self.plugin_path = attributes[:'plugin_path']
      end
    ...
    def list_invalid_properties
      ...
      if @plugin_path.nil?
        invalid_properties.push('invalid value for "plugin_path", plugin_path cannot be nil.')
      end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['PredefinedPlugin', 'DynamicPlugin', 'SystemPlugin'])
      return false unless resource_type_validator.valid?(@resource_type)
      return false if !@display_name.nil? && @display_name.to_s.length > 255
      return false if !@description.nil? && @description.to_s.length > 1024
      return false if @plugin_path.nil?
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['PredefinedPlugin', 'DynamicPlugin', 'SystemPlugin'])
