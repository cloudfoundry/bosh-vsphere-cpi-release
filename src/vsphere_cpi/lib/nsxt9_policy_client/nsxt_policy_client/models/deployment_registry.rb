...
module Nsxt9PolicyClient
  ...
  class DeploymentRegistry
    ...
    # Docker registry url to access docker images.
    attr_accessor :docker_registry

    # Helm repo url to access helm charts.
    attr_accessor :helm_repo

    # Helm repo certificate to access locally hosted helm repository
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'helm_repo')
        self.helm_repo = attributes[:'helm_repo']
      end
    ...
    def list_invalid_properties
      ...
      if @docker_registry.nil?
        invalid_properties.push('invalid value for "docker_registry", docker_registry cannot be nil.')
      end

      if @helm_repo.nil?
        invalid_properties.push('invalid value for "helm_repo", helm_repo cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @docker_registry.nil?
      return false if @helm_repo.nil?
      true
    end
