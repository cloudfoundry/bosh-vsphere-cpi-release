...
module Nsxt9PolicyClient
  ...
  class ChildPolicyLatencyStatProfile
    attr_accessor :_self
    ...
    attr_accessor :policy_latency_stat_profile
    ...
    def self.attribute_map
      {
        ...
        :'policy_latency_stat_profile' => :'PolicyLatencyStatProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyLatencyStatProfile')
        self.policy_latency_stat_profile = attributes[:'PolicyLatencyStatProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_latency_stat_profile.nil?
        invalid_properties.push('invalid value for "policy_latency_stat_profile", policy_latency_stat_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_latency_stat_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_latency_stat_profile == o.policy_latency_stat_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, policy_latency_stat_profile].hash
    end
