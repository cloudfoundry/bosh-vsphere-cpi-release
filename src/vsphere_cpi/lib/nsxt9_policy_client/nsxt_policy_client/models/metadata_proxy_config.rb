...
module Nsxt9PolicyClient
  ...
  class MetadataProxyConfig
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, server_address, server_certificates, secret, edge_cluster_path, preferred_edge_paths, enable_standby_relocation, crypto_protocols].hash
    end
