...
module Nsxt9PolicyClient
  class ComponentHealthMetric
    ...
    def valid?
      data_type_validator = EnumAttributeValidator.new('String', ['INTEGER', 'DOUBLE', 'STRING', 'BOOL', 'TIMESTAMP'])
      return false unless data_type_validator.valid?(@data_type)
      unit_validator = EnumAttributeValidator.new('String', ['BYTES', 'PERCENT', 'MILLISECOND', 'MICROSECOND'])
    ...
    def data_type=(data_type)
      validator = EnumAttributeValidator.new('String', ['INTEGER', 'DOUBLE', 'STRING', 'BOOL', 'TIMESTAMP'])
    ...
    def unit=(unit)
      validator = EnumAttributeValidator.new('String', ['BYTES', 'PERCENT', 'MILLISECOND', 'MICROSECOND'])
    ...
    def hash
      [name, data_type, value, unit].hash
    end
