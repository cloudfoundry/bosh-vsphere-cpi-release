...
module Nsxt9PolicyClient
  ...
  class PolicyIgmpProfile
    ...
    def list_invalid_properties
      ...
      if !@robustness_variable.nil? && @robustness_variable > 7
        invalid_properties.push('invalid value for "robustness_variable", must be smaller than or equal to 7.')
      end
    ...
    def valid?
      ...
      return false if !@robustness_variable.nil? && @robustness_variable > 7
    ...
    def robustness_variable=(robustness_variable)
      if !robustness_variable.nil? && robustness_variable > 7
        fail ArgumentError, 'invalid value for "robustness_variable", must be smaller than or equal to 7.'
      end
