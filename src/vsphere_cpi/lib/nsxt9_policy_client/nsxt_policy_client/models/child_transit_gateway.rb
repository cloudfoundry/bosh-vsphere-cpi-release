...
module Nsxt9PolicyClient
  ...
  class ChildTransitGateway
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TransitGateway')
        self.transit_gateway = attributes[:'TransitGateway']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @transit_gateway.nil?
        invalid_properties.push('invalid value for "transit_gateway", transit_gateway cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @transit_gateway.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transit_gateway == o.transit_gateway
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, transit_gateway].hash
    end
