...
module Nsxt9PolicyClient
  class PolicyTraceflowObservationReceivedLogical
    ...
    def valid?
      ...
      src_component_type_validator = EnumAttributeValidator.new('String', ['PHYSICAL', 'LR', 'LS', 'DFW', 'BRIDGE', 'EDGE_TUNNEL', 'EDGE_HOSTSWITCH', 'FW_BRIDGE', 'EDGE_RTEP_TUNNEL', 'LOAD_BALANCER', 'NAT', 'IPSEC', 'SERVICE_INSERTION', 'VMC', 'SPOOFGUARD', 'EDGE_FW', 'DLB', 'ANTREA_SPOOFGUARD', 'ANTREA_LB', 'ANTREA_ROUTING', 'ANTREA_DFW', 'ANTREA_FORWARDING', 'HOST_SWITCH', 'UNKNOWN', 'DHCP'])
    ...
    def hash
      [resource_type, sequence_no, transport_node_id, transport_node_name, transport_node_type, timestamp, timestamp_micro, component_type, component_sub_type, component_name, site_path, is_ens, component_id, src_component_type, src_component_id, src_component_name, lport_id, lport_name, vni, svc_mac, vlan, ipsec_vpn, component_path, src_component_path, segment_port_path, subnet_port_path, interface_path, ipsec_vpn_path].hash
    end
