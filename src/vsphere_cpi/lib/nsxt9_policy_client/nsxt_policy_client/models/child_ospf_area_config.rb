...
module Nsxt9PolicyClient
  ...
  class ChildOspfAreaConfig
    ...
    attr_accessor :ospf_area_config
    ...
    def self.attribute_map
      {
        ...
        :'ospf_area_config' => :'OspfAreaConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'OspfAreaConfig')
        self.ospf_area_config = attributes[:'OspfAreaConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ospf_area_config.nil?
        invalid_properties.push('invalid value for "ospf_area_config", ospf_area_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ospf_area_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ospf_area_config == o.ospf_area_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, ospf_area_config].hash
    end
