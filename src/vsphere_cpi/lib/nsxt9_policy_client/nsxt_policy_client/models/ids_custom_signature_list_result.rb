...
module Nsxt9PolicyClient
  # Paged collection of IDS custom signatures
  class IdsCustomSignatureListResult
    attr_accessor :_self
    ...
    def self.swagger_types
      {
        ...
        :'cursor' => :'String',
        :'results' => :'Array<IdsCustomSignature>',
    ...
    def hash
      [_self, _links, _schema, result_count, sort_by, sort_ascending, cursor, results, publish_time].hash
    end
