...
module Nsxt9PolicyClient
  ...
  class PolicyFirewallSessionTimerProfile
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, tcp_first_packet, tcp_opening, tcp_established, tcp_closing, tcp_finwait, tcp_closed, udp_first_packet, udp_single, udp_multiple, icmp_first_packet, icmp_error_reply].hash
    end
