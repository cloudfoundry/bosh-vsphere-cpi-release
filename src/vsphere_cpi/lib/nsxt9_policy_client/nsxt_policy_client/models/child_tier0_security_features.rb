...
module Nsxt9PolicyClient
  ...
  class ChildTier0SecurityFeatures
    attr_accessor :_self
    ...
    attr_accessor :tier0_security_features
    ...
    def self.attribute_map
      {
        ...
        :'tier0_security_features' => :'Tier0SecurityFeatures'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Tier0SecurityFeatures')
        self.tier0_security_features = attributes[:'Tier0SecurityFeatures']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tier0_security_features.nil?
        invalid_properties.push('invalid value for "tier0_security_features", tier0_security_features cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tier0_security_features.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tier0_security_features == o.tier0_security_features
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, tier0_security_features].hash
    end
