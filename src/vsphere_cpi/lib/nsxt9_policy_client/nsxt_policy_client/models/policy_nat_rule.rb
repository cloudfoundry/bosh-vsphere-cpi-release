...
module Nsxt9PolicyClient
  ...
  class PolicyNatRule
    ...
    # It indicates how the NSX edge applies Nat Policy for VPN traffic. It is supported only for Nat Rule action type DNAT and NO_DNAT. For all other NAT action, leave it unassigned. BYPASS - Default vpn mode. It indicates that Nat policy will be applied to the inbound traffic          on Routed Based VPN tunnel, if the policy based VTI is in the \"scope\" for this rule.          Default value will be set to BYPASS if MATCH - It indicates that this NAT rule will only match the Policy Based VPN traffic. 
    attr_accessor :policy_based_vpn_mode
    ...
    def self.attribute_map
      {
        ...
        :'policy_based_vpn_mode' => :'policy_based_vpn_mode'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'policy_based_vpn_mode')
        self.policy_based_vpn_mode = attributes[:'policy_based_vpn_mode']
      end
    end
    ...
    def valid?
      ...
      policy_based_vpn_mode_validator = EnumAttributeValidator.new('String', ['BYPASS', 'MATCH'])
      return false unless policy_based_vpn_mode_validator.valid?(@policy_based_vpn_mode)
      true
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] policy_based_vpn_mode Object to be assigned
    def policy_based_vpn_mode=(policy_based_vpn_mode)
      validator = EnumAttributeValidator.new('String', ['BYPASS', 'MATCH'])
      unless validator.valid?(policy_based_vpn_mode)
        fail ArgumentError, 'invalid value for "policy_based_vpn_mode", must be one of #{validator.allowable_values}.'
      end
      @policy_based_vpn_mode = policy_based_vpn_mode
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_based_vpn_mode == o.policy_based_vpn_mode
    end
