...
module Nsxt9PolicyClient
  class TraceflowObservationReplicationLogical
    ...
    def hash
      [resource_type, sequence_no, transport_node_id, transport_node_name, transport_node_type, timestamp, timestamp_micro, component_type, component_sub_type, component_name, site_path, is_ens, local_ip_address, vtep_label, replication_type, uplink_name].hash
    end
