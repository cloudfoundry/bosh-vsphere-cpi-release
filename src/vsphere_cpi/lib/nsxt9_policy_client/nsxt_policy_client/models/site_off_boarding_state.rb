...
module Nsxt9PolicyClient
  ...
  class SiteOffBoardingState
    ...
    attr_accessor :previous_error_message
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'previousErrorMessage')
        self.previous_error_message = attributes[:'previousErrorMessage']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          status == o.status &&
          message == o.message &&
          previous_error_message == o.previous_error_message
    end
