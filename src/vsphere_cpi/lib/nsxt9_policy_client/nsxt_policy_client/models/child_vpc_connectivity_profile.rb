...
module Nsxt9PolicyClient
  ...
  class ChildVpcConnectivityProfile
    attr_accessor :_self
    ...
    attr_accessor :vpc_connectivity_profile
    ...
    def self.attribute_map
      {
        ...
        :'vpc_connectivity_profile' => :'VpcConnectivityProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'VpcConnectivityProfile')
        self.vpc_connectivity_profile = attributes[:'VpcConnectivityProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @vpc_connectivity_profile.nil?
        invalid_properties.push('invalid value for "vpc_connectivity_profile", vpc_connectivity_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vpc_connectivity_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vpc_connectivity_profile == o.vpc_connectivity_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, vpc_connectivity_profile].hash
    end
