...
module Nsxt9PolicyClient
  class LogicalPortStatistics
    ...
    def hash
      [rx_packets, rx_bytes, tx_packets, tx_bytes, dropped_by_security_packets, mac_learning, dropped_by_firewall_packets, distributed_dhcp_server_packets, logical_port_id, last_update_timestamp].hash
    end
