...
module Nsxt9PolicyClient
  class PortMirrorFilter
    ...
    def self.swagger_types
      {
        :'source_ips' => :'IPAddresses',
        :'destination_ips' => :'IPAddresses',
        :'protocol' => :'String',
        :'source_ports' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'source_ips')
        self.source_ips = attributes[:'source_ips']
      end

      if attributes.has_key?(:'destination_ips')
        self.destination_ips = attributes[:'destination_ips']
      end
    ...
    def hash
      [source_ips, destination_ips, protocol, source_ports, destination_ports].hash
    end
