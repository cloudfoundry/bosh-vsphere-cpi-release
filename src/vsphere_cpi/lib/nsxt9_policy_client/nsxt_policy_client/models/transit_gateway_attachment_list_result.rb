...
module Nsxt9PolicyClient
  # List of Transit Gateway Attachment
  class TransitGatewayAttachmentListResult
    attr_accessor :_self
    ...
    # Transit gateway attachment list results
    ...
    def self.swagger_types
      {
        ...
        :'cursor' => :'String',
        :'results' => :'Array<TransitGatewayAttachment>'
      }
    end
