...
module Nsxt9PolicyClient
  ...
  class ChildSecurityFeatures
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SecurityFeatures')
        self.security_features = attributes[:'SecurityFeatures']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @security_features.nil?
        invalid_properties.push('invalid value for "security_features", security_features cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @security_features.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, security_features].hash
    end
