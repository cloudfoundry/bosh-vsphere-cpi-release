...
module Nsxt9PolicyClient
  class TraceflowObservationForwarded
    ...
    def hash
      [resource_type, sequence_no, transport_node_id, transport_node_name, transport_node_type, timestamp, timestamp_micro, component_type, component_sub_type, component_name, site_path, is_ens, dst_transport_node_id, dst_transport_node_name, context, remote_ip_address, local_ip_address, vtep_label, uplink_name].hash
    end
