...
module Nsxt9PolicyClient
  # This entity will be used to establish association between profiles and Vpc Subnet Port. Using this entity, user can specify intent for applying different profiles to particular Vpc Subnet Port. 
  class VpcSubnetPortProfileBindingMap
    attr_accessor :_self
    ...
    # PolicyPath of Subnet Qos Profile
    attr_accessor :qos_profile_path

    # PolicyPath of Security Profile
    attr_accessor :security_profile_path

    # PolicyPath of SpoofGuard Profile
    attr_accessor :spoof_guard_profile_path
    ...
    def self.attribute_map
      {
        ...
        :'spoof_guard_profile_path' => :'spoof_guard_profile_path'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'spoof_guard_profile_path' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'security_profile_path')
        self.security_profile_path = attributes[:'security_profile_path']
      end

      if attributes.has_key?(:'spoof_guard_profile_path')
        self.spoof_guard_profile_path = attributes[:'spoof_guard_profile_path']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          security_profile_path == o.security_profile_path &&
          spoof_guard_profile_path == o.spoof_guard_profile_path
    end
