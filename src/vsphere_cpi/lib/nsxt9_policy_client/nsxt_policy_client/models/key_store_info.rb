...
module Nsxt9PolicyClient
  ...
  class KeyStoreInfo
    ...
    def self.attribute_map
      {
        ...
        :'keystore_phrase' => :'keystore_phrase'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'keystore_alias')
        self.keystore_alias = attributes[:'keystore_alias']
      end

      if attributes.has_key?(:'keystore')
      ...
      if attributes.has_key?(:'keystore_phrase')
        self.keystore_phrase = attributes[:'keystore_phrase']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          keystore_phrase == o.keystore_phrase
    end
    ...
    def hash
      [keystore_alias, keystore, truststore, keystore_phrase].hash
    end
