...
module Nsxt9PolicyClient
  ...
  class LBServiceUsage
    ...
    def hash
      [enforcement_point_path, alarm, resource_type, service_path, service_size, virtual_server_capacity, pool_capacity, pool_member_capacity, current_virtual_server_count, current_pool_count, current_pool_member_count, usage_percentage, severity, last_update_timestamp].hash
    end
