...
module Nsxt9PolicyClient
  ...
  class ChildVpcSubnetPort
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'VpcSubnetPort')
        self.vpc_subnet_port = attributes[:'VpcSubnetPort']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @vpc_subnet_port.nil?
        invalid_properties.push('invalid value for "vpc_subnet_port", vpc_subnet_port cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vpc_subnet_port.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vpc_subnet_port == o.vpc_subnet_port
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, vpc_subnet_port].hash
    end
