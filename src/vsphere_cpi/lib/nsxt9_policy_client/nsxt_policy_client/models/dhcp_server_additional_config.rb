...
module Nsxt9PolicyClient
  ...
  class DhcpServerAdditionalConfig
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'reserved_ip_ranges')
        if (value = attributes[:'reserved_ip_ranges']).is_a?(Array)
          self.reserved_ip_ranges = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          options == o.options &&
          reserved_ip_ranges == o.reserved_ip_ranges
    end
    ...
    def hash
      [options, reserved_ip_ranges].hash
    end
