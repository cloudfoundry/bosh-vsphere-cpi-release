...
module Nsxt9PolicyClient
  class Traceflow
    ...
    def list_invalid_properties
      ...
      if !@timeout.nil? && @timeout > 90000
        invalid_properties.push('invalid value for "timeout", must be smaller than or equal to 90000.')
      end
    ...
    def valid?
      ...
      return false if !@timeout.nil? && @timeout > 90000
    ...
    def timeout=(timeout)
      if !timeout.nil? && timeout > 90000
        fail ArgumentError, 'invalid value for "timeout", must be smaller than or equal to 90000.'
      end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, lport_id, timeout, operation_state, result_overflowed, counters, logical_counters, analysis, request_status].hash
    end
