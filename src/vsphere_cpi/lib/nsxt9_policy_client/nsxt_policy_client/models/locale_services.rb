...
module Nsxt9PolicyClient
  ...
  class LocaleServices
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, route_redistribution_types, route_redistribution_config, edge_cluster_path, preferred_edge_paths, ha_vip_configs, bfd_profile_path].hash
    end
