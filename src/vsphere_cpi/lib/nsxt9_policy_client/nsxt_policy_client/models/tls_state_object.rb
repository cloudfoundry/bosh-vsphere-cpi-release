...
module Nsxt9PolicyClient
  ...
  class TlsStateObject
    ...
    attr_accessor :inspection_action
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'failure_reasons')
        if (value = attributes[:'failure_reasons']).is_a?(Array)
          self.failure_reasons = value
        end
      end

      if attributes.has_key?(:'inspection_action')
        self.inspection_action = attributes[:'inspection_action']
      else
        self.inspection_action = 'INVALID'
      end
    ...
    def valid?
      ...
      inspection_action_validator = EnumAttributeValidator.new('String', ['INVALID', 'BYPASS', 'DROP', 'REJECT'])
      return false unless inspection_action_validator.valid?(@inspection_action)
      true
    end
    ...
    # @param [Object] inspection_action Object to be assigned
    def inspection_action=(inspection_action)
      validator = EnumAttributeValidator.new('String', ['INVALID', 'BYPASS', 'DROP', 'REJECT'])
      unless validator.valid?(inspection_action)
        fail ArgumentError, 'invalid value for "inspection_action", must be one of #{validator.allowable_values}.'
      end
      @inspection_action = inspection_action
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          inspection_action == o.inspection_action &&
          scope == o.scope
    end
