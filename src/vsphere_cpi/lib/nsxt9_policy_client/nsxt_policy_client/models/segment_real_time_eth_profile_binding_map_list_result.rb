...
module Nsxt9PolicyClient
  # Paged collection of Segment Real Time Eth Profile Binding Maps
  class SegmentRealTimeEthProfileBindingMapListResult
    attr_accessor :_self
    ...
    # Segment Real Time Eth Profile Binding Map list results
    ...
    def self.swagger_types
      {
        ...
        :'cursor' => :'String',
        :'results' => :'Array<SegmentRealTimeEthProfileBindingMap>'
      }
    end
