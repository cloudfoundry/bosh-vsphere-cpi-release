...
module Nsxt9PolicyClient
  # Paginated collection of kubernetes clusters associated to a Group. 
  class PolicyGroupAssociatedKubernetesClusterListResult
    attr_accessor :_self
    ...
    # Paged Collection of kubernetes resources that belong to the given Group
    ...
    def self.swagger_types
      {
        ...
        :'cursor' => :'String',
        :'results' => :'Array<PolicyGroupAssociatedKubernetesClusterList>'
      }
    end
