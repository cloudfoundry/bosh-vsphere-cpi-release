...
module Nsxt9PolicyClient
  ...
  class BgpRoutingConfig
    ...
    # Administrative distance for IPv4 and IPv6 eBGP learnt routes(inbound). User is allowed to set this value only if BGP is disabled. 
    attr_accessor :ebgp_admin_distance

    # Administrative distance for IPv4 and IPv6 iBGP learnt routes(inbound). User is allowed to set this value only if BGP is disabled. 
    attr_accessor :ibgp_admin_distance
    ...
    def self.swagger_types
      {
        ...
        :'ebgp_admin_distance' => :'Integer',
        :'ibgp_admin_distance' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ebgp_admin_distance')
        self.ebgp_admin_distance = attributes[:'ebgp_admin_distance']
      else
        self.ebgp_admin_distance = 20
      end

      if attributes.has_key?(:'ibgp_admin_distance')
        self.ibgp_admin_distance = attributes[:'ibgp_admin_distance']
      else
        self.ibgp_admin_distance = 200
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@ebgp_admin_distance.nil? && @ebgp_admin_distance > 255
        invalid_properties.push('invalid value for "ebgp_admin_distance", must be smaller than or equal to 255.')
      end

      if !@ebgp_admin_distance.nil? && @ebgp_admin_distance < 1
        invalid_properties.push('invalid value for "ebgp_admin_distance", must be greater than or equal to 1.')
      end

      if !@ibgp_admin_distance.nil? && @ibgp_admin_distance > 255
        invalid_properties.push('invalid value for "ibgp_admin_distance", must be smaller than or equal to 255.')
      end

      if !@ibgp_admin_distance.nil? && @ibgp_admin_distance < 1
        invalid_properties.push('invalid value for "ibgp_admin_distance", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@ebgp_admin_distance.nil? && @ebgp_admin_distance > 255
      return false if !@ebgp_admin_distance.nil? && @ebgp_admin_distance < 1
      return false if !@ibgp_admin_distance.nil? && @ibgp_admin_distance > 255
      return false if !@ibgp_admin_distance.nil? && @ibgp_admin_distance < 1
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] ebgp_admin_distance Value to be assigned
    def ebgp_admin_distance=(ebgp_admin_distance)
      if !ebgp_admin_distance.nil? && ebgp_admin_distance > 255
        fail ArgumentError, 'invalid value for "ebgp_admin_distance", must be smaller than or equal to 255.'
      end

      if !ebgp_admin_distance.nil? && ebgp_admin_distance < 1
        fail ArgumentError, 'invalid value for "ebgp_admin_distance", must be greater than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] ibgp_admin_distance Value to be assigned
    def ibgp_admin_distance=(ibgp_admin_distance)
      if !ibgp_admin_distance.nil? && ibgp_admin_distance > 255
        fail ArgumentError, 'invalid value for "ibgp_admin_distance", must be smaller than or equal to 255.'
      end

      if !ibgp_admin_distance.nil? && ibgp_admin_distance < 1
        fail ArgumentError, 'invalid value for "ibgp_admin_distance", must be greater than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ebgp_admin_distance == o.ebgp_admin_distance &&
          ibgp_admin_distance == o.ibgp_admin_distance
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, local_as_num, enabled, ecmp, route_aggregations, multipath_relax, inter_sr_ibgp, graceful_restart_config, ebgp_admin_distance, ibgp_admin_distance].hash
    end
