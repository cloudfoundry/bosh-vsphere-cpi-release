...
module Nsxt9PolicyClient
  ...
  class Share
    ...
    # Represents an array of the paths of the contexts (Org or Project) to which the contents of this share should be shared. If any entry in this array refers to a custom project's path, it is mandatory to set the value of sharing_strategy to ALL_DESCENDANTS. 
    attr_accessor :shared_with

    # Strategy used to decide to which shareWith the contents of the share should be shared. Project is descendant of Org. Vpc is descendant of Project. ALL_DESCENDANTS - Share with the shareWith path and all it's descendants. NONE_DESCENDANTS - Share with the shareWith path only and not its descendants. (Default). 
    attr_accessor :sharing_strategy
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sharedWith')
        if (value = attributes[:'sharedWith']).is_a?(Array)
          self.shared_with = value
        end
      end

      if attributes.has_key?(:'sharing_strategy')
        self.sharing_strategy = attributes[:'sharing_strategy']
      else
        self.sharing_strategy = 'NONE_DESCENDANTS'
      end
    end
    ...
    def valid?
      ...
      sharing_strategy_validator = EnumAttributeValidator.new('String', ['NONE_DESCENDANTS', 'ALL_DESCENDANTS'])
      return false unless sharing_strategy_validator.valid?(@sharing_strategy)
      true
    end
    ...
    # @param [Object] sharing_strategy Object to be assigned
    def sharing_strategy=(sharing_strategy)
      validator = EnumAttributeValidator.new('String', ['NONE_DESCENDANTS', 'ALL_DESCENDANTS'])
      unless validator.valid?(sharing_strategy)
        fail ArgumentError, 'invalid value for "sharing_strategy", must be one of #{validator.allowable_values}.'
      end
      @sharing_strategy = sharing_strategy
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sharing_strategy == o.sharing_strategy
    end
