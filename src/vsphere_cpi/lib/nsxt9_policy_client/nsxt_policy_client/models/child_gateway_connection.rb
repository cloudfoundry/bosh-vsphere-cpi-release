...
module Nsxt9PolicyClient
  ...
  class ChildGatewayConnection
    ...
    attr_accessor :gateway_connection
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'GatewayConnection')
        self.gateway_connection = attributes[:'GatewayConnection']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @gateway_connection.nil?
        invalid_properties.push('invalid value for "gateway_connection", gateway_connection cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @gateway_connection.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          gateway_connection == o.gateway_connection
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, gateway_connection].hash
    end
