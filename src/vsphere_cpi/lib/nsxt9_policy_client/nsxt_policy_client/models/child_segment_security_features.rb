...
module Nsxt9PolicyClient
  ...
  class ChildSegmentSecurityFeatures
    attr_accessor :_self
    ...
    attr_accessor :segment_security_features
    ...
    def self.attribute_map
      {
        ...
        :'segment_security_features' => :'SegmentSecurityFeatures'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SegmentSecurityFeatures')
        self.segment_security_features = attributes[:'SegmentSecurityFeatures']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @segment_security_features.nil?
        invalid_properties.push('invalid value for "segment_security_features", segment_security_features cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @segment_security_features.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          segment_security_features == o.segment_security_features
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, segment_security_features].hash
    end
