...
module Nsxt9PolicyClient
  ...
  class ChildL7AccessEntry
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'L7AccessEntry')
        self.l7_access_entry = attributes[:'L7AccessEntry']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @l7_access_entry.nil?
        invalid_properties.push('invalid value for "l7_access_entry", l7_access_entry cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @l7_access_entry.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          l7_access_entry == o.l7_access_entry
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, l7_access_entry].hash
    end
