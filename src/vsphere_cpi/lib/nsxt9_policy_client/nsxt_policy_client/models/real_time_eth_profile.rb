...
module Nsxt9PolicyClient
  class RealTimeEthProfile
    ...
    attr_accessor :profinet

    attr_accessor :parallel_redundancy_prot
    ...
    def self.attribute_map
      {
        ...
        :'profinet' => :'profinet',
        :'parallel_redundancy_prot' => :'parallel_redundancy_prot',
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'profinet' => :'Profinet',
        :'parallel_redundancy_prot' => :'ParallelRedundancyProt',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'profinet')
        self.profinet = attributes[:'profinet']
      end

      if attributes.has_key?(:'parallel_redundancy_prot')
        self.parallel_redundancy_prot = attributes[:'parallel_redundancy_prot']
      end
    ...
    def list_invalid_properties
      ...
      if @profinet.nil?
        invalid_properties.push('invalid value for "profinet", profinet cannot be nil.')
      end

      if @parallel_redundancy_prot.nil?
        invalid_properties.push('invalid value for "parallel_redundancy_prot", parallel_redundancy_prot cannot be nil.')
      end

      if @latency_measurement.nil?
        invalid_properties.push('invalid value for "latency_measurement", latency_measurement cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @profinet.nil?
      return false if @parallel_redundancy_prot.nil?
      return false if @latency_measurement.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          profinet == o.profinet &&
          parallel_redundancy_prot == o.parallel_redundancy_prot &&
