...
module Nsxt9PolicyClient
  ...
  class DirectoryLdapServer
    ...
    # This flag helps in deciding whether to use thumbprint or certificate.
    attr_accessor :use_certificate

    # Directory LDAP server certificate thumbprint used in secure LDAPS connection.
    attr_accessor :thumbprint

    # IdentityFirewallStore LDAP server certificate used in secure LDAPS connection.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'use_certificate')
        self.use_certificate = attributes[:'use_certificate']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          port == o.port &&
          protocol == o.protocol &&
          use_certificate == o.use_certificate &&
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, domain_name, host, port, protocol, use_certificate, thumbprint, certificate_path, username, password].hash
    end
