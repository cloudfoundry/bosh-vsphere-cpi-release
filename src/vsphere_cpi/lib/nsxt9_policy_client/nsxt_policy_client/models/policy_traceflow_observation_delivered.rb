...
module Nsxt9PolicyClient
  class PolicyTraceflowObservationDelivered
    ...
    attr_accessor :parent_port_path
    ...
    def self.attribute_map
      {
        ...
        :'parent_port_path' => :'parent_port_path'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'parent_port_path')
        self.parent_port_path = attributes[:'parent_port_path']
      end
    end
    ...
    def valid?
      ...
      resolution_type_validator = EnumAttributeValidator.new('String', ['UNKNOWN', 'ARP_SUPPRESSION_PORT_CACHE', 'ARP_SUPPRESSION_TABLE', 'ARP_SUPPRESSION_CP_QUERY', 'ARP_VM', 'ARP_LRP'])
    ...
    def resolution_type=(resolution_type)
      validator = EnumAttributeValidator.new('String', ['UNKNOWN', 'ARP_SUPPRESSION_PORT_CACHE', 'ARP_SUPPRESSION_TABLE', 'ARP_SUPPRESSION_CP_QUERY', 'ARP_VM', 'ARP_LRP'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          parent_port_path == o.parent_port_path
    end
    ...
    def hash
      [resource_type, sequence_no, transport_node_id, transport_node_name, transport_node_type, timestamp, timestamp_micro, component_type, component_sub_type, component_name, site_path, is_ens, lport_id, lport_name, vlan_id, resolution_type, target_mac, segment_port_path, subnet_port_path, interface_path, parent_port_path].hash
    end
