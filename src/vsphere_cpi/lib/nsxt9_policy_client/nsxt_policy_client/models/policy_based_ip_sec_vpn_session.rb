...
module Nsxt9PolicyClient
  ...
  class PolicyBasedIPSecVpnSession
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, enabled, local_endpoint_path, authentication_mode, ike_profile_path, tunnel_profile_path, dpd_profile_path, compliance_suite, connection_initiation_mode, tcp_mss_clamping, peer_address, peer_id, psk, site_overrides, rules].hash
    end
