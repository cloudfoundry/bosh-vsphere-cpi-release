...
module Nsxt9PolicyClient
  ...
  class ChildSharedResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SharedResource')
        self.shared_resource = attributes[:'SharedResource']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @shared_resource.nil?
        invalid_properties.push('invalid value for "shared_resource", shared_resource cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @shared_resource.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          shared_resource == o.shared_resource
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, shared_resource].hash
    end
