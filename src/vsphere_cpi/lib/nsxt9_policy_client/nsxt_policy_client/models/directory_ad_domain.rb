...
module Nsxt9PolicyClient
  ...
  class DirectoryAdDomain
    ...
    def self.swagger_types
      {
        ...
        :'event_log_servers' => :'Array<DirectoryEventLogServer>',
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['DirectoryAdDomain'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['DirectoryAdDomain'])
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, name, ldap_servers, event_log_servers, base_distinguished_name, netbios_name, sync_settings, selective_sync_settings].hash
    end
