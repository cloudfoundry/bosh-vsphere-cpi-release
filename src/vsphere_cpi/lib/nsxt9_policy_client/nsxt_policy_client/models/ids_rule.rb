  ...
  class IdsRule
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'oversubscription')
        ...
        self.oversubscription = 'INHERIT_GLOBAL'
      end
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, rule_id, sequence_number, sources_excluded, destinations_excluded, source_groups, destination_groups, services, service_entries, profiles, logged, scope, disabled, notes, direction, tag, ip_protocol, is_default, action, ids_profiles, oversubscription].hash
    end
