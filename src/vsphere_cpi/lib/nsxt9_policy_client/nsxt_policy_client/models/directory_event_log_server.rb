...
module Nsxt9PolicyClient
  ...
  class DirectoryEventLogServer
    ...
    def self.swagger_types
      {
        ...
        :'username' => :'String',
        :'password' => :'String',
        :'status' => :'DirectoryEventLogServerStatus'
      }
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, domain_name, host, username, password, status].hash
    end
