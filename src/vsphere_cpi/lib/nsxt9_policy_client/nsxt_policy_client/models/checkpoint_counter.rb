...
module Nsxt9PolicyClient
  class CheckpointCounter
    ...
    def valid?
      checkpoint_type_validator = EnumAttributeValidator.new('String', ['UNKNOWN', 'PORT_INPUT', 'PORT_OUTPUT', 'SPOOFGUARD_INPUT', 'SPOOFGUARD_OUTPUT', 'SPOOFGUARD_DROP', 'DFW_INPUT', 'DFW_OUTPUT', 'DFW_DROP', 'UPLINK_INPUT', 'UPLINK_OUTPUT', 'ENS_PORT_INPUT', 'ENS_PORT_OUTPUT', 'ENS_UPLINK_INPUT', 'ENS_UPLINK_OUTPUT', 'ENS_DFW_INPUT', 'ENS_DFW_OUTPUT', 'ENS_DFW_DROP', 'ROUTER_DROP'])
      return false unless checkpoint_type_validator.valid?(@checkpoint_type)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] checkpoint_type Object to be assigned
    def checkpoint_type=(checkpoint_type)
      validator = EnumAttributeValidator.new('String', ['UNKNOWN', 'PORT_INPUT', 'PORT_OUTPUT', 'SPOOFGUARD_INPUT', 'SPOOFGUARD_OUTPUT', 'SPOOFGUARD_DROP', 'DFW_INPUT', 'DFW_OUTPUT', 'DFW_DROP', 'UPLINK_INPUT', 'UPLINK_OUTPUT', 'ENS_PORT_INPUT', 'ENS_PORT_OUTPUT', 'ENS_UPLINK_INPUT', 'ENS_UPLINK_OUTPUT', 'ENS_DFW_INPUT', 'ENS_DFW_OUTPUT', 'ENS_DFW_DROP', 'ROUTER_DROP'])
      unless validator.valid?(checkpoint_type)
        fail ArgumentError, 'invalid value for "checkpoint_type", must be one of #{validator.allowable_values}.'
      end
      @checkpoint_type = checkpoint_type
    end
