...
module Nsxt9PolicyClient
  ...
  class TransitGatewayStateNodeStatus
    # Policy path of edge node where the node status is retrieved. Edge should be member of enforcement point. 
    attr_accessor :edge_path

    # The Id of the service gateway where the status is retrieved. 
    attr_accessor :service_gateway_id

    # A service router's HA status on an edge node. 
    attr_accessor :high_availability_status

    # True if the edge transport node is a member of default sub cluster. 
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'service_gateway_id')
        self.service_gateway_id = attributes[:'service_gateway_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_gateway_id == o.service_gateway_id &&
    ...
    def hash
      [edge_path, service_gateway_id, high_availability_status, is_default_sub_cluster].hash
    end
