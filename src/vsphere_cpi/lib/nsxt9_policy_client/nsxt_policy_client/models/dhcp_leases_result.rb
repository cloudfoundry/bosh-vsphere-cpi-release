...
module Nsxt9PolicyClient
  class DhcpLeasesResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ipv6_leases')
        if (value = attributes[:'ipv6_leases']).is_a?(Array)
          self.ipv6_leases = value
        end
      end
    ...
    def hash
      [_self, _links, _schema, result_count, sort_by, sort_ascending, cursor, dhcp_server_id, timestamp, leases, ipv6_leases, connectivity_path].hash
    end
