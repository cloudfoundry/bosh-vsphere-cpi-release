...
module Nsxt9PolicyClient
  ...
  class ChildProjectRouteFilter
    ...
    attr_accessor :project_route_filter
    ...
    def self.attribute_map
      {
        ...
        :'project_route_filter' => :'ProjectRouteFilter'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ProjectRouteFilter')
        self.project_route_filter = attributes[:'ProjectRouteFilter']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @project_route_filter.nil?
        invalid_properties.push('invalid value for "project_route_filter", project_route_filter cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @project_route_filter.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          project_route_filter == o.project_route_filter
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, project_route_filter].hash
    end
