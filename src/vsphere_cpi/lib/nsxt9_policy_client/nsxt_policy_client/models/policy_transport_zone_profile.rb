...
module Nsxt9PolicyClient
  ...
  class PolicyTransportZoneProfile
    attr_accessor :_self
    ...
    def self.attribute_map
      {
        ...
        :'tz_profile_type' => :'tz_profile_type'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'bfd_config' => :'BfdHealthMonitoringConfig',
        :'tz_profile_type' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'tz_profile_type')
        self.tz_profile_type = attributes[:'tz_profile_type']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @bfd_config.nil?
        invalid_properties.push('invalid value for "bfd_config", bfd_config cannot be nil.')
      end

      if @tz_profile_type.nil?
        invalid_properties.push('invalid value for "tz_profile_type", tz_profile_type cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @bfd_config.nil?
      return false if @tz_profile_type.nil?
      tz_profile_type_validator = EnumAttributeValidator.new('String', ['BFD'])
      return false unless tz_profile_type_validator.valid?(@tz_profile_type)
      true
    end
    ...
    # @param [Object] tz_profile_type Object to be assigned
    def tz_profile_type=(tz_profile_type)
      validator = EnumAttributeValidator.new('String', ['BFD'])
      unless validator.valid?(tz_profile_type)
        fail ArgumentError, 'invalid value for "tz_profile_type", must be one of #{validator.allowable_values}.'
      end
      @tz_profile_type = tz_profile_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tz_profile_type == o.tz_profile_type
    end
