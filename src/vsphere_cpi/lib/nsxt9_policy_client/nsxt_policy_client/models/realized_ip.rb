...
module Nsxt9PolicyClient
  ...
  class RealizedIp
    # Depending upon the ip assignment type. IP could be allocated either from DHCP (default) or from Static IP Pool.
    attr_accessor :ip
    ...
    def hash
      [ip, default_gateway, prefix_length, subnet_mask].hash
    end
