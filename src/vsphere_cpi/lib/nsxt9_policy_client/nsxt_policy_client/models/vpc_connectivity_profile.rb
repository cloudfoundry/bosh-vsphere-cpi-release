...
module Nsxt9PolicyClient
  ...
  class VpcConnectivityProfile
    ...
    attr_accessor :transit_gateway_path

    # PolicyPath of External IP block
    attr_accessor :external_ip_blocks

    # PolicyPath of Private IP block
    attr_accessor :private_tgw_ip_blocks
    ...
    def self.attribute_map
      {
        ...
        :'transit_gateway_path' => :'transit_gateway_path',
        :'external_ip_blocks' => :'external_ip_blocks',
        :'private_tgw_ip_blocks' => :'private_tgw_ip_blocks',
    ...
    def self.swagger_types
      {
        ...
        :'external_ip_blocks' => :'Array<String>',
        :'private_tgw_ip_blocks' => :'Array<String>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'transit_gateway_path')
        self.transit_gateway_path = attributes[:'transit_gateway_path']
      end

      if attributes.has_key?(:'external_ip_blocks')
        if (value = attributes[:'external_ip_blocks']).is_a?(Array)
          self.external_ip_blocks = value
        end
      end

      if attributes.has_key?(:'private_tgw_ip_blocks')
        if (value = attributes[:'private_tgw_ip_blocks']).is_a?(Array)
          self.private_tgw_ip_blocks = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @transit_gateway_path.nil?
        invalid_properties.push('invalid value for "transit_gateway_path", transit_gateway_path cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @transit_gateway_path.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transit_gateway_path == o.transit_gateway_path &&
          external_ip_blocks == o.external_ip_blocks &&
          private_tgw_ip_blocks == o.private_tgw_ip_blocks &&
