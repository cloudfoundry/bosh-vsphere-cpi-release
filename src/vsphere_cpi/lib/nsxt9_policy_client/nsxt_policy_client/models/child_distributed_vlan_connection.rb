...
module Nsxt9PolicyClient
  ...
  class ChildDistributedVlanConnection
    attr_accessor :_self
    ...
    attr_accessor :distributed_vlan_connection
    ...
    def self.attribute_map
      {
        ...
        :'distributed_vlan_connection' => :'DistributedVlanConnection'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'DistributedVlanConnection')
        self.distributed_vlan_connection = attributes[:'DistributedVlanConnection']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @distributed_vlan_connection.nil?
        invalid_properties.push('invalid value for "distributed_vlan_connection", distributed_vlan_connection cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @distributed_vlan_connection.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          distributed_vlan_connection == o.distributed_vlan_connection
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, distributed_vlan_connection].hash
    end
