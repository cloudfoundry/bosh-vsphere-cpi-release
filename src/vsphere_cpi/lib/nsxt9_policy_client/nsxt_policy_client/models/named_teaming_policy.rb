...
module Nsxt9PolicyClient
  ...
  class NamedTeamingPolicy
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rolling_order')
        self.rolling_order = attributes[:'rolling_order']
      end
    ...
    def list_invalid_properties
      ...
      if @name.to_s.length > 136
        invalid_properties.push('invalid value for "name", the character length must be smaller than or equal to 136.')
      end
    ...
    def valid?
      ...
      return false if @name.to_s.length > 136
      true
    end
    ...
    def name=(name)
      ...
      if name.to_s.length > 136
        fail ArgumentError, 'invalid value for "name", the character length must be smaller than or equal to 136.'
      end
    ...
    def hash
      [policy, active_list, standby_list, rolling_order, name].hash
    end
