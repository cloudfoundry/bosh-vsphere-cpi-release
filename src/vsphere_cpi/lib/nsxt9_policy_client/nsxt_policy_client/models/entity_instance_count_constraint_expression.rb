...
module Nsxt9PolicyClient
  ...
  class EntityInstanceCountConstraintExpression
    ...
    def list_invalid_properties
      ...
      if @count > 1000000
        invalid_properties.push('invalid value for "count", must be smaller than or equal to 1000000.')
      end
    ...
    def count=(count)
      ...
      if count > 1000000
        fail ArgumentError, 'invalid value for "count", must be smaller than or equal to 1000000.'
      end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, target_resource_type, operator, count].hash
    end
