...
module Nsxt9PolicyClient
  ...
  class ActiveDirectoryIdentitySource
    ...
    attr_accessor :resolve_nested_groups
    ...
    def self.attribute_map
      {
        ...
        :'resolve_nested_groups' => :'resolve_nested_groups',
    ...
    def self.swagger_types
      {
        ...
        :'resolve_nested_groups' => :'BOOLEAN',
        :'group_cache_ttl' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'resolve_nested_groups')
        self.resolve_nested_groups = attributes[:'resolve_nested_groups']
      else
        self.resolve_nested_groups = true
      end

      if attributes.has_key?(:'group_cache_ttl')
        self.group_cache_ttl = attributes[:'group_cache_ttl']
      else
        self.group_cache_ttl = 60
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          resolve_nested_groups == o.resolve_nested_groups &&
          group_cache_ttl == o.group_cache_ttl
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, domain_name, alternative_domain_names, base_dn, ldap_servers, resolve_nested_groups, group_cache_ttl].hash
    end
