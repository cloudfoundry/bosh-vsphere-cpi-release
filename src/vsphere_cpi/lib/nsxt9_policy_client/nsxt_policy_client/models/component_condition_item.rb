...
module Nsxt9PolicyClient
  ...
  class ComponentConditionItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'condition_type')
        self.condition_type = attributes[:'condition_type']
      end

      if attributes.has_key?(:'last_heartbeat_time')
    ...
    def valid?
      condition_type_validator = EnumAttributeValidator.new('String', ['CONTROLLER_HEALTHY', 'MP_ADAPTER_HEALTHY', 'MP_CONNECTED', 'CCP_ADAPTER_HEALTHY', 'CCP_SESSION_STATE_UP'])
    ...
    def condition_type=(condition_type)
      validator = EnumAttributeValidator.new('String', ['CONTROLLER_HEALTHY', 'MP_ADAPTER_HEALTHY', 'MP_CONNECTED', 'CCP_ADAPTER_HEALTHY', 'CCP_SESSION_STATE_UP'])
    ...
    def hash
      [condition_type, last_heartbeat_time, status, reason, message].hash
    end
