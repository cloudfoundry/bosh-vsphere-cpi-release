...
module Nsxt9PolicyClient
  ...
  class OdsRunbookInvocationStatus
    ...
    def valid?
      request_status_validator = EnumAttributeValidator.new('String', ['SUCCESS', 'CONNECTION_ERROR', 'TIMEOUT'])
      return false unless request_status_validator.valid?(@request_status)
      operation_state_validator = EnumAttributeValidator.new('String', ['NONE', 'RUNBOOK_NOT_FOUND', 'QUEUED', 'BUSY_REJECTED', 'THROTTLED', 'ARG_INVALID', 'RUNNING', 'FINISHED', 'GENERAL_ERROR', 'RUNBOOK_NOT_ENABLED', 'ABORTED'])
    ...
    def request_status=(request_status)
      validator = EnumAttributeValidator.new('String', ['SUCCESS', 'CONNECTION_ERROR', 'TIMEOUT'])
    ...
    def operation_state=(operation_state)
      validator = EnumAttributeValidator.new('String', ['NONE', 'RUNBOOK_NOT_FOUND', 'QUEUED', 'BUSY_REJECTED', 'THROTTLED', 'ARG_INVALID', 'RUNNING', 'FINISHED', 'GENERAL_ERROR', 'RUNBOOK_NOT_ENABLED', 'ABORTED'])
    ...
    def hash
      [request_status, operation_state].hash
    end
