...
module Nsxt9PolicyClient
  ...
  class RoleAssignmentPermissionConfig
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'allow_role_assignment')
        self.allow_role_assignment = attributes[:'allow_role_assignment']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          allow_role_assignment == o.allow_role_assignment
    end
