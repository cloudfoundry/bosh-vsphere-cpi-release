...
module Nsxt9PolicyClient
  class PolicyOspfDatabaseListResult
    attr_accessor :_self
    ...
    def self.swagger_types
      {
        ...
        :'results' => :'Array<OspfDatabaseStatus>'
      }
    end
    ...
    def hash
      [_self, _links, _schema, result_count, sort_by, sort_ascending, cursor, tier0_path, last_update_timestamp, results].hash
    end
