...
module Nsxt9PolicyClient
  ...
  class ChildL7AccessProfile
    ...
    attr_accessor :l7_access_profile
    ...
    def self.attribute_map
      {
        ...
        :'l7_access_profile' => :'L7AccessProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'L7AccessProfile')
        self.l7_access_profile = attributes[:'L7AccessProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @l7_access_profile.nil?
        invalid_properties.push('invalid value for "l7_access_profile", l7_access_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @l7_access_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          l7_access_profile == o.l7_access_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, l7_access_profile].hash
    end
