...
module Nsxt9PolicyClient
  # This entity will be used to establish association between real time eth profile and Port. Using this entity, you can  specify intent for applying real time eth profile to particular Port. Port here is Segment Port. 
  class PortRealTimeEthProfileBindingMap
    attr_accessor :_self
    ...
    # PolicyPath of associated Real Time Eth Profile
    attr_accessor :real_time_eth_profile_path
    ...
    def self.attribute_map
      {
        ...
        :'real_time_eth_profile_path' => :'real_time_eth_profile_path'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'real_time_eth_profile_path' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'real_time_eth_profile_path')
        self.real_time_eth_profile_path = attributes[:'real_time_eth_profile_path']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          real_time_eth_profile_path == o.real_time_eth_profile_path
    end
