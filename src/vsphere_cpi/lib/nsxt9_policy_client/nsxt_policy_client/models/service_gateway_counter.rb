...
module Nsxt9PolicyClient
  class ServiceGatewayCounter
    ...
    # The number of error packets
    attr_accessor :error_packets

    # The number of blocked packets
    attr_accessor :blocked_packets

    # The number of dropped packets due to destination_unsupported
    attr_accessor :destination_unsupported_dropped_packets

    # The number of dropped packets by firewall
    attr_accessor :firewall_dropped_packets

    # The number of dropped packets by ipsec
    attr_accessor :ipsec_dropped_packets

    # The number of dropped packets by ipsec no sa
    attr_accessor :ipsec_no_sa_dropped_packets

    # The number of dropped packets by ipsec no vti
    attr_accessor :ipsec_no_vti_dropped_packets

    # The number of dropped ipv6 packets
    attr_accessor :ipv6_dropped_packets

    # The number of dropped kni packets
    attr_accessor :kni_dropped_packets

    # The number of dropped l4port_unsupported packets
    ...
    # The number of dropped no receiver packets
    attr_accessor :no_receiver_dropped_packets

    # The number of proto unsupported packets dropped
    attr_accessor :proto_unsupported_dropped_packets

    # The number of dropped packets due to redirection
    attr_accessor :redirect_dropped_packets

    # The number of dropped packets due to rpf check
    attr_accessor :rpf_check_dropped_packets

    # The number of dropped packets due to exceeding ttl
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'error_packets')
        self.error_packets = attributes[:'error_packets']
      end
    ...
    def hash
      [total_bytes, total_packets, dropped_packets, error_packets, blocked_packets, destination_unsupported_dropped_packets, firewall_dropped_packets, ipsec_dropped_packets, ipsec_no_sa_dropped_packets, ipsec_no_vti_dropped_packets, ipv6_dropped_packets, kni_dropped_packets, l4port_unsupported_dropped_packets, malformed_dropped_packets, no_receiver_dropped_packets, proto_unsupported_dropped_packets, redirect_dropped_packets, rpf_check_dropped_packets, ttl_exceeded_dropped_packets].hash
    end
