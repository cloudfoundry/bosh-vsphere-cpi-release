...
module Nsxt9PolicyClient
  # Child Wrapper object for PolicyEdgeTransportNode, used in hierarchical API.
  class ChildPolicyEdgeTransportNode
    attr_accessor :_self
    ...
    attr_accessor :policy_edge_transport_node
    ...
    def self.attribute_map
      {
        ...
        :'policy_edge_transport_node' => :'PolicyEdgeTransportNode'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyEdgeTransportNode')
        self.policy_edge_transport_node = attributes[:'PolicyEdgeTransportNode']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_edge_transport_node.nil?
        invalid_properties.push('invalid value for "policy_edge_transport_node", policy_edge_transport_node cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_edge_transport_node.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_edge_transport_node == o.policy_edge_transport_node
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, policy_edge_transport_node].hash
    end
