...
module Nsxt9PolicyClient
  ...
  class PolicyTask
    ...
    def hash
      [_self, _links, _schema, id, description, status, message, start_time, end_time, progress, cancelable, user, request_uri, request_method, async_response_available, failure_msg].hash
    end
