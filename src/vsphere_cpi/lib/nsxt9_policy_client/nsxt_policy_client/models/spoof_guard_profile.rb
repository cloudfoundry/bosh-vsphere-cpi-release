...
module Nsxt9PolicyClient
  ...
  class SpoofGuardProfile
    ...
    # If true, enable the SpoofGuard, which only allows VM sending traffic with the IPs in the allowlist. This field is deprecated because it has offensive terminology. Please use address_binding_allowlist. This value cannot conflict with allow list. 
    attr_accessor :address_binding_whitelist

    # If true, enable the SpoofGuard, which only allows VM sending traffic with the IPs in the allowlist. This value cannot conflict with whitelist. 
    attr_accessor :address_binding_allowlist
    ...
    def self.attribute_map
      {
        ...
        :'address_binding_allowlist' => :'address_binding_allowlist'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'address_binding_allowlist' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'address_binding_allowlist')
        self.address_binding_allowlist = attributes[:'address_binding_allowlist']
      else
        self.address_binding_allowlist = false
      end
    end
    ...
    def list_invalid_properties
      ...
      if @address_binding_allowlist.nil?
        invalid_properties.push('invalid value for "address_binding_allowlist", address_binding_allowlist cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @address_binding_allowlist.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          address_binding_allowlist == o.address_binding_allowlist
    end
