...
module Nsxt9PolicyClient
  ...
  class ShaMonitorProfile
    ...
    # The Policy group path list to apply the profile on Sha monitor. 
    attr_accessor :applied_to_group_paths

    # The on-off switch to control whether this profile should be applied to unified appliance cluster nodes. If not provided, profile won't be applied to UA node. 
    attr_accessor :applied_to_ua

    attr_accessor :configs

    # Users can overwrite the configurations in the 'config' field by specifying the corresponding resource of ShaSubMonitorConfig and populate the specific configurations for sub-monitor if necessary. 
    attr_accessor :sub_monitor_configs

    # It includes all the detail configurations of the depend on monitors. To make sure the monitor profile works as expected, it aslo needs to check the depend config on each monitor. 
    attr_accessor :depend_on_monitor_configs

    # It includes all the impacted monitors for this profile. 
    attr_accessor :impact_monitors
    ...
    def self.attribute_map
      {
        ...
        :'applied_to_group_paths' => :'applied_to_group_paths',
        :'applied_to_ua' => :'applied_to_ua',
        :'configs' => :'configs',
        :'sub_monitor_configs' => :'sub_monitor_configs',
        :'depend_on_monitor_configs' => :'depend_on_monitor_configs',
        :'impact_monitors' => :'impact_monitors'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'is_default' => :'BOOLEAN',
        :'applied_to_group_paths' => :'Array<String>',
        :'applied_to_ua' => :'BOOLEAN',
        :'configs' => :'ShaMonitorConfig',
        :'sub_monitor_configs' => :'Array<ShaSubMonitorConfig>',
        :'depend_on_monitor_configs' => :'Array<ShaMonitorDependOnConfig>',
        :'impact_monitors' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'applied_to_group_paths')
        if (value = attributes[:'applied_to_group_paths']).is_a?(Array)
          self.applied_to_group_paths = value
        end
      end

      if attributes.has_key?(:'applied_to_ua')
        self.applied_to_ua = attributes[:'applied_to_ua']
      end
      ...
      if attributes.has_key?(:'sub_monitor_configs')
        if (value = attributes[:'sub_monitor_configs']).is_a?(Array)
          self.sub_monitor_configs = value
        end
      end

      if attributes.has_key?(:'depend_on_monitor_configs')
        if (value = attributes[:'depend_on_monitor_configs']).is_a?(Array)
          self.depend_on_monitor_configs = value
        end
      end

      if attributes.has_key?(:'impact_monitors')
        if (value = attributes[:'impact_monitors']).is_a?(Array)
          self.impact_monitors = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          applied_to_group_paths == o.applied_to_group_paths &&
          applied_to_ua == o.applied_to_ua &&
          configs == o.configs &&
          sub_monitor_configs == o.sub_monitor_configs &&
          depend_on_monitor_configs == o.depend_on_monitor_configs &&
          impact_monitors == o.impact_monitors
    end
