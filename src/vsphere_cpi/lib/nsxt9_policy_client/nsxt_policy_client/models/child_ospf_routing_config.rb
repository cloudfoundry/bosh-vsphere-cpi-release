...
module Nsxt9PolicyClient
  ...
  class ChildOspfRoutingConfig
    ...
    attr_accessor :ospf_routing_config
    ...
    def self.attribute_map
      {
        ...
        :'ospf_routing_config' => :'OspfRoutingConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'OspfRoutingConfig')
        self.ospf_routing_config = attributes[:'OspfRoutingConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ospf_routing_config.nil?
        invalid_properties.push('invalid value for "ospf_routing_config", ospf_routing_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ospf_routing_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ospf_routing_config == o.ospf_routing_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, ospf_routing_config].hash
    end
