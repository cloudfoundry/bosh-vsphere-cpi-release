...
module Nsxt9PolicyClient
  ...
  class SecurityPolicyContainerCluster
    attr_accessor :_self
    ...
    attr_accessor :container_cluster_type

    # Path to the container cluster entity in NSX
    attr_accessor :container_cluster_path
    ...
    def self.attribute_map
      {
        ...
        :'container_cluster_type' => :'container_cluster_type',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'container_cluster_type')
        self.container_cluster_type = attributes[:'container_cluster_type']
      else
        self.container_cluster_type = 'ANTREA'
      end

      if attributes.has_key?(:'container_cluster_path')
        self.container_cluster_path = attributes[:'container_cluster_path']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @container_cluster_path.nil?
        invalid_properties.push('invalid value for "container_cluster_path", container_cluster_path cannot be nil.')
      end
    ...
    def valid?
      ...
      container_cluster_type_validator = EnumAttributeValidator.new('String', ['ANTREA'])
      return false unless container_cluster_type_validator.valid?(@container_cluster_type)
      return false if @container_cluster_path.nil?
      true
    end
    ...
    # @param [Object] container_cluster_type Object to be assigned
    def container_cluster_type=(container_cluster_type)
      validator = EnumAttributeValidator.new('String', ['ANTREA'])
      unless validator.valid?(container_cluster_type)
        fail ArgumentError, 'invalid value for "container_cluster_type", must be one of #{validator.allowable_values}.'
      end
      @container_cluster_type = container_cluster_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          container_cluster_type == o.container_cluster_type &&
          container_cluster_path == o.container_cluster_path
    end
