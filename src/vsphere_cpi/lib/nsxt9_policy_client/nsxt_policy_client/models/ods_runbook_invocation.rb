    ...
    def self.swagger_types
      {
        ...
        :'runbook_path' => :'String',
        :'target_node' => :'String',
        :'arguments' => :'Array<UnboundedKeyValuePair>',
        :'runbook_name' => :'String',
