...
module Nsxt9PolicyClient
  # Result for batched request of Online Diagnostic System runbook artifact collection. 
  class OdsRunbookInvocationArtifactBatchResult
    attr_accessor :_self
    ...
    # State of batch process of Online Diagnostic System runbook artifact collection.   IN-PROGRESS - The batch process is in process.   FINISHED - The batch process is finished. 
    attr_accessor :status

    # This array can consist of one or more policy paths. Only policy paths of Ods invocations are allowed.
    attr_accessor :invocation_paths
    ...
    attr_accessor :successful_invocations

    attr_accessor :failed_invocations
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'status' => :'String',
        :'invocation_paths' => :'Array<String>',
        :'is_transient' => :'BOOLEAN',
        :'successful_invocations' => :'OdsRunbookArtifactListResult',
        :'failed_invocations' => :'OdsRunbookArtifactListResult'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'invocation_paths')
        if (value = attributes[:'invocation_paths']).is_a?(Array)
          self.invocation_paths = value
        end
      end
      ...
      if attributes.has_key?(:'successful_invocations')
        self.successful_invocations = attributes[:'successful_invocations']
      end

      if attributes.has_key?(:'failed_invocations')
        self.failed_invocations = attributes[:'failed_invocations']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @invocation_paths.nil?
        invalid_properties.push('invalid value for "invocation_paths", invocation_paths cannot be nil.')
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['IN-PROGRESS', 'FINISHED'])
      return false unless status_validator.valid?(@status)
      return false if @invocation_paths.nil?
      true
    end
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['IN-PROGRESS', 'FINISHED'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          status == o.status &&
          invocation_paths == o.invocation_paths &&
          is_transient == o.is_transient &&
          successful_invocations == o.successful_invocations &&
          failed_invocations == o.failed_invocations
    end
