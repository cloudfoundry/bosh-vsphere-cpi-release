...
module Nsxt9PolicyClient
  ...
  class HostTransportNodeCollection
    attr_accessor :_self
    ...
    attr_accessor :migration_to_lag
    ...
    def self.attribute_map
      {
        ...
        :'has_nvds' => :'has_nvds',
        :'sub_cluster_config' => :'sub_cluster_config',
        :'enable_nsx_on_dvpg' => :'enable_nsx_on_dvpg',
        :'migration_to_lag' => :'migration_to_lag'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'has_nvds' => :'BOOLEAN',
        :'sub_cluster_config' => :'Array<SubClusterConfig>',
        :'enable_nsx_on_dvpg' => :'BOOLEAN',
        :'migration_to_lag' => :'Array<LacpMigrationConfig>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'has_nvds')
        self.has_nvds = attributes[:'has_nvds']
      end

      if attributes.has_key?(:'sub_cluster_config')
        if (value = attributes[:'sub_cluster_config']).is_a?(Array)
          self.sub_cluster_config = value
        end
      end

      if attributes.has_key?(:'enable_nsx_on_dvpg')
        self.enable_nsx_on_dvpg = attributes[:'enable_nsx_on_dvpg']
      end

      if attributes.has_key?(:'migration_to_lag')
        if (value = attributes[:'migration_to_lag']).is_a?(Array)
          self.migration_to_lag = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          has_nvds == o.has_nvds &&
          sub_cluster_config == o.sub_cluster_config &&
          enable_nsx_on_dvpg == o.enable_nsx_on_dvpg &&
          migration_to_lag == o.migration_to_lag
    end
