...
module Nsxt9PolicyClient
  ...
  class ChildIdsCustomSignatureSettings
    attr_accessor :_self
    ...
    attr_accessor :ids_custom_signature_settings
    ...
    def self.attribute_map
      {
        ...
        :'ids_custom_signature_settings' => :'IdsCustomSignatureSettings'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IdsCustomSignatureSettings')
        self.ids_custom_signature_settings = attributes[:'IdsCustomSignatureSettings']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ids_custom_signature_settings.nil?
        invalid_properties.push('invalid value for "ids_custom_signature_settings", ids_custom_signature_settings cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ids_custom_signature_settings.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ids_custom_signature_settings == o.ids_custom_signature_settings
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, ids_custom_signature_settings].hash
    end
