...
module Nsxt9PolicyClient
  ...
  class ChildPolicyTransportZoneProfile
    attr_accessor :_self
    ...
    attr_accessor :policy_transport_zone_profile
    ...
    def self.attribute_map
      {
        ...
        :'policy_transport_zone_profile' => :'PolicyTransportZoneProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyTransportZoneProfile')
        self.policy_transport_zone_profile = attributes[:'PolicyTransportZoneProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_transport_zone_profile.nil?
        invalid_properties.push('invalid value for "policy_transport_zone_profile", policy_transport_zone_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_transport_zone_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_transport_zone_profile == o.policy_transport_zone_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, policy_transport_zone_profile].hash
    end
