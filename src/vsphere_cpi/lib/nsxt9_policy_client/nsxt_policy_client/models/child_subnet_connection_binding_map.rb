...
module Nsxt9PolicyClient
  ...
  class ChildSubnetConnectionBindingMap
    attr_accessor :_self
    ...
    attr_accessor :subnet_connection_binding_map
    ...
    def self.attribute_map
      {
        ...
        :'subnet_connection_binding_map' => :'SubnetConnectionBindingMap'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SubnetConnectionBindingMap')
        self.subnet_connection_binding_map = attributes[:'SubnetConnectionBindingMap']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @subnet_connection_binding_map.nil?
        invalid_properties.push('invalid value for "subnet_connection_binding_map", subnet_connection_binding_map cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @subnet_connection_binding_map.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          subnet_connection_binding_map == o.subnet_connection_binding_map
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, subnet_connection_binding_map].hash
    end
