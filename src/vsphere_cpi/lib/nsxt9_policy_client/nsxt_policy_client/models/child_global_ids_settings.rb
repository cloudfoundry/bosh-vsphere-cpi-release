...
module Nsxt9PolicyClient
  ...
  class ChildGlobalIdsSettings
    ...
    attr_accessor :global_ids_settings
    ...
    def self.attribute_map
      {
        ...
        :'global_ids_settings' => :'GlobalIdsSettings'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'GlobalIdsSettings')
        self.global_ids_settings = attributes[:'GlobalIdsSettings']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @global_ids_settings.nil?
        invalid_properties.push('invalid value for "global_ids_settings", global_ids_settings cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @global_ids_settings.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          global_ids_settings == o.global_ids_settings
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, global_ids_settings].hash
    end
