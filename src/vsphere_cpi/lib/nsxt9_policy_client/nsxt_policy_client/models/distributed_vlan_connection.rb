...
module Nsxt9PolicyClient
  ...
  class DistributedVlanConnection
    attr_accessor :_self
    ...
    # Gateway IP address in network address and prefix length format 
    ...
    def list_invalid_properties
      ...
      if @gateway_addresses.nil?
        invalid_properties.push('invalid value for "gateway_addresses", gateway_addresses cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @gateway_addresses.nil?
