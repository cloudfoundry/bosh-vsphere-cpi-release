...
module Nsxt9PolicyClient
  ...
  class AutoUpdateErrorsOnAirgappedSites
    # The path of the site where auto-update/update-now is failed 
    attr_accessor :site_path

    # Reason for auto-update/update-now failure. 
