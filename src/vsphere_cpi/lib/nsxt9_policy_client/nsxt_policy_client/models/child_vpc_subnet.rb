...
module Nsxt9PolicyClient
  ...
  class ChildVpcSubnet
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'VpcSubnet')
        self.vpc_subnet = attributes[:'VpcSubnet']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @vpc_subnet.nil?
        invalid_properties.push('invalid value for "vpc_subnet", vpc_subnet cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vpc_subnet.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, vpc_subnet].hash
    end
