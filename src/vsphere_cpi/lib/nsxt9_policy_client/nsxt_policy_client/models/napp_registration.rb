...
module Nsxt9PolicyClient
  ...
  class NappRegistration
    ...
    # UUID of the cluster maintained internally. 
    attr_accessor :cluster_id

    # Name of NSX Application Platform. 
    attr_accessor :cluster_name

    # IP of NSX Application Platform for Message bus. 
    attr_accessor :message_bus_ip_address

    # IP of NSX Application Platform for Ingress HTTP connection. 
    attr_accessor :ingress_ip_address

    # Status of NSX Application Platform. 
    attr_accessor :status

    # Whether Intelligence is enabled on NSX Application Platform. 
    attr_accessor :is_intelligence_enabled

    # Whether Metric is enabled on NSX Application Platform. 
    attr_accessor :is_metric_enabled

    # Whether Malware Prevention is enabled on NSX Application Platform. 
    attr_accessor :is_malware_prevention_enabled

    # Flow Kafka Topic name. 
    attr_accessor :kafka_topic_flow

    # Context kafka topic name. 
    attr_accessor :kafka_topic_context
    ...
    def self.attribute_map
      {
        ...
        :'message_bus_ip_address' => :'message_bus_ip_address',
        :'ingress_ip_address' => :'ingress_ip_address',
        :'status' => :'status',
        :'is_intelligence_enabled' => :'is_intelligence_enabled',
        :'is_metric_enabled' => :'is_metric_enabled',
        :'is_malware_prevention_enabled' => :'is_malware_prevention_enabled',
        :'kafka_topic_flow' => :'kafka_topic_flow',
        :'kafka_topic_context' => :'kafka_topic_context'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'cluster_id' => :'String',
        :'cluster_name' => :'String',
        :'message_bus_ip_address' => :'String',
        :'ingress_ip_address' => :'String',
        :'status' => :'String',
        :'is_intelligence_enabled' => :'BOOLEAN',
        :'is_metric_enabled' => :'BOOLEAN',
        :'is_malware_prevention_enabled' => :'BOOLEAN',
        :'kafka_topic_flow' => :'String',
        :'kafka_topic_context' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'message_bus_ip_address')
        self.message_bus_ip_address = attributes[:'message_bus_ip_address']
      end

      if attributes.has_key?(:'ingress_ip_address')
        self.ingress_ip_address = attributes[:'ingress_ip_address']
      end
      ...
      if attributes.has_key?(:'is_intelligence_enabled')
        self.is_intelligence_enabled = attributes[:'is_intelligence_enabled']
      end

      if attributes.has_key?(:'is_metric_enabled')
        self.is_metric_enabled = attributes[:'is_metric_enabled']
      end

      if attributes.has_key?(:'is_malware_prevention_enabled')
        self.is_malware_prevention_enabled = attributes[:'is_malware_prevention_enabled']
      end

      if attributes.has_key?(:'kafka_topic_flow')
        self.kafka_topic_flow = attributes[:'kafka_topic_flow']
      end

      if attributes.has_key?(:'kafka_topic_context')
        self.kafka_topic_context = attributes[:'kafka_topic_context']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          message_bus_ip_address == o.message_bus_ip_address &&
          ingress_ip_address == o.ingress_ip_address &&
          status == o.status &&
          is_intelligence_enabled == o.is_intelligence_enabled &&
          is_metric_enabled == o.is_metric_enabled &&
          is_malware_prevention_enabled == o.is_malware_prevention_enabled &&
          kafka_topic_flow == o.kafka_topic_flow &&
          kafka_topic_context == o.kafka_topic_context
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, cluster_id, cluster_name, message_bus_ip_address, ingress_ip_address, status, is_intelligence_enabled, is_metric_enabled, is_malware_prevention_enabled, kafka_topic_flow, kafka_topic_context].hash
    end
