...
module Nsxt9PolicyClient
  ...
  class ChildTier0InterfaceGroup
    attr_accessor :_self
    ...
    attr_accessor :tier0_interface_group
    ...
    def self.attribute_map
      {
        ...
        :'tier0_interface_group' => :'Tier0InterfaceGroup'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Tier0InterfaceGroup')
        self.tier0_interface_group = attributes[:'Tier0InterfaceGroup']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tier0_interface_group.nil?
        invalid_properties.push('invalid value for "tier0_interface_group", tier0_interface_group cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tier0_interface_group.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tier0_interface_group == o.tier0_interface_group
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, tier0_interface_group].hash
    end
