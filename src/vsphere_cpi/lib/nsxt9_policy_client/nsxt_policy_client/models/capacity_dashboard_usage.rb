...
module Nsxt9PolicyClient
  class CapacityDashboardUsage
    ...
    def hash
      [usage_type, display_name, current_usage_count, max_supported_count, min_threshold_percentage, max_threshold_percentage, current_usage_percentage, severity].hash
    end
