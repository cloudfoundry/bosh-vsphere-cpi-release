...
module Nsxt9PolicyClient
  ...
  class BgpRouteLeaking
    ...
    def self.swagger_types
      {
        ...
        :'in_filter' => :'Array<String>',
        :'out_filter' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'in_filter')
        if (value = attributes[:'in_filter']).is_a?(Array)
          self.in_filter = value
        end
      end

      if attributes.has_key?(:'out_filter')
        if (value = attributes[:'out_filter']).is_a?(Array)
          self.out_filter = value
        end
      end
    end
    ...
    def valid?
      address_family_validator = EnumAttributeValidator.new('String', ['IPV4', 'IPV6'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          in_filter == o.in_filter &&
          out_filter == o.out_filter
    end
    ...
    def hash
      [address_family, in_filter, out_filter].hash
    end
