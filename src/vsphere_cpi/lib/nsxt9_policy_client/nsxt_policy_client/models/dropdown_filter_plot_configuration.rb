...
module Nsxt9PolicyClient
  ...
  class DropdownFilterPlotConfiguration
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'allow_search')
        self.allow_search = attributes[:'allow_search']
      else
    ...
    def hash
      [condition, allow_maximize, allow_search].hash
    end
