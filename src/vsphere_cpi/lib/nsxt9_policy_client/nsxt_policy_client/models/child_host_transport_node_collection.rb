...
module Nsxt9PolicyClient
  ...
  class ChildHostTransportNodeCollection
    attr_accessor :_self
    ...
    attr_accessor :host_transport_node_collection
    ...
    def self.attribute_map
      {
        ...
        :'host_transport_node_collection' => :'HostTransportNodeCollection'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'HostTransportNodeCollection')
        self.host_transport_node_collection = attributes[:'HostTransportNodeCollection']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @host_transport_node_collection.nil?
        invalid_properties.push('invalid value for "host_transport_node_collection", host_transport_node_collection cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @host_transport_node_collection.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          host_transport_node_collection == o.host_transport_node_collection
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, host_transport_node_collection].hash
    end
