...
module Nsxt9PolicyClient
  # PolicyEdgeNode represents the member node of the policy edge cluster and refers to the policy edge transport node. It should not be mistaken for the edge transport node itself. Consuming services can refer <br>edge_transport_node_uuid</br/<br>edge_transport_node_path</br> property to get the unique id/path of the  policy edge transport node referred by the policy edge node. 
  class PolicyEdgeNode
    ...
    # This field is deprecated.Consuming services can refer <br>edge_transport_node_uuid</br/<br>edge_transport_node_path</br> property to get the unique id/path of the  policy edge transport node referred by the policy edge node. 
    attr_accessor :nsx_id

    # UUID of edge transport node.
    attr_accessor :edge_transport_node_uuid

    # Path of edge transport Node. 
    ...
    def self.attribute_map
      {
        ...
        :'nsx_id' => :'nsx_id',
        :'edge_transport_node_uuid' => :'edge_transport_node_uuid',
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'nsx_id' => :'String',
        :'edge_transport_node_uuid' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'edge_transport_node_uuid')
        self.edge_transport_node_uuid = attributes[:'edge_transport_node_uuid']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          nsx_id == o.nsx_id &&
          edge_transport_node_uuid == o.edge_transport_node_uuid &&
