...
module Nsxt9PolicyClient
  ...
  class VpcSubnetBridgeProfile
    ...
    def list_invalid_properties
      ...
      if @bridge_profiles.nil?
        invalid_properties.push('invalid value for "bridge_profiles", bridge_profiles cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @bridge_profiles.nil?
      true
    end
