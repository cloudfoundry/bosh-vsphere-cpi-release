...
module Nsxt9PolicyClient
  ...
  class IpBlockQuota
    ...
    # The number of /32 subnets that can be carved from IP blocks defined in the quota. A value of -1 for this field denotes no restriction on the number of subnets. 
    ...
    def list_invalid_properties
      ...
      if @ip_block_visibility.nil?
        invalid_properties.push('invalid value for "ip_block_visibility", ip_block_visibility cannot be nil.')
      end

      if @ip_block_address_type.nil?
        invalid_properties.push('invalid value for "ip_block_address_type", ip_block_address_type cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ip_block_visibility.nil?
      ...
      return false if @ip_block_address_type.nil?
    ...
    def hash
      [resource_type, single_ip_cidrs, other_cidrs, ip_block_paths, ip_block_visibility, ip_block_address_type].hash
    end
