...
module Nsxt9PolicyClient
  ...
  class AnalyticsMaintenanceMode
    # Activate/deactivate maintenance mode
    attr_accessor :enable

    # string describing the error
    attr_accessor :agent_error_message
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'agent_error_message')
        self.agent_error_message = attributes[:'agent_error_message']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          enable == o.enable &&
          agent_error_message == o.agent_error_message
    end
    ...
    def hash
      [enable, agent_error_message].hash
    end
