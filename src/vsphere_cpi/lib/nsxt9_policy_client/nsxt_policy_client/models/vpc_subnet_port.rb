...
module Nsxt9PolicyClient
  # VPC Subnet port will create LogicalPort on LogicalSwitch corresponding to the Subnet. Address bindings cannot be removed after realization. 
  class VpcSubnetPort
    attr_accessor :_self
    ...
    # This is an experimental field. The TOFU workflow will be triggered upon modification of this value to a different non-zero positive value.
    attr_accessor :tofu_version
    ...
    def self.swagger_types
      {
        ...
        :'init_state' => :'String',
        :'origin_id' => :'String',
        :'tofu_version' => :'Integer',
        :'external_address_binding' => :'ExternalAddressBinding'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'tofu_version')
        self.tofu_version = attributes[:'tofu_version']
      end
    ...
    def list_invalid_properties
      ...
      if !@tofu_version.nil? && @tofu_version > 4294967295
        invalid_properties.push('invalid value for "tofu_version", must be smaller than or equal to 4294967295.')
      end

      if !@tofu_version.nil? && @tofu_version < 0
        invalid_properties.push('invalid value for "tofu_version", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@tofu_version.nil? && @tofu_version > 4294967295
      return false if !@tofu_version.nil? && @tofu_version < 0
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] tofu_version Value to be assigned
    def tofu_version=(tofu_version)
      if !tofu_version.nil? && tofu_version > 4294967295
        fail ArgumentError, 'invalid value for "tofu_version", must be smaller than or equal to 4294967295.'
      end

      if !tofu_version.nil? && tofu_version < 0
        fail ArgumentError, 'invalid value for "tofu_version", must be greater than or equal to 0.'
      end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, attachment, address_bindings, source_site_id, admin_state, extra_configs, ignored_address_bindings, init_state, origin_id, tofu_version, external_address_binding].hash
    end
