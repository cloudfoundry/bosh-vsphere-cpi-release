...
module Nsxt9PolicyClient
  ...
  class ChildOdsDynamicRunbookInstance
    attr_accessor :_self
    ...
    attr_accessor :ods_dynamic_runbook_instance
    ...
    def self.attribute_map
      {
        ...
        :'ods_dynamic_runbook_instance' => :'OdsDynamicRunbookInstance'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'OdsDynamicRunbookInstance')
        self.ods_dynamic_runbook_instance = attributes[:'OdsDynamicRunbookInstance']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ods_dynamic_runbook_instance.nil?
        invalid_properties.push('invalid value for "ods_dynamic_runbook_instance", ods_dynamic_runbook_instance cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ods_dynamic_runbook_instance.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ods_dynamic_runbook_instance == o.ods_dynamic_runbook_instance
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, ods_dynamic_runbook_instance].hash
    end
