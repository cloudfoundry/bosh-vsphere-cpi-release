...
module Nsxt9PolicyClient
  ...
  class DeploymentChecksStatus
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ['SUCCESS', 'FAILED', 'WARNING', 'SKIPPED', 'IN_PROGRESS', 'STOPPING', 'STOPPED', 'NOT_STARTED'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['SUCCESS', 'FAILED', 'WARNING', 'SKIPPED', 'IN_PROGRESS', 'STOPPING', 'STOPPED', 'NOT_STARTED'])
    ...
    def hash
      [name, description, status, reason].hash
    end
