...
module Nsxt9PolicyClient
  ...
  class CloudNativeDeploymentAction
    ...
    def valid?
      ...
      action_validator = EnumAttributeValidator.new('String', ['DEPLOY', 'UNDEPLOY', 'REDEPLOY', 'UPDATE_FORMFACTOR', 'REDEPLOY_UPDATE_FORMFACTOR', 'FORCE_UNDEPLOY', 'RESTART', 'RESET', 'RESET_BR_VERSION'])
    ...
    def action=(action)
      validator = EnumAttributeValidator.new('String', ['DEPLOY', 'UNDEPLOY', 'REDEPLOY', 'UPDATE_FORMFACTOR', 'REDEPLOY_UPDATE_FORMFACTOR', 'FORCE_UNDEPLOY', 'RESTART', 'RESET', 'RESET_BR_VERSION'])
