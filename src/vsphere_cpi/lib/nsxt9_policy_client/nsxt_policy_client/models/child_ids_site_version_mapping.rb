...
module Nsxt9PolicyClient
  ...
  class ChildIdsSiteVersionMapping
    attr_accessor :_self
    ...
    attr_accessor :ids_site_version_mapping
    ...
    def self.attribute_map
      {
        ...
        :'ids_site_version_mapping' => :'IdsSiteVersionMapping'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IdsSiteVersionMapping')
        self.ids_site_version_mapping = attributes[:'IdsSiteVersionMapping']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ids_site_version_mapping.nil?
        invalid_properties.push('invalid value for "ids_site_version_mapping", ids_site_version_mapping cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ids_site_version_mapping.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ids_site_version_mapping == o.ids_site_version_mapping
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, ids_site_version_mapping].hash
    end
