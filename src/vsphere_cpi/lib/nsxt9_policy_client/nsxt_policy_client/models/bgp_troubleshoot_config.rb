...
module Nsxt9PolicyClient
  ...
  class BgpTroubleshootConfig
    ...
    # Flag to enable/disable the collection of the timestamps of sent and received Keep-Alive messages per BGP peer session, and the session states. Enabled by default. 
    attr_accessor :bgp_session_diagnostics

    # Flag to enable/disable the collection of system diagnostic data such as ARP, Ping, CPU stats, etc. 
    attr_accessor :system_diagnostics

    # Flag to enable/disable the collection of the timestamps of sent and received BFD control messages per BFD peer session. Enabled by default. 
    attr_accessor :bfd_control_pkt_diagnostics
    ...
    def self.attribute_map
      {
        ...
        :'bgp_session_diagnostics' => :'bgp_session_diagnostics',
        :'system_diagnostics' => :'system_diagnostics',
        :'bfd_control_pkt_diagnostics' => :'bfd_control_pkt_diagnostics'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'bgp_session_diagnostics' => :'BOOLEAN',
        :'system_diagnostics' => :'BOOLEAN',
        :'bfd_control_pkt_diagnostics' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bgp_session_diagnostics')
        self.bgp_session_diagnostics = attributes[:'bgp_session_diagnostics']
      else
        self.bgp_session_diagnostics = true
      end

      if attributes.has_key?(:'system_diagnostics')
        self.system_diagnostics = attributes[:'system_diagnostics']
      else
        self.system_diagnostics = true
      end

      if attributes.has_key?(:'bfd_control_pkt_diagnostics')
        self.bfd_control_pkt_diagnostics = attributes[:'bfd_control_pkt_diagnostics']
      else
        self.bfd_control_pkt_diagnostics = true
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bgp_session_diagnostics == o.bgp_session_diagnostics &&
          system_diagnostics == o.system_diagnostics &&
          bfd_control_pkt_diagnostics == o.bfd_control_pkt_diagnostics
    end
