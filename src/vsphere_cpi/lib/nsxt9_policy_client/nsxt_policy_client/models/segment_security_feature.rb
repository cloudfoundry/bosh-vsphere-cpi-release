...
module Nsxt9PolicyClient
  ...
  class SegmentSecurityFeature
    # true - activate the feature, false - deactivate the feture
    attr_accessor :enable

    # Feature to be activated/deactivated. BRIDGE_FIREWALL - Bridge Firewall Use any one of this to enable/disable it. 
    ...
    def valid?
      ...
      feature_validator = EnumAttributeValidator.new('String', ['BRIDGE_FIREWALL'])
    ...
    def feature=(feature)
      validator = EnumAttributeValidator.new('String', ['BRIDGE_FIREWALL'])
