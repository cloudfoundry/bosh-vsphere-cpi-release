...
module Nsxt9PolicyClient
  # OSPF Neighbors. 
  class OspfNeighborsStatusListResult
    attr_accessor :_self
    ...
    def hash
      [_self, _links, _schema, result_count, sort_by, sort_ascending, cursor, gateway_path, last_update_timestamp, results].hash
    end
