...
module Nsxt9PolicyClient
  ...
  class PolicyFirewallIpReputationConfig
    attr_accessor :_self
    ...
    # Property which indicates whether auto-download of IP Reputation feed is activated or deactivated. 
    attr_accessor :enable_auto_download

    # Timestamp of the most recent successful feed download.
    attr_accessor :last_feed_download

    # The frequency at which IP Reputation feed will be downloaded. This is a readonly field showing the current time interval in minutes. The current value is set 720 mins (12 hrs). 
    attr_accessor :download_frequency_in_mins

    # Indicates the download status of IP reputation feed.
    attr_accessor :download_status

    # If feed download fails for some reason like timeout or connectivity issues, then this property will hold the reason for the failure. For other status like IN_PROGRESS and COMPLETE, this field will be empty 
    ...
    def self.attribute_map
      {
        ...
        :'last_feed_download' => :'last_feed_download',
        :'download_frequency_in_mins' => :'download_frequency_in_mins',
    ...
    def self.swagger_types
      {
        ...
        :'last_feed_download' => :'Integer',
        :'download_frequency_in_mins' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'enable_auto_download')
        self.enable_auto_download = attributes[:'enable_auto_download']
      end

      if attributes.has_key?(:'last_feed_download')
        self.last_feed_download = attributes[:'last_feed_download']
      end

      if attributes.has_key?(:'download_frequency_in_mins')
        self.download_frequency_in_mins = attributes[:'download_frequency_in_mins']
      end
    ...
    def list_invalid_properties
      ...
      if @enable_auto_download.nil?
        invalid_properties.push('invalid value for "enable_auto_download", enable_auto_download cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @enable_auto_download.nil?
      download_status_validator = EnumAttributeValidator.new('String', ['IN_PROGRESS', 'COMPLETE', 'FAILED'])
    ...
    def download_status=(download_status)
      validator = EnumAttributeValidator.new('String', ['IN_PROGRESS', 'COMPLETE', 'FAILED'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enable_auto_download == o.enable_auto_download &&
          last_feed_download == o.last_feed_download &&
          download_frequency_in_mins == o.download_frequency_in_mins &&
