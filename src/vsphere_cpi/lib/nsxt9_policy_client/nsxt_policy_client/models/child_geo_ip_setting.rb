...
module Nsxt9PolicyClient
  ...
  class ChildGeoIpSetting
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'GeoIpSetting')
        self.geo_ip_setting = attributes[:'GeoIpSetting']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @geo_ip_setting.nil?
        invalid_properties.push('invalid value for "geo_ip_setting", geo_ip_setting cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @geo_ip_setting.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          geo_ip_setting == o.geo_ip_setting
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, geo_ip_setting].hash
    end
