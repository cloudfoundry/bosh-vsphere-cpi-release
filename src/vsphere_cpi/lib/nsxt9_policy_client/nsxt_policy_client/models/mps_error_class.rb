...
module Nsxt9PolicyClient
  ...
  class MpsErrorClass
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'error_timestamp')
        self.error_timestamp = attributes[:'error_timestamp']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          error_timestamp == o.error_timestamp
    end
    ...
    def hash
      [error_id, error_message, error_timestamp].hash
    end
