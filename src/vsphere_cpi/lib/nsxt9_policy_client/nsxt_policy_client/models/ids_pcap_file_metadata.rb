...
module Nsxt9PolicyClient
  ...
  class IdsPcapFileMetadata
    ...
    # Name of the Pcap File requested by the user. 
    attr_accessor :file_name

    # List of all pcap ids which are requested by the user as part of this File. 
    attr_accessor :pcap_ids

    # List of all signature ids which are part of the events whose pcap files is selected by the user as part of this File. 
    attr_accessor :signature_ids

    # READY means zipped pcap file is succesfully created and ready to download. IN_PROGRESS means creation of zipped pcap file is in progress. FAILED means some error occurred during creation of zipped pcap file. INCOMPLETE means zipped pcap file doea not have all the specified pcaps. 
    attr_accessor :status

    # If creation of zipped pcap file fails then this will tell the failure cause. 
    attr_accessor :failure_cause

    # Tells the size of the zipped pcap file. 
    attr_accessor :file_size

    # Time when the file extraction started. 
    attr_accessor :exported_on

    # Time until which the file will be avilable for download. 
    attr_accessor :available_until

    # Node wher file extraction is triggered. 
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'file_name' => :'String',
        :'pcap_ids' => :'Array<String>',
        :'signature_ids' => :'Array<String>',
        :'status' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pcap_ids')
        if (value = attributes[:'pcap_ids']).is_a?(Array)
          self.pcap_ids = value
        end
      end
      ...
      if attributes.has_key?(:'exported_on')
        self.exported_on = attributes[:'exported_on']
      end
    ...
    def list_invalid_properties
      ...
      if @pcap_ids.nil?
        invalid_properties.push('invalid value for "pcap_ids", pcap_ids cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @pcap_ids.nil?
      return false if @signature_ids.nil?
      status_validator = EnumAttributeValidator.new('String', ['READY', 'IN_PROGRESS', 'FAILED', 'INCOMPLETE'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['READY', 'IN_PROGRESS', 'FAILED', 'INCOMPLETE'])
