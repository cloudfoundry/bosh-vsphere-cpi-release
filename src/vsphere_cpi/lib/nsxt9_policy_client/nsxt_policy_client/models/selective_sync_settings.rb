...
module Nsxt9PolicyClient
  ...
  class SelectiveSyncSettings
    ...
    attr_accessor :selected_org_units
    ...
    def self.swagger_types
      {
        ...
        :'cursor' => :'String',
        :'enabled' => :'BOOLEAN',
        :'selected_org_units' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'selected_org_units')
        if (value = attributes[:'selected_org_units']).is_a?(Array)
          self.selected_org_units = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cursor == o.cursor &&
          enabled == o.enabled &&
          selected_org_units == o.selected_org_units
    end
    ...
    def hash
      [_self, _links, _schema, result_count, sort_by, sort_ascending, cursor, enabled, selected_org_units].hash
    end
