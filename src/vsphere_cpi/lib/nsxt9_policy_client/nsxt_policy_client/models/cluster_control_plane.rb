...
module Nsxt9PolicyClient
  ...
  class ClusterControlPlane
    ...
    attr_accessor :vhc_path

    # This property should be afford in create process. 
    attr_accessor :certificate

    # Indicates node type for ClusterControlPlane. ANTREA_NODE - Default node type. It indicates that the consumer is Antrea Controller. BM_NODE - It indicates that the consumer is Bare Metal Controller. 
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vhc_path')
        self.vhc_path = attributes[:'vhc_path']
      end
    ...
    def valid?
      ...
      node_type_validator = EnumAttributeValidator.new('String', ['ANTREA_NODE', 'BM_NODE'])
    ...
    def node_type=(node_type)
      validator = EnumAttributeValidator.new('String', ['ANTREA_NODE', 'BM_NODE'])
