...
module Nsxt9PolicyClient
  ...
  class TransportNodeState
    ...
    attr_accessor :remote_tunnel_endpoint_state
    ...
    attr_accessor :pending_user_actions

    # Host ID on which the edge node virtual machine resides.
    attr_accessor :host_moref
    ...
    def self.swagger_types
      {
        ...
        :'pending_user_actions' => :'Array<String>',
        :'host_moref' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'remote_tunnel_endpoint_state')
        self.remote_tunnel_endpoint_state = attributes[:'remote_tunnel_endpoint_state']
      end
      ...
      if attributes.has_key?(:'pending_user_actions')
        if (value = attributes[:'pending_user_actions']).is_a?(Array)
          self.pending_user_actions = value
        end
      end

      if attributes.has_key?(:'host_moref')
        self.host_moref = attributes[:'host_moref']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          remote_tunnel_endpoint_state == o.remote_tunnel_endpoint_state &&
          hardware_version == o.hardware_version &&
          pending_user_actions == o.pending_user_actions &&
          host_moref == o.host_moref
    end
    ...
    def hash
      [state, details, failure_message, failure_code, transport_node_id, host_switch_states, maintenance_mode_state, node_deployment_state, deployment_progress_state, remote_tunnel_endpoint_state, hardware_version, pending_user_actions, host_moref].hash
    end
