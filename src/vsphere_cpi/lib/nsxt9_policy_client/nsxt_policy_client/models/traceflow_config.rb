...
module Nsxt9PolicyClient
  ...
  class TraceflowConfig
    ...
    # Policy path or UUID (validated for syntax only) of segment port to start traceflow from. Auto-plumbed ports don't have corresponding policy path. Both overlay backed port and VLAN backed port are supported. 
    ...
    attr_accessor :connected_parent_path_as_source
    ...
    def self.attribute_map
      {
        ...
        :'connected_parent_path_as_source' => :'connected_parent_path_as_source'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'connected_parent_path_as_source' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'connected_parent_path_as_source')
        self.connected_parent_path_as_source = attributes[:'connected_parent_path_as_source']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@timeout.nil? && @timeout > 60
        invalid_properties.push('invalid value for "timeout", must be smaller than or equal to 60.')
      end
    ...
    def timeout=(timeout)
      if !timeout.nil? && timeout > 60
        fail ArgumentError, 'invalid value for "timeout", must be smaller than or equal to 60.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          connected_parent_path_as_source == o.connected_parent_path_as_source
    end
