...
module Nsxt9PolicyClient
  ...
  class ChildIdsPcapFileMetadata
    attr_accessor :_self
    ...
    attr_accessor :ids_pcap_file_metadata
    ...
    def self.attribute_map
      {
        ...
        :'ids_pcap_file_metadata' => :'IdsPcapFileMetadata'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IdsPcapFileMetadata')
        self.ids_pcap_file_metadata = attributes[:'IdsPcapFileMetadata']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ids_pcap_file_metadata.nil?
        invalid_properties.push('invalid value for "ids_pcap_file_metadata", ids_pcap_file_metadata cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ids_pcap_file_metadata.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ids_pcap_file_metadata == o.ids_pcap_file_metadata
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, ids_pcap_file_metadata].hash
    end
