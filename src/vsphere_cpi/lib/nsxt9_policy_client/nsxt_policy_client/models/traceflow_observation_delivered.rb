...
module Nsxt9PolicyClient
  class TraceflowObservationDelivered
    ...
    def hash
      [resource_type, sequence_no, transport_node_id, transport_node_name, transport_node_type, timestamp, timestamp_micro, component_type, component_sub_type, component_name, site_path, is_ens, lport_id, lport_name, vlan_id, resolution_type, target_mac].hash
    end
