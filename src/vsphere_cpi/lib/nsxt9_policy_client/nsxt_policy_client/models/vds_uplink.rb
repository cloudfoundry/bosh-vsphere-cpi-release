...
module Nsxt9PolicyClient
  ...
  class VdsUplink
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vds_uplink_name')
        self.vds_uplink_name = attributes[:'vds_uplink_name']
      end

      if attributes.has_key?(:'vds_lag_name')
        self.vds_lag_name = attributes[:'vds_lag_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          vds_uplink_name == o.vds_uplink_name &&
          vds_lag_name == o.vds_lag_name &&
    ...
    def hash
      [vds_uplink_name, vds_lag_name, uplink_name].hash
    end
