...
module Nsxt9PolicyClient
  # SHA SUB_METRIC_EXPORTER monitor specification
  class ShaSubMetricExporterMonitor
    attr_accessor :_self
    ...
    # The id of parent METRIC_EXPORTER monitor. 
    attr_accessor :parent_monitor_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'parent_monitor_id')
        self.parent_monitor_id = attributes[:'parent_monitor_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          parent_monitor_id == o.parent_monitor_id &&
