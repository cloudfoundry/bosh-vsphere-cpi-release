...
module Nsxt9PolicyClient
  # Details of the kubernetes gateways belonging to a policy Group 
  class PolicyGroupKubernetesGatewayList
    ...
    def self.swagger_types
      {
        :'clusters' => :'Array<PolicyGroupKubernetesGatewayCluster>'
      }
    end
