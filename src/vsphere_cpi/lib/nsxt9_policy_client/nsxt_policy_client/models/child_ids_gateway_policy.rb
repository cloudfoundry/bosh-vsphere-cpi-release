...
module Nsxt9PolicyClient
  ...
  class ChildIdsGatewayPolicy
    ...
    attr_accessor :ids_gateway_policy
    ...
    def self.attribute_map
      {
        ...
        :'ids_gateway_policy' => :'IdsGatewayPolicy'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IdsGatewayPolicy')
        self.ids_gateway_policy = attributes[:'IdsGatewayPolicy']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ids_gateway_policy.nil?
        invalid_properties.push('invalid value for "ids_gateway_policy", ids_gateway_policy cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ids_gateway_policy.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ids_gateway_policy == o.ids_gateway_policy
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, ids_gateway_policy].hash
    end
