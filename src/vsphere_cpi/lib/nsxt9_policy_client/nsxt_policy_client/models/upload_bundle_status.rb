...
module Nsxt9PolicyClient
  ...
  class UploadBundleStatus
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['UPLOADING', 'DOWNLOADING', 'EXTRACTING', 'VERIFYING', 'SUCCESS', 'FAILED'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['UPLOADING', 'DOWNLOADING', 'EXTRACTING', 'VERIFYING', 'SUCCESS', 'FAILED'])
