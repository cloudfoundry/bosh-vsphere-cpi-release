...
module Nsxt9PolicyClient
  # Edge Transport Nodes Datapath Troubleshoot Configuration
  class PolicyEdgeTransportNodeDatapathTroubleshooting
    attr_accessor :_self
    ...
    # This field will enable/disable the control packet logging features in edge transport nodes. 
    attr_accessor :control_pkt_drop_log
    ...
    def self.attribute_map
      {
        ...
        :'control_pkt_drop_log' => :'control_pkt_drop_log'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'control_pkt_drop_log')
        self.control_pkt_drop_log = attributes[:'control_pkt_drop_log']
      else
        self.control_pkt_drop_log = true
      end
    end
    ...
    def list_invalid_properties
      ...
      if @control_pkt_drop_log.nil?
        invalid_properties.push('invalid value for "control_pkt_drop_log", control_pkt_drop_log cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @control_pkt_drop_log.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          control_pkt_drop_log == o.control_pkt_drop_log
    end
