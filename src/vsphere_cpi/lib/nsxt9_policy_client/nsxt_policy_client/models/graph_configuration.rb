...
module Nsxt9PolicyClient
  ...
  class GraphConfiguration
    ...
    attr_accessor :line_chart_plot_configs
    ...
    def self.attribute_map
      {
        ...
        :'line_chart_plot_configs' => :'line_chart_plot_configs'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'x_value_type' => :'String',
        :'y_value_type' => :'String',
        :'line_chart_plot_configs' => :'Array<LineChartPlotConfiguration>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'graphs_colors')
        if (value = attributes[:'graphs_colors']).is_a?(Array)
          self.graphs_colors = value
        end
      end
      ...
      if attributes.has_key?(:'y_value_type')
        self.y_value_type = attributes[:'y_value_type']
      end

      if attributes.has_key?(:'line_chart_plot_configs')
        if (value = attributes[:'line_chart_plot_configs']).is_a?(Array)
          self.line_chart_plot_configs = value
        end
      end
    end
    ...
    def valid?
      ...
      x_value_type_validator = EnumAttributeValidator.new('String', ['string', 'number', 'date', 'millisecond', 'second'])
      return false unless x_value_type_validator.valid?(@x_value_type)
      y_value_type_validator = EnumAttributeValidator.new('String', ['integer', 'double'])
      return false unless y_value_type_validator.valid?(@y_value_type)
      true
    end
    ...
    def x_value_type=(x_value_type)
      validator = EnumAttributeValidator.new('String', ['string', 'number', 'date', 'millisecond', 'second'])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] y_value_type Object to be assigned
    def y_value_type=(y_value_type)
      validator = EnumAttributeValidator.new('String', ['integer', 'double'])
      unless validator.valid?(y_value_type)
        fail ArgumentError, 'invalid value for "y_value_type", must be one of #{validator.allowable_values}.'
      end
      @y_value_type = y_value_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sub_type == o.sub_type &&
          graphs_colors == o.graphs_colors &&
          graphs == o.graphs &&
          axes == o.axes &&
          navigation == o.navigation &&
          display_x_value == o.display_x_value &&
          x_value_type == o.x_value_type &&
          y_value_type == o.y_value_type &&
          line_chart_plot_configs == o.line_chart_plot_configs
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, condition, show_header, datasources, shared, weight, is_drilldown, footer, drilldown_id, filter, filter_value_required, default_filter_value, filters, icons, legend, span, rowspan, feature_set, plot_configs, sub_type, graphs_colors, graphs, axes, navigation, display_x_value, x_value_type, y_value_type, line_chart_plot_configs].hash
    end
