...
module Nsxt9PolicyClient
  ...
  class SubnetConnectionBindingMap
    attr_accessor :_self
    ...
    # VLAN ID is used to identify traffic between the VPC subnet connected to the containers and VPC subnet where the host VM is connected. 
    attr_accessor :vlan_traffic_tag

    # Policy path of the subnet connected to the host VM. 
    attr_accessor :subnet_path
    ...
    def self.attribute_map
      {
        ...
        :'vlan_traffic_tag' => :'vlan_traffic_tag',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vlan_traffic_tag')
        self.vlan_traffic_tag = attributes[:'vlan_traffic_tag']
      end

      if attributes.has_key?(:'subnet_path')
        self.subnet_path = attributes[:'subnet_path']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @vlan_traffic_tag.nil?
        invalid_properties.push('invalid value for "vlan_traffic_tag", vlan_traffic_tag cannot be nil.')
      end

      if @subnet_path.nil?
        invalid_properties.push('invalid value for "subnet_path", subnet_path cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vlan_traffic_tag.nil?
      return false if @subnet_path.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vlan_traffic_tag == o.vlan_traffic_tag &&
          subnet_path == o.subnet_path
    end
