...
module Nsxt9PolicyClient
  ...
  class LBCookiePersistenceProfile
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, persistence_shared, cookie_name, cookie_mode, cookie_fallback, cookie_garble, cookie_domain, cookie_path, cookie_time, cookie_httponly, cookie_secure].hash
    end
