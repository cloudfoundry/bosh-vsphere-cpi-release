...
module Nsxt9PolicyClient
  ...
  class ShaMonitorStatus
    ...
    # SHA monitor path
    attr_accessor :monitor_path

    attr_accessor :status_details

    attr_accessor :effective_profile

    # The path for the reported status transport node
    attr_accessor :transport_node_path

    # The path for the reported status node
    attr_accessor :node_id

    # The timing reflecting this status (unit is milliseconds). 
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'monitor_path' => :'String',
        :'status_details' => :'ShaMonitorStatusDetail',
        :'effective_profile' => :'ShaMonitorEffectiveConfig',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'monitor_path')
        self.monitor_path = attributes[:'monitor_path']
      end
      ...
      if attributes.has_key?(:'effective_profile')
        self.effective_profile = attributes[:'effective_profile']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          effective_profile == o.effective_profile &&
