...
module Nsxt9PolicyClient
  # Setting for Online Diagnostic System runbook. 
  class OdsRunbookSetting
    attr_accessor :_self
    ...
    attr_accessor :runbook_path

    # The policy path of group to which the profile is applied. 
    attr_accessor :applied_to_group_path

    # The on-off switch of runbook on all UA appliance nodes. If applied to specific UA appliances, please use the applied_to_appliance_ids instead. The fields applied_to_all_appliances and applied_to_appliance_ids are exclusive to each other. 
    attr_accessor :applied_to_all_appliances

    # Identifier(s) of UA appliance(s) to which the profile is applied. If this field is specified, then it should be a non-empty array. The appliance id list can be obtained from API api/v1/cluster/nodes. The valid id is the external id of appliance with manager role. If applied to all UA appliances, please use the applied_to_all_appliance instead. 
    attr_accessor :applied_to_appliance_ids
    ...
    def self.attribute_map
      {
        ...
        :'applied_to_all_appliances' => :'applied_to_all_appliances',
        :'applied_to_appliance_ids' => :'applied_to_appliance_ids',
        :'config' => :'config'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'runbook_path' => :'String',
        :'applied_to_group_path' => :'String',
        :'applied_to_all_appliances' => :'BOOLEAN',
        :'applied_to_appliance_ids' => :'Array<String>',
        :'config' => :'OdsRunbookSettingData'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'runbook_path')
        self.runbook_path = attributes[:'runbook_path']
      end

      if attributes.has_key?(:'applied_to_group_path')
        self.applied_to_group_path = attributes[:'applied_to_group_path']
      end

      if attributes.has_key?(:'applied_to_all_appliances')
        self.applied_to_all_appliances = attributes[:'applied_to_all_appliances']
      end

      if attributes.has_key?(:'applied_to_appliance_ids')
        if (value = attributes[:'applied_to_appliance_ids']).is_a?(Array)
          self.applied_to_appliance_ids = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @runbook_path.nil?
        invalid_properties.push('invalid value for "runbook_path", runbook_path cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @runbook_path.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          runbook_path == o.runbook_path &&
          applied_to_group_path == o.applied_to_group_path &&
          applied_to_all_appliances == o.applied_to_all_appliances &&
          applied_to_appliance_ids == o.applied_to_appliance_ids &&
          config == o.config
    end
