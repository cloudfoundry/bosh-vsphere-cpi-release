...
module Nsxt9PolicyClient
  # Represents and maintains NSX+ site offboarding status. 
  class PmaasSiteOffBoardingStatus
    attr_accessor :_self
    ...
    # Contains site offboading state. 
    attr_accessor :state

    # Contains status of site offboarding state. 
    ...
    def valid?
      ...
      state_validator = EnumAttributeValidator.new('String', ['PRECHECK', 'DISCONNECT_SITE', 'CLEANUP'])
      return false unless state_validator.valid?(@state)
      status_validator = EnumAttributeValidator.new('String', ['IN_PROGRESS', 'FAILED', 'SUCCESSFUL'])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ['PRECHECK', 'DISCONNECT_SITE', 'CLEANUP'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['IN_PROGRESS', 'FAILED', 'SUCCESSFUL'])
