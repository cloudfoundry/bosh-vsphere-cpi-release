...
module Nsxt9PolicyClient
  ...
  class LabelValueConfiguration
    ...
    def valid?
      ...
      sub_type_validator = EnumAttributeValidator.new('String', ['VERTICALLY_ALIGNED', 'HORIZONTALLY_ALIGNED'])
    ...
    def sub_type=(sub_type)
      validator = EnumAttributeValidator.new('String', ['VERTICALLY_ALIGNED', 'HORIZONTALLY_ALIGNED'])
