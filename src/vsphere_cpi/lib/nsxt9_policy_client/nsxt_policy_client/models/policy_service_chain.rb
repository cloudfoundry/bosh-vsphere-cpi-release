  ...
  class PolicyServiceChain
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'path_selection_policy')
        ...
        self.path_selection_policy = 'LOCAL'
      end
    end
