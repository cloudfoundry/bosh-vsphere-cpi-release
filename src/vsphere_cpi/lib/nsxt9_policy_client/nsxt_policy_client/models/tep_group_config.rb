...
module Nsxt9PolicyClient
  ...
  class TepGroupConfig
    ...
    attr_accessor :enable_tep_grouping_on_edge

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'enable_tep_grouping_on_edge' => :'enable_tep_grouping_on_edge'
      }
    end
    ...
    def self.swagger_types
      {
        :'enable_tep_grouping_on_edge' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'enable_tep_grouping_on_edge')
        self.enable_tep_grouping_on_edge = attributes[:'enable_tep_grouping_on_edge']
      else
        self.enable_tep_grouping_on_edge = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          enable_tep_grouping_on_edge == o.enable_tep_grouping_on_edge
    end
    ...
    def hash
      [enable_tep_grouping_on_edge].hash
    end
