...
module Nsxt9PolicyClient
  ...
  class MitreAttack
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'tactic_url')
        self.tactic_url = attributes[:'tactic_url']
      end

      if attributes.has_key?(:'tactic_name')
        self.tactic_name = attributes[:'tactic_name']
      end

      if attributes.has_key?(:'technique_name')
        self.technique_name = attributes[:'technique_name']
      end

      if attributes.has_key?(:'technique_url')
    ...
    def hash
      [tactic_url, tactic_name, technique_name, technique_url].hash
    end
