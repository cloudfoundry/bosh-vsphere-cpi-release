...
module Nsxt9PolicyClient
  ...
  class ChildOdsRunbookInvocationArtifactBatchRequest
    attr_accessor :_self
    ...
    attr_accessor :ods_runbook_invocation
    ...
    def self.attribute_map
      {
        ...
        :'ods_runbook_invocation' => :'OdsRunbookInvocation'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'ods_runbook_invocation' => :'OdsRunbookInvocationArtifactBatchRequest'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'OdsRunbookInvocation')
        self.ods_runbook_invocation = attributes[:'OdsRunbookInvocation']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ods_runbook_invocation.nil?
        invalid_properties.push('invalid value for "ods_runbook_invocation", ods_runbook_invocation cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ods_runbook_invocation.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ods_runbook_invocation == o.ods_runbook_invocation
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, ods_runbook_invocation].hash
    end
