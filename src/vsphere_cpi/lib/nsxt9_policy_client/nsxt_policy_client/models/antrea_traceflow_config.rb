...
module Nsxt9PolicyClient
  ...
  class AntreaTraceflowConfig
    ...
    attr_accessor :destination_external_id
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'packet' => :'AntreaTraceflowPacketData',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'source_external_id')
        self.source_external_id = attributes[:'source_external_id']
      end

      if attributes.has_key?(:'destination_external_id')
        self.destination_external_id = attributes[:'destination_external_id']
      end
    ...
    def list_invalid_properties
      ...
      if @container_cluster_id.nil?
        invalid_properties.push('invalid value for "container_cluster_id", container_cluster_id cannot be nil.')
      end

      if @source_external_id.nil?
        invalid_properties.push('invalid value for "source_external_id", source_external_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @container_cluster_id.nil?
      return false if @source_external_id.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          destination_external_id == o.destination_external_id &&
