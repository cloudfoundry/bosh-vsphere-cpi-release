...
module Nsxt9PolicyClient
  ...
  class ResourceObject
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'resource_path')
        self.resource_path = attributes[:'resource_path']
      end

      if attributes.has_key?(:'include_children')
        self.include_children = attributes[:'include_children']
      else
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          include_children == o.include_children
    end
    ...
    def hash
      [resource_path, include_children].hash
    end
