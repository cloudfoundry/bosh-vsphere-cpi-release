...
module Nsxt9PolicyClient
  ...
  class BaseCompatibilityCheckResult
    ...
    attr_accessor :version_compatible

    # Local Site NSX version where active Global Mananger is running.
    attr_accessor :local_nsx_version
    ...
    def self.swagger_types
      {
        :'rtt' => :'Integer',
        :'rtt_exceeded' => :'BOOLEAN',
        :'nsx_version' => :'String',
        :'version_compatible' => :'BOOLEAN',
        :'local_nsx_version' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rtt')
        self.rtt = attributes[:'rtt']
      end

      if attributes.has_key?(:'rtt_exceeded')
        self.rtt_exceeded = attributes[:'rtt_exceeded']
      end
      ...
      if attributes.has_key?(:'version_compatible')
        self.version_compatible = attributes[:'version_compatible']
      end

      if attributes.has_key?(:'local_nsx_version')
        self.local_nsx_version = attributes[:'local_nsx_version']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          rtt == o.rtt &&
          rtt_exceeded == o.rtt_exceeded &&
          nsx_version == o.nsx_version &&
          version_compatible == o.version_compatible &&
          local_nsx_version == o.local_nsx_version
    end
    ...
    def hash
      [rtt, rtt_exceeded, nsx_version, version_compatible, local_nsx_version].hash
    end
