...
module Nsxt9PolicyClient
  # Allocation parameters for the IP address (e.g. specific IP address) can be specified. 
  class ProjectIpAddressAllocation
    attr_accessor :_self
    ...
    # IP block path for project IP allocation. 
    attr_accessor :ip_block

    # The customer needs to pass allocation_ips or allocation_size. If allocation_size is used, the system will allocate IP addresses from unused IP addresses. Range or comma separated is not supported in Project IP allocation. 
    ...
    def list_invalid_properties
      ...
      if !@allocation_size.nil? && @allocation_size > 1
        invalid_properties.push('invalid value for "allocation_size", must be smaller than or equal to 1.')
      end

      if !@allocation_size.nil? && @allocation_size < 1
        invalid_properties.push('invalid value for "allocation_size", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@allocation_size.nil? && @allocation_size > 1
      return false if !@allocation_size.nil? && @allocation_size < 1
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] allocation_size Value to be assigned
    def allocation_size=(allocation_size)
      if !allocation_size.nil? && allocation_size > 1
        fail ArgumentError, 'invalid value for "allocation_size", must be smaller than or equal to 1.'
      end

      if !allocation_size.nil? && allocation_size < 1
        fail ArgumentError, 'invalid value for "allocation_size", must be greater than or equal to 1.'
      end
