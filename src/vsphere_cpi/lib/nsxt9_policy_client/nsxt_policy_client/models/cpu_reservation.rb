...
module Nsxt9PolicyClient
  ...
  class CPUReservation
    ...
    attr_accessor :reservation_in_shares
    ...
    attr_accessor :reservation_in_mhz
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'reservation_in_shares')
        self.reservation_in_shares = attributes[:'reservation_in_shares']
      else
        self.reservation_in_shares = 'HIGH_PRIORITY'
      end

      if attributes.has_key?(:'reservation_in_mhz')
        self.reservation_in_mhz = attributes[:'reservation_in_mhz']
      end
    end
    ...
    def valid?
      reservation_in_shares_validator = EnumAttributeValidator.new('String', ['EXTRA_HIGH_PRIORITY', 'HIGH_PRIORITY', 'NORMAL_PRIORITY', 'LOW_PRIORITY'])
      return false unless reservation_in_shares_validator.valid?(@reservation_in_shares)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] reservation_in_shares Object to be assigned
    def reservation_in_shares=(reservation_in_shares)
      validator = EnumAttributeValidator.new('String', ['EXTRA_HIGH_PRIORITY', 'HIGH_PRIORITY', 'NORMAL_PRIORITY', 'LOW_PRIORITY'])
      unless validator.valid?(reservation_in_shares)
        fail ArgumentError, 'invalid value for "reservation_in_shares", must be one of #{validator.allowable_values}.'
      end
      @reservation_in_shares = reservation_in_shares
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          reservation_in_shares == o.reservation_in_shares &&
          reservation_in_mhz == o.reservation_in_mhz
    end
    ...
    def hash
      [reservation_in_shares, reservation_in_mhz].hash
    end
