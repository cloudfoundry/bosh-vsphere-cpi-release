...
module Nsxt9PolicyClient
  ...
  class ChildShaPredefinedPlugin
    attr_accessor :_self
    ...
    attr_accessor :sha_plugin_profile
    ...
    def self.attribute_map
      {
        ...
        :'sha_plugin_profile' => :'ShaPluginProfile'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'sha_plugin_profile' => :'ShaPredefinedPlugin'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ShaPluginProfile')
        self.sha_plugin_profile = attributes[:'ShaPluginProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @sha_plugin_profile.nil?
        invalid_properties.push('invalid value for "sha_plugin_profile", sha_plugin_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @sha_plugin_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sha_plugin_profile == o.sha_plugin_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, sha_plugin_profile].hash
    end
