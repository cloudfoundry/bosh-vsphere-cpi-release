...
module Nsxt9PolicyClient
  # Provides the following traffic statistics of an L2VPN tunnel since the time the L2VPN session is UP:  - Incoming packet count. - Outgoing packet count. - Dropped packet count. 
  class L2VPNTapStatistics
    # The total number of outgoing data packets on an L2VPN tunnel. 
    attr_accessor :packets_out

    # The total number of traffic bytes sent on an L2VPN tunnel. 
    attr_accessor :bytes_out

    # The total number of incoming data packets on an L2VPN tunnel. 
    attr_accessor :packets_in

    # The total number of traffic bytes received on an L2VPN tunnel. 
    attr_accessor :bytes_in

    # The total number of incoming packets dropped on an L2VPN tunnel. 
    attr_accessor :packets_receive_error

    # The total number of outgoing packets dropped on an L2VPN tunnel. 
    ...
    def hash
      [packets_out, bytes_out, packets_in, bytes_in, packets_receive_error, packets_sent_error].hash
    end
