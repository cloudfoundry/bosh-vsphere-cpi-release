...
module Nsxt9PolicyClient
  ...
  class SandboxedResource
    ...
    # Referenced Paths
    attr_accessor :referenced_paths

    # Local Entity Paths
    attr_accessor :local_entity_paths

    # Alarm info detail
    attr_accessor :alarms

    # Number of reference path 
    attr_accessor :number_of_reference_path
    ...
    def self.attribute_map
      {
        ...
        :'alarms' => :'alarms',
        :'number_of_reference_path' => :'number_of_reference_path'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'local_entity_paths' => :'Array<String>',
        :'alarms' => :'Array<PolicyAlarmResource>',
        :'number_of_reference_path' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'referenced_paths')
        if (value = attributes[:'referenced_paths']).is_a?(Array)
          self.referenced_paths = value
        end
      end

      if attributes.has_key?(:'local_entity_paths')
        if (value = attributes[:'local_entity_paths']).is_a?(Array)
          self.local_entity_paths = value
        end
      end
      ...
      if attributes.has_key?(:'number_of_reference_path')
        self.number_of_reference_path = attributes[:'number_of_reference_path']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          site_id == o.site_id &&
          referenced_paths == o.referenced_paths &&
          local_entity_paths == o.local_entity_paths &&
          alarms == o.alarms &&
          number_of_reference_path == o.number_of_reference_path
    end
