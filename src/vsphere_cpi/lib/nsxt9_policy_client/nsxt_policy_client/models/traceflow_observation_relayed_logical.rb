...
module Nsxt9PolicyClient
  class TraceflowObservationRelayedLogical
    ...
    def hash
      [resource_type, sequence_no, transport_node_id, transport_node_name, transport_node_type, timestamp, timestamp_micro, component_type, component_sub_type, component_name, site_path, is_ens, relay_server_address, dst_server_address, logical_comp_uuid, message_type].hash
    end
