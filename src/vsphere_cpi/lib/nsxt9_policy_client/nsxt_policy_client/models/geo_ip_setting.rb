...
module Nsxt9PolicyClient
  ...
  class GeoIpSetting
    ...
    # Property which indicates whether auto-download of Geo IP Bundle is ON or OFF. 
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'auto_download')
        self.auto_download = attributes[:'auto_download']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @auto_download.nil?
        invalid_properties.push('invalid value for "auto_download", auto_download cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @auto_download.nil?
      true
    end
