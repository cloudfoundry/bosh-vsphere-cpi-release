...
module Nsxt9PolicyClient
  class AdditionalMetadata
    ...
    # Telemetry info about the 'number_of_firewall_rules'
    ...
    # true if value of any one of \"nta_detectorstate_*\" events in SSP telemetry is enabled. Does not show if unable to get events.
    ...
    def self.swagger_types
      {
        ...
        :'nsx_site_id' => :'String',
        :'license_edition_type' => :'Array<String>',
        :'license_key' => :'Array<String>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'license_edition_type')
        if (value = attributes[:'license_edition_type']).is_a?(Array)
          self.license_edition_type = value
        end
      end

      if attributes.has_key?(:'license_key')
        if (value = attributes[:'license_key']).is_a?(Array)
