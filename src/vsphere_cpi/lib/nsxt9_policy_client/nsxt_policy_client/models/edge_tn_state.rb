...
module Nsxt9PolicyClient
  # This field contains the edge vm deployment and tn config state.
  class EdgeTnState
    ...
    attr_accessor :transport_node_state

    # Overall state of edge tn state
    attr_accessor :consolidated_status

    attr_accessor :progress_state
    ...
    def self.attribute_map
      {
        ...
        :'transport_node_state' => :'transport_node_state',
    ...
    def self.swagger_types
      {
        ...
        :'deployment_state' => :'ConfigurationState',
        :'transport_node_state' => :'ConfigurationState',
        :'consolidated_status' => :'String',
        :'progress_state' => :'TransportNodeDeploymentProgressState'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'deployment_state')
        self.deployment_state = attributes[:'deployment_state']
      end

      if attributes.has_key?(:'transport_node_state')
        self.transport_node_state = attributes[:'transport_node_state']
      end
      ...
      if attributes.has_key?(:'progress_state')
        self.progress_state = attributes[:'progress_state']
      end
    end
    ...
    def valid?
      ...
      consolidated_status_validator = EnumAttributeValidator.new('String', ['SUCCESS', 'IN_PROGRESS', 'ERROR', 'UNKNOWN', 'UNINITIALIZED', 'SANDBOXED_REALIZATION_PENDING'])
    ...
    def consolidated_status=(consolidated_status)
      validator = EnumAttributeValidator.new('String', ['SUCCESS', 'IN_PROGRESS', 'ERROR', 'UNKNOWN', 'UNINITIALIZED', 'SANDBOXED_REALIZATION_PENDING'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          deployment_state == o.deployment_state &&
          transport_node_state == o.transport_node_state &&
          consolidated_status == o.consolidated_status &&
          progress_state == o.progress_state
    end
    ...
    def hash
      [state, details, failure_message, failure_code, deployment_state, transport_node_state, consolidated_status, progress_state].hash
    end
