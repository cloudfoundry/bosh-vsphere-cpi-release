...
module Nsxt9PolicyClient
  ...
  class ChildPolicyVpcNatRule
    ...
    attr_accessor :policy_vpc_nat_rule
    ...
    def self.attribute_map
      {
        ...
        :'policy_vpc_nat_rule' => :'PolicyVpcNatRule'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyVpcNatRule')
        self.policy_vpc_nat_rule = attributes[:'PolicyVpcNatRule']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_vpc_nat_rule.nil?
        invalid_properties.push('invalid value for "policy_vpc_nat_rule", policy_vpc_nat_rule cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_vpc_nat_rule.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_vpc_nat_rule == o.policy_vpc_nat_rule
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, policy_vpc_nat_rule].hash
    end
