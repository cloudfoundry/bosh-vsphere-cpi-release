...
module Nsxt9PolicyClient
  # IDS custom signature
  class IdsCustomSignature
    attr_accessor :_self
    ...
    # Represents the original signature Id provided by the user. 
    attr_accessor :original_signature_id

    # Validation status of the custom signature. 
    attr_accessor :validation_status

    # Represents the warning/error message for the custom signature if any. 
    attr_accessor :validation_message

    # Validation errors of Signature.
    attr_accessor :validation_errors

    # Validation notes for Signature.
    attr_accessor :validation_notes

    # Represents the original signature provided by the user. 
    attr_accessor :original_signature
    ...
    def self.attribute_map
      {
        ...
        :'signature' => :'signature',
        :'threshold' => :'threshold',
        :'original_signature_id' => :'original_signature_id',
    ...
    def self.swagger_types
      {
        ...
        :'validation_errors' => :'Array<IdsValidationError>',
        :'validation_notes' => :'Array<ValidationNote>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'original_signature_id')
        self.original_signature_id = attributes[:'original_signature_id']
      end
      ...
      if attributes.has_key?(:'validation_message')
        self.validation_message = attributes[:'validation_message']
      end
      ...
      if attributes.has_key?(:'validation_notes')
        if (value = attributes[:'validation_notes']).is_a?(Array)
          self.validation_notes = value
        end
      end

      if attributes.has_key?(:'original_signature')
        self.original_signature = attributes[:'original_signature']
      end
    end
    ...
    def valid?
      ...
      validation_status_validator = EnumAttributeValidator.new('String', ['VALID', 'INVALID', 'PENDING', 'WARNING'])
    ...
    def validation_status=(validation_status)
      validator = EnumAttributeValidator.new('String', ['VALID', 'INVALID', 'PENDING', 'WARNING'])
