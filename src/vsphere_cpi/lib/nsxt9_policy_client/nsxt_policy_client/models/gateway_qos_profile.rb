...
module Nsxt9PolicyClient
  ...
  class GatewayQosProfile
    ...
    attr_accessor :committed_bandwidth
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'committed_bandwidth')
        self.committed_bandwidth = attributes[:'committed_bandwidth']
      else
        self.committed_bandwidth = 1
      end
    ...
    def list_invalid_properties
      ...
      if !@committed_bandwidth.nil? && @committed_bandwidth < 1
        invalid_properties.push('invalid value for "committed_bandwidth", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@committed_bandwidth.nil? && @committed_bandwidth < 1
    ...
    # Custom attribute writer method with validation
    # @param [Object] committed_bandwidth Value to be assigned
    def committed_bandwidth=(committed_bandwidth)
      if !committed_bandwidth.nil? && committed_bandwidth < 1
        fail ArgumentError, 'invalid value for "committed_bandwidth", must be greater than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          committed_bandwidth == o.committed_bandwidth &&
