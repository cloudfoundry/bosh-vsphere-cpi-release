...
module Nsxt9PolicyClient
  class MetadataProxyStatisticsPerSegment
    ...
    def hash
      [segment_path, requests_from_clients, responses_to_clients, requests_to_nova_server, succeeded_responses_from_nova_server, error_responses_from_nova_server].hash
    end
