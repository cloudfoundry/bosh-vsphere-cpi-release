...
module Nsxt9PolicyClient
  ...
  class Constraint
    ...
    # Constraint target's owner type
    attr_accessor :target_owner_type

    # Collection of target resources attribute details.
    attr_accessor :targets

    # Expressions to constrain the target attribute value.
    attr_accessor :constraint_expressions
    ...
    def self.swagger_types
      {
        ...
        :'constraint_expressions' => :'Array<ConstraintExpression>',
        :'message' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'target_owner_type')
        self.target_owner_type = attributes[:'target_owner_type']
      end
      ...
      if attributes.has_key?(:'constraint_expressions')
        if (value = attributes[:'constraint_expressions']).is_a?(Array)
          self.constraint_expressions = value
        end
      end
    ...
    def valid?
      ...
      target_owner_type_validator = EnumAttributeValidator.new('String', ['GM', 'LM', 'ALL'])
      return false unless target_owner_type_validator.valid?(@target_owner_type)
      true
    end
    ...
    # @param [Object] target_owner_type Object to be assigned
    def target_owner_type=(target_owner_type)
      validator = EnumAttributeValidator.new('String', ['GM', 'LM', 'ALL'])
      unless validator.valid?(target_owner_type)
        fail ArgumentError, 'invalid value for "target_owner_type", must be one of #{validator.allowable_values}.'
      end
      @target_owner_type = target_owner_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          target_owner_type == o.target_owner_type &&
          targets == o.targets &&
          constraint_expressions == o.constraint_expressions &&
          message == o.message
    end
