...
module Nsxt9PolicyClient
  ...
  class PolicyExtraConfigHostSwitchProfile
    attr_accessor :_self
    ...
    def self.swagger_types
      {
        ...
        :'extra_configs' => :'Array<PolicyExtraConfig>'
      }
    end
