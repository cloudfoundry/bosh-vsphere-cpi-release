...
module Nsxt9PolicyClient
  ...
  class KubeconfigInfo
    ...
    # Kubernetes cluster kubeconfig file name
    attr_accessor :name
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'current_context')
