...
module Nsxt9PolicyClient
  ...
  class Tier0SecurityFeature
    # true - activate the feature, false - deactivate the feture
    attr_accessor :enable

    # Feature to be activated/deactivated. IDFW - Identity Firewall IDPS - Intrusion Detection System GFW_MULTICAST - Multicast on GFW GEOIP_MONITORING - Geo IP Monitoring Use any one of this to enable/disabe it. 
    ...
    def valid?
      ...
      feature_validator = EnumAttributeValidator.new('String', ['IDFW', 'IDPS', 'GEOIP_MONITORING'])
    ...
    def feature=(feature)
      validator = EnumAttributeValidator.new('String', ['IDFW', 'IDPS', 'GEOIP_MONITORING'])
