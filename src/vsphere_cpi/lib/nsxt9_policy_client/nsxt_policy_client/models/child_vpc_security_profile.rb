...
module Nsxt9PolicyClient
  ...
  class ChildVpcSecurityProfile
    ...
    attr_accessor :vpc_security_profile
    ...
    def self.attribute_map
      {
        ...
        :'vpc_security_profile' => :'VpcSecurityProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'VpcSecurityProfile')
        self.vpc_security_profile = attributes[:'VpcSecurityProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @vpc_security_profile.nil?
        invalid_properties.push('invalid value for "vpc_security_profile", vpc_security_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vpc_security_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vpc_security_profile == o.vpc_security_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, vpc_security_profile].hash
    end
