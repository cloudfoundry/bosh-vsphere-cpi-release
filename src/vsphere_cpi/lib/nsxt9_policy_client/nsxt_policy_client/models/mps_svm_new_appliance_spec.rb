...
module Nsxt9PolicyClient
  # Used to provide the SVM deployment specification for changing the appliance on a cluster.
  class MpsSvmNewApplianceSpec
    ...
    def hash
      [deployment_spec_name, storage_id].hash
    end
