...
module Nsxt9PolicyClient
  # IDS raw signatures
  class CustomSignatureModification
    attr_accessor :_self
    ...
    # IDS custom signature ID. 
    attr_accessor :signature_id

    attr_accessor :overridden_signature
    ...
    def self.swagger_types
      {
        ...
        :'signature_id' => :'String',
        :'overridden_signature' => :'OverriddenSignature'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'raw_signature')
        self.raw_signature = attributes[:'raw_signature']
      end
      ...
      if attributes.has_key?(:'overridden_signature')
        self.overridden_signature = attributes[:'overridden_signature']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          raw_signature == o.raw_signature &&
          signature_id == o.signature_id &&
          overridden_signature == o.overridden_signature
    end
