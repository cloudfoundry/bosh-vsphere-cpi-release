...
module Nsxt9PolicyClient
  ...
  class ChildVpcIpAddressAllocation
    attr_accessor :_self
    ...
    attr_accessor :vpc_ip_address_allocation
    ...
    def self.attribute_map
      {
        ...
        :'vpc_ip_address_allocation' => :'VpcIpAddressAllocation'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'VpcIpAddressAllocation')
        self.vpc_ip_address_allocation = attributes[:'VpcIpAddressAllocation']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @vpc_ip_address_allocation.nil?
        invalid_properties.push('invalid value for "vpc_ip_address_allocation", vpc_ip_address_allocation cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vpc_ip_address_allocation.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vpc_ip_address_allocation == o.vpc_ip_address_allocation
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, vpc_ip_address_allocation].hash
    end
