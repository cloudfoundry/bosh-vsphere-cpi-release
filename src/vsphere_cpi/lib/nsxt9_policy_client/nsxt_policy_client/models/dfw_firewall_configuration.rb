...
module Nsxt9PolicyClient
  ...
  class DfwFirewallConfiguration
    ...
    # To deactivate auto drafts, set it to true. By default, auto drafts are enabled. 
    ...
    # MACSet optimization is turned on when this flag is set to true. By default it is set to false.
    attr_accessor :global_macset_optimization_mode_enabled

    # If set to true, identity firewall is enabled. 
    attr_accessor :idfw_enabled

    # Enables event log scraping for Identity firewall. 
    attr_accessor :idfw_event_log_scraper_enabled

    # If set to true, collection of login/logout events from Loginsight server is enabled. 
    attr_accessor :idfw_loginsight_enabled
    ...
    def self.attribute_map
      {
        ...
        :'global_macset_optimization_mode_enabled' => :'global_macset_optimization_mode_enabled',
        :'idfw_enabled' => :'idfw_enabled',
        :'idfw_event_log_scraper_enabled' => :'idfw_event_log_scraper_enabled',
        :'idfw_loginsight_enabled' => :'idfw_loginsight_enabled'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'global_macset_optimization_mode_enabled' => :'BOOLEAN',
        :'idfw_enabled' => :'BOOLEAN',
        :'idfw_event_log_scraper_enabled' => :'BOOLEAN',
        :'idfw_loginsight_enabled' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'global_macset_optimization_mode_enabled')
        self.global_macset_optimization_mode_enabled = attributes[:'global_macset_optimization_mode_enabled']
      else
        self.global_macset_optimization_mode_enabled = false
      end
      ...
      if attributes.has_key?(:'idfw_event_log_scraper_enabled')
        self.idfw_event_log_scraper_enabled = attributes[:'idfw_event_log_scraper_enabled']
      else
        self.idfw_event_log_scraper_enabled = false
      end

      if attributes.has_key?(:'idfw_loginsight_enabled')
        self.idfw_loginsight_enabled = attributes[:'idfw_loginsight_enabled']
      else
        self.idfw_loginsight_enabled = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          global_macset_optimization_mode_enabled == o.global_macset_optimization_mode_enabled &&
          idfw_enabled == o.idfw_enabled &&
          idfw_event_log_scraper_enabled == o.idfw_event_log_scraper_enabled &&
          idfw_loginsight_enabled == o.idfw_loginsight_enabled
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, enable_firewall, disable_auto_drafts, global_addrset_mode_enabled, global_macset_optimization_mode_enabled, idfw_enabled, idfw_event_log_scraper_enabled, idfw_loginsight_enabled].hash
    end
