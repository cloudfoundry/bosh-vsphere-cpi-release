...
module Nsxt9PolicyClient
  ...
  class L7AccessProfile
    ...
    attr_accessor :l7_access_entries
    ...
    attr_accessor :default_action_logged
    ...
    def self.attribute_map
      {
        ...
        :'l7_access_entries' => :'l7_access_entries',
        :'entry_count' => :'entry_count',
        :'default_action' => :'default_action',
        :'default_action_logged' => :'default_action_logged'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'l7_access_entries' => :'Array<L7AccessEntry>',
        :'entry_count' => :'Integer',
        :'default_action' => :'String',
        :'default_action_logged' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'l7_access_entries')
        if (value = attributes[:'l7_access_entries']).is_a?(Array)
          self.l7_access_entries = value
        end
      end
      ...
      if attributes.has_key?(:'default_action_logged')
        self.default_action_logged = attributes[:'default_action_logged']
      else
        self.default_action_logged = false
      end
    end
    ...
    def valid?
      ...
      default_action_validator = EnumAttributeValidator.new('String', ['ALLOW', 'REJECT', 'REJECT_WITH_RESPONSE'])
      return false unless default_action_validator.valid?(@default_action)
      true
    end
    ...
    # @param [Object] default_action Object to be assigned
    def default_action=(default_action)
      validator = EnumAttributeValidator.new('String', ['ALLOW', 'REJECT', 'REJECT_WITH_RESPONSE'])
      unless validator.valid?(default_action)
        fail ArgumentError, 'invalid value for "default_action", must be one of #{validator.allowable_values}.'
      end
      @default_action = default_action
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          l7_access_entries == o.l7_access_entries &&
          entry_count == o.entry_count &&
          default_action == o.default_action &&
          default_action_logged == o.default_action_logged
    end
