...
module Nsxt9PolicyClient
  ...
  class LBHttpsMonitorProfile
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, monitor_port, interval, timeout, rise_count, fall_count, request_url, request_method, request_version, request_headers, request_body, response_status_codes, response_body, server_ssl_profile_binding].hash
    end
