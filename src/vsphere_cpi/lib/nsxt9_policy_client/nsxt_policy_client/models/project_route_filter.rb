...
module Nsxt9PolicyClient
  ...
  class ProjectRouteFilter
    ...
    # Policy path to prefixList to filter routes advertised from Tier1 Gateway. 
    attr_accessor :match_prefix_list

    # Prefix list will be applied to all Tier-1s and VPCs under the specified list of project Paths. Project cannot be part of multiple route filter configurations. 
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'match_prefix_list' => :'Array<String>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'match_prefix_list')
        if (value = attributes[:'match_prefix_list']).is_a?(Array)
          self.match_prefix_list = value
        end
      end

      if attributes.has_key?(:'projects_list')
        if (value = attributes[:'projects_list']).is_a?(Array)
          self.projects_list = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @match_prefix_list.nil?
        invalid_properties.push('invalid value for "match_prefix_list", match_prefix_list cannot be nil.')
      end

      if @projects_list.nil?
        invalid_properties.push('invalid value for "projects_list", projects_list cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @match_prefix_list.nil?
      return false if @projects_list.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          match_prefix_list == o.match_prefix_list &&
          projects_list == o.projects_list
    end
