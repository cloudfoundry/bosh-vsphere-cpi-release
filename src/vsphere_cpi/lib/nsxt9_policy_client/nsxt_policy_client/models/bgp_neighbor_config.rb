...
module Nsxt9PolicyClient
  ...
  class BgpNeighborConfig
    ...
    attr_accessor :neighbor_local_as_config

    # Flag to enable/disable BGP peering. Disabling will stop the BGP peering. True - indicates enable BGP peering, False - indicates disable BGP peering. Default is True. 
    ...
    def self.swagger_types
      {
        ...
        :'neighbor_local_as_config' => :'BgpNeighborLocalAsConfig',
        :'enabled' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'neighbor_local_as_config')
        self.neighbor_local_as_config = attributes[:'neighbor_local_as_config']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          neighbor_local_as_config == o.neighbor_local_as_config &&
          enabled == o.enabled
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, source_addresses, neighbor_address, remote_as_num, password, in_route_filters, out_route_filters, route_filtering, keep_alive_time, hold_down_time, bfd, allow_as_in, maximum_hop_limit, graceful_restart_mode, neighbor_local_as_config, enabled].hash
    end
