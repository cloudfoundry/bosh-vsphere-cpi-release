...
module Nsxt9PolicyClient
  ...
  class IdentityFirewallAdStore
    ...
    # Domain resource type comes from multiple sub-classes extending this base class. For example, IdentityFirewallAdStore is one accepted resource_type. If there are more sub-classes defined, they will also be accepted resource_type.
    ...
    attr_accessor :event_log_servers
    ...
    attr_accessor :selective_sync_settings
    ...
    def self.attribute_map
      {
        ...
        :'event_log_servers' => :'event_log_servers',
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'name' => :'String',
        :'ldap_servers' => :'Array<IdentityFirewallStoreLdapServer>',
        :'event_log_servers' => :'Array<IdentityFirewallStoreEventLogServer>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'event_log_servers')
        if (value = attributes[:'event_log_servers']).is_a?(Array)
          self.event_log_servers = value
        end
      end
      ...
      if attributes.has_key?(:'selective_sync_settings')
        self.selective_sync_settings = attributes[:'selective_sync_settings']
      end
    end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['IdentityFirewallAdStore'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['IdentityFirewallAdStore'])
