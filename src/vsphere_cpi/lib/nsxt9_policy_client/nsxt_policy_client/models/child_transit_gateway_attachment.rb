...
module Nsxt9PolicyClient
  ...
  class ChildTransitGatewayAttachment
    attr_accessor :_self
    ...
    attr_accessor :transit_gateway_attachment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TransitGatewayAttachment')
        self.transit_gateway_attachment = attributes[:'TransitGatewayAttachment']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @transit_gateway_attachment.nil?
        invalid_properties.push('invalid value for "transit_gateway_attachment", transit_gateway_attachment cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @transit_gateway_attachment.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transit_gateway_attachment == o.transit_gateway_attachment
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, transit_gateway_attachment].hash
    end
