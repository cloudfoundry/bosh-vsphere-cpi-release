...
module Nsxt9PolicyClient
  # IDS raw signatures
  class CustomSignatureValidationPayload
    attr_accessor :_self
    ...
    # IDS custom signature modification collection. 
    attr_accessor :modified_signatures

    # List of deleted custom signature paths. Paths should be of type IdsCustomSignaturePreview. As the Validate action is only supported on Preview Signatures. 
    attr_accessor :deleted_signatures

    # List of custom signature ids that need to be reverted to default action/state. 
    attr_accessor :revert_overridden_signatures
    ...
    def self.attribute_map
      {
        ...
        :'revert_overridden_signatures' => :'revert_overridden_signatures'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'modified_signatures' => :'Array<CustomSignatureModification>',
        :'deleted_signatures' => :'Array<String>',
        :'revert_overridden_signatures' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'modified_signatures')
        if (value = attributes[:'modified_signatures']).is_a?(Array)
          self.modified_signatures = value
        end
      end

      if attributes.has_key?(:'deleted_signatures')
        if (value = attributes[:'deleted_signatures']).is_a?(Array)
          self.deleted_signatures = value
        end
      end

      if attributes.has_key?(:'revert_overridden_signatures')
        if (value = attributes[:'revert_overridden_signatures']).is_a?(Array)
          self.revert_overridden_signatures = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          modified_signatures == o.modified_signatures &&
          deleted_signatures == o.deleted_signatures &&
          revert_overridden_signatures == o.revert_overridden_signatures
    end
