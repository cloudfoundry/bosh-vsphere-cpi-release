...
module Nsxt9PolicyClient
  # Common parameters needed to onboard/offboard site to/from NSXi, NDR, and Metrics.
  class UAAgentCommonResource
    attr_accessor :_self
