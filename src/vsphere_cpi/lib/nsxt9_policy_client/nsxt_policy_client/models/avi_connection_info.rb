...
module Nsxt9PolicyClient
  ...
  class AviConnectionInfo
    ...
    # This is connection property which checks whether ALB is connected to the controller. Enum options - ACTIVATE, DEACTIVATE_PROVIDER, DEACTIVATE_API. Default value is DEACTIVATE_API. 
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'is_default_cert')
        self.is_default_cert = attributes[:'is_default_cert']
      end
    end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['NSXTConnectionInfo', 'NSXVConnectionInfo', 'CvxConnectionInfo', 'AviConnectionInfo'])
      return false unless resource_type_validator.valid?(@resource_type)
      return false if @tenant.nil?
      return false if @status.nil?
      status_validator = EnumAttributeValidator.new('String', ['ACTIVATE', 'DEACTIVATE_PROVIDER', 'DEACTIVATE_API'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['NSXTConnectionInfo', 'NSXVConnectionInfo', 'CvxConnectionInfo', 'AviConnectionInfo'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['ACTIVATE', 'DEACTIVATE_PROVIDER', 'DEACTIVATE_API'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_default_cert == o.is_default_cert
    end
    ...
    def hash
      [enforcement_point_address, resource_type, username, password, version, tenant, cloud, thumbprint, expires_at, managed_by, status, certificate, is_default_cert].hash
    end
