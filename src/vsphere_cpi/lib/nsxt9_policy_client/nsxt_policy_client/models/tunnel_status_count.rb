...
module Nsxt9PolicyClient
  class TunnelStatusCount
    ...
    def self.swagger_types
      {
        ...
        :'down_pnics' => :'Array<PnicBondStatus>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'down_pnics')
        if (value = attributes[:'down_pnics']).is_a?(Array)
          self.down_pnics = value
        end
      end
    ...
    def hash
      [status, up_count, down_count, degraded_count, status_description, last_status_changed_time, down_pnics, bfd_status, bfd_diagnostic].hash
    end
