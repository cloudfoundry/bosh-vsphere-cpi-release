...
module Nsxt9PolicyClient
  ...
  class IPFIXL2Profile
    ...
    # Specifies the probability, in percentage, that a packet will be sampled. The value must be between 0 and 100, with up to three decimal places. This probability is applied uniformly to all packets. 
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, ipfix_collector_profile_path, packet_sample_probability, active_timeout, idle_timeout, max_flows, observation_domain_id, priority, export_overlay_flow].hash
    end
