...
module Nsxt9PolicyClient
  ...
  class IpAddressPool
    ...
    attr_accessor :check_overlap_with_existing_pools
    ...
    def self.attribute_map
      {
        ...
        :'check_overlap_with_existing_pools' => :'check_overlap_with_existing_pools',
    ...
    def self.swagger_types
      {
        ...
        :'pool_usage' => :'PolicyPoolUsage',
        :'check_overlap_with_existing_pools' => :'BOOLEAN',
        :'visibility' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'check_overlap_with_existing_pools')
        self.check_overlap_with_existing_pools = attributes[:'check_overlap_with_existing_pools']
      else
        self.check_overlap_with_existing_pools = false
      end
    ...
    def valid?
      ...
      ip_address_type_validator = EnumAttributeValidator.new('String', ['IPV4', 'IPV6', 'DUAL'])
    ...
    def ip_address_type=(ip_address_type)
      validator = EnumAttributeValidator.new('String', ['IPV4', 'IPV6', 'DUAL'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          check_overlap_with_existing_pools == o.check_overlap_with_existing_pools &&
