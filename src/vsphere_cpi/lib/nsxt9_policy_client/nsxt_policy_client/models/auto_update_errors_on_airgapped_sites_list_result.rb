...
module Nsxt9PolicyClient
  ...
  class AutoUpdateErrorsOnAirgappedSitesListResult
    attr_accessor :_self
    ...
    # Auto-update/update-now error on airgapped sites list results
    ...
    def self.swagger_types
      {
        ...
        :'cursor' => :'String',
        :'results' => :'Array<AutoUpdateErrorsOnAirgappedSites>'
      }
    end
