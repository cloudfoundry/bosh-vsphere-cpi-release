...
module Nsxt9PolicyClient
  ...
  class LegendWidgetConfiguration
    attr_accessor :_self
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'source_widget_id')
        self.source_widget_id = attributes[:'source_widget_id']
      end
    ...
    def list_invalid_properties
      ...
      if @source_widget_id.nil?
        invalid_properties.push('invalid value for "source_widget_id", source_widget_id cannot be nil.')
      end

      if @source_widget_id.to_s.length > 255
        invalid_properties.push('invalid value for "source_widget_id", the character length must be smaller than or equal to 255.')
      end
    ...
    def valid?
      ...
      return false if @source_widget_id.nil?
      return false if @source_widget_id.to_s.length > 255
    ...
    # Custom attribute writer method with validation
    # @param [Object] source_widget_id Value to be assigned
    def source_widget_id=(source_widget_id)
      if source_widget_id.nil?
        fail ArgumentError, 'source_widget_id cannot be nil'
      end

      if source_widget_id.to_s.length > 255
        fail ArgumentError, 'invalid value for "source_widget_id", the character length must be smaller than or equal to 255.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          source_widget_id == o.source_widget_id &&
          layout == o.layout
    end
