...
module Nsxt9PolicyClient
  ...
  class ChildVpcServiceProfile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'VpcServiceProfile')
        self.vpc_service_profile = attributes[:'VpcServiceProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @vpc_service_profile.nil?
        invalid_properties.push('invalid value for "vpc_service_profile", vpc_service_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vpc_service_profile.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, vpc_service_profile].hash
    end
