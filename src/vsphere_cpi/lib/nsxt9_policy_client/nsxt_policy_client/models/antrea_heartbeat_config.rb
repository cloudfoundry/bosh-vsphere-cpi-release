...
module Nsxt9PolicyClient
  ...
  class AntreaHeartbeatConfig
    ...
    def list_invalid_properties
      ...
      if @report_interval > 600
        invalid_properties.push('invalid value for "report_interval", must be smaller than or equal to 600.')
      end

      if @report_interval < 60
        invalid_properties.push('invalid value for "report_interval", must be greater than or equal to 60.')
      end
    ...
    def valid?
      ...
      return false if @report_interval > 600
      return false if @report_interval < 60
      true
    end
    ...
    def report_interval=(report_interval)
      ...
      if report_interval > 600
        fail ArgumentError, 'invalid value for "report_interval", must be smaller than or equal to 600.'
      end

      if report_interval < 60
        fail ArgumentError, 'invalid value for "report_interval", must be greater than or equal to 60.'
      end
