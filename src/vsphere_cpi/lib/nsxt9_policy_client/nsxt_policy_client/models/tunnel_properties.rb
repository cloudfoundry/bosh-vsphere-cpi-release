...
module Nsxt9PolicyClient
  class TunnelProperties
    ...
    def valid?
      ...
      encap_validator = EnumAttributeValidator.new('String', ['STT', 'VXLAN', 'GENEVE', 'NONE', 'UNKNOWN_ENCAP'])
    ...
    def encap=(encap)
      validator = EnumAttributeValidator.new('String', ['STT', 'VXLAN', 'GENEVE', 'NONE', 'UNKNOWN_ENCAP'])
    ...
    def hash
      [_self, _links, _schema, name, status, egress_interface, local_ip, remote_ip, remote_node_id, remote_node_display_name, encap, bfd, last_updated_time, latency_type, latency_value].hash
    end
