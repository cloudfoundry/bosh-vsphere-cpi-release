...
module Nsxt9PolicyClient
  ...
  class NodeStatus
    ...
    def valid?
      ...
      maintenance_mode_validator = EnumAttributeValidator.new('String', ['OFF', 'ENTERING', 'ON', 'EXITING', 'ENABLED', 'DISABLED'])
    ...
    def maintenance_mode=(maintenance_mode)
      validator = EnumAttributeValidator.new('String', ['OFF', 'ENTERING', 'ON', 'EXITING', 'ENABLED', 'DISABLED'])
    ...
    def hash
      [last_heartbeat_timestamp, last_sync_time, mpa_connectivity_status, mpa_connectivity_status_details, lcp_connectivity_status, lcp_connectivity_status_details, host_node_deployment_status, inventory_sync_paused, inventory_sync_reenable_time, software_version, system_status, maintenance_mode, external_id].hash
    end
