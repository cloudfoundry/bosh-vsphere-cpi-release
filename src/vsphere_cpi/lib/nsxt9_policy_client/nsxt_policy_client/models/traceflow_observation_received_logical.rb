...
module Nsxt9PolicyClient
  class TraceflowObservationReceivedLogical
    ...
    def hash
      [resource_type, sequence_no, transport_node_id, transport_node_name, transport_node_type, timestamp, timestamp_micro, component_type, component_sub_type, component_name, site_path, is_ens, component_id, src_component_type, src_component_id, src_component_name, lport_id, lport_name, vni, svc_mac, vlan, ipsec_vpn].hash
    end
