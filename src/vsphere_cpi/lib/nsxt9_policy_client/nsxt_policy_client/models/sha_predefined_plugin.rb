...
module Nsxt9PolicyClient
  ...
  class ShaPredefinedPlugin
    ...
    def self.attribute_map
      {
        ...
        :'delay_on_reboot' => :'delay_on_reboot'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'delay_on_reboot')
        self.delay_on_reboot = attributes[:'delay_on_reboot']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          delay_on_reboot == o.delay_on_reboot
    end
