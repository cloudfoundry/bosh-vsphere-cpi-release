...
module Nsxt9PolicyClient
  ...
  class ChildPolicyInterVrfRoutingConfig
    attr_accessor :_self
    ...
    attr_accessor :policy_inter_vrf_routing_config
    ...
    def self.attribute_map
      {
        ...
        :'policy_inter_vrf_routing_config' => :'PolicyInterVrfRoutingConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyInterVrfRoutingConfig')
        self.policy_inter_vrf_routing_config = attributes[:'PolicyInterVrfRoutingConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_inter_vrf_routing_config.nil?
        invalid_properties.push('invalid value for "policy_inter_vrf_routing_config", policy_inter_vrf_routing_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_inter_vrf_routing_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_inter_vrf_routing_config == o.policy_inter_vrf_routing_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, policy_inter_vrf_routing_config].hash
    end
