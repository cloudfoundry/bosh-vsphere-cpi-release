...
module Nsxt9PolicyClient
  ...
  class MpsSvmProperties
    ...
    def list_invalid_properties
      ...
      if @ip_allocation_type.nil?
        invalid_properties.push('invalid value for "ip_allocation_type", ip_allocation_type cannot be nil.')
      end
    ...
    def valid?
      return false if @ip_allocation_type.nil?
      ip_allocation_type_validator = EnumAttributeValidator.new('String', ['STATIC', 'DHCP'])
    ...
    def hash
      [storage_id, network_id, ip_allocation_type, ip_pool_id].hash
    end
