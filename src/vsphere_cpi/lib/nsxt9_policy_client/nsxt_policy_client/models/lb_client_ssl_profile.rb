...
module Nsxt9PolicyClient
  ...
  class LBClientSslProfile
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, cipher_group_label, ciphers, protocols, session_cache_enabled, session_cache_timeout, prefer_server_ciphers, is_secure, is_fips].hash
    end
