...
module Nsxt9PolicyClient
  ...
  class ChildGatewayQosProfile
    ...
    attr_accessor :gateway_qos_profile
    ...
    def self.attribute_map
      {
        ...
        :'gateway_qos_profile' => :'GatewayQosProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'GatewayQosProfile')
        self.gateway_qos_profile = attributes[:'GatewayQosProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @gateway_qos_profile.nil?
        invalid_properties.push('invalid value for "gateway_qos_profile", gateway_qos_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @gateway_qos_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          gateway_qos_profile == o.gateway_qos_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, gateway_qos_profile].hash
    end
