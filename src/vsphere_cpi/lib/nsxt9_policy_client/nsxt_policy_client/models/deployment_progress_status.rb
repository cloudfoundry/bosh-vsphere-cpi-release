...
module Nsxt9PolicyClient
  ...
  class DeploymentProgressStatus
    ...
    def overall_status=(overall_status)
      validator = EnumAttributeValidator.new('String', ['DEPLOYMENT_IN_PROGRESS', 'UNDEPLOYMENT_IN_PROGRESS', 'UPGRADE_IN_PROGRESS', 'UPDATE_IN_PROGRESS', 'DEPLOYMENT_QUEUED', 'UNDEPLOYMENT_QUEUED', 'UPDATE_QUEUED', 'DEPLOYMENT_SUCCESSFUL', 'UNDEPLOYMENT_SUCCESSFUL', 'UPGRADE_SUCCESSFUL', 'UPDATE_SUCCESSFUL', 'DEPLOYMENT_FAILED', 'UNDEPLOYMENT_FAILED', 'UPGRADE_FAILED', 'UPDATE_FAILED', 'NOT_DEPLOYED'])
    ...
    def hash
      [overall_status, percentage, progress_message, error_message].hash
    end
