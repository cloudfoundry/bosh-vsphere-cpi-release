...
module Nsxt9PolicyClient
  ...
  class IdsProfileSeverity
    ...
    def valid?
      ...
      severity_validator = EnumAttributeValidator.new('String', ['CRITICAL', 'HIGH', 'MEDIUM', 'LOW', 'SUSPICIOUS', 'NONE'])
    ...
    def severity=(severity)
      validator = EnumAttributeValidator.new('String', ['CRITICAL', 'HIGH', 'MEDIUM', 'LOW', 'SUSPICIOUS', 'NONE'])
