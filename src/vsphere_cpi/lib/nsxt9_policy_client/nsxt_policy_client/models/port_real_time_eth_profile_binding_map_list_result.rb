...
module Nsxt9PolicyClient
  # Paged collection of Port Real Time Eth Profile Binding Maps
  class PortRealTimeEthProfileBindingMapListResult
    attr_accessor :_self
    ...
    # Port Real Time Eth Profile Binding Map list results
    ...
    def self.swagger_types
      {
        ...
        :'cursor' => :'String',
        :'results' => :'Array<PortRealTimeEthProfileBindingMap>'
      }
    end
