...
module Nsxt9PolicyClient
  class DhcpIpPoolUsage
    ...
    # The consumed number is intended to display the total number of IP addresses consumed by DHCP clients. However, it may not always reflect an accurate count due to the asynchronous running DHCP data path. 
    attr_accessor :consumed_number
    ...
    def self.attribute_map
      {
        ...
        :'consumed_number' => :'consumed_number'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'consumed_number')
        self.consumed_number = attributes[:'consumed_number']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          consumed_number == o.consumed_number
    end
    ...
    def hash
      [dhcp_ip_pool_id, pool_size, allocated_number, allocated_percentage, consumed_number].hash
    end
