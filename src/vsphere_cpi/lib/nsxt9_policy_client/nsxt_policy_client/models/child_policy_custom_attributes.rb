...
module Nsxt9PolicyClient
  ...
  class ChildPolicyCustomAttributes
    attr_accessor :_self
    ...
    attr_accessor :policy_custom_attributes
    ...
    def self.attribute_map
      {
        ...
        :'policy_custom_attributes' => :'PolicyCustomAttributes'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyCustomAttributes')
        self.policy_custom_attributes = attributes[:'PolicyCustomAttributes']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_custom_attributes.nil?
        invalid_properties.push('invalid value for "policy_custom_attributes", policy_custom_attributes cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_custom_attributes.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_custom_attributes == o.policy_custom_attributes
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, policy_custom_attributes].hash
    end
