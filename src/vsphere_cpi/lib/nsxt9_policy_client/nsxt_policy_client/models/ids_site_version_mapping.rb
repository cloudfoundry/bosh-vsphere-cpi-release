...
module Nsxt9PolicyClient
  ...
  class IdsSiteVersionMapping
    ...
    # Associate the provided signature version to this site.
    attr_accessor :site_path

    # Associate the provided site to this signature version. To associate the provided site with the auto updated version on the GM, set this field to \"AUTO_UPDATE\". 
    attr_accessor :signature_version_path

    # This readonly field provides which version is associated with the provided site. This flag is useful when the auto_update flag is true. 
    attr_accessor :effective_signature_version_path
    ...
    def self.attribute_map
      {
        ...
        :'site_path' => :'site_path',
        :'signature_version_path' => :'signature_version_path',
        :'effective_signature_version_path' => :'effective_signature_version_path',
    ...
    def self.swagger_types
      {
        ...
        :'overridden' => :'BOOLEAN',
        :'site_path' => :'String',
        :'signature_version_path' => :'String',
        :'effective_signature_version_path' => :'String',
        :'site_settings' => :'IdsSiteSettings'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'signature_version_path')
        self.signature_version_path = attributes[:'signature_version_path']
      end

      if attributes.has_key?(:'effective_signature_version_path')
        self.effective_signature_version_path = attributes[:'effective_signature_version_path']
      end

      if attributes.has_key?(:'site_settings')
        self.site_settings = attributes[:'site_settings']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @signature_version_path.nil?
        invalid_properties.push('invalid value for "signature_version_path", signature_version_path cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @signature_version_path.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          signature_version_path == o.signature_version_path &&
          effective_signature_version_path == o.effective_signature_version_path &&
          site_settings == o.site_settings
    end
