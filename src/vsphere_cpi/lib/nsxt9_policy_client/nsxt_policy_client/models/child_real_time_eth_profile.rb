...
module Nsxt9PolicyClient
  ...
  class ChildRealTimeEthProfile
    ...
    attr_accessor :real_time_eth_profile
    ...
    def self.attribute_map
      {
        ...
        :'real_time_eth_profile' => :'RealTimeEthProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'RealTimeEthProfile')
        self.real_time_eth_profile = attributes[:'RealTimeEthProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @real_time_eth_profile.nil?
        invalid_properties.push('invalid value for "real_time_eth_profile", real_time_eth_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @real_time_eth_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          real_time_eth_profile == o.real_time_eth_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, real_time_eth_profile].hash
    end
