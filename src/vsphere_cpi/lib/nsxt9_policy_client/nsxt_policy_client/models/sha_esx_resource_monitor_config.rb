...
module Nsxt9PolicyClient
  ...
  class ShaEsxResourceMonitorConfig
    ...
    # Memory threshold after which memory consumption alarm is raised for user space agents 
    attr_accessor :agent_memory_threshold
    ...
    def self.attribute_map
      {
        ...
        :'agent_memory_threshold' => :'agent_memory_threshold'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'agent_memory_threshold')
        self.agent_memory_threshold = attributes[:'agent_memory_threshold']
      else
        self.agent_memory_threshold = '{\\\"NSX_CFGAGENT\\\": 80, \\\"NSX_OPSAGENT\\\": 80, \\\"NSX_EXPORTER\\\": 80, \\\"NSX_NESTDB\\\": 80, \\\"NSX_VDPI\\\": 80, \\\"NSX_PLATFORM-CLIENT\\\": 80, \\\"NSX_PROXY\\\": 80}'
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@check_interval.nil? && @check_interval > 60
        invalid_properties.push('invalid value for "check_interval", must be smaller than or equal to 60.')
      end

      if !@check_interval.nil? && @check_interval < 20
        invalid_properties.push('invalid value for "check_interval", must be greater than or equal to 20.')
      end
    ...
    def valid?
      ...
      return false if !@check_interval.nil? && @check_interval < 20
      true
    end
    ...
    def check_interval=(check_interval)
      if !check_interval.nil? && check_interval > 60
        fail ArgumentError, 'invalid value for "check_interval", must be smaller than or equal to 60.'
      end

      if !check_interval.nil? && check_interval < 20
        fail ArgumentError, 'invalid value for "check_interval", must be greater than or equal to 20.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          agent_memory_threshold == o.agent_memory_threshold
    end
    ...
    def hash
      [resource_type, enable, check_interval, agent_memory_threshold].hash
    end
