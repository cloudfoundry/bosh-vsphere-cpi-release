...
module Nsxt9PolicyClient
  ...
  class ChildSiteSecuritySetting
    attr_accessor :_self
    ...
    attr_accessor :site_security_setting
    ...
    def self.attribute_map
      {
        ...
        :'site_security_setting' => :'SiteSecuritySetting'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SiteSecuritySetting')
        self.site_security_setting = attributes[:'SiteSecuritySetting']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @site_security_setting.nil?
        invalid_properties.push('invalid value for "site_security_setting", site_security_setting cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @site_security_setting.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          site_security_setting == o.site_security_setting
    end
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, marked_for_delete, mark_for_override, request_parameter, site_security_setting].hash
    end
