...
module Nsxt9PolicyClient
  ...
  class DirectoryDomainSyncStats
    ...
    def valid?
      current_state_validator = EnumAttributeValidator.new('String', ['IDLE', 'FULL_SYNC', 'DELTA_SYNC', 'SELECTIVE_FULL_SYNC', 'SELECTIVE_DELTA_SYNC'])
      return false unless current_state_validator.valid?(@current_state)
      prev_sync_type_validator = EnumAttributeValidator.new('String', ['IDLE', 'FULL_SYNC', 'DELTA_SYNC', 'SELECTIVE_FULL_SYNC', 'SELECTIVE_DELTA_SYNC'])
    ...
    def current_state=(current_state)
      validator = EnumAttributeValidator.new('String', ['IDLE', 'FULL_SYNC', 'DELTA_SYNC', 'SELECTIVE_FULL_SYNC', 'SELECTIVE_DELTA_SYNC'])
    ...
    def hash
      [current_state, current_state_begin_time, avg_full_sync_time, num_full_sync, avg_delta_sync_time, num_delta_sync, prev_sync_type, prev_sync_status, prev_sync_error, prev_sync_end_time].hash
    end
