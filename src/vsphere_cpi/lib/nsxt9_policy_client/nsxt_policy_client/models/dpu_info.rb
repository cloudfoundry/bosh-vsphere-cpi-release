...
module Nsxt9PolicyClient
  ...
  class DpuInfo
    ...
    def valid?
      state_validator = EnumAttributeValidator.new('String', ['UNAVAILABLE', 'UNMANAGED', 'UNUSED', 'MANAGED', 'INVALID'])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ['UNAVAILABLE', 'UNMANAGED', 'UNUSED', 'MANAGED', 'INVALID'])
    ...
    def hash
      [dpu_id, state, model, vendor, firmware_version, os_version, is_primary].hash
    end
