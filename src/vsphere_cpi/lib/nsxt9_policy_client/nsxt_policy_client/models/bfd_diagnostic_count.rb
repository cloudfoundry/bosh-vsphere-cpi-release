...
module Nsxt9PolicyClient
  class BFDDiagnosticCount
    ...
    def hash
      [no_diagnostic_count, control_detection_time_expired_count, echo_function_failed_count, forwarding_plane_reset_count, path_down_count, concatenated_path_down_count, administratively_down_count, reverse_concatenated_path_down_count, neighbor_signaled_session_down_count].hash
    end
