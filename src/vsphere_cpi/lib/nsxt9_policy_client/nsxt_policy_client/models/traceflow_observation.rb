...
module Nsxt9PolicyClient
  class TraceflowObservation
    ...
    def hash
      [resource_type, sequence_no, transport_node_id, transport_node_name, transport_node_type, timestamp, timestamp_micro, component_type, component_sub_type, component_name, site_path, is_ens].hash
    end
