...
module Nsxt9PolicyClient
  ...
  class TlsCsrWithDaysValid
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'days_valid')
        self.days_valid = attributes[:'days_valid']
      else
        self.days_valid = 825
      end
    end
    ...
    def valid?
      ...
      algorithm_validator = EnumAttributeValidator.new('String', ['RSA', 'EC'])
    ...
    def algorithm=(algorithm)
      validator = EnumAttributeValidator.new('String', ['RSA', 'EC'])
