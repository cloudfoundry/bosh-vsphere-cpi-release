...
module Nsxt9PolicyClient
  ...
  class TransitGatewayAttachment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'connection_path')
    ...
    def list_invalid_properties
      ...
      if @connection_path.nil?
        invalid_properties.push('invalid value for "connection_path", connection_path cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @connection_path.nil?
      true
    end
