...
module Nsxt9PolicyClient
  ...
  class Tier0Interface
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dhcp_relay_path')
        self.dhcp_relay_path = attributes[:'dhcp_relay_path']
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['EXTERNAL', 'SERVICE', 'LOOPBACK', 'INTERVRF'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['EXTERNAL', 'SERVICE', 'LOOPBACK', 'INTERVRF'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          subnets == o.subnets &&
          dhcp_relay_path == o.dhcp_relay_path &&
          ls_id == o.ls_id &&
    ...
    def hash
      [_self, _links, _schema, _revision, resource_type, _create_user, _create_time, _last_modified_user, _last_modified_time, _system_owned, _protection, id, display_name, description, tags, path, relative_path, parent_path, remote_path, unique_id, realization_id, owner_id, origin_site_id, children, marked_for_delete, overridden, subnets, dhcp_relay_path, ls_id, edge_cluster_member_index, mtu, urpf_mode, edge_path, segment_path, type, multicast, igmp_local_join_groups, ipv6_profile_paths, access_vlan_id, proxy_arp_filters, ospf, admin_state].hash
    end
