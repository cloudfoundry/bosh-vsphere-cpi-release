...
module Nsxt9PolicyClient
  ...
  class StaticMimeContent
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'text_message')
    ...
    def list_invalid_properties
      ...
      if @text_message.nil?
        invalid_properties.push('invalid value for "text_message", text_message cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @text_message.nil?
      true
    end
