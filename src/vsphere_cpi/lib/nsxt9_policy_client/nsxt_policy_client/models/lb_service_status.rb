...
module Nsxt9PolicyClient
  class LBServiceStatus
    ...
    def hash
      [enforcement_point_path, alarm, resource_type, service_path, service_status, error_message, virtual_servers, pools, memory_usage, cpu_usage, active_transport_nodes, standby_transport_nodes, last_update_timestamp, instance_detail_per_tn].hash
    end
