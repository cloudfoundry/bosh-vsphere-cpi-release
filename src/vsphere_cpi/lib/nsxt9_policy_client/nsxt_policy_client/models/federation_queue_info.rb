...
module Nsxt9PolicyClient
  ...
  class FederationQueueInfo
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'max_size')
        self.max_size = attributes[:'max_size']
      end

      if attributes.has_key?(:'current_size')
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['TRANSMITTER', 'RECEIVER'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['TRANSMITTER', 'RECEIVER'])
    ...
    def hash
      [name, namespace, type, max_size, current_size].hash
    end
