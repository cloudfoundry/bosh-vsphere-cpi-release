...
module Nsxt9PolicyClient
  ...
  class StaticIpv6
    ...
    # Ipv6 default gateway for edge node must be specified if all the nodes it communicates with are not in the same subnet. 
    ...
    def self.swagger_types
      {
        ...
        :'management_port_subnets' => :'Array<IPv6Subnet>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'default_gateway')
        if (value = attributes[:'default_gateway']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @management_port_subnets.nil?
        invalid_properties.push('invalid value for "management_port_subnets", management_port_subnets cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @management_port_subnets.nil?
      true
    end
    ...
    def hash
      [ip_assignment_type, management_port_subnets, default_gateway].hash
    end
