...
module Nsxt9PolicyClient
  # Intent resource created for Metrics
  class MetricsAgent
    attr_accessor :_self
    ...
    # Action to perform for NSX+ agents
    attr_accessor :admin_action

    # Receiver endpoint used by NSX+ agents to communicate with the cloud
    attr_accessor :receiver_endpoint

    # Id of the NSX+ Organization where the site is onboarded.
    attr_accessor :org_id

    # Id of the NSX+ Instance where the site is onboarded.
    attr_accessor :instance_id

    # Configure log level for NSX+ agents
    attr_accessor :log_level

    # This flag denotes if metrics agent is configured to ingest timeseries metrics or not. 
    attr_accessor :enable_time_series_metrics_ingestion
    ...
    def self.attribute_map
      {
        ...
        :'log_level' => :'log_level',
        :'enable_time_series_metrics_ingestion' => :'enable_time_series_metrics_ingestion'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'instance_id' => :'String',
        :'log_level' => :'String',
        :'enable_time_series_metrics_ingestion' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'correlation_id')
        self.correlation_id = attributes[:'correlation_id']
      end

      if attributes.has_key?(:'admin_action')
        self.admin_action = attributes[:'admin_action']
      end

      if attributes.has_key?(:'receiver_endpoint')
        self.receiver_endpoint = attributes[:'receiver_endpoint']
      end
      ...
      if attributes.has_key?(:'enable_time_series_metrics_ingestion')
        self.enable_time_series_metrics_ingestion = attributes[:'enable_time_series_metrics_ingestion']
      else
        self.enable_time_series_metrics_ingestion = false
      end
    end
    ...
    def list_invalid_properties
      ...
      if @admin_action.nil?
        invalid_properties.push('invalid value for "admin_action", admin_action cannot be nil.')
      end

      if @receiver_endpoint.nil?
        invalid_properties.push('invalid value for "receiver_endpoint", receiver_endpoint cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @admin_action.nil?
      admin_action_validator = EnumAttributeValidator.new('String', ['ONBOARD', 'OFFBOARD', 'FORCE_OFFBOARD'])
      return false unless admin_action_validator.valid?(@admin_action)
      return false if @receiver_endpoint.nil?
      return false if @org_id.nil?
      return false if @instance_id.nil?
      log_level_validator = EnumAttributeValidator.new('String', ['INFO', 'DEBUG'])
    ...
    def admin_action=(admin_action)
      validator = EnumAttributeValidator.new('String', ['ONBOARD', 'OFFBOARD', 'FORCE_OFFBOARD'])
    ...
    def log_level=(log_level)
      validator = EnumAttributeValidator.new('String', ['INFO', 'DEBUG'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          receiver_endpoint == o.receiver_endpoint &&
          org_id == o.org_id &&
          instance_id == o.instance_id &&
          log_level == o.log_level &&
          enable_time_series_metrics_ingestion == o.enable_time_series_metrics_ingestion
    end
