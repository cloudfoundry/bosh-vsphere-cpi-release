  ...
  class EVPNSettingApi
    ...
    def create_or_update_evpn_config_with_http_info(tier_0_id, evpn_config, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EVPNSettingApi.create_or_update_evpn_config ...'
      end
      # verify the required parameter 'tier_0_id' is set
      if @api_client.config.client_side_validation && tier_0_id.nil?
        fail ArgumentError, "Missing the required parameter 'tier_0_id' when calling EVPNSettingApi.create_or_update_evpn_config"
      end
      # verify the required parameter 'evpn_config' is set
      if @api_client.config.client_side_validation && evpn_config.nil?
        fail ArgumentError, "Missing the required parameter 'evpn_config' when calling EVPNSettingApi.create_or_update_evpn_config"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EVPNSettingApi#create_or_update_evpn_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def create_or_update_evpn_tunnel_endpoint_config_with_http_info(tier_0_id, locale_services_id, tunnel_endpoint_id, evpn_tunnel_endpoint_config, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EVPNSettingApi.create_or_update_evpn_tunnel_endpoint_config ...'
      end
      # verify the required parameter 'tier_0_id' is set
      if @api_client.config.client_side_validation && tier_0_id.nil?
        fail ArgumentError, "Missing the required parameter 'tier_0_id' when calling EVPNSettingApi.create_or_update_evpn_tunnel_endpoint_config"
      end
      ...
      if @api_client.config.client_side_validation && locale_services_id.nil?
        fail ArgumentError, "Missing the required parameter 'locale_services_id' when calling EVPNSettingApi.create_or_update_evpn_tunnel_endpoint_config"
      end
      ...
      if @api_client.config.client_side_validation && tunnel_endpoint_id.nil?
        fail ArgumentError, "Missing the required parameter 'tunnel_endpoint_id' when calling EVPNSettingApi.create_or_update_evpn_tunnel_endpoint_config"
      end
      ...
      if @api_client.config.client_side_validation && evpn_tunnel_endpoint_config.nil?
        fail ArgumentError, "Missing the required parameter 'evpn_tunnel_endpoint_config' when calling EVPNSettingApi.create_or_update_evpn_tunnel_endpoint_config"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EVPNSettingApi#create_or_update_evpn_tunnel_endpoint_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_evpn_tenant_config_with_http_info(config_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EVPNSettingApi.delete_evpn_tenant_config ...'
      end
      # verify the required parameter 'config_id' is set
      if @api_client.config.client_side_validation && config_id.nil?
        fail ArgumentError, "Missing the required parameter 'config_id' when calling EVPNSettingApi.delete_evpn_tenant_config"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EVPNSettingApi#delete_evpn_tenant_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Delete evpn tunnel endpoint configuration
    ...
    def delete_evpn_tunnel_endpoint_config_with_http_info(tier_0_id, locale_services_id, tunnel_endpoint_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EVPNSettingApi.delete_evpn_tunnel_endpoint_config ...'
      end
      # verify the required parameter 'tier_0_id' is set
      if @api_client.config.client_side_validation && tier_0_id.nil?
        fail ArgumentError, "Missing the required parameter 'tier_0_id' when calling EVPNSettingApi.delete_evpn_tunnel_endpoint_config"
      end
      # verify the required parameter 'locale_services_id' is set
      if @api_client.config.client_side_validation && locale_services_id.nil?
        fail ArgumentError, "Missing the required parameter 'locale_services_id' when calling EVPNSettingApi.delete_evpn_tunnel_endpoint_config"
      end
      # verify the required parameter 'tunnel_endpoint_id' is set
      if @api_client.config.client_side_validation && tunnel_endpoint_id.nil?
        fail ArgumentError, "Missing the required parameter 'tunnel_endpoint_id' when calling EVPNSettingApi.delete_evpn_tunnel_endpoint_config"
      end
      # resource path
      local_var_path = '/infra/tier-0s/{tier-0-id}/locale-services/{locale-services-id}/evpn-tunnel-endpoints/{tunnel-endpoint-id}'.sub('{' + 'tier-0-id' + '}', tier_0_id.to_s).sub('{' + 'locale-services-id' + '}', locale_services_id.to_s).sub('{' + 'tunnel-endpoint-id' + '}', tunnel_endpoint_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EVPNSettingApi#delete_evpn_tunnel_endpoint_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_evpn_tunnel_endpoint_config_with_http_info(tier_0_id, locale_services_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EVPNSettingApi.list_evpn_tunnel_endpoint_config ...'
      end
      # verify the required parameter 'tier_0_id' is set
      if @api_client.config.client_side_validation && tier_0_id.nil?
        fail ArgumentError, "Missing the required parameter 'tier_0_id' when calling EVPNSettingApi.list_evpn_tunnel_endpoint_config"
      end
      # verify the required parameter 'locale_services_id' is set
      if @api_client.config.client_side_validation && locale_services_id.nil?
        fail ArgumentError, "Missing the required parameter 'locale_services_id' when calling EVPNSettingApi.list_evpn_tunnel_endpoint_config"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling EVPNSettingApi.list_evpn_tunnel_endpoint_config, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling EVPNSettingApi.list_evpn_tunnel_endpoint_config, must be greater than or equal to 0.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EVPNSettingApi#list_evpn_tunnel_endpoint_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create or Update evpn configuration
    ...
    def patch_evpn_config_with_http_info(tier_0_id, evpn_config, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EVPNSettingApi.patch_evpn_config ...'
      end
      # verify the required parameter 'tier_0_id' is set
      if @api_client.config.client_side_validation && tier_0_id.nil?
        fail ArgumentError, "Missing the required parameter 'tier_0_id' when calling EVPNSettingApi.patch_evpn_config"
      end
      # verify the required parameter 'evpn_config' is set
      if @api_client.config.client_side_validation && evpn_config.nil?
        fail ArgumentError, "Missing the required parameter 'evpn_config' when calling EVPNSettingApi.patch_evpn_config"
      end
      # resource path
      local_var_path = '/infra/tier-0s/{tier-0-id}/evpn'.sub('{' + 'tier-0-id' + '}', tier_0_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EVPNSettingApi#patch_evpn_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create or Update evpn tunnel endpoint configuration
    ...
    def patch_evpn_tunnel_endpoint_config_with_http_info(tier_0_id, locale_services_id, tunnel_endpoint_id, evpn_tunnel_endpoint_config, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EVPNSettingApi.patch_evpn_tunnel_endpoint_config ...'
      end
      # verify the required parameter 'tier_0_id' is set
      if @api_client.config.client_side_validation && tier_0_id.nil?
        fail ArgumentError, "Missing the required parameter 'tier_0_id' when calling EVPNSettingApi.patch_evpn_tunnel_endpoint_config"
      end
      # verify the required parameter 'locale_services_id' is set
      if @api_client.config.client_side_validation && locale_services_id.nil?
        fail ArgumentError, "Missing the required parameter 'locale_services_id' when calling EVPNSettingApi.patch_evpn_tunnel_endpoint_config"
      end
      # verify the required parameter 'tunnel_endpoint_id' is set
      if @api_client.config.client_side_validation && tunnel_endpoint_id.nil?
        fail ArgumentError, "Missing the required parameter 'tunnel_endpoint_id' when calling EVPNSettingApi.patch_evpn_tunnel_endpoint_config"
      end
      # verify the required parameter 'evpn_tunnel_endpoint_config' is set
      if @api_client.config.client_side_validation && evpn_tunnel_endpoint_config.nil?
        fail ArgumentError, "Missing the required parameter 'evpn_tunnel_endpoint_config' when calling EVPNSettingApi.patch_evpn_tunnel_endpoint_config"
      end
      # resource path
      local_var_path = '/infra/tier-0s/{tier-0-id}/locale-services/{locale-services-id}/evpn-tunnel-endpoints/{tunnel-endpoint-id}'.sub('{' + 'tier-0-id' + '}', tier_0_id.to_s).sub('{' + 'locale-services-id' + '}', locale_services_id.to_s).sub('{' + 'tunnel-endpoint-id' + '}', tunnel_endpoint_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EVPNSettingApi#patch_evpn_tunnel_endpoint_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def read_evpn_config_with_http_info(tier_0_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EVPNSettingApi.read_evpn_config ...'
      end
      # verify the required parameter 'tier_0_id' is set
      if @api_client.config.client_side_validation && tier_0_id.nil?
        fail ArgumentError, "Missing the required parameter 'tier_0_id' when calling EVPNSettingApi.read_evpn_config"
      end
      # resource path
      local_var_path = '/infra/tier-0s/{tier-0-id}/evpn'.sub('{' + 'tier-0-id' + '}', tier_0_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'EvpnConfig')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EVPNSettingApi#read_evpn_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def read_evpn_tunnel_endpoint_config_with_http_info(tier_0_id, locale_services_id, tunnel_endpoint_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EVPNSettingApi.read_evpn_tunnel_endpoint_config ...'
      end
      # verify the required parameter 'tier_0_id' is set
      if @api_client.config.client_side_validation && tier_0_id.nil?
        fail ArgumentError, "Missing the required parameter 'tier_0_id' when calling EVPNSettingApi.read_evpn_tunnel_endpoint_config"
      end
      # verify the required parameter 'locale_services_id' is set
      if @api_client.config.client_side_validation && locale_services_id.nil?
        fail ArgumentError, "Missing the required parameter 'locale_services_id' when calling EVPNSettingApi.read_evpn_tunnel_endpoint_config"
      end
      # verify the required parameter 'tunnel_endpoint_id' is set
      if @api_client.config.client_side_validation && tunnel_endpoint_id.nil?
        fail ArgumentError, "Missing the required parameter 'tunnel_endpoint_id' when calling EVPNSettingApi.read_evpn_tunnel_endpoint_config"
      end
      # resource path
      local_var_path = '/infra/tier-0s/{tier-0-id}/locale-services/{locale-services-id}/evpn-tunnel-endpoints/{tunnel-endpoint-id}'.sub('{' + 'tier-0-id' + '}', tier_0_id.to_s).sub('{' + 'locale-services-id' + '}', locale_services_id.to_s).sub('{' + 'tunnel-endpoint-id' + '}', tunnel_endpoint_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'EvpnTunnelEndpointConfig')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EVPNSettingApi#read_evpn_tunnel_endpoint_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
