  ...
  class LatencyApi
    ...
    def create_or_replace_policy_latency_stat_profile_with_http_info(profile_id, policy_latency_stat_profile, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LatencyApi.create_or_replace_policy_latency_stat_profile ...'
      end
      # verify the required parameter 'profile_id' is set
      if @api_client.config.client_side_validation && profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'profile_id' when calling LatencyApi.create_or_replace_policy_latency_stat_profile"
      end
      ...
      if @api_client.config.client_side_validation && policy_latency_stat_profile.nil?
        fail ArgumentError, "Missing the required parameter 'policy_latency_stat_profile' when calling LatencyApi.create_or_replace_policy_latency_stat_profile"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LatencyApi#create_or_replace_policy_latency_stat_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_policy_latency_stat_profile_with_http_info(profile_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LatencyApi.delete_policy_latency_stat_profile ...'
      end
      # verify the required parameter 'profile_id' is set
      if @api_client.config.client_side_validation && profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'profile_id' when calling LatencyApi.delete_policy_latency_stat_profile"
      end
      # resource path
      local_var_path = '/infra/latency-profiles/{profile-id}'.sub('{' + 'profile-id' + '}', profile_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LatencyApi#delete_policy_latency_stat_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_policy_latency_profiles_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LatencyApi.list_policy_latency_profiles ...'
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling LatencyApi.list_policy_latency_profiles, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling LatencyApi.list_policy_latency_profiles, must be greater than or equal to 0.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LatencyApi#list_policy_latency_profiles\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def patch_policy_latency_stat_profile_with_http_info(profile_id, policy_latency_stat_profile, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LatencyApi.patch_policy_latency_stat_profile ...'
      end
      # verify the required parameter 'profile_id' is set
      if @api_client.config.client_side_validation && profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'profile_id' when calling LatencyApi.patch_policy_latency_stat_profile"
      end
      # verify the required parameter 'policy_latency_stat_profile' is set
      if @api_client.config.client_side_validation && policy_latency_stat_profile.nil?
        fail ArgumentError, "Missing the required parameter 'policy_latency_stat_profile' when calling LatencyApi.patch_policy_latency_stat_profile"
      end
      # resource path
      local_var_path = '/infra/latency-profiles/{profile-id}'.sub('{' + 'profile-id' + '}', profile_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :return_type => 'PolicyLatencyStatProfile')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LatencyApi#patch_policy_latency_stat_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def read_policy_latency_stat_profile_with_http_info(profile_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LatencyApi.read_policy_latency_stat_profile ...'
      end
      # verify the required parameter 'profile_id' is set
      if @api_client.config.client_side_validation && profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'profile_id' when calling LatencyApi.read_policy_latency_stat_profile"
      end
      # resource path
      local_var_path = '/infra/latency-profiles/{profile-id}'.sub('{' + 'profile-id' + '}', profile_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'PolicyLatencyStatProfile')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LatencyApi#read_policy_latency_stat_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
