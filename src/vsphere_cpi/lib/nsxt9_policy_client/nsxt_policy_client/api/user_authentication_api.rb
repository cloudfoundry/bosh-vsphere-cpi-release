  ...
  class UserAuthenticationApi
    ...
    def create_authenticated_session_with_http_info(session_authentication_credentials, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserAuthenticationApi.create_authenticated_session ...'
      end
      ...
      if @api_client.config.client_side_validation && session_authentication_credentials.nil?
        fail ArgumentError, "Missing the required parameter 'session_authentication_credentials' when calling UserAuthenticationApi.create_authenticated_session"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserAuthenticationApi#create_authenticated_session\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def destroy_authenticated_session_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserAuthenticationApi.destroy_authenticated_session ...'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserAuthenticationApi#destroy_authenticated_session\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
