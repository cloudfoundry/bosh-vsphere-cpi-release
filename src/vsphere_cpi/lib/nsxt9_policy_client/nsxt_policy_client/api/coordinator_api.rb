  ...
  class CoordinatorApi
    ...
    def get_available_uc_versions_with_http_info(site_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CoordinatorApi.get_available_uc_versions ...'
      end
      # verify the required parameter 'site_id' is set
      if @api_client.config.client_side_validation && site_id.nil?
        fail ArgumentError, "Missing the required parameter 'site_id' when calling CoordinatorApi.get_available_uc_versions"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CoordinatorApi#get_available_uc_versions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_uc_deployment_checks_status_with_http_info(site_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CoordinatorApi.get_uc_deployment_checks_status ...'
      end
      # verify the required parameter 'site_id' is set
      if @api_client.config.client_side_validation && site_id.nil?
        fail ArgumentError, "Missing the required parameter 'site_id' when calling CoordinatorApi.get_uc_deployment_checks_status"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CoordinatorApi#get_uc_deployment_checks_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_upgrade_coordinator_deployment_config_with_http_info(site_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CoordinatorApi.get_upgrade_coordinator_deployment_config ...'
      end
      # verify the required parameter 'site_id' is set
      if @api_client.config.client_side_validation && site_id.nil?
        fail ArgumentError, "Missing the required parameter 'site_id' when calling CoordinatorApi.get_upgrade_coordinator_deployment_config"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CoordinatorApi#get_upgrade_coordinator_deployment_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_upgrade_coordinator_deployment_progress_status_with_http_info(site_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CoordinatorApi.get_upgrade_coordinator_deployment_progress_status ...'
      end
      # verify the required parameter 'site_id' is set
      if @api_client.config.client_side_validation && site_id.nil?
        fail ArgumentError, "Missing the required parameter 'site_id' when calling CoordinatorApi.get_upgrade_coordinator_deployment_progress_status"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CoordinatorApi#get_upgrade_coordinator_deployment_progress_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def run_uc_deployment_checks_with_http_info(site_id, deployment_checks_action, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CoordinatorApi.run_uc_deployment_checks ...'
      end
      # verify the required parameter 'site_id' is set
      if @api_client.config.client_side_validation && site_id.nil?
        fail ArgumentError, "Missing the required parameter 'site_id' when calling CoordinatorApi.run_uc_deployment_checks"
      end
      ...
      if @api_client.config.client_side_validation && deployment_checks_action.nil?
        fail ArgumentError, "Missing the required parameter 'deployment_checks_action' when calling CoordinatorApi.run_uc_deployment_checks"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CoordinatorApi#run_uc_deployment_checks\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_upgrade_coordinator_deployment_config_with_http_info(site_id, upgrade_coordinator_deployment_config, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CoordinatorApi.update_upgrade_coordinator_deployment_config ...'
      end
      # verify the required parameter 'site_id' is set
      if @api_client.config.client_side_validation && site_id.nil?
        fail ArgumentError, "Missing the required parameter 'site_id' when calling CoordinatorApi.update_upgrade_coordinator_deployment_config"
      end
      ...
      if @api_client.config.client_side_validation && upgrade_coordinator_deployment_config.nil?
        fail ArgumentError, "Missing the required parameter 'upgrade_coordinator_deployment_config' when calling CoordinatorApi.update_upgrade_coordinator_deployment_config"
      end
      # resource path
      local_var_path = '/infra/sites/{site-id}/napp/deployment/upgrade-coordinator'.sub('{' + 'site-id' + '}', site_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :return_type => 'UpgradeCoordinatorDeploymentConfig')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CoordinatorApi#update_upgrade_coordinator_deployment_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
