...
module Nsxt9PolicyClient
  class CpuMemoryThresholdsProfilesApi
    ...
    def delete_cpu_mem_thresholds_profile_with_http_info(profile_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CpuMemoryThresholdsProfilesApi.delete_cpu_mem_thresholds_profile ...'
      end
      # verify the required parameter 'profile_id' is set
      if @api_client.config.client_side_validation && profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'profile_id' when calling CpuMemoryThresholdsProfilesApi.delete_cpu_mem_thresholds_profile"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CpuMemoryThresholdsProfilesApi#delete_cpu_mem_thresholds_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_policy_firewall_cpu_mem_thresholds_profile_binding_map_with_http_info(cpu_mem_thresholds_profile_binding_map_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CpuMemoryThresholdsProfilesApi.delete_policy_firewall_cpu_mem_thresholds_profile_binding_map ...'
      end
      ...
      if @api_client.config.client_side_validation && cpu_mem_thresholds_profile_binding_map_id.nil?
        fail ArgumentError, "Missing the required parameter 'cpu_mem_thresholds_profile_binding_map_id' when calling CpuMemoryThresholdsProfilesApi.delete_policy_firewall_cpu_mem_thresholds_profile_binding_map"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CpuMemoryThresholdsProfilesApi#delete_policy_firewall_cpu_mem_thresholds_profile_binding_map\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_policy_firewall_cpu_mem_thresholds_profile_binding_map_with_http_info(cpu_mem_thresholds_profile_binding_map_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CpuMemoryThresholdsProfilesApi.get_policy_firewall_cpu_mem_thresholds_profile_binding_map ...'
      end
      # verify the required parameter 'cpu_mem_thresholds_profile_binding_map_id' is set
      if @api_client.config.client_side_validation && cpu_mem_thresholds_profile_binding_map_id.nil?
        fail ArgumentError, "Missing the required parameter 'cpu_mem_thresholds_profile_binding_map_id' when calling CpuMemoryThresholdsProfilesApi.get_policy_firewall_cpu_mem_thresholds_profile_binding_map"
      end
      # resource path
      local_var_path = '/infra/settings/firewall/cpu-mem-thresholds-profile-binding-maps/{cpu-mem-thresholds-profile-binding-map-id}'.sub('{' + 'cpu-mem-thresholds-profile-binding-map-id' + '}', cpu_mem_thresholds_profile_binding_map_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CpuMemoryThresholdsProfilesApi#get_policy_firewall_cpu_mem_thresholds_profile_binding_map\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Delete CPU and memory thresholds profile
    ...
    def global_infra_delete_cpu_mem_thresholds_profile_with_http_info(profile_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CpuMemoryThresholdsProfilesApi.global_infra_delete_cpu_mem_thresholds_profile ...'
      end
      # verify the required parameter 'profile_id' is set
      if @api_client.config.client_side_validation && profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'profile_id' when calling CpuMemoryThresholdsProfilesApi.global_infra_delete_cpu_mem_thresholds_profile"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CpuMemoryThresholdsProfilesApi#global_infra_delete_cpu_mem_thresholds_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def global_infra_list_cpu_mem_thresholds_profiles_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CpuMemoryThresholdsProfilesApi.global_infra_list_cpu_mem_thresholds_profiles ...'
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling CpuMemoryThresholdsProfilesApi.global_infra_list_cpu_mem_thresholds_profiles, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling CpuMemoryThresholdsProfilesApi.global_infra_list_cpu_mem_thresholds_profiles, must be greater than or equal to 0.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CpuMemoryThresholdsProfilesApi#global_infra_list_cpu_mem_thresholds_profiles\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def global_infra_list_policy_firewall_cpu_mem_thresholds_profile_binding_maps_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CpuMemoryThresholdsProfilesApi.global_infra_list_policy_firewall_cpu_mem_thresholds_profile_binding_maps ...'
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling CpuMemoryThresholdsProfilesApi.global_infra_list_policy_firewall_cpu_mem_thresholds_profile_binding_maps, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling CpuMemoryThresholdsProfilesApi.global_infra_list_policy_firewall_cpu_mem_thresholds_profile_binding_maps, must be greater than or equal to 0.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CpuMemoryThresholdsProfilesApi#global_infra_list_policy_firewall_cpu_mem_thresholds_profile_binding_maps\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def global_infra_patch_cpu_mem_thresholds_profile_with_http_info(profile_id, policy_firewall_cpu_mem_thresholds_profile, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CpuMemoryThresholdsProfilesApi.global_infra_patch_cpu_mem_thresholds_profile ...'
      end
      # verify the required parameter 'profile_id' is set
      if @api_client.config.client_side_validation && profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'profile_id' when calling CpuMemoryThresholdsProfilesApi.global_infra_patch_cpu_mem_thresholds_profile"
      end
      ...
      if @api_client.config.client_side_validation && policy_firewall_cpu_mem_thresholds_profile.nil?
        fail ArgumentError, "Missing the required parameter 'policy_firewall_cpu_mem_thresholds_profile' when calling CpuMemoryThresholdsProfilesApi.global_infra_patch_cpu_mem_thresholds_profile"
      end
      # resource path
      local_var_path = '/global-infra/settings/firewall/cpu-mem-thresholds-profiles/{profile-id}'.sub('{' + 'profile-id' + '}', profile_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CpuMemoryThresholdsProfilesApi#global_infra_patch_cpu_mem_thresholds_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def global_infra_read_cpu_mem_thresholds_profile_with_http_info(profile_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CpuMemoryThresholdsProfilesApi.global_infra_read_cpu_mem_thresholds_profile ...'
      end
      # verify the required parameter 'profile_id' is set
      if @api_client.config.client_side_validation && profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'profile_id' when calling CpuMemoryThresholdsProfilesApi.global_infra_read_cpu_mem_thresholds_profile"
      end
      # resource path
      local_var_path = '/global-infra/settings/firewall/cpu-mem-thresholds-profiles/{profile-id}'.sub('{' + 'profile-id' + '}', profile_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CpuMemoryThresholdsProfilesApi#global_infra_read_cpu_mem_thresholds_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create or update CPU and memory thresholds profile
    ...
    def global_infra_update_cpu_mem_thresholds_profile_with_http_info(profile_id, policy_firewall_cpu_mem_thresholds_profile, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CpuMemoryThresholdsProfilesApi.global_infra_update_cpu_mem_thresholds_profile ...'
      end
      # verify the required parameter 'profile_id' is set
      if @api_client.config.client_side_validation && profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'profile_id' when calling CpuMemoryThresholdsProfilesApi.global_infra_update_cpu_mem_thresholds_profile"
      end
      # verify the required parameter 'policy_firewall_cpu_mem_thresholds_profile' is set
      if @api_client.config.client_side_validation && policy_firewall_cpu_mem_thresholds_profile.nil?
        fail ArgumentError, "Missing the required parameter 'policy_firewall_cpu_mem_thresholds_profile' when calling CpuMemoryThresholdsProfilesApi.global_infra_update_cpu_mem_thresholds_profile"
      end
      # resource path
      local_var_path = '/global-infra/settings/firewall/cpu-mem-thresholds-profiles/{profile-id}'.sub('{' + 'profile-id' + '}', profile_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'PolicyFirewallCpuMemThresholdsProfile')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CpuMemoryThresholdsProfilesApi#global_infra_update_cpu_mem_thresholds_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # List all CPU and memory thresholds profiles
    ...
    def list_cpu_mem_thresholds_profiles_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CpuMemoryThresholdsProfilesApi.list_cpu_mem_thresholds_profiles ...'
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling CpuMemoryThresholdsProfilesApi.list_cpu_mem_thresholds_profiles, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling CpuMemoryThresholdsProfilesApi.list_cpu_mem_thresholds_profiles, must be greater than or equal to 0.'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'PolicyFirewallCpuMemThresholdsProfileListResult')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CpuMemoryThresholdsProfilesApi#list_cpu_mem_thresholds_profiles\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # List Firewall CPU Memory Thresholds Profile Binding Maps
    ...
    def list_policy_firewall_cpu_mem_thresholds_profile_binding_maps_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CpuMemoryThresholdsProfilesApi.list_policy_firewall_cpu_mem_thresholds_profile_binding_maps ...'
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling CpuMemoryThresholdsProfilesApi.list_policy_firewall_cpu_mem_thresholds_profile_binding_maps, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling CpuMemoryThresholdsProfilesApi.list_policy_firewall_cpu_mem_thresholds_profile_binding_maps, must be greater than or equal to 0.'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'PolicyFirewallCPUMemThresholdsProfileBindingMapListResult')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CpuMemoryThresholdsProfilesApi#list_policy_firewall_cpu_mem_thresholds_profile_binding_maps\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create or update CPU and memory thresholds profile
    ...
    def patch_cpu_mem_thresholds_profile_with_http_info(profile_id, policy_firewall_cpu_mem_thresholds_profile, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CpuMemoryThresholdsProfilesApi.patch_cpu_mem_thresholds_profile ...'
      end
      # verify the required parameter 'profile_id' is set
      if @api_client.config.client_side_validation && profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'profile_id' when calling CpuMemoryThresholdsProfilesApi.patch_cpu_mem_thresholds_profile"
      end
      # verify the required parameter 'policy_firewall_cpu_mem_thresholds_profile' is set
      if @api_client.config.client_side_validation && policy_firewall_cpu_mem_thresholds_profile.nil?
        fail ArgumentError, "Missing the required parameter 'policy_firewall_cpu_mem_thresholds_profile' when calling CpuMemoryThresholdsProfilesApi.patch_cpu_mem_thresholds_profile"
      end
      # resource path
      local_var_path = '/infra/settings/firewall/cpu-mem-thresholds-profiles/{profile-id}'.sub('{' + 'profile-id' + '}', profile_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CpuMemoryThresholdsProfilesApi#patch_cpu_mem_thresholds_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def patch_policy_firewall_cpu_mem_thresholds_profile_binding_map_with_http_info(cpu_mem_thresholds_profile_binding_map_id, policy_firewall_cpu_mem_thresholds_profile_binding_map, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CpuMemoryThresholdsProfilesApi.patch_policy_firewall_cpu_mem_thresholds_profile_binding_map ...'
      end
      # verify the required parameter 'cpu_mem_thresholds_profile_binding_map_id' is set
      if @api_client.config.client_side_validation && cpu_mem_thresholds_profile_binding_map_id.nil?
        fail ArgumentError, "Missing the required parameter 'cpu_mem_thresholds_profile_binding_map_id' when calling CpuMemoryThresholdsProfilesApi.patch_policy_firewall_cpu_mem_thresholds_profile_binding_map"
      end
      ...
      if @api_client.config.client_side_validation && policy_firewall_cpu_mem_thresholds_profile_binding_map.nil?
        fail ArgumentError, "Missing the required parameter 'policy_firewall_cpu_mem_thresholds_profile_binding_map' when calling CpuMemoryThresholdsProfilesApi.patch_policy_firewall_cpu_mem_thresholds_profile_binding_map"
      end
      # resource path
      local_var_path = '/infra/settings/firewall/cpu-mem-thresholds-profile-binding-maps/{cpu-mem-thresholds-profile-binding-map-id}'.sub('{' + 'cpu-mem-thresholds-profile-binding-map-id' + '}', cpu_mem_thresholds_profile_binding_map_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CpuMemoryThresholdsProfilesApi#patch_policy_firewall_cpu_mem_thresholds_profile_binding_map\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Read the CPU and memory thresholds profile
    ...
    def read_cpu_mem_thresholds_profile_with_http_info(profile_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CpuMemoryThresholdsProfilesApi.read_cpu_mem_thresholds_profile ...'
      end
      # verify the required parameter 'profile_id' is set
      if @api_client.config.client_side_validation && profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'profile_id' when calling CpuMemoryThresholdsProfilesApi.read_cpu_mem_thresholds_profile"
      end
      # resource path
      local_var_path = '/infra/settings/firewall/cpu-mem-thresholds-profiles/{profile-id}'.sub('{' + 'profile-id' + '}', profile_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'PolicyFirewallCpuMemThresholdsProfile')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CpuMemoryThresholdsProfilesApi#read_cpu_mem_thresholds_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create or update CPU and memory thresholds profile
    ...
    def update_cpu_mem_thresholds_profile_with_http_info(profile_id, policy_firewall_cpu_mem_thresholds_profile, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CpuMemoryThresholdsProfilesApi.update_cpu_mem_thresholds_profile ...'
      end
      # verify the required parameter 'profile_id' is set
      if @api_client.config.client_side_validation && profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'profile_id' when calling CpuMemoryThresholdsProfilesApi.update_cpu_mem_thresholds_profile"
      end
      # verify the required parameter 'policy_firewall_cpu_mem_thresholds_profile' is set
      if @api_client.config.client_side_validation && policy_firewall_cpu_mem_thresholds_profile.nil?
        fail ArgumentError, "Missing the required parameter 'policy_firewall_cpu_mem_thresholds_profile' when calling CpuMemoryThresholdsProfilesApi.update_cpu_mem_thresholds_profile"
      end
      # resource path
      local_var_path = '/infra/settings/firewall/cpu-mem-thresholds-profiles/{profile-id}'.sub('{' + 'profile-id' + '}', profile_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'PolicyFirewallCpuMemThresholdsProfile')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CpuMemoryThresholdsProfilesApi#update_cpu_mem_thresholds_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_policy_firewall_cpu_mem_thresholds_profile_binding_map_with_http_info(cpu_mem_thresholds_profile_binding_map_id, policy_firewall_cpu_mem_thresholds_profile_binding_map, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CpuMemoryThresholdsProfilesApi.update_policy_firewall_cpu_mem_thresholds_profile_binding_map ...'
      end
      # verify the required parameter 'cpu_mem_thresholds_profile_binding_map_id' is set
      if @api_client.config.client_side_validation && cpu_mem_thresholds_profile_binding_map_id.nil?
        fail ArgumentError, "Missing the required parameter 'cpu_mem_thresholds_profile_binding_map_id' when calling CpuMemoryThresholdsProfilesApi.update_policy_firewall_cpu_mem_thresholds_profile_binding_map"
      end
      # verify the required parameter 'policy_firewall_cpu_mem_thresholds_profile_binding_map' is set
      if @api_client.config.client_side_validation && policy_firewall_cpu_mem_thresholds_profile_binding_map.nil?
        fail ArgumentError, "Missing the required parameter 'policy_firewall_cpu_mem_thresholds_profile_binding_map' when calling CpuMemoryThresholdsProfilesApi.update_policy_firewall_cpu_mem_thresholds_profile_binding_map"
      end
      # resource path
      local_var_path = '/infra/settings/firewall/cpu-mem-thresholds-profile-binding-maps/{cpu-mem-thresholds-profile-binding-map-id}'.sub('{' + 'cpu-mem-thresholds-profile-binding-map-id' + '}', cpu_mem_thresholds_profile_binding_map_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'PolicyFirewallCPUMemThresholdsProfileBindingMap')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CpuMemoryThresholdsProfilesApi#update_policy_firewall_cpu_mem_thresholds_profile_binding_map\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
