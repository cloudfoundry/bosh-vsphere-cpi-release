  ...
  class AlbAuthTokenApi
    ...
    def get_alb_auth_token_with_http_info(alb_auth_token, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AlbAuthTokenApi.get_alb_auth_token ...'
      end
      # verify the required parameter 'alb_auth_token' is set
      if @api_client.config.client_side_validation && alb_auth_token.nil?
        fail ArgumentError, "Missing the required parameter 'alb_auth_token' when calling AlbAuthTokenApi.get_alb_auth_token"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AlbAuthTokenApi#get_alb_auth_token\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
