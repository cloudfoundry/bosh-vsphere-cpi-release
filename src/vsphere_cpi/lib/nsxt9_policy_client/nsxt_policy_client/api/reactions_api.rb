  ...
  class ReactionsApi
    ...
    def create_or_patch_infra_reaction_with_http_info(reaction_id, reaction, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ReactionsApi.create_or_patch_infra_reaction ...'
      end
      # verify the required parameter 'reaction_id' is set
      if @api_client.config.client_side_validation && reaction_id.nil?
        fail ArgumentError, "Missing the required parameter 'reaction_id' when calling ReactionsApi.create_or_patch_infra_reaction"
      end
      # verify the required parameter 'reaction' is set
      if @api_client.config.client_side_validation && reaction.nil?
        fail ArgumentError, "Missing the required parameter 'reaction' when calling ReactionsApi.create_or_patch_infra_reaction"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ReactionsApi#create_or_patch_infra_reaction\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def create_or_update_infra_reaction_with_http_info(reaction_id, reaction, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ReactionsApi.create_or_update_infra_reaction ...'
      end
      # verify the required parameter 'reaction_id' is set
      if @api_client.config.client_side_validation && reaction_id.nil?
        fail ArgumentError, "Missing the required parameter 'reaction_id' when calling ReactionsApi.create_or_update_infra_reaction"
      end
      # verify the required parameter 'reaction' is set
      if @api_client.config.client_side_validation && reaction.nil?
        fail ArgumentError, "Missing the required parameter 'reaction' when calling ReactionsApi.create_or_update_infra_reaction"
      end
      # resource path
      local_var_path = '/infra/reactions/{reaction-id}'.sub('{' + 'reaction-id' + '}', reaction_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ReactionsApi#create_or_update_infra_reaction\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Delete Reaction
    ...
    def delete_infra_reaction_with_http_info(reaction_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ReactionsApi.delete_infra_reaction ...'
      end
      # verify the required parameter 'reaction_id' is set
      if @api_client.config.client_side_validation && reaction_id.nil?
        fail ArgumentError, "Missing the required parameter 'reaction_id' when calling ReactionsApi.delete_infra_reaction"
      end
      # resource path
      local_var_path = '/infra/reactions/{reaction-id}'.sub('{' + 'reaction-id' + '}', reaction_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ReactionsApi#delete_infra_reaction\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Get Reaction
    ...
    def get_infra_reaction_with_http_info(reaction_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ReactionsApi.get_infra_reaction ...'
      end
      # verify the required parameter 'reaction_id' is set
      if @api_client.config.client_side_validation && reaction_id.nil?
        fail ArgumentError, "Missing the required parameter 'reaction_id' when calling ReactionsApi.get_infra_reaction"
      end
      # resource path
      local_var_path = '/infra/reactions/{reaction-id}'.sub('{' + 'reaction-id' + '}', reaction_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Reaction')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ReactionsApi#get_infra_reaction\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_infra_reactions_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ReactionsApi.list_infra_reactions ...'
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ReactionsApi.list_infra_reactions, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ReactionsApi.list_infra_reactions, must be greater than or equal to 0.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ReactionsApi#list_infra_reactions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
