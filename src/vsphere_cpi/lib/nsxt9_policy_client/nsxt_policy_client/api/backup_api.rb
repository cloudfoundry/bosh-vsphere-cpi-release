  ...
  class BackupApi
    ...
    def configure_backup_config_with_http_info(backup_configuration, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BackupApi.configure_backup_config ...'
      end
      ...
      if @api_client.config.client_side_validation && backup_configuration.nil?
        fail ArgumentError, "Missing the required parameter 'backup_configuration' when calling BackupApi.configure_backup_config"
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BackupApi#configure_backup_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_backup_config_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BackupApi.get_backup_config ...'
      end
      # resource path
      local_var_path = '/cluster/backups/config'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'BackupConfiguration')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BackupApi#get_backup_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Get backup history
    ...
    def get_backup_history_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BackupApi.get_backup_history ...'
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BackupApi#get_backup_history\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_backup_overview_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BackupApi.get_backup_overview ...'
      end
      if @api_client.config.client_side_validation && opts[:'frame_type'] && !['GLOBAL_MANAGER', 'LOCAL_MANAGER', 'LOCAL_LOCAL_MANAGER', 'NSX_INTELLIGENCE'].include?(opts[:'frame_type'])
        fail ArgumentError, 'invalid value for "frame_type", must be one of GLOBAL_MANAGER, LOCAL_MANAGER, LOCAL_LOCAL_MANAGER, NSX_INTELLIGENCE'
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling BackupApi.get_backup_overview, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling BackupApi.get_backup_overview, must be greater than or equal to 0.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BackupApi#get_backup_overview\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Get backup status
    ...
    def get_backup_status_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BackupApi.get_backup_status ...'
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BackupApi#get_backup_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_ssh_fingerprint_of_server_with_http_info(remote_server_fingerprint_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BackupApi.get_ssh_fingerprint_of_server ...'
      end
      ...
      if @api_client.config.client_side_validation && remote_server_fingerprint_request.nil?
        fail ArgumentError, "Missing the required parameter 'remote_server_fingerprint_request' when calling BackupApi.get_ssh_fingerprint_of_server"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BackupApi#get_ssh_fingerprint_of_server\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def request_onetime_backup_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BackupApi.request_onetime_backup ...'
      end
      if @api_client.config.client_side_validation && opts[:'frame_type'] && !['GLOBAL_MANAGER', 'LOCAL_MANAGER', 'LOCAL_LOCAL_MANAGER', 'NSX_INTELLIGENCE'].include?(opts[:'frame_type'])
        fail ArgumentError, 'invalid value for "frame_type", must be one of GLOBAL_MANAGER, LOCAL_MANAGER, LOCAL_LOCAL_MANAGER, NSX_INTELLIGENCE'
      end
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BackupApi#request_onetime_backup\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def request_onetime_inventory_summary_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BackupApi.request_onetime_inventory_summary ...'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BackupApi#request_onetime_inventory_summary\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
