  ...
  class GlobalManagersApi
    ...
    def global_infra_list_infra_global_managers_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GlobalManagersApi.global_infra_list_infra_global_managers ...'
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling GlobalManagersApi.global_infra_list_infra_global_managers, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling GlobalManagersApi.global_infra_list_infra_global_managers, must be greater than or equal to 0.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobalManagersApi#global_infra_list_infra_global_managers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def global_infra_read_infra_global_manager_with_http_info(global_manager_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GlobalManagersApi.global_infra_read_infra_global_manager ...'
      end
      # verify the required parameter 'global_manager_id' is set
      if @api_client.config.client_side_validation && global_manager_id.nil?
        fail ArgumentError, "Missing the required parameter 'global_manager_id' when calling GlobalManagersApi.global_infra_read_infra_global_manager"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobalManagersApi#global_infra_read_infra_global_manager\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
