  ...
  class APIServicesApi
    ...
    def get_api_service_config_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIServicesApi.get_api_service_config ...'
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIServicesApi#get_api_service_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def update_api_service_config_with_http_info(api_service_config, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIServicesApi.update_api_service_config ...'
      end
      ...
      if @api_client.config.client_side_validation && api_service_config.nil?
        fail ArgumentError, "Missing the required parameter 'api_service_config' when calling APIServicesApi.update_api_service_config"
      end
      # resource path
      local_var_path = '/cluster/api-service'
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ApiServiceConfig')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIServicesApi#update_api_service_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
