...
module Nsxt9PolicyClient
  class BaremetalServersInterfacesApi
    ...
    def apply_tag_on_bare_metal_server_interface_with_http_info(bare_metal_server_interface_tag_list, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BaremetalServersInterfacesApi.apply_tag_on_bare_metal_server_interface ...'
      end
      ...
      if @api_client.config.client_side_validation && bare_metal_server_interface_tag_list.nil?
        fail ArgumentError, "Missing the required parameter 'bare_metal_server_interface_tag_list' when calling BaremetalServersInterfacesApi.apply_tag_on_bare_metal_server_interface"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BaremetalServersInterfacesApi#apply_tag_on_bare_metal_server_interface\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def orgs_org_id_projects_project_id_infra_apply_tag_on_bare_metal_server_interface_with_http_info(org_id, project_id, bare_metal_server_interface_tag_list, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BaremetalServersInterfacesApi.orgs_org_id_projects_project_id_infra_apply_tag_on_bare_metal_server_interface ...'
      end
      # verify the required parameter 'org_id' is set
      if @api_client.config.client_side_validation && org_id.nil?
        fail ArgumentError, "Missing the required parameter 'org_id' when calling BaremetalServersInterfacesApi.orgs_org_id_projects_project_id_infra_apply_tag_on_bare_metal_server_interface"
      end
      # verify the required parameter 'project_id' is set
      if @api_client.config.client_side_validation && project_id.nil?
        fail ArgumentError, "Missing the required parameter 'project_id' when calling BaremetalServersInterfacesApi.orgs_org_id_projects_project_id_infra_apply_tag_on_bare_metal_server_interface"
      end
      # verify the required parameter 'bare_metal_server_interface_tag_list' is set
      if @api_client.config.client_side_validation && bare_metal_server_interface_tag_list.nil?
        fail ArgumentError, "Missing the required parameter 'bare_metal_server_interface_tag_list' when calling BaremetalServersInterfacesApi.orgs_org_id_projects_project_id_infra_apply_tag_on_bare_metal_server_interface"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'BareMetalServerInterfaceTagList')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BaremetalServersInterfacesApi#orgs_org_id_projects_project_id_infra_apply_tag_on_bare_metal_server_interface\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
