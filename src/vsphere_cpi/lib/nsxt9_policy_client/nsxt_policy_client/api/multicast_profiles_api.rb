  ...
  class MulticastProfilesApi
    ...
    def create_or_update_policy_igmp_profile_with_http_info(igmp_profile_id, policy_igmp_profile, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MulticastProfilesApi.create_or_update_policy_igmp_profile ...'
      end
      # verify the required parameter 'igmp_profile_id' is set
      if @api_client.config.client_side_validation && igmp_profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'igmp_profile_id' when calling MulticastProfilesApi.create_or_update_policy_igmp_profile"
      end
      ...
      if @api_client.config.client_side_validation && policy_igmp_profile.nil?
        fail ArgumentError, "Missing the required parameter 'policy_igmp_profile' when calling MulticastProfilesApi.create_or_update_policy_igmp_profile"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MulticastProfilesApi#create_or_update_policy_igmp_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def create_or_update_policy_pim_profile_with_http_info(pim_profile_id, policy_pim_profile, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MulticastProfilesApi.create_or_update_policy_pim_profile ...'
      end
      # verify the required parameter 'pim_profile_id' is set
      if @api_client.config.client_side_validation && pim_profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'pim_profile_id' when calling MulticastProfilesApi.create_or_update_policy_pim_profile"
      end
      ...
      if @api_client.config.client_side_validation && policy_pim_profile.nil?
        fail ArgumentError, "Missing the required parameter 'policy_pim_profile' when calling MulticastProfilesApi.create_or_update_policy_pim_profile"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MulticastProfilesApi#create_or_update_policy_pim_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Delete Igmp Profile
    ...
    def delete_policy_igmp_profile_with_http_info(igmp_profile_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MulticastProfilesApi.delete_policy_igmp_profile ...'
      end
      # verify the required parameter 'igmp_profile_id' is set
      if @api_client.config.client_side_validation && igmp_profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'igmp_profile_id' when calling MulticastProfilesApi.delete_policy_igmp_profile"
      end
      # resource path
      local_var_path = '/infra/igmp-profiles/{igmp-profile-id}'.sub('{' + 'igmp-profile-id' + '}', igmp_profile_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MulticastProfilesApi#delete_policy_igmp_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Delete Pim Profile
    ...
    def delete_policy_pim_profile_with_http_info(pim_profile_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MulticastProfilesApi.delete_policy_pim_profile ...'
      end
      # verify the required parameter 'pim_profile_id' is set
      if @api_client.config.client_side_validation && pim_profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'pim_profile_id' when calling MulticastProfilesApi.delete_policy_pim_profile"
      end
      # resource path
      local_var_path = '/infra/pim-profiles/{pim-profile-id}'.sub('{' + 'pim-profile-id' + '}', pim_profile_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MulticastProfilesApi#delete_policy_pim_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # List Igmp Profile
    ...
    def list_policy_igmp_profile_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MulticastProfilesApi.list_policy_igmp_profile ...'
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling MulticastProfilesApi.list_policy_igmp_profile, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling MulticastProfilesApi.list_policy_igmp_profile, must be greater than or equal to 0.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MulticastProfilesApi#list_policy_igmp_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # List Pim Profile
    ...
    def list_policy_pim_profile_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MulticastProfilesApi.list_policy_pim_profile ...'
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling MulticastProfilesApi.list_policy_pim_profile, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling MulticastProfilesApi.list_policy_pim_profile, must be greater than or equal to 0.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MulticastProfilesApi#list_policy_pim_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update igmp profile
    ...
    def patch_policy_igmp_profile_with_http_info(igmp_profile_id, policy_igmp_profile, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MulticastProfilesApi.patch_policy_igmp_profile ...'
      end
      # verify the required parameter 'igmp_profile_id' is set
      if @api_client.config.client_side_validation && igmp_profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'igmp_profile_id' when calling MulticastProfilesApi.patch_policy_igmp_profile"
      end
      # verify the required parameter 'policy_igmp_profile' is set
      if @api_client.config.client_side_validation && policy_igmp_profile.nil?
        fail ArgumentError, "Missing the required parameter 'policy_igmp_profile' when calling MulticastProfilesApi.patch_policy_igmp_profile"
      end
      # resource path
      local_var_path = '/infra/igmp-profiles/{igmp-profile-id}'.sub('{' + 'igmp-profile-id' + '}', igmp_profile_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MulticastProfilesApi#patch_policy_igmp_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update pim profile
    ...
    def patch_policy_pim_profile_with_http_info(pim_profile_id, policy_pim_profile, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MulticastProfilesApi.patch_policy_pim_profile ...'
      end
      # verify the required parameter 'pim_profile_id' is set
      if @api_client.config.client_side_validation && pim_profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'pim_profile_id' when calling MulticastProfilesApi.patch_policy_pim_profile"
      end
      # verify the required parameter 'policy_pim_profile' is set
      if @api_client.config.client_side_validation && policy_pim_profile.nil?
        fail ArgumentError, "Missing the required parameter 'policy_pim_profile' when calling MulticastProfilesApi.patch_policy_pim_profile"
      end
      # resource path
      local_var_path = '/infra/pim-profiles/{pim-profile-id}'.sub('{' + 'pim-profile-id' + '}', pim_profile_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MulticastProfilesApi#patch_policy_pim_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Read Igmp Profile
    ...
    def read_policy_igmp_profile_with_http_info(igmp_profile_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MulticastProfilesApi.read_policy_igmp_profile ...'
      end
      # verify the required parameter 'igmp_profile_id' is set
      if @api_client.config.client_side_validation && igmp_profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'igmp_profile_id' when calling MulticastProfilesApi.read_policy_igmp_profile"
      end
      # resource path
      local_var_path = '/infra/igmp-profiles/{igmp-profile-id}'.sub('{' + 'igmp-profile-id' + '}', igmp_profile_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'PolicyIgmpProfile')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MulticastProfilesApi#read_policy_igmp_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Read Pim Profile
    ...
    def read_policy_pim_profile_with_http_info(pim_profile_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MulticastProfilesApi.read_policy_pim_profile ...'
      end
      # verify the required parameter 'pim_profile_id' is set
      if @api_client.config.client_side_validation && pim_profile_id.nil?
        fail ArgumentError, "Missing the required parameter 'pim_profile_id' when calling MulticastProfilesApi.read_policy_pim_profile"
      end
      # resource path
      local_var_path = '/infra/pim-profiles/{pim-profile-id}'.sub('{' + 'pim-profile-id' + '}', pim_profile_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'PolicyPimProfile')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MulticastProfilesApi#read_policy_pim_profile\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
