  ...
  module Resources
    class Datacenter
      ...
      def initialize(attrs)
        ...
        @ephemeral_datastore_cluster_pattern = attrs.fetch(:ephemeral_datastore_cluster_pattern)
        @persistent_pattern = attrs.fetch(:persistent_pattern)
        @persistent_datastore_cluster_pattern = attrs.fetch(:persistent_datastore_cluster_pattern)
        @clusters = attrs.fetch(:clusters)
        @cluster_provider = attrs.fetch(:cluster_provider)
      end

      attr_reader :name, :disk_path, :ephemeral_pattern, :ephemeral_datastore_cluster_pattern, :persistent_pattern, :persistent_datastore_cluster_pattern, :client
