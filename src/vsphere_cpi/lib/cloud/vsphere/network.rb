...
module VSphereCloud
  class Network
    ...
    def self.build(nsxt_provider, switch_provider, router_provider, network_definition)
      new(nsxt_provider, switch_provider, router_provider, network_definition).tap(&:validate)
    end

    def initialize(nsxt_provider, switch_provider, router_provider, network_definition)
