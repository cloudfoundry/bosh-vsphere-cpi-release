...
module VSphereCloud
  class Network
    def self.build(nsxt_provider, network_definition, logger)
      new(nsxt_provider, network_definition, logger).tap(&:validate)
    end

    def initialize(nsxt_provider, network_definition, logger)
