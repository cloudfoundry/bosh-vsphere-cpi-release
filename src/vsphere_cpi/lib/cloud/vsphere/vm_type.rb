...
module VSphereCloud
  class VmType
    ...
    %w[cpu ram disk cpu_hot_add_enabled memory_hot_add_enabled nsx vmx_options nsxt nested_hardware_virtualization upgrade_hw_version datacenters gpu ].each do |name|
