...
module NSXT
  class ManagementPlaneApiAssociationsApi
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(AssociationListResult, Integer, Hash)>] AssociationListResult data, response status code and response headers
    def get_associations_with_http_info(associated_resource_type, resource_id, resource_type, opts = {})
      ...
      return_type = opts[:return_type] || 'AssociationListResult' 
