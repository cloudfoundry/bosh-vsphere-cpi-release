...
module NSXT
  class ManagementPlaneApiVpnIpsecIkeProfilesApi
    ...
    def create_ip_sec_vpnike_profile(body, opts = {})
      data, _status_code, _headers = create_ip_sec_vpnike_profile_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IPSecVPNIKEProfile, Integer, Hash)>] IPSecVPNIKEProfile data, response status code and response headers
    def create_ip_sec_vpnike_profile_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiVpnIpsecIkeProfilesApi.create_ip_sec_vpnike_profile"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'IPSecVPNIKEProfile' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(IPSecVPNIKEProfileListResult, Integer, Hash)>] IPSecVPNIKEProfileListResult data, response status code and response headers
    def list_ip_sec_vpnike_profiles_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'IPSecVPNIKEProfileListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [IPSecVPNIKEProfile]
    def update_ip_sec_vpnike_profile(body, ipsec_vpn_ike_profile_id, opts = {})
      data, _status_code, _headers = update_ip_sec_vpnike_profile_with_http_info(body, ipsec_vpn_ike_profile_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(IPSecVPNIKEProfile, Integer, Hash)>] IPSecVPNIKEProfile data, response status code and response headers
    def update_ip_sec_vpnike_profile_with_http_info(body, ipsec_vpn_ike_profile_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiVpnIpsecIkeProfilesApi.update_ip_sec_vpnike_profile ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiVpnIpsecIkeProfilesApi.update_ip_sec_vpnike_profile"
      end
      # verify the required parameter 'ipsec_vpn_ike_profile_id' is set
      if @api_client.config.client_side_validation && ipsec_vpn_ike_profile_id.nil?
