...
module NSXT
  class ManagementPlaneApiLogicalRoutingAndServicesBfdPeersApi
    ...
    def create_static_hop_bfd_peer(body, logical_router_id, opts = {})
      data, _status_code, _headers = create_static_hop_bfd_peer_with_http_info(body, logical_router_id, opts)
      data
    end
    ...
    # @param logical_router_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(StaticHopBfdPeer, Integer, Hash)>] StaticHopBfdPeer data, response status code and response headers
    def create_static_hop_bfd_peer_with_http_info(body, logical_router_id, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiLogicalRoutingAndServicesBfdPeersApi.create_static_hop_bfd_peer"
      end
      ...
      return_type = opts[:return_type] || 'StaticHopBfdPeer' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(StaticHopBfdPeerListResult, Integer, Hash)>] StaticHopBfdPeerListResult data, response status code and response headers
    def list_static_hop_bfd_peers_with_http_info(logical_router_id, opts = {})
      ...
      return_type = opts[:return_type] || 'StaticHopBfdPeerListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [StaticHopBfdPeer]
    def update_static_hop_bfd_peer(body, logical_router_id, bfd_peer_id, opts = {})
      data, _status_code, _headers = update_static_hop_bfd_peer_with_http_info(body, logical_router_id, bfd_peer_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(StaticHopBfdPeer, Integer, Hash)>] StaticHopBfdPeer data, response status code and response headers
    def update_static_hop_bfd_peer_with_http_info(body, logical_router_id, bfd_peer_id, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiLogicalRoutingAndServicesBfdPeersApi.update_static_hop_bfd_peer"
      end
      # verify the required parameter 'logical_router_id' is set
      if @api_client.config.client_side_validation && logical_router_id.nil?
