...
module NSXT
  class ManagementPlaneApiLogicalRoutingAndServicesRoutingBfdConfigurationApi
    ...
    # @param logical_router_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(BfdConfig, Integer, Hash)>] BfdConfig data, response status code and response headers
    def read_routing_bfd_config_with_http_info(logical_router_id, opts = {})
      ...
      return_type = opts[:return_type] || 'BfdConfig' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [BfdConfig]
    def update_routing_bfd_config(body, logical_router_id, opts = {})
      data, _status_code, _headers = update_routing_bfd_config_with_http_info(body, logical_router_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(BfdConfig, Integer, Hash)>] BfdConfig data, response status code and response headers
    def update_routing_bfd_config_with_http_info(body, logical_router_id, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiLogicalRoutingAndServicesRoutingBfdConfigurationApi.update_routing_bfd_config"
      end
      # verify the required parameter 'logical_router_id' is set
      if @api_client.config.client_side_validation && logical_router_id.nil?
