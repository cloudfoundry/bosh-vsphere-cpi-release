...
module NSXT
  class ManagementPlaneApiNormalizationApi
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(NormalizedResourceListResult, Integer, Hash)>] NormalizedResourceListResult data, response status code and response headers
    def get_normalizations_with_http_info(preferred_normalization_type, resource_id, resource_type, opts = {})
      ...
      return_type = opts[:return_type] || 'NormalizedResourceListResult' 
