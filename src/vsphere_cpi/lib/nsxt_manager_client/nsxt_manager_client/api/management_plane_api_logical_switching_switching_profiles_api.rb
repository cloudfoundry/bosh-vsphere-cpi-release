...
module NSXT
  class ManagementPlaneApiLogicalSwitchingSwitchingProfilesApi
    ...
    def create_switching_profile(body, opts = {})
      data, _status_code, _headers = create_switching_profile_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(BaseSwitchingProfile, Integer, Hash)>] BaseSwitchingProfile data, response status code and response headers
    def create_switching_profile_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiLogicalSwitchingSwitchingProfilesApi.create_switching_profile"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'BaseSwitchingProfile' 
    ...
    # @param switching_profile_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(SwitchingProfileStatus, Integer, Hash)>] SwitchingProfileStatus data, response status code and response headers
    def get_switching_profile_status_with_http_info(switching_profile_id, opts = {})
      ...
      return_type = opts[:return_type] || 'SwitchingProfileStatus' 
    ...
    # @option opts [String] :sort_by Field by which records are sorted
    # @option opts [String] :switching_profile_type comma-separated list of switching profile types, e.g. ?switching_profile_type&#x3D;QosSwitchingProfile,IpDiscoverySwitchingProfile
    # @return [Array<(SwitchingProfilesListResult, Integer, Hash)>] SwitchingProfilesListResult data, response status code and response headers
    def list_switching_profiles_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'SwitchingProfilesListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [BaseSwitchingProfile]
    def update_switching_profile(body, switching_profile_id, opts = {})
      data, _status_code, _headers = update_switching_profile_with_http_info(body, switching_profile_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(BaseSwitchingProfile, Integer, Hash)>] BaseSwitchingProfile data, response status code and response headers
    def update_switching_profile_with_http_info(body, switching_profile_id, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiLogicalSwitchingSwitchingProfilesApi.update_switching_profile"
      end
      # verify the required parameter 'switching_profile_id' is set
      if @api_client.config.client_side_validation && switching_profile_id.nil?
