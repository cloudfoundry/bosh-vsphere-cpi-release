...
module NSXT
  class ManagementPlaneApiNsxComponentAdministrationTrustManagementCertificateApi
    ...
    def add_certificate_import(body, opts = {})
      data, _status_code, _headers = add_certificate_import_with_http_info(body, opts)
      data
    end
    ...
    def add_certificate_import_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiNsxComponentAdministrationTrustManagementCertificateApi.add_certificate_import"
      end
      # resource path
