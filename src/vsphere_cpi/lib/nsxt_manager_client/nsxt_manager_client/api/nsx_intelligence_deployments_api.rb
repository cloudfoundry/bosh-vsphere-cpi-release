...
module NSXT
  class NsxIntelligenceDeploymentsApi
    ...
    def add_pace_cluster_node_vm(body, opts = {})
      data, _status_code, _headers = add_pace_cluster_node_vm_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IntelligenceClusterNodeVMDeploymentRequestList, Integer, Hash)>] IntelligenceClusterNodeVMDeploymentRequestList data, response status code and response headers
    def add_pace_cluster_node_vm_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling NsxIntelligenceDeploymentsApi.add_pace_cluster_node_vm"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'IntelligenceClusterNodeVMDeploymentRequestList' 
    ...
    # @param node_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IntelligenceClusterNodeVMDeploymentRequest, Integer, Hash)>] IntelligenceClusterNodeVMDeploymentRequest data, response status code and response headers
    def read_pace_cluster_node_vm_deployment_request_with_http_info(node_id, opts = {})
      ...
      return_type = opts[:return_type] || 'IntelligenceClusterNodeVMDeploymentRequest' 
    ...
    # @param node_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IntelligenceClusterNodeVMDeploymentStatusReport, Integer, Hash)>] IntelligenceClusterNodeVMDeploymentStatusReport data, response status code and response headers
    def read_pace_cluster_node_vm_deployment_status_with_http_info(node_id, opts = {})
      ...
      return_type = opts[:return_type] || 'IntelligenceClusterNodeVMDeploymentStatusReport' 
