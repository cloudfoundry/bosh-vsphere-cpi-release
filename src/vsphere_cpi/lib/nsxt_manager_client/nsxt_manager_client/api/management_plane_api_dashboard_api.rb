...
module NSXT
  class ManagementPlaneApiDashboardApi
    ...
    # @return [View]
    def create_view(body, opts = {})
      data, _status_code, _headers = create_view_with_http_info(body, opts)
      data
    end
    ...
    def create_view_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiDashboardApi.create_view ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiDashboardApi.create_view"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'View' 
    ...
    def create_widget_configuration(body, view_id, opts = {})
      data, _status_code, _headers = create_widget_configuration_with_http_info(body, view_id, opts)
      data
    end
    ...
    # @param view_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(WidgetConfiguration, Integer, Hash)>] WidgetConfiguration data, response status code and response headers
    def create_widget_configuration_with_http_info(body, view_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiDashboardApi.create_widget_configuration ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiDashboardApi.create_widget_configuration"
      end
      ...
      return_type = opts[:return_type] || 'WidgetConfiguration' 
    ...
    # @option opts [String] :view_ids Ids of the Views
    # @option opts [String] :widget_id Id of widget configuration
    # @return [Array<(ViewList, Integer, Hash)>] ViewList data, response status code and response headers
    def list_views_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ViewList' 
    ...
    # @option opts [String] :container Id of the container
    # @option opts [String] :widget_ids Ids of the WidgetConfigurations
    # @return [Array<(WidgetConfigurationList, Integer, Hash)>] WidgetConfigurationList data, response status code and response headers
    def list_widget_configurations_with_http_info(view_id, opts = {})
      ...
      return_type = opts[:return_type] || 'WidgetConfigurationList' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [View]
    def update_view(body, view_id, opts = {})
      data, _status_code, _headers = update_view_with_http_info(body, view_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(View, Integer, Hash)>] View data, response status code and response headers
    def update_view_with_http_info(body, view_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiDashboardApi.update_view ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiDashboardApi.update_view"
      end
      # verify the required parameter 'view_id' is set
      if @api_client.config.client_side_validation && view_id.nil?
    ...
    # @param [Hash] opts the optional parameters
    # @return [WidgetConfiguration]
    def update_widget_configuration(body, view_id, widgetconfiguration_id, opts = {})
      data, _status_code, _headers = update_widget_configuration_with_http_info(body, view_id, widgetconfiguration_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(WidgetConfiguration, Integer, Hash)>] WidgetConfiguration data, response status code and response headers
    def update_widget_configuration_with_http_info(body, view_id, widgetconfiguration_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiDashboardApi.update_widget_configuration ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiDashboardApi.update_widget_configuration"
      end
      # verify the required parameter 'view_id' is set
      if @api_client.config.client_side_validation && view_id.nil?
