...
module NSXT
  class ManagementPlaneApiUpgradeStatusApi
    ...
    # Get the functional state of the upgrade coordinator. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(UcFunctionalState, Integer, Hash)>] UcFunctionalState data, response status code and response headers
    def get_uc_functional_state_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'UcFunctionalState' 
    ...
    # Get upgrade-coordinator upgrade status 
    # @param [Hash] opts the optional parameters
    # @return [Array<(UcUpgradeStatus, Integer, Hash)>] UcUpgradeStatus data, response status code and response headers
    def get_uc_upgrade_status_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'UcUpgradeStatus' 
    ...
    # @option opts [BOOLEAN] :show_history Get upgrade activity for a given component
    # @return [Array<(UpgradeStatus, Integer, Hash)>] UpgradeStatus data, response status code and response headers
    def get_upgrade_status_summary_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'UpgradeStatus' 
    ...
    # Get upgrade summary
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpgradeSummary, Integer, Hash)>] UpgradeSummary data, response status code and response headers
    def get_upgrade_summary_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'UpgradeSummary' 
