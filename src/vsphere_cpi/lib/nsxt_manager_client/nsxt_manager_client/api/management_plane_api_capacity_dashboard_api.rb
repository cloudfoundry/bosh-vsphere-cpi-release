...
module NSXT
  class ManagementPlaneApiCapacityDashboardApi
    ...
    # Returns warning threshold(s) set for NSX Objects.
    # @param [Hash] opts the optional parameters
    # @return [Array<(CapacityThresholdList, Integer, Hash)>] CapacityThresholdList data, response status code and response headers
    def get_capacity_thresholds_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'CapacityThresholdList' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(CapacityUsageResponse, Integer, Hash)>] CapacityUsageResponse data, response status code and response headers
    def get_capacity_usage_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'CapacityUsageResponse' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [CapacityThresholdList]
    def update_capacity_thresholds(body, opts = {})
      data, _status_code, _headers = update_capacity_thresholds_with_http_info(body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CapacityThresholdList, Integer, Hash)>] CapacityThresholdList data, response status code and response headers
    def update_capacity_thresholds_with_http_info(body, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiCapacityDashboardApi.update_capacity_thresholds"
      end
      # resource path
      local_var_path = '/capacity/threshold'
