...
module NSXT
  class ManagementPlaneApiVpnIpsecSessionsApi
    ...
    def create_ip_sec_vpn_session(body, opts = {})
      data, _status_code, _headers = create_ip_sec_vpn_session_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IPSecVPNSession, Integer, Hash)>] IPSecVPNSession data, response status code and response headers
    def create_ip_sec_vpn_session_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiVpnIpsecSessionsApi.create_ip_sec_vpn_session"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'IPSecVPNSession' 
    ...
    # @option opts [Integer] :barrier_id 
    # @option opts [String] :request_id Realization request ID
    # @return [Array<(IPSecVPNSessionState, Integer, Hash)>] IPSecVPNSessionState data, response status code and response headers
    def get_ip_sec_vpn_session_state_with_http_info(ipsec_vpn_session_id, opts = {})
      ...
      return_type = opts[:return_type] || 'IPSecVPNSessionState' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(IPSecVPNSessionListResult, Integer, Hash)>] IPSecVPNSessionListResult data, response status code and response headers
    def list_ip_sec_vpn_sessions_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'IPSecVPNSessionListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [IPSecVPNSession]
    def update_ip_sec_vpn_session(body, ipsec_vpn_session_id, opts = {})
      data, _status_code, _headers = update_ip_sec_vpn_session_with_http_info(body, ipsec_vpn_session_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(IPSecVPNSession, Integer, Hash)>] IPSecVPNSession data, response status code and response headers
    def update_ip_sec_vpn_session_with_http_info(body, ipsec_vpn_session_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiVpnIpsecSessionsApi.update_ip_sec_vpn_session ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiVpnIpsecSessionsApi.update_ip_sec_vpn_session"
      end
      # verify the required parameter 'ipsec_vpn_session_id' is set
      if @api_client.config.client_side_validation && ipsec_vpn_session_id.nil?
