...
module NSXT
  class ManagementPlaneApiPoolManagementIpBlocksApi
    ...
    def allocate_or_release_from_ip_block_subnet(body, action, subnet_id, opts = {})
      data, _status_code, _headers = allocate_or_release_from_ip_block_subnet_with_http_info(body, action, subnet_id, opts)
      data
    end
    ...
    # @param subnet_id IP subnet id
    # @param [Hash] opts the optional parameters
    # @return [Array<(AllocationIpAddress, Integer, Hash)>] AllocationIpAddress data, response status code and response headers
    def allocate_or_release_from_ip_block_subnet_with_http_info(body, action, subnet_id, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiPoolManagementIpBlocksApi.allocate_or_release_from_ip_block_subnet"
      end
      ...
      return_type = opts[:return_type] || 'AllocationIpAddress' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [IpBlock]
    def create_ip_block(body, opts = {})
      data, _status_code, _headers = create_ip_block_with_http_info(body, opts)
      data
    end
    ...
    def create_ip_block_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiPoolManagementIpBlocksApi.create_ip_block ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiPoolManagementIpBlocksApi.create_ip_block"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'IpBlock' 
    ...
    def create_ip_block_subnet(body, opts = {})
      data, _status_code, _headers = create_ip_block_subnet_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IpBlockSubnet, Integer, Hash)>] IpBlockSubnet data, response status code and response headers
    def create_ip_block_subnet_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiPoolManagementIpBlocksApi.create_ip_block_subnet ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiPoolManagementIpBlocksApi.create_ip_block_subnet"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'IpBlockSubnet' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(IpBlockSubnetListResult, Integer, Hash)>] IpBlockSubnetListResult data, response status code and response headers
    def list_ip_block_subnets_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'IpBlockSubnetListResult' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(IpBlockListResult, Integer, Hash)>] IpBlockListResult data, response status code and response headers
    def list_ip_blocks_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'IpBlockListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [IpBlock]
    def update_ip_block(body, block_id, opts = {})
      data, _status_code, _headers = update_ip_block_with_http_info(body, block_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(IpBlock, Integer, Hash)>] IpBlock data, response status code and response headers
    def update_ip_block_with_http_info(body, block_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiPoolManagementIpBlocksApi.update_ip_block ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiPoolManagementIpBlocksApi.update_ip_block"
      end
      # verify the required parameter 'block_id' is set
      if @api_client.config.client_side_validation && block_id.nil?
