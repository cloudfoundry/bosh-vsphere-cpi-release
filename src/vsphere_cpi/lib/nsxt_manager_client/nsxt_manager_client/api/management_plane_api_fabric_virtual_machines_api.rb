...
module NSXT
  class ManagementPlaneApiFabricVirtualMachinesApi
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(VmToolsInfoListResult, Integer, Hash)>] VmToolsInfoListResult data, response status code and response headers
    def list_vm_tools_info_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'VmToolsInfoListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_virtual_machine_tags_update_tags(body, opts = {})
      update_virtual_machine_tags_update_tags_with_http_info(body, opts)
      nil
    end
    ...
    def update_virtual_machine_tags_update_tags_with_http_info(body, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiFabricVirtualMachinesApi.update_virtual_machine_tags_update_tags"
      end
      # resource path
