...
module NSXT
  class ManagementPlaneApiTroubleshootingAndMonitoringHealthcheckApi
    ...
    def create_manual_health_check(body, opts = {})
      data, _status_code, _headers = create_manual_health_check_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ManualHealthCheck, Integer, Hash)>] ManualHealthCheck data, response status code and response headers
    def create_manual_health_check_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiTroubleshootingAndMonitoringHealthcheckApi.create_manual_health_check"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'ManualHealthCheck' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(ManualHealthCheckListResult, Integer, Hash)>] ManualHealthCheckListResult data, response status code and response headers
    def list_manual_health_checks_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ManualHealthCheckListResult' 
