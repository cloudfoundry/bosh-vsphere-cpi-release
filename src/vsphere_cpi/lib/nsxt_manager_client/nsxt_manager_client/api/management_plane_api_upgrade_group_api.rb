...
module NSXT
  class ManagementPlaneApiUpgradeGroupApi
    ...
    def add_upgrade_units_to_group_add_upgrade_units(body, group_id, opts = {})
      data, _status_code, _headers = add_upgrade_units_to_group_add_upgrade_units_with_http_info(body, group_id, opts)
      data
    end
    ...
    # @param group_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpgradeUnitList, Integer, Hash)>] UpgradeUnitList data, response status code and response headers
    def add_upgrade_units_to_group_add_upgrade_units_with_http_info(body, group_id, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiUpgradeGroupApi.add_upgrade_units_to_group_add_upgrade_units"
      end
      ...
      return_type = opts[:return_type] || 'UpgradeUnitList' 
    ...
    def create_upgrade_unit_group(body, opts = {})
      data, _status_code, _headers = create_upgrade_unit_group_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpgradeUnitGroup, Integer, Hash)>] UpgradeUnitGroup data, response status code and response headers
    def create_upgrade_unit_group_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiUpgradeGroupApi.create_upgrade_unit_group ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiUpgradeGroupApi.create_upgrade_unit_group"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'UpgradeUnitGroup' 
    ...
    # @return [Array<(UpgradeUnitGroupAggregateInfoListResult, Integer, Hash)>] UpgradeUnitGroupAggregateInfoListResult data, response status code and response headers
    def get_upgrade_unit_group_aggregate_info_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'UpgradeUnitGroupAggregateInfoListResult' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(UpgradeUnitStatusListResult, Integer, Hash)>] UpgradeUnitStatusListResult data, response status code and response headers
    def get_upgrade_unit_group_status_with_http_info(group_id, opts = {})
      ...
      return_type = opts[:return_type] || 'UpgradeUnitStatusListResult' 
    ...
    # @option opts [BOOLEAN] :summary Flag indicating whether to return summary
    # @option opts [BOOLEAN] :sync Synchronize before returning upgrade unit groups
    # @return [Array<(UpgradeUnitGroupListResult, Integer, Hash)>] UpgradeUnitGroupListResult data, response status code and response headers
    def get_upgrade_unit_groups_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'UpgradeUnitGroupListResult' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(UpgradeUnitGroupStatusListResult, Integer, Hash)>] UpgradeUnitGroupStatusListResult data, response status code and response headers
    def get_upgrade_unit_groups_status_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'UpgradeUnitGroupStatusListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def reorder_upgrade_unit_group_reorder(body, group_id, opts = {})
      reorder_upgrade_unit_group_reorder_with_http_info(body, group_id, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def reorder_upgrade_unit_group_reorder_with_http_info(body, group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiUpgradeGroupApi.reorder_upgrade_unit_group_reorder ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiUpgradeGroupApi.reorder_upgrade_unit_group_reorder"
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def reorder_upgrade_unit_reorder(body, group_id, upgrade_unit_id, opts = {})
      reorder_upgrade_unit_reorder_with_http_info(body, group_id, upgrade_unit_id, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def reorder_upgrade_unit_reorder_with_http_info(body, group_id, upgrade_unit_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiUpgradeGroupApi.reorder_upgrade_unit_reorder ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiUpgradeGroupApi.reorder_upgrade_unit_reorder"
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
    ...
    # @param [Hash] opts the optional parameters
    # @return [UpgradeUnitGroup]
    def update_upgrade_unit_group(body, group_id, opts = {})
      data, _status_code, _headers = update_upgrade_unit_group_with_http_info(body, group_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpgradeUnitGroup, Integer, Hash)>] UpgradeUnitGroup data, response status code and response headers
    def update_upgrade_unit_group_with_http_info(body, group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiUpgradeGroupApi.update_upgrade_unit_group ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiUpgradeGroupApi.update_upgrade_unit_group"
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
