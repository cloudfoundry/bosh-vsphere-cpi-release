...
module NSXT
  class ManagementPlaneApiLogicalRoutingAndServicesDhcpRelayProfilesApi
    ...
    def create_dhcp_relay_profile(body, opts = {})
      data, _status_code, _headers = create_dhcp_relay_profile_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(DhcpRelayProfile, Integer, Hash)>] DhcpRelayProfile data, response status code and response headers
    def create_dhcp_relay_profile_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiLogicalRoutingAndServicesDhcpRelayProfilesApi.create_dhcp_relay_profile"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'DhcpRelayProfile' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(DhcpRelayProfileListResult, Integer, Hash)>] DhcpRelayProfileListResult data, response status code and response headers
    def list_dhcp_relay_profiles_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'DhcpRelayProfileListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [DhcpRelayProfile]
    def update_dhcp_relay_profile(body, relay_profile_id, opts = {})
      data, _status_code, _headers = update_dhcp_relay_profile_with_http_info(body, relay_profile_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(DhcpRelayProfile, Integer, Hash)>] DhcpRelayProfile data, response status code and response headers
    def update_dhcp_relay_profile_with_http_info(body, relay_profile_id, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiLogicalRoutingAndServicesDhcpRelayProfilesApi.update_dhcp_relay_profile"
      end
      # verify the required parameter 'relay_profile_id' is set
      if @api_client.config.client_side_validation && relay_profile_id.nil?
