...
module NSXT
  class ManagementPlaneApiFabricNodesApi
    ...
    # @return [Node]
    def add_node(body, opts = {})
      data, _status_code, _headers = add_node_with_http_info(body, opts)
      data
    end
    ...
    def add_node_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiFabricNodesApi.add_node ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiFabricNodesApi.add_node"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'Node' 
    ...
    # Returns names of all supported host OS.
    # @param [Hash] opts the optional parameters
    # @return [Array<(SupportedHostOSListResult, Integer, Hash)>] SupportedHostOSListResult data, response status code and response headers
    def get_supported_host_os_types_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'SupportedHostOSListResult' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(NodeListResult, Integer, Hash)>] NodeListResult data, response status code and response headers
    def list_nodes_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'NodeListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :source Data source type.
    # @return [Array<(NodeStatus, Integer, Hash)>] NodeStatus data, response status code and response headers
    def read_node_status_with_http_info(node_id, opts = {})
      ...
      return_type = opts[:return_type] || 'NodeStatus' 
    ...
    # @param node_ids List of requested Nodes.
    # @param [Hash] opts the optional parameters
    # @return [Array<(NodeStatusListResult, Integer, Hash)>] NodeStatusListResult data, response status code and response headers
    def read_nodes_status_with_http_info(node_ids, opts = {})
      ...
      return_type = opts[:return_type] || 'NodeStatusListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [Node]
    def update_node(body, node_id, opts = {})
      data, _status_code, _headers = update_node_with_http_info(body, node_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Node, Integer, Hash)>] Node data, response status code and response headers
    def update_node_with_http_info(body, node_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiFabricNodesApi.update_node ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiFabricNodesApi.update_node"
      end
      # verify the required parameter 'node_id' is set
      if @api_client.config.client_side_validation && node_id.nil?
