...
module NSXT
  class ManagementPlaneApiUpgradeUpgradeUnitsApi
    ...
    # @param upgrade_unit_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpgradeUnit, Integer, Hash)>] UpgradeUnit data, response status code and response headers
    def get_upgrade_unit_with_http_info(upgrade_unit_id, opts = {})
      ...
      return_type = opts[:return_type] || 'UpgradeUnit' 
    ...
    # @option opts [String] :sort_by Field by which records are sorted
    # @option opts [String] :upgrade_unit_display_name Display name of upgrade unit
    # @return [Array<(UpgradeUnitAggregateInfoListResult, Integer, Hash)>] UpgradeUnitAggregateInfoListResult data, response status code and response headers
    def get_upgrade_unit_aggregate_info_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'UpgradeUnitAggregateInfoListResult' 
    ...
    # @option opts [String] :sort_by Field by which records are sorted
    # @option opts [String] :upgrade_unit_type Upgrade unit type based on which upgrade units to be filtered
    # @return [Array<(UpgradeUnitListResult, Integer, Hash)>] UpgradeUnitListResult data, response status code and response headers
    def get_upgrade_units_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'UpgradeUnitListResult' 
    ...
    # @return [Array<(UpgradeUnitTypeStatsList, Integer, Hash)>] UpgradeUnitTypeStatsList data, response status code and response headers
    def get_upgrade_units_stats_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'UpgradeUnitTypeStatsList' 
