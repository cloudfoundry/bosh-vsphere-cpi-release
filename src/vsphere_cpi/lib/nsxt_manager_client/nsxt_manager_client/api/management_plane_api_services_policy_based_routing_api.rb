...
module NSXT
  class ManagementPlaneApiServicesPolicyBasedRoutingApi
    ...
    # @return [PBRRule]
    def add_pbr_rule_in_section(body, section_id, opts = {})
      data, _status_code, _headers = add_pbr_rule_in_section_with_http_info(body, section_id, opts)
      data
    end
    ...
    # @return [Array<(PBRRule, Integer, Hash)>] PBRRule data, response status code and response headers
    def add_pbr_rule_in_section_with_http_info(body, section_id, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiServicesPolicyBasedRoutingApi.add_pbr_rule_in_section"
      end
      ...
      return_type = opts[:return_type] || 'PBRRule' 
    ...
    # @option opts [String] :operation Operation (default to insert_top)
    # @return [PBRRuleList]
    def add_pbr_rules_in_section_create_multiple(body, section_id, opts = {})
      data, _status_code, _headers = add_pbr_rules_in_section_create_multiple_with_http_info(body, section_id, opts)
      data
    end
    ...
    # @option opts [String] :id Identifier of the anchor rule or section. This is a required field in case operation like &#x27;insert_before&#x27; and &#x27;insert_after&#x27;.
    # @option opts [String] :operation Operation
    # @return [Array<(PBRRuleList, Integer, Hash)>] PBRRuleList data, response status code and response headers
    def add_pbr_rules_in_section_create_multiple_with_http_info(body, section_id, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiServicesPolicyBasedRoutingApi.add_pbr_rules_in_section_create_multiple"
      end
      # verify the required parameter 'section_id' is set
      if @api_client.config.client_side_validation && section_id.nil?
      ...
      return_type = opts[:return_type] || 'PBRRuleList' 
    ...
    # @option opts [String] :operation Operation (default to insert_top)
    # @return [PBRSection]
    def add_pbr_section(body, opts = {})
      data, _status_code, _headers = add_pbr_section_with_http_info(body, opts)
      data
    end
    ...
    # @option opts [String] :id Identifier of the anchor rule or section. This is a required field in case operation like &#x27;insert_before&#x27; and &#x27;insert_after&#x27;.
    # @option opts [String] :operation Operation
    # @return [Array<(PBRSection, Integer, Hash)>] PBRSection data, response status code and response headers
    def add_pbr_section_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiServicesPolicyBasedRoutingApi.add_pbr_section ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiServicesPolicyBasedRoutingApi.add_pbr_section"
      end
      if @api_client.config.client_side_validation && opts[:'operation'] && !['insert_top', 'insert_bottom', 'insert_after', 'insert_before'].include?(opts[:'operation'])
        fail ArgumentError, 'invalid value for "operation", must be one of insert_top, insert_bottom, insert_after, insert_before'
      end
      ...
      return_type = opts[:return_type] || 'PBRSection' 
    ...
    def add_pbr_section_with_rules_create_with_rules(body, opts = {})
      data, _status_code, _headers = add_pbr_section_with_rules_create_with_rules_with_http_info(body, opts)
      data
    end
    ...
    # @option opts [String] :id Identifier of the anchor rule or section. This is a required field in case operation like &#x27;insert_before&#x27; and &#x27;insert_after&#x27;.
    # @option opts [String] :operation Operation
    # @return [Array<(PBRSectionRuleList, Integer, Hash)>] PBRSectionRuleList data, response status code and response headers
    def add_pbr_section_with_rules_create_with_rules_with_http_info(body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiServicesPolicyBasedRoutingApi.add_pbr_section_with_rules_create_with_rules"
      end
      if @api_client.config.client_side_validation && opts[:'operation'] && !['insert_top', 'insert_bottom', 'insert_after', 'insert_before'].include?(opts[:'operation'])
        fail ArgumentError, 'invalid value for "operation", must be one of insert_top, insert_bottom, insert_after, insert_before'
      end
      ...
      return_type = opts[:return_type] || 'PBRSectionRuleList' 
    ...
    # @param rule_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(PBRStats, Integer, Hash)>] PBRStats data, response status code and response headers
    def get_pbr_rule_stats_with_http_info(section_id, rule_id, opts = {})
      ...
      return_type = opts[:return_type] || 'PBRStats' 
    ...
    # @option opts [String] :sort_by Field by which records are sorted
    # @option opts [String] :sources Sources referenced by this section&#x27;s Distributed Service Rules .
    # @return [Array<(PBRRuleListResult, Integer, Hash)>] PBRRuleListResult data, response status code and response headers
    def get_pbr_rules_with_http_info(section_id, opts = {})
      ...
      return_type = opts[:return_type] || 'PBRRuleListResult' 
    ...
    # @param section_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(PBRStatsList, Integer, Hash)>] PBRStatsList data, response status code and response headers
    def get_pbr_section_stats_with_http_info(section_id, opts = {})
      ...
      return_type = opts[:return_type] || 'PBRStatsList' 
    ...
    # @option opts [String] :sort_by Field by which records are sorted
    # @option opts [String] :sources Sources referenced by this section&#x27;s Distributed Service Rules .
    # @return [Array<(PBRSectionListResult, Integer, Hash)>] PBRSectionListResult data, response status code and response headers
    def list_pbr_sections_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'PBRSectionListResult' 
    ...
    # @option opts [String] :operation Operation (default to insert_top)
    # @return [PBRRule]
    def revise_pbr_rule_revise(body, section_id, rule_id, opts = {})
      data, _status_code, _headers = revise_pbr_rule_revise_with_http_info(body, section_id, rule_id, opts)
      data
    end
    ...
    # @option opts [String] :operation Operation
    # @return [Array<(PBRRule, Integer, Hash)>] PBRRule data, response status code and response headers
    def revise_pbr_rule_revise_with_http_info(body, section_id, rule_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiServicesPolicyBasedRoutingApi.revise_pbr_rule_revise ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiServicesPolicyBasedRoutingApi.revise_pbr_rule_revise"
      end
      # verify the required parameter 'section_id' is set
      if @api_client.config.client_side_validation && section_id.nil?
    ...
    # @option opts [String] :operation Operation (default to insert_top)
    # @return [PBRSection]
    def revise_pbr_section_revise(body, section_id, opts = {})
      data, _status_code, _headers = revise_pbr_section_revise_with_http_info(body, section_id, opts)
      data
    end
    ...
    # @option opts [String] :operation Operation
    # @return [Array<(PBRSection, Integer, Hash)>] PBRSection data, response status code and response headers
    def revise_pbr_section_revise_with_http_info(body, section_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiServicesPolicyBasedRoutingApi.revise_pbr_section_revise ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiServicesPolicyBasedRoutingApi.revise_pbr_section_revise"
      end
      # verify the required parameter 'section_id' is set
      if @api_client.config.client_side_validation && section_id.nil?
    ...
    # @option opts [String] :operation Operation (default to insert_top)
    # @return [PBRSectionRuleList]
    def revise_pbr_section_with_rules_revise_with_rules(body, section_id, opts = {})
      data, _status_code, _headers = revise_pbr_section_with_rules_revise_with_rules_with_http_info(body, section_id, opts)
      data
    end
    ...
    # @option opts [String] :operation Operation
    # @return [Array<(PBRSectionRuleList, Integer, Hash)>] PBRSectionRuleList data, response status code and response headers
    def revise_pbr_section_with_rules_revise_with_rules_with_http_info(body, section_id, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiServicesPolicyBasedRoutingApi.revise_pbr_section_with_rules_revise_with_rules"
      end
      # verify the required parameter 'section_id' is set
      if @api_client.config.client_side_validation && section_id.nil?
    ...
    # @param [Hash] opts the optional parameters
    # @return [PBRRule]
    def update_pbr_rule(body, section_id, rule_id, opts = {})
      data, _status_code, _headers = update_pbr_rule_with_http_info(body, section_id, rule_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(PBRRule, Integer, Hash)>] PBRRule data, response status code and response headers
    def update_pbr_rule_with_http_info(body, section_id, rule_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiServicesPolicyBasedRoutingApi.update_pbr_rule ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiServicesPolicyBasedRoutingApi.update_pbr_rule"
      end
      # verify the required parameter 'section_id' is set
      if @api_client.config.client_side_validation && section_id.nil?
    ...
    # @param [Hash] opts the optional parameters
    # @return [PBRSection]
    def update_pbr_section(body, section_id, opts = {})
      data, _status_code, _headers = update_pbr_section_with_http_info(body, section_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(PBRSection, Integer, Hash)>] PBRSection data, response status code and response headers
    def update_pbr_section_with_http_info(body, section_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiServicesPolicyBasedRoutingApi.update_pbr_section ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiServicesPolicyBasedRoutingApi.update_pbr_section"
      end
      # verify the required parameter 'section_id' is set
      if @api_client.config.client_side_validation && section_id.nil?
    ...
    # @param [Hash] opts the optional parameters
    # @return [PBRSectionRuleList]
    def update_pbr_section_with_rules_update_with_rules(body, section_id, opts = {})
      data, _status_code, _headers = update_pbr_section_with_rules_update_with_rules_with_http_info(body, section_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(PBRSectionRuleList, Integer, Hash)>] PBRSectionRuleList data, response status code and response headers
    def update_pbr_section_with_rules_update_with_rules_with_http_info(body, section_id, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiServicesPolicyBasedRoutingApi.update_pbr_section_with_rules_update_with_rules"
      end
      # verify the required parameter 'section_id' is set
      if @api_client.config.client_side_validation && section_id.nil?
