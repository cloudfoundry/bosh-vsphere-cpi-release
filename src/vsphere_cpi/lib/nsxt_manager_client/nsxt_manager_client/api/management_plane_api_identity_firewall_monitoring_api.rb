...
module NSXT
  class ManagementPlaneApiIdentityFirewallMonitoringApi
    ...
    # @param compute_collection_ext_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IdfwComputeCollectionStatus, Integer, Hash)>] IdfwComputeCollectionStatus data, response status code and response headers
    def get_compute_collection_status_by_id_with_http_info(compute_collection_ext_id, opts = {})
      ...
      return_type = opts[:return_type] || 'IdfwComputeCollectionStatus' 
    ...
    # Retrieve all the Compute collection status. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IdfwComputeCollectionListResult, Integer, Hash)>] IdfwComputeCollectionListResult data, response status code and response headers
    def list_compute_collection_statuses_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'IdfwComputeCollectionListResult' 
    ...
    # @param cc_ext_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IdfwTransportNodeStatusListResult, Integer, Hash)>] IdfwTransportNodeStatusListResult data, response status code and response headers
    def list_transport_node_statuses_by_compute_collection_id_with_http_info(cc_ext_id, opts = {})
      ...
      return_type = opts[:return_type] || 'IdfwTransportNodeStatusListResult' 
    ...
    # @param transport_node_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IdfwVirtualMachineStatusListResult, Integer, Hash)>] IdfwVirtualMachineStatusListResult data, response status code and response headers
    def list_virtual_machine_statuses_by_transport_node_id_with_http_info(transport_node_id, opts = {})
      ...
      return_type = opts[:return_type] || 'IdfwVirtualMachineStatusListResult' 
