...
module NSXT
  class ManagementPlaneApiApiServicesApiRequestBatchingApi
    ...
    def register_batch_request(body, opts = {})
      data, _status_code, _headers = register_batch_request_with_http_info(body, opts)
      data
    end
    ...
    def register_batch_request_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiApiServicesApiRequestBatchingApi.register_batch_request"
      end
      # resource path
