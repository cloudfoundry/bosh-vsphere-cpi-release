...
module NSXT
  class ManagementPlaneApiMigrationPlanApi
    ...
    # @param component_type 
    # @param [Hash] opts the optional parameters
    # @return [Array<(MigrationPlanSettings, Integer, Hash)>] MigrationPlanSettings data, response status code and response headers
    def get_migration_plan_settings_with_http_info(component_type, opts = {})
      ...
      return_type = opts[:return_type] || 'MigrationPlanSettings' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [MigrationPlanSettings]
    def update_migration_plan_settings(body, component_type, opts = {})
      data, _status_code, _headers = update_migration_plan_settings_with_http_info(body, component_type, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(MigrationPlanSettings, Integer, Hash)>] MigrationPlanSettings data, response status code and response headers
    def update_migration_plan_settings_with_http_info(body, component_type, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiMigrationPlanApi.update_migration_plan_settings"
      end
      # verify the required parameter 'component_type' is set
      if @api_client.config.client_side_validation && component_type.nil?
