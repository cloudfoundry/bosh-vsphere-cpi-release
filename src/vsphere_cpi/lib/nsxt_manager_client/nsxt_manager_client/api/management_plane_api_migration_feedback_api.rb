...
module NSXT
  class ManagementPlaneApiMigrationFeedbackApi
    ...
    # @option opts [String] :sub_category Sub category based on which feedback request should be filtered
    # @return [Array<(MigrationFeedbackRequestListResult, Integer, Hash)>] MigrationFeedbackRequestListResult data, response status code and response headers
    def get_feedback_requests_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'MigrationFeedbackRequestListResult' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(MigrationFeedbackSummaryListResult, Integer, Hash)>] MigrationFeedbackSummaryListResult data, response status code and response headers
    def get_feedback_summary_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'MigrationFeedbackSummaryListResult' 
    ...
    # @option opts [String] :state Filter based on current state of the feedback request
    # @option opts [String] :sub_category Sub category based on which feedback request should be filtered
    # @return [Array<(GroupedMigrationFeedbackRequestListResult, Integer, Hash)>] GroupedMigrationFeedbackRequestListResult data, response status code and response headers
    def get_grouped_feedback_requests_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'GroupedMigrationFeedbackRequestListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_feedback_response(body, opts = {})
      update_feedback_response_with_http_info(body, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_feedback_response_with_http_info(body, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiMigrationFeedbackApi.update_feedback_response"
      end
      # resource path
