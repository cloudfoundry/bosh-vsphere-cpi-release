...
module NSXT
  class ManagementPlaneApiClusterNodesDeploymentsApi
    ...
    def add_cluster_node_vm(body, opts = {})
      data, _status_code, _headers = add_cluster_node_vm_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ClusterNodeVMDeploymentRequestList, Integer, Hash)>] ClusterNodeVMDeploymentRequestList data, response status code and response headers
    def add_cluster_node_vm_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiClusterNodesDeploymentsApi.add_cluster_node_vm"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'ClusterNodeVMDeploymentRequestList' 
    ...
    # @param node_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(RepoSyncStatusReport, Integer, Hash)>] RepoSyncStatusReport data, response status code and response headers
    def get_repo_sync_status_with_http_info(node_id, opts = {})
      ...
      return_type = opts[:return_type] || 'RepoSyncStatusReport' 
    ...
    # @param node_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ClusterNodeVMDeploymentRequest, Integer, Hash)>] ClusterNodeVMDeploymentRequest data, response status code and response headers
    def read_cluster_node_vm_deployment_request_with_http_info(node_id, opts = {})
      ...
      return_type = opts[:return_type] || 'ClusterNodeVMDeploymentRequest' 
    ...
    # @param node_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ClusterNodeVMDeploymentStatusReport, Integer, Hash)>] ClusterNodeVMDeploymentStatusReport data, response status code and response headers
    def read_cluster_node_vm_deployment_status_with_http_info(node_id, opts = {})
      ...
      return_type = opts[:return_type] || 'ClusterNodeVMDeploymentStatusReport' 
