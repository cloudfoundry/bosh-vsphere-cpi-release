...
module NSXT
  class ManagementPlaneApiErrorResolverApi
    ...
    # @param error_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ErrorResolverInfo, Integer, Hash)>] ErrorResolverInfo data, response status code and response headers
    def get_error_resolver_info_with_http_info(error_id, opts = {})
      ...
      return_type = opts[:return_type] || 'ErrorResolverInfo' 
    ...
    # Returns a list of metadata for all the error resolvers registered. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ErrorResolverInfoList, Integer, Hash)>] ErrorResolverInfoList data, response status code and response headers
    def list_error_resolver_info_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ErrorResolverInfoList' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def resolve_error_resolve_error(body, opts = {})
      resolve_error_resolve_error_with_http_info(body, opts)
      nil
    end
    ...
    def resolve_error_resolve_error_with_http_info(body, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiErrorResolverApi.resolve_error_resolve_error"
      end
      # resource path
