...
module NSXT
  class ManagementPlaneApiNetworkTransportTransportNodeProfilesApi
    ...
    def create_transport_node_profile(body, opts = {})
      data, _status_code, _headers = create_transport_node_profile_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(TransportNodeProfile, Integer, Hash)>] TransportNodeProfile data, response status code and response headers
    def create_transport_node_profile_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiNetworkTransportTransportNodeProfilesApi.create_transport_node_profile"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'TransportNodeProfile' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(TransportNodeProfileListResult, Integer, Hash)>] TransportNodeProfileListResult data, response status code and response headers
    def list_transport_node_profiles_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'TransportNodeProfileListResult' 
    ...
    # @return [TransportNodeProfile]
    def update_transport_node_profile(body, transport_node_profile_id, opts = {})
      data, _status_code, _headers = update_transport_node_profile_with_http_info(body, transport_node_profile_id, opts)
      data
    end
    ...
    # @option opts [String] :vnic_migration_dest The migration destinations of ESX vmk interfaces and/or VM NIC
    # @return [Array<(TransportNodeProfile, Integer, Hash)>] TransportNodeProfile data, response status code and response headers
    def update_transport_node_profile_with_http_info(body, transport_node_profile_id, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiNetworkTransportTransportNodeProfilesApi.update_transport_node_profile"
      end
      # verify the required parameter 'transport_node_profile_id' is set
      if @api_client.config.client_side_validation && transport_node_profile_id.nil?
