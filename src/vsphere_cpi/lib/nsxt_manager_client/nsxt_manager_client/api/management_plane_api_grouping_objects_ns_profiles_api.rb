...
module NSXT
  class ManagementPlaneApiGroupingObjectsNsProfilesApi
    ...
    # @return [NSProfile]
    def create_ns_profile(body, opts = {})
      data, _status_code, _headers = create_ns_profile_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(NSProfile, Integer, Hash)>] NSProfile data, response status code and response headers
    def create_ns_profile_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiGroupingObjectsNsProfilesApi.create_ns_profile"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'NSProfile' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(NSProfileListResult, Integer, Hash)>] NSProfileListResult data, response status code and response headers
    def list_ns_profiles_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'NSProfileListResult' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(NSSupportedAttributesListResult, Integer, Hash)>] NSSupportedAttributesListResult data, response status code and response headers
    def list_ns_supported_attributes_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'NSSupportedAttributesListResult' 
    ...
    # Returns supported attribute type strings for NSProfile. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(NSSupportedAttributeTypesResult, Integer, Hash)>] NSSupportedAttributeTypesResult data, response status code and response headers
    def list_ns_supported_attributes_types_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'NSSupportedAttributeTypesResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [NSProfile]
    def update_ns_profile(body, ns_profile_id, opts = {})
      data, _status_code, _headers = update_ns_profile_with_http_info(body, ns_profile_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(NSProfile, Integer, Hash)>] NSProfile data, response status code and response headers
    def update_ns_profile_with_http_info(body, ns_profile_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiGroupingObjectsNsProfilesApi.update_ns_profile ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiGroupingObjectsNsProfilesApi.update_ns_profile"
      end
      # verify the required parameter 'ns_profile_id' is set
      if @api_client.config.client_side_validation && ns_profile_id.nil?
