...
module NSXT
  class ManagementPlaneApiNetworkTransportClusterProfilesApi
    ...
    def create_cluster_profile(body, opts = {})
      data, _status_code, _headers = create_cluster_profile_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ClusterProfile, Integer, Hash)>] ClusterProfile data, response status code and response headers
    def create_cluster_profile_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiNetworkTransportClusterProfilesApi.create_cluster_profile"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'ClusterProfile' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(ClusterProfileListResult, Integer, Hash)>] ClusterProfileListResult data, response status code and response headers
    def list_cluster_profiles_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ClusterProfileListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [ClusterProfile]
    def update_cluster_profile(body, cluster_profile_id, opts = {})
      data, _status_code, _headers = update_cluster_profile_with_http_info(body, cluster_profile_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ClusterProfile, Integer, Hash)>] ClusterProfile data, response status code and response headers
    def update_cluster_profile_with_http_info(body, cluster_profile_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiNetworkTransportClusterProfilesApi.update_cluster_profile ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiNetworkTransportClusterProfilesApi.update_cluster_profile"
      end
      # verify the required parameter 'cluster_profile_id' is set
      if @api_client.config.client_side_validation && cluster_profile_id.nil?
