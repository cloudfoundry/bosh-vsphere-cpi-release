...
module NSXT
  class ManagementPlaneApiGroupingObjectsNsServicesApi
    ...
    # @return [NSService]
    def create_ns_service(body, opts = {})
      data, _status_code, _headers = create_ns_service_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(NSService, Integer, Hash)>] NSService data, response status code and response headers
    def create_ns_service_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiGroupingObjectsNsServicesApi.create_ns_service"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'NSService' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(NSServiceListResult, Integer, Hash)>] NSServiceListResult data, response status code and response headers
    def list_ns_services_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'NSServiceListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [NSService]
    def update_ns_service(body, ns_service_id, opts = {})
      data, _status_code, _headers = update_ns_service_with_http_info(body, ns_service_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(NSService, Integer, Hash)>] NSService data, response status code and response headers
    def update_ns_service_with_http_info(body, ns_service_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiGroupingObjectsNsServicesApi.update_ns_service ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiGroupingObjectsNsServicesApi.update_ns_service"
      end
      # verify the required parameter 'ns_service_id' is set
      if @api_client.config.client_side_validation && ns_service_id.nil?
