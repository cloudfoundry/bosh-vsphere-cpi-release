...
module NSXT
  class ManagementPlaneApiNsxNotificationsApi
    ...
    def add_notification_watcher(body, opts = {})
      data, _status_code, _headers = add_notification_watcher_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(NotificationWatcher, Integer, Hash)>] NotificationWatcher data, response status code and response headers
    def add_notification_watcher_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiNsxNotificationsApi.add_notification_watcher"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'NotificationWatcher' 
    ...
    def add_uri_filters_add_uri_filters(body, watcher_id, opts = {})
      data, _status_code, _headers = add_uri_filters_add_uri_filters_with_http_info(body, watcher_id, opts)
      data
    end
    ...
    # @param watcher_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(NotificationsList, Integer, Hash)>] NotificationsList data, response status code and response headers
    def add_uri_filters_add_uri_filters_with_http_info(body, watcher_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiNsxNotificationsApi.add_uri_filters_add_uri_filters ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiNsxNotificationsApi.add_uri_filters_add_uri_filters"
      end
      ...
      return_type = opts[:return_type] || 'NotificationsList' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [NotificationsList]
    def delete_uri_filters_delete_uri_filters(body, watcher_id, opts = {})
      data, _status_code, _headers = delete_uri_filters_delete_uri_filters_with_http_info(body, watcher_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(NotificationsList, Integer, Hash)>] NotificationsList data, response status code and response headers
    def delete_uri_filters_delete_uri_filters_with_http_info(body, watcher_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiNsxNotificationsApi.delete_uri_filters_delete_uri_filters ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiNsxNotificationsApi.delete_uri_filters_delete_uri_filters"
      end
      # verify the required parameter 'watcher_id' is set
      if @api_client.config.client_side_validation && watcher_id.nil?
    ...
    # Returns a list of registered notification watchers.
    # @param [Hash] opts the optional parameters
    # @return [Array<(NotificationWatcherListResult, Integer, Hash)>] NotificationWatcherListResult data, response status code and response headers
    def list_notification_watchers_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'NotificationWatcherListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [NotificationWatcher]
    def update_notification_watcher(body, watcher_id, opts = {})
      data, _status_code, _headers = update_notification_watcher_with_http_info(body, watcher_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(NotificationWatcher, Integer, Hash)>] NotificationWatcher data, response status code and response headers
    def update_notification_watcher_with_http_info(body, watcher_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiNsxNotificationsApi.update_notification_watcher ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiNsxNotificationsApi.update_notification_watcher"
      end
      # verify the required parameter 'watcher_id' is set
      if @api_client.config.client_side_validation && watcher_id.nil?
    ...
    # @param [Hash] opts the optional parameters
    # @return [NotificationsList]
    def update_notifications(body, watcher_id, opts = {})
      data, _status_code, _headers = update_notifications_with_http_info(body, watcher_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(NotificationsList, Integer, Hash)>] NotificationsList data, response status code and response headers
    def update_notifications_with_http_info(body, watcher_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiNsxNotificationsApi.update_notifications ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiNsxNotificationsApi.update_notifications"
      end
      # verify the required parameter 'watcher_id' is set
      if @api_client.config.client_side_validation && watcher_id.nil?
