...
module NSXT
  class ManagementPlaneApiTroubleshootingAndMonitoringPacketCaptureApi
    ...
    def create_packet_capture_session(body, opts = {})
      data, _status_code, _headers = create_packet_capture_session_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(PacketCaptureSession, Integer, Hash)>] PacketCaptureSession data, response status code and response headers
    def create_packet_capture_session_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiTroubleshootingAndMonitoringPacketCaptureApi.create_packet_capture_session"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'PacketCaptureSession' 
    ...
    # Delete all the packet capture sessions. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(PacketCaptureSessionList, Integer, Hash)>] PacketCaptureSessionList data, response status code and response headers
    def delete_all_capture_sessions_delete_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'PacketCaptureSessionList' 
