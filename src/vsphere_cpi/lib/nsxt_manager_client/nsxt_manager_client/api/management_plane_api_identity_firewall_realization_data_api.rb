...
module NSXT
  class ManagementPlaneApiIdentityFirewallRealizationDataApi
    ...
    # @param group_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IdfwNsgroupVmDetailListResult, Integer, Hash)>] IdfwNsgroupVmDetailListResult data, response status code and response headers
    def get_nsgroup_vm_details_with_http_info(group_id, opts = {})
      ...
      return_type = opts[:return_type] || 'IdfwNsgroupVmDetailListResult' 
    ...
    # Get IDFW system statistics data.
    # @param [Hash] opts the optional parameters
    # @return [Array<(IdfwSystemStats, Integer, Hash)>] IdfwSystemStats data, response status code and response headers
    def get_system_stats_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'IdfwSystemStats' 
    ...
    # @param user_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IdfwUserStats, Integer, Hash)>] IdfwUserStats data, response status code and response headers
    def get_user_stats_with_http_info(user_id, opts = {})
      ...
      return_type = opts[:return_type] || 'IdfwUserStats' 
    ...
    # @param vm_ext_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IdfwVmStats, Integer, Hash)>] IdfwVmStats data, response status code and response headers
    def get_vm_stats_with_http_info(vm_ext_id, opts = {})
      ...
      return_type = opts[:return_type] || 'IdfwVmStats' 
    ...
    # Get user session data.
    # @param [Hash] opts the optional parameters
    # @return [Array<(IdfwUserSessionDataAndMappings, Integer, Hash)>] IdfwUserSessionDataAndMappings data, response status code and response headers
    def list_user_sessions_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'IdfwUserSessionDataAndMappings' 
