...
module NSXT
  class ManagementPlaneApiLogicalRoutingAndServicesLogicalRouterPortsApi
    ...
    def create_logical_router_port(body, opts = {})
      data, _status_code, _headers = create_logical_router_port_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(LogicalRouterPort, Integer, Hash)>] LogicalRouterPort data, response status code and response headers
    def create_logical_router_port_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiLogicalRoutingAndServicesLogicalRouterPortsApi.create_logical_router_port"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'LogicalRouterPort' 
    ...
    # @option opts [String] :source Data source type.
    # @option opts [String] :transport_node_id TransportNode Id
    # @return [Array<(LogicalRouterPortArpTable, Integer, Hash)>] LogicalRouterPortArpTable data, response status code and response headers
    def get_logical_router_port_arp_table_with_http_info(logical_router_port_id, opts = {})
      ...
      return_type = opts[:return_type] || 'LogicalRouterPortArpTable' 
    ...
    # @option opts [String] :source Data source type.
    # @option opts [String] :transport_node_id TransportNode Id
    # @return [Array<(LogicalRouterPortArpTableInCsvFormat, Integer, Hash)>] LogicalRouterPortArpTableInCsvFormat data, response status code and response headers
    def get_logical_router_port_arp_table_in_csv_format_csv_with_http_info(logical_router_port_id, opts = {})
      ...
      return_type = opts[:return_type] || 'LogicalRouterPortArpTableInCsvFormat' 
    ...
    # @option opts [Integer] :barrier_id 
    # @option opts [String] :request_id Realization request ID
    # @return [Array<(LogicalRouterPortState, Integer, Hash)>] LogicalRouterPortState data, response status code and response headers
    def get_logical_router_port_state_with_http_info(logical_router_port_id, opts = {})
      ...
      return_type = opts[:return_type] || 'LogicalRouterPortState' 
    ...
    # @option opts [String] :source Data source type.
    # @option opts [String] :transport_node_id TransportNode Id
    # @return [Array<(LogicalRouterPortStatistics, Integer, Hash)>] LogicalRouterPortStatistics data, response status code and response headers
    def get_logical_router_port_statistics_with_http_info(logical_router_port_id, opts = {})
      ...
      return_type = opts[:return_type] || 'LogicalRouterPortStatistics' 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :source Data source type.
    # @return [Array<(LogicalRouterPortStatisticsSummary, Integer, Hash)>] LogicalRouterPortStatisticsSummary data, response status code and response headers
    def get_logical_router_port_statistics_summary_with_http_info(logical_router_port_id, opts = {})
      ...
      return_type = opts[:return_type] || 'LogicalRouterPortStatisticsSummary' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(LogicalRouterPortListResult, Integer, Hash)>] LogicalRouterPortListResult data, response status code and response headers
    def list_logical_router_ports_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'LogicalRouterPortListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [LogicalRouterPort]
    def update_logical_router_port(body, logical_router_port_id, opts = {})
      data, _status_code, _headers = update_logical_router_port_with_http_info(body, logical_router_port_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(LogicalRouterPort, Integer, Hash)>] LogicalRouterPort data, response status code and response headers
    def update_logical_router_port_with_http_info(body, logical_router_port_id, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiLogicalRoutingAndServicesLogicalRouterPortsApi.update_logical_router_port"
      end
      # verify the required parameter 'logical_router_port_id' is set
      if @api_client.config.client_side_validation && logical_router_port_id.nil?
