...
module NSXT
  class ManagementPlaneApiVpnStatisticsL2VpnSessionsSummaryApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :source Data source type.
    # @return [Array<(L2VPNSessionSummary, Integer, Hash)>] L2VPNSessionSummary data, response status code and response headers
    def get_l2_vpn_session_summary_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'L2VPNSessionSummary' 
