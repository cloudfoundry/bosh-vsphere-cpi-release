...
module NSXT
  class ManagementPlaneApiNsxComponentAdministrationBackupRestoreManagementRestoreApi
    ...
    def advance_cluster_restore_advance(body, opts = {})
      data, _status_code, _headers = advance_cluster_restore_advance_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ClusterRestoreStatus, Integer, Hash)>] ClusterRestoreStatus data, response status code and response headers
    def advance_cluster_restore_advance_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiNsxComponentAdministrationBackupRestoreManagementRestoreApi.advance_cluster_restore_advance"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'ClusterRestoreStatus' 
    ...
    def configure_restore_config(body, opts = {})
      data, _status_code, _headers = configure_restore_config_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(RestoreConfiguration, Integer, Hash)>] RestoreConfiguration data, response status code and response headers
    def configure_restore_config_with_http_info(body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiNsxComponentAdministrationBackupRestoreManagementRestoreApi.configure_restore_config"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'RestoreConfiguration' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [ClusterRestoreStatus]
    def initiate_cluster_restore_start(body, opts = {})
      data, _status_code, _headers = initiate_cluster_restore_start_with_http_info(body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ClusterRestoreStatus, Integer, Hash)>] ClusterRestoreStatus data, response status code and response headers
    def initiate_cluster_restore_start_with_http_info(body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiNsxComponentAdministrationBackupRestoreManagementRestoreApi.initiate_cluster_restore_start"
      end
      # resource path
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(ClusterBackupInfoListResult, Integer, Hash)>] ClusterBackupInfoListResult data, response status code and response headers
    def list_cluster_backup_timestamps_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ClusterBackupInfoListResult' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(ActionableResourceListResult, Integer, Hash)>] ActionableResourceListResult data, response status code and response headers
    def list_restore_instruction_resources_with_http_info(instruction_id, opts = {})
      ...
      return_type = opts[:return_type] || 'ActionableResourceListResult' 
