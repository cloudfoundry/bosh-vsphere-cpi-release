...
module NSXT
  class ManagementPlaneApiAggregationServiceConfigurationApi
    ...
    # Read global health performance monitoring configuration
    # @param [Hash] opts the optional parameters
    # @return [Array<(GlobalCollectionConfiguration, Integer, Hash)>] GlobalCollectionConfiguration data, response status code and response headers
    def get_aggregation_service_global_config_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'GlobalCollectionConfiguration' 
    ...
    # @param feature_stack_name 
    # @param [Hash] opts the optional parameters
    # @return [Array<(FeatureStackCollectionConfiguration, Integer, Hash)>] FeatureStackCollectionConfiguration data, response status code and response headers
    def get_feature_stack_configuration_with_http_info(feature_stack_name, opts = {})
      ...
      return_type = opts[:return_type] || 'FeatureStackCollectionConfiguration' 
    ...
    # List all health performance monitoring feature stacks
    # @param [Hash] opts the optional parameters
    # @return [Array<(FeatureStackCollectionConfigurationList, Integer, Hash)>] FeatureStackCollectionConfigurationList data, response status code and response headers
    def list_feature_stack_configurations_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'FeatureStackCollectionConfigurationList' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [GlobalCollectionConfiguration]
    def update_aggregation_service_global_config(body, opts = {})
      data, _status_code, _headers = update_aggregation_service_global_config_with_http_info(body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GlobalCollectionConfiguration, Integer, Hash)>] GlobalCollectionConfiguration data, response status code and response headers
    def update_aggregation_service_global_config_with_http_info(body, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiAggregationServiceConfigurationApi.update_aggregation_service_global_config"
      end
      # resource path
      local_var_path = '/hpm/global-config'
    ...
    # @param [Hash] opts the optional parameters
    # @return [FeatureStackCollectionConfiguration]
    def update_feature_stack_configuration(body, feature_stack_name, opts = {})
      data, _status_code, _headers = update_feature_stack_configuration_with_http_info(body, feature_stack_name, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(FeatureStackCollectionConfiguration, Integer, Hash)>] FeatureStackCollectionConfiguration data, response status code and response headers
    def update_feature_stack_configuration_with_http_info(body, feature_stack_name, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiAggregationServiceConfigurationApi.update_feature_stack_configuration"
      end
      # verify the required parameter 'feature_stack_name' is set
      if @api_client.config.client_side_validation && feature_stack_name.nil?
