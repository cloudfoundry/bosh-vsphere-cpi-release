...
module NSXT
  class ManagementPlaneApiFabricComputeManagersApi
    ...
    def add_compute_manager(body, opts = {})
      data, _status_code, _headers = add_compute_manager_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ComputeManager, Integer, Hash)>] ComputeManager data, response status code and response headers
    def add_compute_manager_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiFabricComputeManagersApi.add_compute_manager"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'ComputeManager' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(ComputeManagerListResult, Integer, Hash)>] ComputeManagerListResult data, response status code and response headers
    def list_compute_managers_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ComputeManagerListResult' 
    ...
    # @param compute_manager_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ComputeManagerStatus, Integer, Hash)>] ComputeManagerStatus data, response status code and response headers
    def read_compute_manager_status_with_http_info(compute_manager_id, opts = {})
      ...
      return_type = opts[:return_type] || 'ComputeManagerStatus' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [ComputeManager]
    def update_compute_manager(body, compute_manager_id, opts = {})
      data, _status_code, _headers = update_compute_manager_with_http_info(body, compute_manager_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ComputeManager, Integer, Hash)>] ComputeManager data, response status code and response headers
    def update_compute_manager_with_http_info(body, compute_manager_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiFabricComputeManagersApi.update_compute_manager ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiFabricComputeManagersApi.update_compute_manager"
      end
      # verify the required parameter 'compute_manager_id' is set
      if @api_client.config.client_side_validation && compute_manager_id.nil?
