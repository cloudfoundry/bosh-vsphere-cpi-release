...
module NSXT
  class ManagementPlaneApiGroupingObjectsNsServiceGroupsApi
    ...
    def create_ns_service_group(body, opts = {})
      data, _status_code, _headers = create_ns_service_group_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(NSServiceGroup, Integer, Hash)>] NSServiceGroup data, response status code and response headers
    def create_ns_service_group_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiGroupingObjectsNsServiceGroupsApi.create_ns_service_group"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'NSServiceGroup' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(NSServiceGroupListResult, Integer, Hash)>] NSServiceGroupListResult data, response status code and response headers
    def list_ns_service_groups_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'NSServiceGroupListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [NSServiceGroup]
    def update_ns_service_group(body, ns_service_group_id, opts = {})
      data, _status_code, _headers = update_ns_service_group_with_http_info(body, ns_service_group_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(NSServiceGroup, Integer, Hash)>] NSServiceGroup data, response status code and response headers
    def update_ns_service_group_with_http_info(body, ns_service_group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiGroupingObjectsNsServiceGroupsApi.update_ns_service_group ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiGroupingObjectsNsServiceGroupsApi.update_ns_service_group"
      end
      # verify the required parameter 'ns_service_group_id' is set
      if @api_client.config.client_side_validation && ns_service_group_id.nil?
