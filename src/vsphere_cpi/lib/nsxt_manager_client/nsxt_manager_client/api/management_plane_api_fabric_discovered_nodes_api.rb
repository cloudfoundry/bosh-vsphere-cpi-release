...
module NSXT
  class ManagementPlaneApiFabricDiscoveredNodesApi
    ...
    def create_transport_node_for_discovered_node_create_transport_node(body, node_ext_id, opts = {})
      data, _status_code, _headers = create_transport_node_for_discovered_node_create_transport_node_with_http_info(body, node_ext_id, opts)
      data
    end
    ...
    def create_transport_node_for_discovered_node_create_transport_node_with_http_info(body, node_ext_id, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiFabricDiscoveredNodesApi.create_transport_node_for_discovered_node_create_transport_node"
      end
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(DiscoveredNodeListResult, Integer, Hash)>] DiscoveredNodeListResult data, response status code and response headers
    def list_discovered_nodes_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'DiscoveredNodeListResult' 
    ...
    # @param node_ext_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(DiscoveredNode, Integer, Hash)>] DiscoveredNode data, response status code and response headers
    def read_discovered_node_with_http_info(node_ext_id, opts = {})
      ...
      return_type = opts[:return_type] || 'DiscoveredNode' 
