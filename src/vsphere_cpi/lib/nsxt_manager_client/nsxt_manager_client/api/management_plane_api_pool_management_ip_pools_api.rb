...
module NSXT
  class ManagementPlaneApiPoolManagementIpPoolsApi
    ...
    def allocate_or_release_from_ip_pool(body, action, pool_id, opts = {})
      data, _status_code, _headers = allocate_or_release_from_ip_pool_with_http_info(body, action, pool_id, opts)
      data
    end
    ...
    def allocate_or_release_from_ip_pool_with_http_info(body, action, pool_id, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiPoolManagementIpPoolsApi.allocate_or_release_from_ip_pool"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [IpPool]
    def create_ip_pool(body, opts = {})
      data, _status_code, _headers = create_ip_pool_with_http_info(body, opts)
      data
    end
    ...
    def create_ip_pool_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiPoolManagementIpPoolsApi.create_ip_pool ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiPoolManagementIpPoolsApi.create_ip_pool"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'IpPool' 
    ...
    # @param pool_id IP pool ID
    # @param [Hash] opts the optional parameters
    # @return [Array<(AllocationIpAddressListResult, Integer, Hash)>] AllocationIpAddressListResult data, response status code and response headers
    def list_ip_pool_allocations_with_http_info(pool_id, opts = {})
      ...
      return_type = opts[:return_type] || 'AllocationIpAddressListResult' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(IpPoolListResult, Integer, Hash)>] IpPoolListResult data, response status code and response headers
    def list_ip_pools_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'IpPoolListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [IpPool]
    def update_ip_pool(body, pool_id, opts = {})
      data, _status_code, _headers = update_ip_pool_with_http_info(body, pool_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(IpPool, Integer, Hash)>] IpPool data, response status code and response headers
    def update_ip_pool_with_http_info(body, pool_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiPoolManagementIpPoolsApi.update_ip_pool ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiPoolManagementIpPoolsApi.update_ip_pool"
      end
      # verify the required parameter 'pool_id' is set
      if @api_client.config.client_side_validation && pool_id.nil?
