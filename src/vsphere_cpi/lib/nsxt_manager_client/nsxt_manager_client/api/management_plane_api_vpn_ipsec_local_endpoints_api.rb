...
module NSXT
  class ManagementPlaneApiVpnIpsecLocalEndpointsApi
    ...
    def create_ip_sec_vpn_local_endpoint(body, opts = {})
      data, _status_code, _headers = create_ip_sec_vpn_local_endpoint_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IPSecVPNLocalEndpoint, Integer, Hash)>] IPSecVPNLocalEndpoint data, response status code and response headers
    def create_ip_sec_vpn_local_endpoint_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiVpnIpsecLocalEndpointsApi.create_ip_sec_vpn_local_endpoint"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'IPSecVPNLocalEndpoint' 
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(IPSecVPNLocalEndpointListResult, Integer, Hash)>] IPSecVPNLocalEndpointListResult data, response status code and response headers
    def list_ip_sec_vpn_local_endpoints_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'IPSecVPNLocalEndpointListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [IPSecVPNLocalEndpoint]
    def update_ip_sec_vpn_local_endpoint(body, ipsec_vpn_local_endpoint_id, opts = {})
      data, _status_code, _headers = update_ip_sec_vpn_local_endpoint_with_http_info(body, ipsec_vpn_local_endpoint_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(IPSecVPNLocalEndpoint, Integer, Hash)>] IPSecVPNLocalEndpoint data, response status code and response headers
    def update_ip_sec_vpn_local_endpoint_with_http_info(body, ipsec_vpn_local_endpoint_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiVpnIpsecLocalEndpointsApi.update_ip_sec_vpn_local_endpoint ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiVpnIpsecLocalEndpointsApi.update_ip_sec_vpn_local_endpoint"
      end
      # verify the required parameter 'ipsec_vpn_local_endpoint_id' is set
      if @api_client.config.client_side_validation && ipsec_vpn_local_endpoint_id.nil?
