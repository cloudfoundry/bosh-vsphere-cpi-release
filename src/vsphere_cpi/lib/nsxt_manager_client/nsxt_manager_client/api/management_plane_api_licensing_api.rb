...
module NSXT
  class ManagementPlaneApiLicensingApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [License]
    def create_license(body, opts = {})
      data, _status_code, _headers = create_license_with_http_info(body, opts)
      data
    end
    ...
    def create_license_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiLicensingApi.create_license ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiLicensingApi.create_license"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_license_key_delete(body, opts = {})
      delete_license_key_delete_with_http_info(body, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_license_key_delete_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiLicensingApi.delete_license_key_delete ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiLicensingApi.delete_license_key_delete"
      end
      # resource path
    ...
    # Return the acceptance status of end user license agreement 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EULAAcceptance, Integer, Hash)>] EULAAcceptance data, response status code and response headers
    def get_eula_acceptance_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'EULAAcceptance' 
    ...
    # @option opts [String] :sort_by Field by which records are sorted
    # @option opts [String] :value_format End User License Agreement content output format
    # @return [Array<(EULAContent, Integer, Hash)>] EULAContent data, response status code and response headers
    def get_eula_content_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'EULAContent' 
    ...
    # Returns usage report of all registered modules 
    # @param [Hash] opts the optional parameters
    # @return [Array<(FeatureUsageList, Integer, Hash)>] FeatureUsageList data, response status code and response headers
    def get_license_usage_report_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'FeatureUsageList' 
    ...
    # Returns usage report of all registered modules in CSV format 
    # @param [Hash] opts the optional parameters
    # @return [Array<(FeatureUsageListInCsvFormat, Integer, Hash)>] FeatureUsageListInCsvFormat data, response status code and response headers
    def get_license_usage_report_in_csv_format_csv_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'FeatureUsageListInCsvFormat' 
    ...
    # Returns all licenses. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(LicensesListResult, Integer, Hash)>] LicensesListResult data, response status code and response headers
    def get_licenses_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'LicensesListResult' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [License]
    def update_license(body, opts = {})
      data, _status_code, _headers = update_license_with_http_info(body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(License, Integer, Hash)>] License data, response status code and response headers
    def update_license_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiLicensingApi.update_license ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiLicensingApi.update_license"
      end
      # resource path
      local_var_path = '/license'
