...
module NSXT
  class ManagementPlaneApiNsxComponentAdministrationClusterManagementApi
    ...
    def add_cluster_node(body, action, opts = {})
      data, _status_code, _headers = add_cluster_node_with_http_info(body, action, opts)
      data
    end
    ...
    # @param action 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ClusterNodeConfig, Integer, Hash)>] ClusterNodeConfig data, response status code and response headers
    def add_cluster_node_with_http_info(body, action, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiNsxComponentAdministrationClusterManagementApi.add_cluster_node"
      end
      ...
      return_type = opts[:return_type] || 'ClusterNodeConfig' 
    ...
    # @param certificate_id Certificate ID
    # @param [Hash] opts the optional parameters
    # @return [Array<(ClusterCertificateId, Integer, Hash)>] ClusterCertificateId data, response status code and response headers
    def clear_cluster_certificate_clear_cluster_certificate_with_http_info(certificate_id, opts = {})
      ...
      return_type = opts[:return_type] || 'ClusterCertificateId' 
    ...
    # Clears the cluster virtual IP address. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ClusterVirtualIpProperties, Integer, Hash)>] ClusterVirtualIpProperties data, response status code and response headers
    def clear_cluster_virtual_ip_clear_virtual_ip_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ClusterVirtualIpProperties' 
    ...
    # @return [Array<(ClusterConfiguration, Integer, Hash)>] ClusterConfiguration data, response status code and response headers
    def detach_cluster_node_remove_node_with_http_info(node_id, opts = {})
      ...
      return_type = opts[:return_type] || 'ClusterConfiguration' 
    ...
    # Read the configuration of the NSX API service. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApiServiceConfig, Integer, Hash)>] ApiServiceConfig data, response status code and response headers
    def get_api_service_config_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ApiServiceConfig' 
    ...
    # @param node_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ClusterNodeInfo, Integer, Hash)>] ClusterNodeInfo data, response status code and response headers
    def get_cluster_node_config_with_http_info(node_id, opts = {})
      ...
      return_type = opts[:return_type] || 'ClusterNodeInfo' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [ClusterConfiguration]
    def join_cluster_join_cluster(body, opts = {})
      data, _status_code, _headers = join_cluster_join_cluster_with_http_info(body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ClusterConfiguration, Integer, Hash)>] ClusterConfiguration data, response status code and response headers
    def join_cluster_join_cluster_with_http_info(body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiNsxComponentAdministrationClusterManagementApi.join_cluster_join_cluster"
      end
      # resource path
    ...
    # @option opts [BOOLEAN] :sort_ascending 
    # @option opts [String] :sort_by Field by which records are sorted
    # @return [Array<(ClusterNodeConfigListResult, Integer, Hash)>] ClusterNodeConfigListResult data, response status code and response headers
    def list_cluster_node_configs_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ClusterNodeConfigListResult' 
    ...
    # Returns information about the NSX cluster configuration. An NSX cluster has two functions or purposes, commonly referred to as \&quot;roles.\&quot; These two roles are control and management. Each NSX installation has a single cluster. Separate NSX clusters do not share data. In other words, a given data-plane node is attached to only one cluster, not to multiple clusters. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ClusterConfig, Integer, Hash)>] ClusterConfig data, response status code and response headers
    def read_cluster_config_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ClusterConfig' 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :source Data source type.
    # @return [Array<(ClusterNodeStatus, Integer, Hash)>] ClusterNodeStatus data, response status code and response headers
    def read_cluster_node_status_with_http_info(node_id, opts = {})
      ...
      return_type = opts[:return_type] || 'ClusterNodeStatus' 
    ...
    # Read aggregated runtime status of all cluster nodes. Deprecated. Use GET /cluster/status instead. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ClustersAggregateInfo, Integer, Hash)>] ClustersAggregateInfo data, response status code and response headers
    def read_cluster_nodes_aggregate_status_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ClustersAggregateInfo' 
    ...
    # Returns status information for the NSX cluster control role and management role. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ClusterStatus, Integer, Hash)>] ClusterStatus data, response status code and response headers
    def read_cluster_status_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ClusterStatus' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [ApiServiceConfig]
    def update_api_service_config(body, opts = {})
      data, _status_code, _headers = update_api_service_config_with_http_info(body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApiServiceConfig, Integer, Hash)>] ApiServiceConfig data, response status code and response headers
    def update_api_service_config_with_http_info(body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ManagementPlaneApiNsxComponentAdministrationClusterManagementApi.update_api_service_config"
      end
      # resource path
      local_var_path = '/cluster/api-service'
