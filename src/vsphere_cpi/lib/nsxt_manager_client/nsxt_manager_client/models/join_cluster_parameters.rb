...
module NSXT
  ...
  class JoinClusterParameters
    ...
    def self.openapi_types
      {
        :'username' => :'Object',
        :'certficate_sha256_thumbprint' => :'Object',
        :'token' => :'Object',
        :'cluster_id' => :'Object',
        :'password' => :'Object',
        :'ip_address' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::JoinClusterParameters` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::JoinClusterParameters`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'certficate_sha256_thumbprint')
