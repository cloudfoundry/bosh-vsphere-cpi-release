  ...
  class ServiceDeploymentConfig
    ...
    def self.openapi_types
      {
        :'storage_id' => :'Object',
        :'host_id' => :'Object',
        :'compute_collection_id' => :'Object',
        :'vm_nic_info' => :'Object',
        :'compute_manager_id' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::ServiceDeploymentConfig` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::ServiceDeploymentConfig`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'compute_collection_id')
      ...
      if attributes.key?(:'compute_manager_id')
