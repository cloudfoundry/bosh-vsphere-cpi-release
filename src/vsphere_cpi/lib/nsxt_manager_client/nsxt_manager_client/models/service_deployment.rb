  ...
  class ServiceDeployment
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::ServiceDeployment` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::ServiceDeployment`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'service_deployment_config')
      ...
      if attributes.key?(:'clustered_deployment_count')
    ...
    def valid?
      perimeter_validator = EnumAttributeValidator.new('', ['CLUSTER', 'HOST'])
      ...
      deployment_type_validator = EnumAttributeValidator.new('', ['HOSTLOCAL', 'CLUSTERED'])
    ...
    def perimeter=(perimeter)
      validator = EnumAttributeValidator.new('', ['CLUSTER', 'HOST'])
    ...
    def deployment_type=(deployment_type)
      validator = EnumAttributeValidator.new('', ['HOSTLOCAL', 'CLUSTERED'])
