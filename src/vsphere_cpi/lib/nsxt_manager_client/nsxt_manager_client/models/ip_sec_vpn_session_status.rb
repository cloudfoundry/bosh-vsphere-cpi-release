...
module NSXT
  ...
  class IPSecVPNSessionStatus
    ...
    def self.openapi_types
      {
        :'ipsec_vpn_session_id' => :'Object',
        :'display_name' => :'Object',
        :'failed_tunnels' => :'Object',
        :'negotiated_tunnels' => :'Object',
        :'session_status' => :'Object',
        :'last_update_timestamp' => :'Object',
        :'aggregate_traffic_counters' => :'Object',
        :'ike_status' => :'Object',
        :'total_tunnels' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::IPSecVPNSessionStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::IPSecVPNSessionStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'ipsec_vpn_session_id')
      ...
      if attributes.key?(:'failed_tunnels')
        self.failed_tunnels = attributes[:'failed_tunnels']
      end

      if attributes.key?(:'negotiated_tunnels')
    ...
    def valid?
      session_status_validator = EnumAttributeValidator.new('Object', ['UP', 'DOWN', 'DEGRADED'])
    ...
    def session_status=(session_status)
      validator = EnumAttributeValidator.new('Object', ['UP', 'DOWN', 'DEGRADED'])
