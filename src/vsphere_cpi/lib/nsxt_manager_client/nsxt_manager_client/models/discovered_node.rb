  ...
  class DiscoveredNode
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::DiscoveredNode` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::DiscoveredNode`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'stateless')
        self.stateless = attributes[:'stateless']
      end

      if attributes.key?(:'parent_compute_collection')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cm_local_id == o.cm_local_id && super(o)
    end
    ...
    def hash
      [_last_sync_time, display_name, description, resource_type, tags, stateless, parent_compute_collection, certificate, origin_id, ip_addresses, hardware_id, os_version, node_type, os_type, origin_properties, external_id, cm_local_id].hash
    end
