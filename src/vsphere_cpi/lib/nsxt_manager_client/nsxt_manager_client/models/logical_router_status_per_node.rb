...
module NSXT
  class LogicalRouterStatusPerNode
    ...
    def self.openapi_types
      {
        :'high_availability_status' => :'Object',
        :'service_router_id' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::LogicalRouterStatusPerNode` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::LogicalRouterStatusPerNode`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'high_availability_status')
        self.high_availability_status = attributes[:'high_availability_status']
      end

      if attributes.key?(:'service_router_id')
    ...
    def valid?
      ...
      high_availability_status_validator = EnumAttributeValidator.new('Object', ['ACTIVE', 'STANDBY', 'DOWN', 'SYNC', 'UNKNOWN'])
    ...
    def high_availability_status=(high_availability_status)
      validator = EnumAttributeValidator.new('Object', ['ACTIVE', 'STANDBY', 'DOWN', 'SYNC', 'UNKNOWN'])
