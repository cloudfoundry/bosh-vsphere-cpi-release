...
module NSXT
  ...
  class SVMDeploymentSpec
    ...
    def self.openapi_types
      {
        :'min_host_version' => :'Object',
        :'ovf_url' => :'Object',
        :'service_form_factor' => :'Object',
        :'host_type' => :'Object',
        :'name' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::SVMDeploymentSpec` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::SVMDeploymentSpec`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'min_host_version')
      ...
      if attributes.key?(:'service_form_factor')
    ...
    def valid?
      ...
      service_form_factor_validator = EnumAttributeValidator.new('Object', ['SMALL', 'MEDIUM', 'LARGE'])
      return false unless service_form_factor_validator.valid?(@service_form_factor)
      return false if @host_type.nil?
      host_type_validator = EnumAttributeValidator.new('Object', ['ESXI', 'RHELKVM', 'UBUNTUKVM'])
    ...
    def service_form_factor=(service_form_factor)
      validator = EnumAttributeValidator.new('Object', ['SMALL', 'MEDIUM', 'LARGE'])
    ...
    def host_type=(host_type)
      validator = EnumAttributeValidator.new('Object', ['ESXI', 'RHELKVM', 'UBUNTUKVM'])
