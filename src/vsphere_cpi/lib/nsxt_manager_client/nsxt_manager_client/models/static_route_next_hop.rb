...
module NSXT
  class StaticRouteNextHop
    ...
    def self.openapi_types
      {
        :'blackhole_action' => :'Object',
        :'administrative_distance' => :'Object',
        :'ip_address' => :'Object',
        :'bfd_enabled' => :'Object',
        :'logical_router_port_id' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::StaticRouteNextHop` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::StaticRouteNextHop`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'blackhole_action')
        self.blackhole_action = attributes[:'blackhole_action']
      end

      if attributes.key?(:'administrative_distance')
      ...
      if attributes.key?(:'bfd_enabled')
        self.bfd_enabled = attributes[:'bfd_enabled']
      else
        self.bfd_enabled = false
      end

      if attributes.key?(:'logical_router_port_id')
    ...
    def valid?
      blackhole_action_validator = EnumAttributeValidator.new('Object', ['DISCARD'])
    ...
    def blackhole_action=(blackhole_action)
      validator = EnumAttributeValidator.new('Object', ['DISCARD'])
