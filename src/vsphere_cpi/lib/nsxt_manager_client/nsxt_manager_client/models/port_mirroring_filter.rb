  ...
  class PortMirroringFilter
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::PortMirroringFilter` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::PortMirroringFilter`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'src_ips')
        self.src_ips = attributes[:'src_ips']
      end

      if attributes.key?(:'dst_ips')
        self.dst_ips = attributes[:'dst_ips']
      end

      if attributes.key?(:'dst_ports')
        self.dst_ports = attributes[:'dst_ports']
      end

      if attributes.key?(:'src_ports')
    ...
    def valid?
      filter_action_validator = EnumAttributeValidator.new('Object', ['MIRROR', 'DO_NOT_MIRROR'])
      return false unless filter_action_validator.valid?(@filter_action)
      ip_protocol_validator = EnumAttributeValidator.new('Object', ['TCP', 'UDP'])
    ...
    def filter_action=(filter_action)
      validator = EnumAttributeValidator.new('Object', ['MIRROR', 'DO_NOT_MIRROR'])
    ...
    def ip_protocol=(ip_protocol)
      validator = EnumAttributeValidator.new('Object', ['TCP', 'UDP'])
