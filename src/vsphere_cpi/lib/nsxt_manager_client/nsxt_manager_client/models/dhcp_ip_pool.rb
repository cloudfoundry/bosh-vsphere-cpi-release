  ...
  class DhcpIpPool
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::DhcpIpPool` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::DhcpIpPool`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'allocation_ranges')
      ...
      if attributes.key?(:'error_threshold')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          error_threshold == o.error_threshold && super(o)
    end
    ...
    def hash
      [lease_time, gateway_ip, options, allocation_ranges, warning_threshold, error_threshold].hash
    end
