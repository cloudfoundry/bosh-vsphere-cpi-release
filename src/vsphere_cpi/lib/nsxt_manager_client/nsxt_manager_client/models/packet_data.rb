  ...
  class PacketData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::PacketData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::PacketData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      transport_type_validator = EnumAttributeValidator.new('Object', ['BROADCAST', 'UNICAST', 'MULTICAST', 'UNKNOWN'])
      return false unless transport_type_validator.valid?(@transport_type)
      return false if @resource_type.nil?
      resource_type_validator = EnumAttributeValidator.new('Object', ['BinaryPacketData', 'FieldsPacketData'])
    ...
    def transport_type=(transport_type)
      validator = EnumAttributeValidator.new('Object', ['BROADCAST', 'UNICAST', 'MULTICAST', 'UNKNOWN'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('Object', ['BinaryPacketData', 'FieldsPacketData'])
