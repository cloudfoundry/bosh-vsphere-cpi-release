  ...
  class ContainerApplicationInstance
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::ContainerApplicationInstance` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::ContainerApplicationInstance`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'container_cluster_id')
        self.container_cluster_id = attributes[:'container_cluster_id']
      end

      if attributes.key?(:'cluster_node_id')
      ...
      if attributes.key?(:'origin_properties')
        if (value = attributes[:'origin_properties']).is_a?(Array)
          self.origin_properties = value
        end
      end

      if attributes.key?(:'container_application_ids')
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('', ['UNKNOWN', 'HEALTHY', 'UP', 'DOWN', 'DEGRADED'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('', ['UNKNOWN', 'HEALTHY', 'UP', 'DOWN', 'DEGRADED'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          container_project_id == o.container_project_id && super(o)
    end
    ...
    def hash
      [_last_sync_time, display_name, description, resource_type, tags, status, container_cluster_id, cluster_node_id, external_id, origin_properties, container_application_ids, container_project_id].hash
    end
