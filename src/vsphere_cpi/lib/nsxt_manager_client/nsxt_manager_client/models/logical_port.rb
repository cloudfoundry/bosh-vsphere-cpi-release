  ...
  class LogicalPort
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::LogicalPort` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::LogicalPort`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'logical_switch_id')
        self.logical_switch_id = attributes[:'logical_switch_id']
      end

      if attributes.key?(:'init_state')
      ...
      if attributes.key?(:'ignore_address_bindings')
    ...
    def valid?
      ...
      init_state_validator = EnumAttributeValidator.new('', ['UNBLOCKED_VLAN'])
    ...
    def init_state=(init_state)
      validator = EnumAttributeValidator.new('', ['UNBLOCKED_VLAN'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ignore_address_bindings == o.ignore_address_bindings && super(o)
    end
    ...
    def hash
      [_system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, logical_switch_id, init_state, switching_profile_ids, attachment, admin_state, extra_configs, address_bindings, ignore_address_bindings].hash
    end
