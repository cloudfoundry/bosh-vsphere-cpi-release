  ...
  class IntelligenceClusterNodeVMDeploymentRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::IntelligenceClusterNodeVMDeploymentRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::IntelligenceClusterNodeVMDeploymentRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      form_factor_validator = EnumAttributeValidator.new('Object', ['SMALL', 'LARGE'])
    ...
    def form_factor=(form_factor)
      validator = EnumAttributeValidator.new('Object', ['SMALL', 'LARGE'])
