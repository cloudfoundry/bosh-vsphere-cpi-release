  ...
  class StaticIpMacListSpec
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::StaticIpMacListSpec` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::StaticIpMacListSpec`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('', ['StaticIpPoolSpec', 'StaticIpListSpec', 'AssignedByDhcp', 'StaticIpMacListSpec'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('', ['StaticIpPoolSpec', 'StaticIpListSpec', 'AssignedByDhcp', 'StaticIpMacListSpec'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          default_gateway == o.default_gateway && super(o)
    end
