...
module NSXT
  ...
  class L2VPNPerLSTrafficStatistics
    ...
    def self.openapi_types
      {
        :'packets_out' => :'Object',
        :'packets_receive_error' => :'Object',
        :'bytes_in' => :'Object',
        :'bum_packets_in' => :'Object',
        :'bum_bytes_out' => :'Object',
        :'logical_switch' => :'Object',
        :'bytes_out' => :'Object',
        :'packets_sent_error' => :'Object',
        :'bum_packets_out' => :'Object',
        :'packets_in' => :'Object',
        :'bum_bytes_in' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::L2VPNPerLSTrafficStatistics` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::L2VPNPerLSTrafficStatistics`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'packets_receive_error')
      ...
      if attributes.key?(:'bum_packets_in')
        self.bum_packets_in = attributes[:'bum_packets_in']
      end

      if attributes.key?(:'bum_bytes_out')
        self.bum_bytes_out = attributes[:'bum_bytes_out']
      end

      if attributes.key?(:'logical_switch')
      ...
      if attributes.key?(:'packets_sent_error')
        self.packets_sent_error = attributes[:'packets_sent_error']
      end

      if attributes.key?(:'bum_packets_out')
      ...
      if attributes.key?(:'bum_bytes_in')
