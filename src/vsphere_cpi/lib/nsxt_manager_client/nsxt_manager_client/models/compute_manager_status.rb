  ...
  class ComputeManagerStatus
    ...
    def self.openapi_types
      {
        ...
        :'connection_status_details' => :'Object',
        :'registration_errors' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::ComputeManagerStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::ComputeManagerStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'connection_errors')
      ...
      if attributes.key?(:'connection_status_details')
        self.connection_status_details = attributes[:'connection_status_details']
      end

      if attributes.key?(:'registration_errors')
    ...
    def valid?
      connection_status_validator = EnumAttributeValidator.new('Object', ['UP', 'DOWN', 'CONNECTING'])
      return false unless connection_status_validator.valid?(@connection_status)
      registration_status_validator = EnumAttributeValidator.new('Object', ['REGISTERED', 'UNREGISTERED', 'REGISTERING'])
    ...
    def connection_status=(connection_status)
      validator = EnumAttributeValidator.new('Object', ['UP', 'DOWN', 'CONNECTING'])
    ...
    def registration_status=(registration_status)
      validator = EnumAttributeValidator.new('Object', ['REGISTERED', 'UNREGISTERED', 'REGISTERING'])
