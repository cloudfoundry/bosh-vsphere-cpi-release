...
module NSXT
  ...
  class StandardHostSwitch
    ...
    def self.openapi_types
      {
        :'pnics_uninstall_migration' => :'Object',
        :'ip_assignment_spec' => :'Object',
        :'cpu_config' => :'Object',
        :'is_migrate_pnics' => :'Object',
        :'vmk_uninstall_migration' => :'Object',
        :'pnics' => :'Object',
        :'host_switch_name' => :'Object',
        :'vmk_install_migration' => :'Object',
        :'host_switch_profile_ids' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::StandardHostSwitch` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::StandardHostSwitch`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'pnics_uninstall_migration')
        if (value = attributes[:'pnics_uninstall_migration']).is_a?(Array)
          self.pnics_uninstall_migration = value
        end
      end

      if attributes.key?(:'ip_assignment_spec')
        self.ip_assignment_spec = attributes[:'ip_assignment_spec']
      end

      if attributes.key?(:'cpu_config')
        if (value = attributes[:'cpu_config']).is_a?(Array)
          self.cpu_config = value
        end
      end

      if attributes.key?(:'is_migrate_pnics')
        self.is_migrate_pnics = attributes[:'is_migrate_pnics']
      else
        self.is_migrate_pnics = false
      end

      if attributes.key?(:'vmk_uninstall_migration')
        if (value = attributes[:'vmk_uninstall_migration']).is_a?(Array)
          self.vmk_uninstall_migration = value
        end
      end

      if attributes.key?(:'pnics')
