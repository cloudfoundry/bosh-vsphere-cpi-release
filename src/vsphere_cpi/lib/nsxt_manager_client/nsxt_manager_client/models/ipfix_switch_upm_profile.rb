  ...
  class IpfixSwitchUpmProfile
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::IpfixSwitchUpmProfile` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::IpfixSwitchUpmProfile`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'collector_profile')
      ...
      if attributes.key?(:'observation_domain_id')
      ...
      if attributes.key?(:'export_overlay_flow')
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('', ['IpfixSwitchUpmProfile'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('', ['IpfixSwitchUpmProfile'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          packet_sample_probability == o.packet_sample_probability && super(o)
    end
    ...
    def hash
      [resource_type, priority, collector_profile, idle_timeout, max_flows, observation_domain_id, active_timeout, export_overlay_flow, applied_tos, packet_sample_probability].hash
    end
