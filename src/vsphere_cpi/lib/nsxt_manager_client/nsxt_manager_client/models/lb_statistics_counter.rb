...
module NSXT
  class LbStatisticsCounter
    ...
    def self.openapi_types
      {
        :'source_ip_persistence_entry_size' => :'Object',
        :'packets_out' => :'Object',
        :'bytes_out_rate' => :'Object',
        :'total_sessions' => :'Object',
        :'http_request_rate' => :'Object',
        :'bytes_out' => :'Object',
        :'packets_in_rate' => :'Object',
        :'bytes_in_rate' => :'Object',
        :'current_sessions' => :'Object',
        :'max_sessions' => :'Object',
        :'packets_out_rate' => :'Object',
        :'http_requests' => :'Object',
        :'bytes_in' => :'Object',
        :'current_session_rate' => :'Object',
        :'packets_in' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::LbStatisticsCounter` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::LbStatisticsCounter`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'source_ip_persistence_entry_size')
      ...
      if attributes.key?(:'bytes_out_rate')
      ...
      if attributes.key?(:'http_request_rate')
      ...
      if attributes.key?(:'packets_in_rate')
        self.packets_in_rate = attributes[:'packets_in_rate']
      end

      if attributes.key?(:'bytes_in_rate')
        self.bytes_in_rate = attributes[:'bytes_in_rate']
      end

      if attributes.key?(:'current_sessions')
      ...
      if attributes.key?(:'packets_out_rate')
      ...
      if attributes.key?(:'current_session_rate')
