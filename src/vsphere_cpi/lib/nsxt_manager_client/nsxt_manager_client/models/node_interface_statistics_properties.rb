  ...
  class NodeInterfaceStatisticsProperties
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::NodeInterfaceStatisticsProperties` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::NodeInterfaceStatisticsProperties`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'tx_dropped')
        self.tx_dropped = attributes[:'tx_dropped']
      end

      if attributes.key?(:'rx_packets')
        self.rx_packets = attributes[:'rx_packets']
      end

      if attributes.key?(:'tx_carrier')
      ...
      if attributes.key?(:'tx_colls')
        self.tx_colls = attributes[:'tx_colls']
      end

      if attributes.key?(:'rx_frame')
        self.rx_frame = attributes[:'rx_frame']
      end

      if attributes.key?(:'rx_errors')
      ...
      if attributes.key?(:'rx_dropped')
        self.rx_dropped = attributes[:'rx_dropped']
      end

      if attributes.key?(:'tx_packets')
