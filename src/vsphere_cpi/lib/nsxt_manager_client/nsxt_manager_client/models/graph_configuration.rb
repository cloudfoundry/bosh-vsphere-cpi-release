  ...
  class GraphConfiguration
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::GraphConfiguration` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::GraphConfiguration`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'graphs')
        if (value = attributes[:'graphs']).is_a?(Array)
          self.graphs = value
        end
      end

      if attributes.key?(:'axes')
      ...
      if attributes.key?(:'display_x_value')
    ...
    def valid?
      ...
      sub_type_validator = EnumAttributeValidator.new('', ['LINE_GRAPH', 'BAR_GRAPH', 'STACKED_BAR_GRAPH'])
    ...
    def sub_type=(sub_type)
      validator = EnumAttributeValidator.new('', ['LINE_GRAPH', 'BAR_GRAPH', 'STACKED_BAR_GRAPH'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sub_type == o.sub_type &&
          display_x_value == o.display_x_value && super(o)
    end
    ...
    def hash
      [resource_type, display_name, datasources, weight, icons, shared, footer, drilldown_id, is_drilldown, legend, graphs, axes, navigation, sub_type, display_x_value].hash
    end
