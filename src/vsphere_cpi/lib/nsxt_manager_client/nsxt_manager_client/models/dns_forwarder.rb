  ...
  class DnsForwarder
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::DnsForwarder` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::DnsForwarder`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'conditional_forwarders')
      ...
      if attributes.key?(:'default_forwarder')
    ...
    def valid?
      ...
      log_level_validator = EnumAttributeValidator.new('', ['DEBUG', 'INFO', 'WARNING', 'ERROR', 'FATAL'])
    ...
    def log_level=(log_level)
      validator = EnumAttributeValidator.new('', ['DEBUG', 'INFO', 'WARNING', 'ERROR', 'FATAL'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enabled == o.enabled &&
          listener_ip == o.listener_ip && super(o)
    end
    ...
    def hash
      [_system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, conditional_forwarders, logical_router_id, cache_size, default_forwarder, log_level, enabled, listener_ip].hash
    end
