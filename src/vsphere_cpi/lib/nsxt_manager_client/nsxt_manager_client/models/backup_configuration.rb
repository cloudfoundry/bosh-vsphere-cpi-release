  ...
  class BackupConfiguration
    ...
    def self.openapi_types
      {
        ...
        :'after_inventory_update_interval' => :'Object',
        :'inventory_summary_interval' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::BackupConfiguration` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::BackupConfiguration`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'backup_enabled')
      ...
      if attributes.key?(:'after_inventory_update_interval')
        self.after_inventory_update_interval = attributes[:'after_inventory_update_interval']
      end

      if attributes.key?(:'inventory_summary_interval')
