  ...
  class LbServiceUsage
    ...
    def self.openapi_types
      {
        ...
        :'service_size' => :'Object',
        :'severity' => :'Object',
        :'pool_member_capacity' => :'Object',
        :'current_virtual_server_count' => :'Object',
        :'usage_percentage' => :'Object',
        :'service_id' => :'Object',
        :'current_pool_count' => :'Object',
        :'virtual_server_capacity' => :'Object',
        :'current_pool_member_count' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::LbServiceUsage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::LbServiceUsage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'pool_capacity')
        self.pool_capacity = attributes[:'pool_capacity']
      end

      if attributes.key?(:'service_size')
      ...
      if attributes.key?(:'pool_member_capacity')
        self.pool_member_capacity = attributes[:'pool_member_capacity']
      end

      if attributes.key?(:'current_virtual_server_count')
      ...
      if attributes.key?(:'current_pool_count')
        self.current_pool_count = attributes[:'current_pool_count']
      end

      if attributes.key?(:'virtual_server_capacity')
        self.virtual_server_capacity = attributes[:'virtual_server_capacity']
      end

      if attributes.key?(:'current_pool_member_count')
    ...
    def valid?
      service_size_validator = EnumAttributeValidator.new('Object', ['SMALL', 'MEDIUM', 'LARGE', 'DLB'])
      return false unless service_size_validator.valid?(@service_size)
      severity_validator = EnumAttributeValidator.new('Object', ['GREEN', 'ORANGE', 'RED'])
    ...
    def service_size=(service_size)
      validator = EnumAttributeValidator.new('Object', ['SMALL', 'MEDIUM', 'LARGE', 'DLB'])
    ...
    def severity=(severity)
      validator = EnumAttributeValidator.new('Object', ['GREEN', 'ORANGE', 'RED'])
