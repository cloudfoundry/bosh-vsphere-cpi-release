  ...
  class TraceflowObservationForwardedLogical
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::TraceflowObservationForwardedLogical` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::TraceflowObservationForwardedLogical`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'service_path_index')
      ...
      if attributes.key?(:'service_index')
        self.service_index = attributes[:'service_index']
      end

      if attributes.key?(:'dst_component_type')
        self.dst_component_type = attributes[:'dst_component_type']
      end

      if attributes.key?(:'dst_component_name')
      ...
      if attributes.key?(:'translated_src_ip')
        self.translated_src_ip = attributes[:'translated_src_ip']
      end

      if attributes.key?(:'translated_dst_ip')
      ...
      if attributes.key?(:'dst_component_id')
        self.dst_component_id = attributes[:'dst_component_id']
      end

      if attributes.key?(:'service_ttl')
    ...
    def valid?
      component_sub_type_validator = EnumAttributeValidator.new('', ['LR_TIER0', 'LR_TIER1', 'LR_VRF_TIER0', 'LS_TRANSIT', 'SI_CLASSIFIER', 'SI_PROXY', 'VDR', 'ENI', 'AWS_GATEWAY', 'TGW_ROUTE', 'EDGE_UPLINK', 'UNKNOWN'])
      return false unless component_sub_type_validator.valid?(@component_sub_type)
      return false if @resource_type.nil?
      resource_type_validator = EnumAttributeValidator.new('', ['TraceflowObservationForwarded', 'TraceflowObservationDropped', 'TraceflowObservationDelivered', 'TraceflowObservationReceived', 'TraceflowObservationForwardedLogical', 'TraceflowObservationDroppedLogical', 'TraceflowObservationReceivedLogical', 'TraceflowObservationReplicationLogical', 'TraceflowObservationRelayedLogical'])
      return false unless resource_type_validator.valid?(@resource_type)
      component_type_validator = EnumAttributeValidator.new('', ['PHYSICAL', 'LR', 'LS', 'DFW', 'BRIDGE', 'EDGE_TUNNEL', 'EDGE_HOSTSWITCH', 'FW_BRIDGE', 'LOAD_BALANCER', 'NAT', 'IPSEC', 'SERVICE_INSERTION', 'VMC', 'EDGE_FW', 'UNKNOWN'])
      return false unless component_type_validator.valid?(@component_type)
      transport_node_type_validator = EnumAttributeValidator.new('', ['ESX', 'RHELKVM', 'UBUNTUKVM', 'EDGE', 'PUBLIC_CLOUD_GATEWAY_NODE', 'OTHERS', 'HYPERV'])
      return false unless transport_node_type_validator.valid?(@transport_node_type)
      resend_type_validator = EnumAttributeValidator.new('', ['UNKNOWN', 'ARP_UNKNOWN_FROM_CP', 'ND_NS_UNKNWON_FROM_CP'])
      return false unless resend_type_validator.valid?(@resend_type)
      dst_component_type_validator = EnumAttributeValidator.new('', ['PHYSICAL', 'LR', 'LS', 'DFW', 'BRIDGE', 'EDGE_TUNNEL', 'EDGE_HOSTSWITCH', 'FW_BRIDGE', 'LOAD_BALANCER', 'NAT', 'IPSEC', 'SERVICE_INSERTION', 'VMC', 'EDGE_FW', 'UNKNOWN'])
    ...
    def component_sub_type=(component_sub_type)
      validator = EnumAttributeValidator.new('', ['LR_TIER0', 'LR_TIER1', 'LR_VRF_TIER0', 'LS_TRANSIT', 'SI_CLASSIFIER', 'SI_PROXY', 'VDR', 'ENI', 'AWS_GATEWAY', 'TGW_ROUTE', 'EDGE_UPLINK', 'UNKNOWN'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('', ['TraceflowObservationForwarded', 'TraceflowObservationDropped', 'TraceflowObservationDelivered', 'TraceflowObservationReceived', 'TraceflowObservationForwardedLogical', 'TraceflowObservationDroppedLogical', 'TraceflowObservationReceivedLogical', 'TraceflowObservationReplicationLogical', 'TraceflowObservationRelayedLogical'])
    ...
    def component_type=(component_type)
      validator = EnumAttributeValidator.new('', ['PHYSICAL', 'LR', 'LS', 'DFW', 'BRIDGE', 'EDGE_TUNNEL', 'EDGE_HOSTSWITCH', 'FW_BRIDGE', 'LOAD_BALANCER', 'NAT', 'IPSEC', 'SERVICE_INSERTION', 'VMC', 'EDGE_FW', 'UNKNOWN'])
    ...
    def transport_node_type=(transport_node_type)
      validator = EnumAttributeValidator.new('', ['ESX', 'RHELKVM', 'UBUNTUKVM', 'EDGE', 'PUBLIC_CLOUD_GATEWAY_NODE', 'OTHERS', 'HYPERV'])
    ...
    def resend_type=(resend_type)
      validator = EnumAttributeValidator.new('', ['UNKNOWN', 'ARP_UNKNOWN_FROM_CP', 'ND_NS_UNKNWON_FROM_CP'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_ttl == o.service_ttl && super(o)
    end
