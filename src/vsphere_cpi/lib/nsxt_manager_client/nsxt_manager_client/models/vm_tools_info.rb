  ...
  class VmToolsInfo
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::VmToolsInfo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::VmToolsInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'network_agent_version')
        self.network_agent_version = attributes[:'network_agent_version']
      end

      if attributes.key?(:'host_local_id')
      ...
      if attributes.key?(:'file_agent_version')
    ...
    def valid?
      ...
      vm_type_validator = EnumAttributeValidator.new('', ['EDGE', 'SERVICE', 'REGULAR'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          file_agent_version == o.file_agent_version && super(o)
    end
    ...
    def hash
      [_last_sync_time, display_name, description, resource_type, tags, source, vm_type, network_agent_version, host_local_id, external_id, tools_version, file_agent_version].hash
    end
