  ...
  class IPMirrorDestination
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::IPMirrorDestination` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::IPMirrorDestination`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('', ['LogicalPortMirrorDestination', 'PnicMirrorDestination', 'IPMirrorDestination'])
      return false unless resource_type_validator.valid?(@resource_type)
      return false if @destination_ips.nil?
      return false if @encapsulation_type.nil?
      encapsulation_type_validator = EnumAttributeValidator.new('', ['GRE', 'ERSPAN_TWO', 'ERSPAN_THREE'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('', ['LogicalPortMirrorDestination', 'PnicMirrorDestination', 'IPMirrorDestination'])
    ...
    def encapsulation_type=(encapsulation_type)
      validator = EnumAttributeValidator.new('', ['GRE', 'ERSPAN_TWO', 'ERSPAN_THREE'])
