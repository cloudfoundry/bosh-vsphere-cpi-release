  ...
  class PrincipalIdentityWithCertificate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::PrincipalIdentityWithCertificate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::PrincipalIdentityWithCertificate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          node_id == o.node_id &&
          certificate_pem == o.certificate_pem && super(o)
    end
    ...
    def hash
      [is_protected, role, name, permission_group, certificate_id, node_id, certificate_pem].hash
    end
