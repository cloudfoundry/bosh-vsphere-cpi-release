  ...
  class TraceflowObservationRelayedLogical
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::TraceflowObservationRelayedLogical` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::TraceflowObservationRelayedLogical`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'dst_server_address')
        self.dst_server_address = attributes[:'dst_server_address']
      end

      if attributes.key?(:'logical_comp_uuid')
        self.logical_comp_uuid = attributes[:'logical_comp_uuid']
      end

      if attributes.key?(:'relay_server_address')
    ...
    def valid?
      ...
      message_type_validator = EnumAttributeValidator.new('', ['REQUEST', 'REPLY'])
    ...
    def message_type=(message_type)
      validator = EnumAttributeValidator.new('', ['REQUEST', 'REPLY'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          relay_server_address == o.relay_server_address && super(o)
    end
