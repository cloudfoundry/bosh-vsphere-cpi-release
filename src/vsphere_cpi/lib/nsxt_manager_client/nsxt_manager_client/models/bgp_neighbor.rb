  ...
  class BgpNeighbor
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::BgpNeighbor` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::BgpNeighbor`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'remote_as_num')
    ...
    def valid?
      graceful_restart_mode_validator = EnumAttributeValidator.new('', ['DISABLE', 'HELPER_ONLY', 'GR_AND_HELPER'])
    ...
    def graceful_restart_mode=(graceful_restart_mode)
      validator = EnumAttributeValidator.new('', ['DISABLE', 'HELPER_ONLY', 'GR_AND_HELPER'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          neighbor_address == o.neighbor_address && super(o)
    end
