  ...
  class NSGroupSimpleExpression
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::NSGroupSimpleExpression` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::NSGroupSimpleExpression`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'target_property')
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('', ['NSGroupSimpleExpression', 'NSGroupComplexExpression', 'NSGroupTagExpression'])
      return false unless resource_type_validator.valid?(@resource_type)
      return false if @target_property.nil?
      return false if @target_type.nil?
      target_type_validator = EnumAttributeValidator.new('', ['NSGroup', 'IPSet', 'MACSet', 'LogicalSwitch', 'LogicalPort', 'VirtualMachine', 'DirectoryGroup', 'VirtualNetworkInterface', 'TransportNode'])
      return false unless target_type_validator.valid?(@target_type)
      return false if @value.nil?
      return false if @op.nil?
      op_validator = EnumAttributeValidator.new('', ['EQUALS', 'CONTAINS', 'STARTSWITH', 'ENDSWITH', 'NOTEQUALS'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('', ['NSGroupSimpleExpression', 'NSGroupComplexExpression', 'NSGroupTagExpression'])
    ...
    def target_type=(target_type)
      validator = EnumAttributeValidator.new('', ['NSGroup', 'IPSet', 'MACSet', 'LogicalSwitch', 'LogicalPort', 'VirtualMachine', 'DirectoryGroup', 'VirtualNetworkInterface', 'TransportNode'])
    ...
    def op=(op)
      validator = EnumAttributeValidator.new('', ['EQUALS', 'CONTAINS', 'STARTSWITH', 'ENDSWITH', 'NOTEQUALS'])
