  ...
  class TraceflowObservationDelivered
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::TraceflowObservationDelivered` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::TraceflowObservationDelivered`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      resolution_type_validator = EnumAttributeValidator.new('', ['UNKNOWN', 'ARP_SUPPRESSION_PORT_CACHE', 'ARP_SUPPRESSION_TABLE', 'ARP_SUPPRESSION_CP_QUERY', 'ARP_VM'])
    ...
    def resolution_type=(resolution_type)
      validator = EnumAttributeValidator.new('', ['UNKNOWN', 'ARP_SUPPRESSION_PORT_CACHE', 'ARP_SUPPRESSION_TABLE', 'ARP_SUPPRESSION_CP_QUERY', 'ARP_VM'])
