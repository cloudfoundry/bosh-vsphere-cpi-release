...
module NSXT
  class DhcpIpPoolUsage
    ...
    def self.openapi_types
      {
        :'allocated_percentage' => :'Object',
        :'pool_size' => :'Object',
        :'allocated_number' => :'Object',
        :'dhcp_ip_pool_id' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::DhcpIpPoolUsage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::DhcpIpPoolUsage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'allocated_percentage')
      ...
      if attributes.key?(:'allocated_number')
        self.allocated_number = attributes[:'allocated_number']
      end

      if attributes.key?(:'dhcp_ip_pool_id')
