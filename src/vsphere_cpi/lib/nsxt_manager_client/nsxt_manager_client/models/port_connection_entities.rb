  ...
  class PortConnectionEntities
    ...
    def self.openapi_types
      {
        ...
        :'hypervisors' => :'Object',
        :'errors' => :'Object',
        :'logical_switches' => :'Object',
        :'edge_node_groups' => :'Object',
        :'routers' => :'Object',
        :'vms' => :'Object',
        :'tunnels' => :'Object',
        :'physical_hosts' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::PortConnectionEntities` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::PortConnectionEntities`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'physical_hosts')
