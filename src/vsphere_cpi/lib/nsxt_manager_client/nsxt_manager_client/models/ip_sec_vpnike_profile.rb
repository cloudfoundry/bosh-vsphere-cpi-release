  ...
  class IPSecVPNIKEProfile
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::IPSecVPNIKEProfile` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::IPSecVPNIKEProfile`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ike_version_validator = EnumAttributeValidator.new('', ['IKE_V1', 'IKE_V2', 'IKE_FLEX'])
    ...
    def ike_version=(ike_version)
      validator = EnumAttributeValidator.new('', ['IKE_V1', 'IKE_V2', 'IKE_FLEX'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ike_version == o.ike_version && super(o)
    end
    ...
    def hash
      [_system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, digest_algorithms, encryption_algorithms, dh_groups, sa_life_time, ike_version].hash
    end
