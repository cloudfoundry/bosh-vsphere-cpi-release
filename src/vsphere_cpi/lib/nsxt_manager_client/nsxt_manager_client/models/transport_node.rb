  ...
  class TransportNode
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::TransportNode` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::TransportNode`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'host_switch_spec')
      ...
      if attributes.key?(:'node_deployment_info')
        self.node_deployment_info = attributes[:'node_deployment_info']
      end

      if attributes.key?(:'host_switches')
      ...
      if attributes.key?(:'failure_domain_id')
      ...
      if attributes.key?(:'transport_zone_endpoints')
    ...
    def valid?
      maintenance_mode_validator = EnumAttributeValidator.new('', ['ENABLED', 'FORCE_ENABLED', 'DISABLED'])
    ...
    def maintenance_mode=(maintenance_mode)
      validator = EnumAttributeValidator.new('', ['ENABLED', 'FORCE_ENABLED', 'DISABLED'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transport_zone_endpoints == o.transport_zone_endpoints && super(o)
    end
    ...
    def hash
      [_system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, host_switch_spec, node_id, node_deployment_info, host_switches, maintenance_mode, failure_domain_id, is_overridden, transport_zone_endpoints].hash
    end
