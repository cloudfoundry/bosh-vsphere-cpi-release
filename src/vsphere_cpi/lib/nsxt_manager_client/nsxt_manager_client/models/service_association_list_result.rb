  ...
  class ServiceAssociationListResult
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::ServiceAssociationListResult` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::ServiceAssociationListResult`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      service_type_validator = EnumAttributeValidator.new('', ['FireWallServiceAssociationListResult', 'IpfixServiceAssociationListResult'])
    ...
    def service_type=(service_type)
      validator = EnumAttributeValidator.new('', ['FireWallServiceAssociationListResult', 'IpfixServiceAssociationListResult'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_type == o.service_type && super(o)
    end
    ...
    def hash
      [cursor, sort_ascending, sort_by, result_count, service_type].hash
    end
