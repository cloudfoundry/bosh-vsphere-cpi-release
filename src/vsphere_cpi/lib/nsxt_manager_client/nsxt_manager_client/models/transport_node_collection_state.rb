...
module NSXT
  ...
  class TransportNodeCollectionState
    ...
    def self.openapi_types
      {
        :'state' => :'Object',
        :'aggregate_progress_percentage' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::TransportNodeCollectionState` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::TransportNodeCollectionState`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'aggregate_progress_percentage')
    ...
    def valid?
      state_validator = EnumAttributeValidator.new('Object', ['FAILED_TO_CREATE', 'FAILED_TO_REALIZE', 'IN_PROGRESS', 'PROFILE_MISMATCH', 'SUCCESS'])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('Object', ['FAILED_TO_CREATE', 'FAILED_TO_REALIZE', 'IN_PROGRESS', 'PROFILE_MISMATCH', 'SUCCESS'])
