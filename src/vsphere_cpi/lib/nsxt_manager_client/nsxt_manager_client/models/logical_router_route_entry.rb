  ...
  class LogicalRouterRouteEntry
    ...
    def self.openapi_types
      {
        ...
        :'next_hop' => :'Object',
        :'lr_component_type' => :'Object',
        :'network' => :'Object',
        :'route_type' => :'Object',
        :'logical_router_port_id' => :'Object',
        :'admin_distance' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::LogicalRouterRouteEntry` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::LogicalRouterRouteEntry`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'lr_component_type')
      ...
      if attributes.key?(:'admin_distance')
