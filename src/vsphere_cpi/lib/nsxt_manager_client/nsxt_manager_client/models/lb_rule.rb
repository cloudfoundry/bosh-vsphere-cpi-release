  ...
  class LbRule
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::LbRule` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::LbRule`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'match_strategy')
    ...
    def valid?
      ...
      phase_validator = EnumAttributeValidator.new('', ['HTTP_REQUEST_REWRITE', 'HTTP_FORWARDING', 'HTTP_RESPONSE_REWRITE'])
      return false unless phase_validator.valid?(@phase)
      return false if @actions.nil?
      return false if @match_strategy.nil?
      match_strategy_validator = EnumAttributeValidator.new('', ['ALL', 'ANY'])
    ...
    def phase=(phase)
      validator = EnumAttributeValidator.new('', ['HTTP_REQUEST_REWRITE', 'HTTP_FORWARDING', 'HTTP_RESPONSE_REWRITE'])
    ...
    def match_strategy=(match_strategy)
      validator = EnumAttributeValidator.new('', ['ALL', 'ANY'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          actions == o.actions &&
          match_strategy == o.match_strategy && super(o)
    end
    ...
    def hash
      [_system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, phase, match_conditions, actions, match_strategy].hash
    end
