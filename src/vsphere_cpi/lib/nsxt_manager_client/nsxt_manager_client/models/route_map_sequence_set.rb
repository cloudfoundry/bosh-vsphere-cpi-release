  ...
  class RouteMapSequenceSet
    ...
    def self.openapi_types
      {
        ...
        :'as_path_prepend' => :'Object',
        :'community' => :'Object',
        :'multi_exit_discriminator' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::RouteMapSequenceSet` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::RouteMapSequenceSet`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'local_preference')
      ...
      if attributes.key?(:'large_community')
        self.large_community = attributes[:'large_community']
      end

      if attributes.key?(:'as_path_prepend')
      ...
      if attributes.key?(:'multi_exit_discriminator')
