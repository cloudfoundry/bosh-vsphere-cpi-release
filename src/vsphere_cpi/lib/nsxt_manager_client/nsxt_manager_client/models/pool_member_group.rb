...
module NSXT
  class PoolMemberGroup
    ...
    def self.openapi_types
      {
        :'grouping_object' => :'Object',
        :'ip_revision_filter' => :'Object',
        :'max_ip_list_size' => :'Object',
        :'port' => :'Object',
        :'customized_members' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::PoolMemberGroup` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::PoolMemberGroup`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'grouping_object')
        self.grouping_object = attributes[:'grouping_object']
      end

      if attributes.key?(:'ip_revision_filter')
        self.ip_revision_filter = attributes[:'ip_revision_filter']
      else
        self.ip_revision_filter = 'IPV4'
      end

      if attributes.key?(:'max_ip_list_size')
      ...
      if attributes.key?(:'customized_members')
    ...
    def valid?
      ...
      ip_revision_filter_validator = EnumAttributeValidator.new('Object', ['IPV4', 'IPV6', 'IPV4_IPV6'])
    ...
    def ip_revision_filter=(ip_revision_filter)
      validator = EnumAttributeValidator.new('Object', ['IPV4', 'IPV6', 'IPV4_IPV6'])
