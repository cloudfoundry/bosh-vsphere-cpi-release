  ...
  class IntelligenceVsphereClusterNodeVMDeploymentConfig
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::IntelligenceVsphereClusterNodeVMDeploymentConfig` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::IntelligenceVsphereClusterNodeVMDeploymentConfig`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'compute_id')
        self.compute_id = attributes[:'compute_id']
      end

      if attributes.key?(:'vc_id')
      ...
      if attributes.key?(:'management_network_id')
    ...
    def valid?
      ...
      placement_type_validator = EnumAttributeValidator.new('', ['IntelligenceVsphereClusterNodeVMDeploymentConfig'])
    ...
    def placement_type=(placement_type)
      validator = EnumAttributeValidator.new('', ['IntelligenceVsphereClusterNodeVMDeploymentConfig'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          host_id == o.host_id &&
          management_network_id == o.management_network_id && super(o)
    end
