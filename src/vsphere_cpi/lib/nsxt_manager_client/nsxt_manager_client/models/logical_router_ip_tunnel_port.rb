  ...
  class LogicalRouterIPTunnelPort
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::LogicalRouterIPTunnelPort` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::LogicalRouterIPTunnelPort`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'vpn_session_id')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vpn_session_id == o.vpn_session_id && super(o)
    end
    ...
    def hash
      [logical_router_id, service_bindings, resource_type, subnets, admin_state, vpn_session_id].hash
    end
