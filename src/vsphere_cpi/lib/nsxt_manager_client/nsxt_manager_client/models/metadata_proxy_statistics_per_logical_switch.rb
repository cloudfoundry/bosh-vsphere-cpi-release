...
module NSXT
  class MetadataProxyStatisticsPerLogicalSwitch
    ...
    def self.openapi_types
      {
        :'requests_to_nova_server' => :'Object',
        :'responses_to_clients' => :'Object',
        :'succeeded_responses_from_nova_server' => :'Object',
        :'logical_switch_id' => :'Object',
        :'requests_from_clients' => :'Object',
        :'error_responses_from_nova_server' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::MetadataProxyStatisticsPerLogicalSwitch` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::MetadataProxyStatisticsPerLogicalSwitch`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'requests_to_nova_server')
        self.requests_to_nova_server = attributes[:'requests_to_nova_server']
      end

      if attributes.key?(:'responses_to_clients')
        self.responses_to_clients = attributes[:'responses_to_clients']
      end

      if attributes.key?(:'succeeded_responses_from_nova_server')
      ...
      if attributes.key?(:'requests_from_clients')
        self.requests_from_clients = attributes[:'requests_from_clients']
      end

      if attributes.key?(:'error_responses_from_nova_server')
