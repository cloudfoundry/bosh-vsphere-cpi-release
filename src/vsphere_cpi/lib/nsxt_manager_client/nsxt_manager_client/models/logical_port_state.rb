...
module NSXT
  ...
  class LogicalPortState
    ...
    def self.openapi_types
      {
        :'duplicate_bindings' => :'Object',
        :'transport_node_ids' => :'Object',
        :'discovered_bindings' => :'Object',
        :'id' => :'Object',
        :'realized_bindings' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::LogicalPortState` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::LogicalPortState`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'duplicate_bindings')
        if (value = attributes[:'duplicate_bindings']).is_a?(Array)
          self.duplicate_bindings = value
        end
      end

      if attributes.key?(:'transport_node_ids')
        if (value = attributes[:'transport_node_ids']).is_a?(Array)
          self.transport_node_ids = value
        end
      end

      if attributes.key?(:'discovered_bindings')
      ...
      if attributes.key?(:'realized_bindings')
