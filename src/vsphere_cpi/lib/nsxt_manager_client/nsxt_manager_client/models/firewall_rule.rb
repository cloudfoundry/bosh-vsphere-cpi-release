  ...
  class FirewallRule
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::FirewallRule` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::FirewallRule`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          section_id == o.section_id && super(o)
    end
    ...
    def hash
      [is_default, direction, rule_tag, ip_protocol, notes, applied_tos, logged, disabled, sources, action, priority, sources_excluded, destinations_excluded, destinations, services, context_profiles, extended_sources, section_id].hash
    end
