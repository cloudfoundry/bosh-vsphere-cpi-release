  ...
  class ContainerCluster
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::ContainerCluster` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::ContainerCluster`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'infrastructure')
    ...
    def valid?
      ...
      cluster_type_validator = EnumAttributeValidator.new('', ['PAS', 'PKS', 'Kubernetes', 'Openshift', 'WCP', 'Other'])
    ...
    def cluster_type=(cluster_type)
      validator = EnumAttributeValidator.new('', ['PAS', 'PKS', 'Kubernetes', 'Openshift', 'WCP', 'Other'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          infrastructure == o.infrastructure && super(o)
    end
    ...
    def hash
      [_last_sync_time, display_name, description, resource_type, tags, cluster_type, origin_properties, external_id, infrastructure].hash
    end
