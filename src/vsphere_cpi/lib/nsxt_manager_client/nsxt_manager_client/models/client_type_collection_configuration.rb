...
module NSXT
  ...
  class ClientTypeCollectionConfiguration
    ...
    def self.openapi_types
      {
        :'client_type' => :'Object',
        :'data_type_configurations' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::ClientTypeCollectionConfiguration` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::ClientTypeCollectionConfiguration`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'data_type_configurations')
    ...
    def valid?
      ...
      client_type_validator = EnumAttributeValidator.new('Object', ['HYPERVISOR', 'EDGE', 'CONTROL_PLANE', 'CONTROL_PLANE_PLATFORM', 'MANAGEMENT_PLANE', 'MANAGEMENT_PLANE_PLATFORM'])
    ...
    def client_type=(client_type)
      validator = EnumAttributeValidator.new('Object', ['HYPERVISOR', 'EDGE', 'CONTROL_PLANE', 'CONTROL_PLANE_PLATFORM', 'MANAGEMENT_PLANE', 'MANAGEMENT_PLANE_PLATFORM'])
