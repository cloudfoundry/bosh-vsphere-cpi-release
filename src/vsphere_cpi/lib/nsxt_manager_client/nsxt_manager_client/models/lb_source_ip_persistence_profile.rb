  ...
  class LbSourceIpPersistenceProfile
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::LbSourceIpPersistenceProfile` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::LbSourceIpPersistenceProfile`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'purge')
        self.purge = attributes[:'purge']
      else
        self.purge = 'FULL'
      end

      if attributes.key?(:'ha_persistence_mirroring_enabled')
    ...
    def valid?
      ...
      purge_validator = EnumAttributeValidator.new('', ['NO_PURGE', 'FULL'])
    ...
    def purge=(purge)
      validator = EnumAttributeValidator.new('', ['NO_PURGE', 'FULL'])
    ...
    def hash
      [persistence_shared, resource_type, purge, ha_persistence_mirroring_enabled, timeout].hash
    end
