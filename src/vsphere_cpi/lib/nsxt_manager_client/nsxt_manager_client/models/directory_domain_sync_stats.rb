...
module NSXT
  ...
  class DirectoryDomainSyncStats
    ...
    def self.openapi_types
      {
        :'prev_sync_status' => :'Object',
        :'avg_full_sync_time' => :'Object',
        :'prev_sync_type' => :'Object',
        :'num_full_sync' => :'Object',
        :'current_state_begin_time' => :'Object',
        :'avg_delta_sync_time' => :'Object',
        :'prev_sync_error' => :'Object',
        :'current_state' => :'Object',
        :'num_delta_sync' => :'Object',
        :'prev_sync_end_time' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::DirectoryDomainSyncStats` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::DirectoryDomainSyncStats`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'prev_sync_status')
        self.prev_sync_status = attributes[:'prev_sync_status']
      end

      if attributes.key?(:'avg_full_sync_time')
        self.avg_full_sync_time = attributes[:'avg_full_sync_time']
      end

      if attributes.key?(:'prev_sync_type')
        self.prev_sync_type = attributes[:'prev_sync_type']
      end

      if attributes.key?(:'num_full_sync')
        self.num_full_sync = attributes[:'num_full_sync']
      end

      if attributes.key?(:'current_state_begin_time')
        self.current_state_begin_time = attributes[:'current_state_begin_time']
      end

      if attributes.key?(:'avg_delta_sync_time')
        self.avg_delta_sync_time = attributes[:'avg_delta_sync_time']
      end

      if attributes.key?(:'prev_sync_error')
      ...
      if attributes.key?(:'num_delta_sync')
        self.num_delta_sync = attributes[:'num_delta_sync']
      end

      if attributes.key?(:'prev_sync_end_time')
    ...
    def valid?
      prev_sync_status_validator = EnumAttributeValidator.new('Object', ['SUCCESS', 'FAILURE', 'UNKNOWN'])
      return false unless prev_sync_status_validator.valid?(@prev_sync_status)
      prev_sync_type_validator = EnumAttributeValidator.new('Object', ['IDLE', 'FULL_SYNC', 'DELTA_SYNC'])
      return false unless prev_sync_type_validator.valid?(@prev_sync_type)
      current_state_validator = EnumAttributeValidator.new('Object', ['IDLE', 'FULL_SYNC', 'DELTA_SYNC'])
    ...
    def prev_sync_status=(prev_sync_status)
      validator = EnumAttributeValidator.new('Object', ['SUCCESS', 'FAILURE', 'UNKNOWN'])
    ...
    def prev_sync_type=(prev_sync_type)
      validator = EnumAttributeValidator.new('Object', ['IDLE', 'FULL_SYNC', 'DELTA_SYNC'])
