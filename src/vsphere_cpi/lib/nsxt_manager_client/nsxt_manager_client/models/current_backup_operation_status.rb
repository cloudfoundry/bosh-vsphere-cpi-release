  ...
  class CurrentBackupOperationStatus
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::CurrentBackupOperationStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::CurrentBackupOperationStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'current_step_message')
    ...
    def valid?
      current_step_validator = EnumAttributeValidator.new('Object', ['BACKUP_CREATING_CLUSTER_BACKUP', 'BACKUP_CREATING_NODE_BACKUP'])
      return false unless current_step_validator.valid?(@current_step)
      return false if @operation_type.nil?
      operation_type_validator = EnumAttributeValidator.new('Object', ['NONE', 'BACKUP'])
    ...
    def current_step=(current_step)
      validator = EnumAttributeValidator.new('Object', ['BACKUP_CREATING_CLUSTER_BACKUP', 'BACKUP_CREATING_NODE_BACKUP'])
    ...
    def operation_type=(operation_type)
      validator = EnumAttributeValidator.new('Object', ['NONE', 'BACKUP'])
