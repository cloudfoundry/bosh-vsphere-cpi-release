...
module NSXT
  class ComponentUpgradeStatus
    ...
    def self.openapi_types
      {
        :'status' => :'Object',
        :'pre_upgrade_status' => :'Object',
        :'details' => :'Object',
        :'component_type' => :'Object',
        :'node_count_at_target_version' => :'Object',
        :'target_component_version' => :'Object',
        :'percent_complete' => :'Object',
        :'can_skip' => :'Object',
        :'current_version_node_summary' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::ComponentUpgradeStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::ComponentUpgradeStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('Object', ['SUCCESS', 'FAILED', 'IN_PROGRESS', 'NOT_STARTED', 'PAUSING', 'PAUSED'])
