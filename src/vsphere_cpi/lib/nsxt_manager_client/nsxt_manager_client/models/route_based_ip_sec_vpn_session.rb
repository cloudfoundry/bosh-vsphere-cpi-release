  ...
  class RouteBasedIPSecVPNSession
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::RouteBasedIPSecVPNSession` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::RouteBasedIPSecVPNSession`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'tunnel_ports')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tunnel_ports == o.tunnel_ports && super(o)
    end
    ...
    def hash
      [peer_endpoint_id, ipsec_vpn_service_id, local_endpoint_id, tcp_mss_clamping, enabled, resource_type, tunnel_ports].hash
    end
