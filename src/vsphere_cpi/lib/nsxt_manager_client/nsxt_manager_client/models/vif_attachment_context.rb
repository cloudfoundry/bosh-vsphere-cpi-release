  ...
  class VifAttachmentContext
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::VifAttachmentContext` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::VifAttachmentContext`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'allocate_addresses')
      ...
      if attributes.key?(:'vif_type')
        self.vif_type = attributes[:'vif_type']
      end

      if attributes.key?(:'parent_vif_id')
      ...
      if attributes.key?(:'traffic_tag')
        self.traffic_tag = attributes[:'traffic_tag']
      end

      if attributes.key?(:'transport_node_uuid')
    ...
    def valid?
      allocate_addresses_validator = EnumAttributeValidator.new('', ['IpPool', 'MacPool', 'Both', 'None'])
      return false unless allocate_addresses_validator.valid?(@allocate_addresses)
      return false if @resource_type.nil?
      return false if @vif_type.nil?
      vif_type_validator = EnumAttributeValidator.new('', ['PARENT', 'CHILD', 'INDEPENDENT'])
    ...
    def allocate_addresses=(allocate_addresses)
      validator = EnumAttributeValidator.new('', ['IpPool', 'MacPool', 'Both', 'None'])
    ...
    def vif_type=(vif_type)
      validator = EnumAttributeValidator.new('', ['PARENT', 'CHILD', 'INDEPENDENT'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transport_node_uuid == o.transport_node_uuid && super(o)
    end
