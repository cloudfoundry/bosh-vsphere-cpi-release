  ...
  class LbPoolMemberStatus
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::LbPoolMemberStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::LbPoolMemberStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'failure_cause')
        self.failure_cause = attributes[:'failure_cause']
      end

      if attributes.key?(:'last_check_time')
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('Object', ['UP', 'DOWN', 'DISABLED', 'GRACEFUL_DISABLED', 'UNUSED'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('Object', ['UP', 'DOWN', 'DISABLED', 'GRACEFUL_DISABLED', 'UNUSED'])
