  ...
  class TransportNodeState
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::TransportNodeState` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::TransportNodeState`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      maintenance_mode_state_validator = EnumAttributeValidator.new('', ['ENTERING', 'ENABLED', 'EXITING', 'DISABLED'])
    ...
    def maintenance_mode_state=(maintenance_mode_state)
      validator = EnumAttributeValidator.new('', ['ENTERING', 'ENABLED', 'EXITING', 'DISABLED'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transport_node_id == o.transport_node_id && super(o)
    end
