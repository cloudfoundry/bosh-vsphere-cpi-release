  ...
  class FirewallSection
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NSXT::FirewallSection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NSXT::FirewallSection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'lock_modified_by')
        self.lock_modified_by = attributes[:'lock_modified_by']
      end

      if attributes.key?(:'lock_modified_time')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          comments == o.comments &&
          autoplumbed == o.autoplumbed && super(o)
    end
    ...
    def hash
      [stateful, is_default, applied_tos, rule_count, section_type, priority, enforced_on, locked, tcp_strict, lock_modified_by, lock_modified_time, comments, autoplumbed].hash
    end
