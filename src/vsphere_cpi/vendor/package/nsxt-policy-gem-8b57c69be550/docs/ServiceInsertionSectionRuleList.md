# SwaggerClient::ServiceInsertionSectionRuleList
...
**rules** | [**Array&lt;ServiceInsertionRule&gt;**](ServiceInsertionRule.md) | List of Service Insertion rules in the section. Only homogeneous rules are supported. | 
