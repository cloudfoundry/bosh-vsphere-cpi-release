# SwaggerClient::ExternalIDExpression
...
**external_ids** | **Array&lt;String&gt;** | This array can consist of one or more external IDs for the specified member type. | 
**member_type** | **String** | External ID member type | 
