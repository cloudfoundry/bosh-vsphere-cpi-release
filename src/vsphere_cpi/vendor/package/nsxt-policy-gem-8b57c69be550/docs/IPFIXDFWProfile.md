...
**ipfix_dfw_collector_profile_path** | **String** | Policy path for IPFIX collector profiles. IPFIX data from these logical segments will be sent to all specified IPFIX collectors.  | 
...
**active_flow_export_timeout** | **Integer** | For long standing active flows, IPFIX records will be sent per timeout period in minutes.  | [default to 1]
