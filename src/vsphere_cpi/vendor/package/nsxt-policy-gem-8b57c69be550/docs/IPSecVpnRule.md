...
**sources** | [**Array&lt;IPSecVpnSubnet&gt;**](IPSecVpnSubnet.md) | List of local subnets. Specifying no value is interpreted as 0.0.0.0/0.  | [optional] 
...
**enabled** | **BOOLEAN** | A flag to enable/disable the rule. | [optional] [default to true]
**logged** | **BOOLEAN** | A flag to enable/disable the logging for the rule. | [optional] [default to false]
**sequence_number** | **Integer** | A sequence number is used to give a priority to an IPSecVpnRule. | [optional] 
**destinations** | [**Array&lt;IPSecVpnSubnet&gt;**](IPSecVpnSubnet.md) | List of peer subnets. Specifying no value is interpreted as 0.0.0.0/0.  | [optional] 
