# SwaggerClient::ServiceChainListResult
...
**results** | [**Array&lt;ServiceChain&gt;**](ServiceChain.md) | List of the Service-Insertion Services. The list has to be homogenous. | [optional] 
