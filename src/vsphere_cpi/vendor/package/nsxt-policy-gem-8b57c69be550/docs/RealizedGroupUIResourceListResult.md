# SwaggerClient::RealizedGroupUIResourceListResult
...
**results** | [**Array&lt;RealizedGroupUIResource&gt;**](RealizedGroupUIResource.md) | Intent and realized group list results | 
