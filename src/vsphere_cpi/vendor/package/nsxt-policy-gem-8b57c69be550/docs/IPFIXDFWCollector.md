# SwaggerClient::IPFIXDFWCollector
...
**collector_ip_address** | **String** | IP address for the IPFIX DFW collector. IP addresses such as 0.0.0.0, 127.0.0.1, 255.255.255.255 are invalid.  | 
**collector_port** | **Integer** | Port for the IPFIX DFW collector. | 
