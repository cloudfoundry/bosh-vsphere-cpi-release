...
**message** | **String** | User friendly message to be shown to users upon violation. | [optional] 
**constraint_expression** | [**ConstraintExpression**](ConstraintExpression.md) | Expression to constrain the target attribute value. | 
**target** | [**ConstraintTarget**](ConstraintTarget.md) | Target resource attribute details. | 
