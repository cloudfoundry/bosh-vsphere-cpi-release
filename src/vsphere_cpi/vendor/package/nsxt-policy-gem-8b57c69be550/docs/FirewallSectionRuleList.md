# SwaggerClient::FirewallSectionRuleList
...
**rules** | [**Array&lt;FirewallRule&gt;**](FirewallRule.md) | List of firewall rules in the section. Only homogenous rules are supported. | 
