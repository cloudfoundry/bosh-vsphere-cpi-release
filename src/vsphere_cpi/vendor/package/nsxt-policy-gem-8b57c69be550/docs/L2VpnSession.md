...
**transport_tunnels** | **Array&lt;String&gt;** | List of transport tunnels for redundancy. | 
**tunnel_encapsulation** | [**L2VPNTunnelEncapsulation**](L2VPNTunnelEncapsulation.md) | Tunnel encapsulation config. This property only applies in CLIENT mode. It is auto-populated from the L2VPNSessionData.  | [optional] 
