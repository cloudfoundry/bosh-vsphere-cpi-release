# SwaggerClient::PolicyTransportZone
...
**is_default** | **BOOLEAN** | Indicates whether the transport zone is default. | [optional] [default to false]
**tz_type** | **String** | Type of Transport Zone | [optional] 
**nsx_id** | **String** | UUID of transport zone on enforcement point. | [optional] 
