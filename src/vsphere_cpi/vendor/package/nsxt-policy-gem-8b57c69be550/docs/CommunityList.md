...
**communities** | **Array&lt;String&gt;** | List of BGP community entries. In additon to numbered communites (e.g. 3356:2040), predefined communities (NO_EXPORT, NO_ADVERTISE, NO_EXPORT_SUBCONFED) are supported.  | 
