# SwaggerClient::PortMirroringInstance
...
**direction** | **String** | Port mirroring instance direction | [optional] 
**destination_group** | **String** | Data from source group will be copied to members of destination group.  | 
