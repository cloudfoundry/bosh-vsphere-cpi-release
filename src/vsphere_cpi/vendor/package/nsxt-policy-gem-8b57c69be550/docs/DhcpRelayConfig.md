...
**server_addresses** | **Array&lt;String&gt;** | DHCP server IP addresses for DHCP relay configuration. Both IPv4 and IPv6 addresses are supported.  | 
