# SwaggerClient::ServiceInstanceEndpoint
...
**target_ips** | [**Array&lt;IPInfo&gt;**](IPInfo.md) | IPs where either inbound or outbound traffic is to be redirected.  | 
**service_interface_path** | **String** | Path of Service Interface to which this ServiceInstanceEndpoint is connected. | 
