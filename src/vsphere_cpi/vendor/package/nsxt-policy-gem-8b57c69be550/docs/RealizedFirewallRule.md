# SwaggerClient::RealizedFirewallRule
...
**direction** | **String** | Rule direction in case of stateless firewall rules. This will only considered if section level parameter is set to stateless. Default to IN_OUT if not specified. | [optional] [default to &#39;IN_OUT&#39;]
**services** | [**Array&lt;ResourceReference&gt;**](ResourceReference.md) | List of the services. Null will be treated as any. | [optional] 
**action** | **String** | Action enforced on the packets which matches the firewall rule. | [optional] 
