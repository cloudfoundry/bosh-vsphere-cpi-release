...
**next_hops** | [**Array&lt;RouterNexthop&gt;**](RouterNexthop.md) | Specify next hop routes for network.  | 
**network** | **String** | Specify network address in CIDR format.  | 
