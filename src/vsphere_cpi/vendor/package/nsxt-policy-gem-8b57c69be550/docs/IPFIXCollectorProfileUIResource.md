# SwaggerClient::IPFIXCollectorProfileUIResource
...
**ipaddress** | **String** | IP address for the IPFIX collector. | 
**port** | **Integer** | Port for the IPFIX collector. | [default to 4739]
