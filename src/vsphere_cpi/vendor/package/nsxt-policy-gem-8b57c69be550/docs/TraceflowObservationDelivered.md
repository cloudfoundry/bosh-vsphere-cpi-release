# SwaggerClient::TraceflowObservationDelivered
...
**lport_name** | **String** | The name of the logical port into which the traceflow packet was delivered | [optional] 
**vlan_id** | **Integer** | VLAN on bridged network | [optional] 
**lport_id** | **String** | The id of the logical port into which the traceflow packet was delivered | [optional] 
