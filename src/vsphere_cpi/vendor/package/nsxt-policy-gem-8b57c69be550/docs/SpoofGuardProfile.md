# SwaggerClient::SpoofGuardProfile
...
**address_binding_whitelist** | **BOOLEAN** | If true, enable the SpoofGuard, which only allows VM sending traffic with the IPs in the whitelist.  | [default to false]
