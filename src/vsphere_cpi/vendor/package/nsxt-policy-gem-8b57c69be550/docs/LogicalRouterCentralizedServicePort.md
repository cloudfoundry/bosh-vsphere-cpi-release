# SwaggerClient::LogicalRouterCentralizedServicePort
...
**enable_netx** | **BOOLEAN** | Port is exclusively used for N-S service insertion | [optional] [default to false]
...
**mtu** | **Integer** | Maximum transmission unit specifies the size of the largest packet that network a protocol can transmit. If not specified, the global logical MTU set in the /api/v1/global-configs/RoutingGlobalConfig API will be used.  | [optional] 
