# SwaggerClient::EffectiveProfileListResult
...
**results** | [**Array&lt;NSXProfileReference&gt;**](NSXProfileReference.md) | Paged Collection of profiles which are applied to an Entity | 
