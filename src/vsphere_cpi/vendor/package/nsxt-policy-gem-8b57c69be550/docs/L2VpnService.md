...
**mode** | **String** | Specify an L2VPN service mode as SERVER or CLIENT. | [optional] [default to &#39;SERVER&#39;]
**enable_hub** | **BOOLEAN** | This property applies only in SERVER mode. If set to true, traffic from any client will be replicated to all other clients. If set to false, traffic received from clients is only replicated to the local VPN endpoint.  | [optional] [default to false]
