...
**member_index** | **Integer** | Member index of edge node in edge cluster. | [optional] 
**nsx_id** | **String** | UUID of edge node on enforcement point. | [optional] 
