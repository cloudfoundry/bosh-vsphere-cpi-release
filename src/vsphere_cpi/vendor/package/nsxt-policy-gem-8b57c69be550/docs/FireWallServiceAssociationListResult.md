# SwaggerClient::FireWallServiceAssociationListResult
...
**service_type** | **String** |  | 
**results** | [**Array&lt;FirewallRule&gt;**](FirewallRule.md) | Firewall rule list result with pagination support. | [optional] 
