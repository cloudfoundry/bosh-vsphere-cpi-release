# SwaggerClient::ChildPolicyContextProfile
...
**policy_context_profile** | [**PolicyContextProfile**](PolicyContextProfile.md) | Contains the actual PolicyContextProfile objects  | 
