# SwaggerClient::IPFIXL2Collector
...
**collector_ip_address** | **String** | IP address for the IPFIX L2 collector. IP addresses such as 0.0.0.0, 127.0.0.1, 255.255.255.255 are invalid.  | 
**collector_port** | **Integer** | Port number for the IPFIX L2 collector. | [optional] [default to 4739]
