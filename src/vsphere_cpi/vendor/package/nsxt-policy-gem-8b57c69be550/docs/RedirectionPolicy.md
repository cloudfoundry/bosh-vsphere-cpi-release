# SwaggerClient::RedirectionPolicy
...
**rules** | [**Array&lt;RedirectionRule&gt;**](RedirectionRule.md) | Redirection rules that are a part of this RedirectionPolicy. At max, there can be 1000 rules in a given RedirectPolicy.  | [optional] 
...
**redirect_to** | **Array&lt;String&gt;** | List of path Service Instance/service Instance endpoint | 
