...
**action** | **String** | Action to exchange data with or without protection. PROTECT - Allows to exchange data with ipsec protection. Protect rules are defined per L3Vpn. BYPASS - Allows to exchange data without ipsec protection. Bypass rules are defined per L3VpnContext and affects all policy based L3Vpns. Bypass rules are prioritized over protect rules.  | [optional] [default to &#39;PROTECT&#39;]
**sources** | [**Array&lt;L3VpnSubnet&gt;**](L3VpnSubnet.md) | List of local subnets used in policy-based L3Vpn.  | 
**sequence_number** | **Integer** | This field is used to resolve conflicts between multiple L3VpnRules associated with a single L3Vpn or L3VpnContext.  | [optional] 
**destinations** | [**Array&lt;L3VpnSubnet&gt;**](L3VpnSubnet.md) | List of remote subnets used in policy-based L3Vpn.  | 
