# SwaggerClient::IPSecVpnDpdProfile
...
**enabled** | **BOOLEAN** | If true, enable dead peer detection. | [optional] [default to true]
**dpd_probe_interval** | **Integer** | DPD probe interval defines a periodic interval for DPD probes. | [optional] [default to 60]
