# SwaggerClient::LogicalRouterIPTunnelPort
...
**subnets** | [**Array&lt;IPSubnet&gt;**](IPSubnet.md) | Tunnel port subnets. | [optional] 
**admin_state** | **String** | Admin state of port. | [optional] 
**vpn_session_id** | **String** | Associated VPN session identifier. | [optional] 
