# SwaggerClient::ServiceInsertionRuleListResult
...
**results** | [**Array&lt;ServiceInsertionRule&gt;**](ServiceInsertionRule.md) | ServiceInsertion rule list result with pagination support. | [optional] 
