# SwaggerClient::BfdHealthMonitoringProfile
...
**probe_interval** | **Integer** | The time interval (in millisec) between probe packets for tunnels between transport nodes. | [optional] [default to 1000]
