...
# Unit tests for SwaggerClient::Crl
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Crl' do
  before do
    # run before each test
    @instance = SwaggerClient::Crl.new
  end
  ...
  describe 'test an instance of Crl' do
    it 'should create an instance of Crl' do
      expect(@instance).to be_instance_of(SwaggerClient::Crl)
    end
  end
