...
# Unit tests for SwaggerClient::NSServiceGroup
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NSServiceGroup' do
  before do
    # run before each test
    @instance = SwaggerClient::NSServiceGroup.new
  end
  ...
  describe 'test an instance of NSServiceGroup' do
    it 'should create an instance of NSServiceGroup' do
      expect(@instance).to be_instance_of(SwaggerClient::NSServiceGroup)
    end
  end
  ...
  describe 'test attribute "service_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ETHER", "NON_ETHER"])
