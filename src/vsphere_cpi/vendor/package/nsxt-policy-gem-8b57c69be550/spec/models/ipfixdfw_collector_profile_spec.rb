...
# Unit tests for SwaggerClient::IPFIXDFWCollectorProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IPFIXDFWCollectorProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::IPFIXDFWCollectorProfile.new
  end
  ...
  describe 'test an instance of IPFIXDFWCollectorProfile' do
    it 'should create an instance of IPFIXDFWCollectorProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::IPFIXDFWCollectorProfile)
    end
  end
  ...
  describe 'test attribute "ipfix_dfw_collectors"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
