...
# Unit tests for SwaggerClient::SegmentPort
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SegmentPort' do
  before do
    # run before each test
    @instance = SwaggerClient::SegmentPort.new
  end
  ...
  describe 'test an instance of SegmentPort' do
    it 'should create an instance of SegmentPort' do
      expect(@instance).to be_instance_of(SwaggerClient::SegmentPort)
    end
  end
