...
# Unit tests for SwaggerClient::ServiceSegment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceSegment' do
  before do
    # run before each test
    @instance = SwaggerClient::ServiceSegment.new
  end
  ...
  describe 'test an instance of ServiceSegment' do
    it 'should create an instance of ServiceSegment' do
      expect(@instance).to be_instance_of(SwaggerClient::ServiceSegment)
    end
  end
