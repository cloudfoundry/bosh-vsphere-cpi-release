...
# Unit tests for SwaggerClient::VtepListResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VtepListResult' do
  before do
    # run before each test
    @instance = SwaggerClient::VtepListResult.new
  end
  ...
  describe 'test an instance of VtepListResult' do
    it 'should create an instance of VtepListResult' do
      expect(@instance).to be_instance_of(SwaggerClient::VtepListResult)
    end
  end
