...
# Unit tests for SwaggerClient::TraceflowObservationDelivered
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TraceflowObservationDelivered' do
  before do
    # run before each test
    @instance = SwaggerClient::TraceflowObservationDelivered.new
  end
  ...
  describe 'test an instance of TraceflowObservationDelivered' do
    it 'should create an instance of TraceflowObservationDelivered' do
      expect(@instance).to be_instance_of(SwaggerClient::TraceflowObservationDelivered)
    end
  end
