...
# Unit tests for SwaggerClient::ChildL3VpnContext
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildL3VpnContext' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildL3VpnContext.new
  end
  ...
  describe 'test an instance of ChildL3VpnContext' do
    it 'should create an instance of ChildL3VpnContext' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildL3VpnContext)
    end
  end
  ...
  describe 'test attribute "l3_vpn_context"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
