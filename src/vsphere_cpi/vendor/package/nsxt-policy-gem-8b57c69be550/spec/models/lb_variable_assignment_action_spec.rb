...
# Unit tests for SwaggerClient::LBVariableAssignmentAction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LBVariableAssignmentAction' do
  before do
    # run before each test
    @instance = SwaggerClient::LBVariableAssignmentAction.new
  end
  ...
  describe 'test an instance of LBVariableAssignmentAction' do
    it 'should create an instance of LBVariableAssignmentAction' do
      expect(@instance).to be_instance_of(SwaggerClient::LBVariableAssignmentAction)
    end
  end
