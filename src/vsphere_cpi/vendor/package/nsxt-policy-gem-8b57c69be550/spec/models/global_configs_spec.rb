...
# Unit tests for SwaggerClient::GlobalConfigs
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GlobalConfigs' do
  before do
    # run before each test
    @instance = SwaggerClient::GlobalConfigs.new
  end
  ...
  describe 'test an instance of GlobalConfigs' do
    it 'should create an instance of GlobalConfigs' do
      expect(@instance).to be_instance_of(SwaggerClient::GlobalConfigs)
    end
  end
