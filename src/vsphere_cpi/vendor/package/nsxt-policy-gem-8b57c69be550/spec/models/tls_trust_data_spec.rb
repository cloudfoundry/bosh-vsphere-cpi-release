...
# Unit tests for SwaggerClient::TlsTrustData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TlsTrustData' do
  before do
    # run before each test
    @instance = SwaggerClient::TlsTrustData.new
  end
  ...
  describe 'test an instance of TlsTrustData' do
    it 'should create an instance of TlsTrustData' do
      expect(@instance).to be_instance_of(SwaggerClient::TlsTrustData)
    end
  end
