...
# Unit tests for SwaggerClient::VendorTemplate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VendorTemplate' do
  before do
    # run before each test
    @instance = SwaggerClient::VendorTemplate.new
  end
  ...
  describe 'test an instance of VendorTemplate' do
    it 'should create an instance of VendorTemplate' do
      expect(@instance).to be_instance_of(SwaggerClient::VendorTemplate)
    end
  end
