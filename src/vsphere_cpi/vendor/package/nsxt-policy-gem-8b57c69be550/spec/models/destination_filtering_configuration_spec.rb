...
# Unit tests for SwaggerClient::DestinationFilteringConfiguration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DestinationFilteringConfiguration' do
  before do
    # run before each test
    @instance = SwaggerClient::DestinationFilteringConfiguration.new
  end
  ...
  describe 'test an instance of DestinationFilteringConfiguration' do
    it 'should create an instance of DestinationFilteringConfiguration' do
      expect(@instance).to be_instance_of(SwaggerClient::DestinationFilteringConfiguration)
    end
  end
