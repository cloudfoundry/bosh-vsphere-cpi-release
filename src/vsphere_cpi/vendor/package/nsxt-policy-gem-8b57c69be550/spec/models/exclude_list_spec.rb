...
# Unit tests for SwaggerClient::ExcludeList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ExcludeList' do
  before do
    # run before each test
    @instance = SwaggerClient::ExcludeList.new
  end
  ...
  describe 'test an instance of ExcludeList' do
    it 'should create an instance of ExcludeList' do
      expect(@instance).to be_instance_of(SwaggerClient::ExcludeList)
    end
  end
