...
# Unit tests for SwaggerClient::ChildEndpointPolicy
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildEndpointPolicy' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildEndpointPolicy.new
  end
  ...
  describe 'test an instance of ChildEndpointPolicy' do
    it 'should create an instance of ChildEndpointPolicy' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildEndpointPolicy)
    end
  end
  ...
  describe 'test attribute "endpoint_policy"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
