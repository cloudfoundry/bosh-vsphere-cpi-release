...
# Unit tests for SwaggerClient::SolutionConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SolutionConfig' do
  before do
    # run before each test
    @instance = SwaggerClient::SolutionConfig.new
  end
  ...
  describe 'test an instance of SolutionConfig' do
    it 'should create an instance of SolutionConfig' do
      expect(@instance).to be_instance_of(SwaggerClient::SolutionConfig)
    end
  end
  ...
  describe 'test attribute "control_ip"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
