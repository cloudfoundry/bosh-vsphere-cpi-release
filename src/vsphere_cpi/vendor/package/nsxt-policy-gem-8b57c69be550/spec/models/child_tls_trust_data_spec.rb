...
# Unit tests for SwaggerClient::ChildTlsTrustData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildTlsTrustData' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildTlsTrustData.new
  end
  ...
  describe 'test an instance of ChildTlsTrustData' do
    it 'should create an instance of ChildTlsTrustData' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildTlsTrustData)
    end
  end
  ...
  describe 'test attribute "tls_trust_data"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
