...
# Unit tests for SwaggerClient::ClusterProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ClusterProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::ClusterProfile.new
  end
  ...
  describe 'test an instance of ClusterProfile' do
    it 'should create an instance of ClusterProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::ClusterProfile)
    end
  end
