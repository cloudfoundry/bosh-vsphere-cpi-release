...
# Unit tests for SwaggerClient::L2Vpn
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'L2Vpn' do
  before do
    # run before each test
    @instance = SwaggerClient::L2Vpn.new
  end
  ...
  describe 'test an instance of L2Vpn' do
    it 'should create an instance of L2Vpn' do
      expect(@instance).to be_instance_of(SwaggerClient::L2Vpn)
    end
  end
