...
# Unit tests for SwaggerClient::CrlObjectData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CrlObjectData' do
  before do
    # run before each test
    @instance = SwaggerClient::CrlObjectData.new
  end
  ...
  describe 'test an instance of CrlObjectData' do
    it 'should create an instance of CrlObjectData' do
      expect(@instance).to be_instance_of(SwaggerClient::CrlObjectData)
    end
  end
