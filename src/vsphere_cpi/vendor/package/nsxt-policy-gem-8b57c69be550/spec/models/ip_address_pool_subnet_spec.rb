...
# Unit tests for SwaggerClient::IpAddressPoolSubnet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IpAddressPoolSubnet' do
  before do
    # run before each test
    @instance = SwaggerClient::IpAddressPoolSubnet.new
  end
  ...
  describe 'test an instance of IpAddressPoolSubnet' do
    it 'should create an instance of IpAddressPoolSubnet' do
      expect(@instance).to be_instance_of(SwaggerClient::IpAddressPoolSubnet)
    end
  end
