...
# Unit tests for SwaggerClient::ServiceProfileNSGroups
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceProfileNSGroups' do
  before do
    # run before each test
    @instance = SwaggerClient::ServiceProfileNSGroups.new
  end
  ...
  describe 'test an instance of ServiceProfileNSGroups' do
    it 'should create an instance of ServiceProfileNSGroups' do
      expect(@instance).to be_instance_of(SwaggerClient::ServiceProfileNSGroups)
    end
  end
  ...
  describe 'test attribute "nsroups"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
