...
# Unit tests for SwaggerClient::ChildL3Vpn
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildL3Vpn' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildL3Vpn.new
  end
  ...
  describe 'test an instance of ChildL3Vpn' do
    it 'should create an instance of ChildL3Vpn' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildL3Vpn)
    end
  end
  ...
  describe 'test attribute "l3_vpn"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
