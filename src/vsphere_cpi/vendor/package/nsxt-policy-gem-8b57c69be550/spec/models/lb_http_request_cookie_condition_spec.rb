...
# Unit tests for SwaggerClient::LBHttpRequestCookieCondition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LBHttpRequestCookieCondition' do
  before do
    # run before each test
    @instance = SwaggerClient::LBHttpRequestCookieCondition.new
  end
  ...
  describe 'test an instance of LBHttpRequestCookieCondition' do
    it 'should create an instance of LBHttpRequestCookieCondition' do
      expect(@instance).to be_instance_of(SwaggerClient::LBHttpRequestCookieCondition)
    end
  end
  ...
  describe 'test attribute "cookie_value"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
