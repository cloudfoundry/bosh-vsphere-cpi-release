...
# Unit tests for SwaggerClient::SecurityProfileBindingMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SecurityProfileBindingMap' do
  before do
    # run before each test
    @instance = SwaggerClient::SecurityProfileBindingMap.new
  end
  ...
  describe 'test an instance of SecurityProfileBindingMap' do
    it 'should create an instance of SecurityProfileBindingMap' do
      expect(@instance).to be_instance_of(SwaggerClient::SecurityProfileBindingMap)
    end
  end
