...
# Unit tests for SwaggerClient::ChildServiceInterface
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildServiceInterface' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildServiceInterface.new
  end
  ...
  describe 'test an instance of ChildServiceInterface' do
    it 'should create an instance of ChildServiceInterface' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildServiceInterface)
    end
  end
  ...
  describe 'test attribute "service_interface"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
