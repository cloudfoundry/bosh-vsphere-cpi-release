...
# Unit tests for SwaggerClient::ChildLBClientSslProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildLBClientSslProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildLBClientSslProfile.new
  end
  ...
  describe 'test an instance of ChildLBClientSslProfile' do
    it 'should create an instance of ChildLBClientSslProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildLBClientSslProfile)
    end
  end
  ...
  describe 'test attribute "lb_client_ssl_profile"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
