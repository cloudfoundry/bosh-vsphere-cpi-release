...
# Unit tests for SwaggerClient::ChildDhcpRelayConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildDhcpRelayConfig' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildDhcpRelayConfig.new
  end
  ...
  describe 'test an instance of ChildDhcpRelayConfig' do
    it 'should create an instance of ChildDhcpRelayConfig' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildDhcpRelayConfig)
    end
  end
  ...
  describe 'test attribute "dhcp_relay_config"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
