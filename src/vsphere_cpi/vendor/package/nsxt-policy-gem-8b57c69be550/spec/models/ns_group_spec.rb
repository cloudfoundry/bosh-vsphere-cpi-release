...
# Unit tests for SwaggerClient::NSGroup
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NSGroup' do
  before do
    # run before each test
    @instance = SwaggerClient::NSGroup.new
  end
  ...
  describe 'test an instance of NSGroup' do
    it 'should create an instance of NSGroup' do
      expect(@instance).to be_instance_of(SwaggerClient::NSGroup)
    end
  end
  ...
  describe 'test attribute "membership_criteria"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
