...
# Unit tests for SwaggerClient::LBIpHeaderCondition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LBIpHeaderCondition' do
  before do
    # run before each test
    @instance = SwaggerClient::LBIpHeaderCondition.new
  end
  ...
  describe 'test an instance of LBIpHeaderCondition' do
    it 'should create an instance of LBIpHeaderCondition' do
      expect(@instance).to be_instance_of(SwaggerClient::LBIpHeaderCondition)
    end
  end
