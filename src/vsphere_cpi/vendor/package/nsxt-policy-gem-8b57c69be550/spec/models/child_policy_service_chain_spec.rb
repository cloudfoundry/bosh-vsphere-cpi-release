...
# Unit tests for SwaggerClient::ChildPolicyServiceChain
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildPolicyServiceChain' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildPolicyServiceChain.new
  end
  ...
  describe 'test an instance of ChildPolicyServiceChain' do
    it 'should create an instance of ChildPolicyServiceChain' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildPolicyServiceChain)
    end
  end
  ...
  describe 'test attribute "policy_service_chain"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
