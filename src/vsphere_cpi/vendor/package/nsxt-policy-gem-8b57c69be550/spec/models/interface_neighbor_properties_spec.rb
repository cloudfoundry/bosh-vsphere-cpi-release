...
# Unit tests for SwaggerClient::InterfaceNeighborProperties
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InterfaceNeighborProperties' do
  before do
    # run before each test
    @instance = SwaggerClient::InterfaceNeighborProperties.new
  end
  ...
  describe 'test an instance of InterfaceNeighborProperties' do
    it 'should create an instance of InterfaceNeighborProperties' do
      expect(@instance).to be_instance_of(SwaggerClient::InterfaceNeighborProperties)
    end
  end
