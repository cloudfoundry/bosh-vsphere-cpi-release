...
# Unit tests for SwaggerClient::RouteMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RouteMap' do
  before do
    # run before each test
    @instance = SwaggerClient::RouteMap.new
  end
  ...
  describe 'test an instance of RouteMap' do
    it 'should create an instance of RouteMap' do
      expect(@instance).to be_instance_of(SwaggerClient::RouteMap)
    end
  end
