...
# Unit tests for SwaggerClient::ChildPolicyLbPoolAccess
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildPolicyLbPoolAccess' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildPolicyLbPoolAccess.new
  end
  ...
  describe 'test an instance of ChildPolicyLbPoolAccess' do
    it 'should create an instance of ChildPolicyLbPoolAccess' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildPolicyLbPoolAccess)
    end
  end
  ...
  describe 'test attribute "policy_lb_pool_access"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
