...
# Unit tests for SwaggerClient::PolicyEdgeCluster
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PolicyEdgeCluster' do
  before do
    # run before each test
    @instance = SwaggerClient::PolicyEdgeCluster.new
  end
  ...
  describe 'test an instance of PolicyEdgeCluster' do
    it 'should create an instance of PolicyEdgeCluster' do
      expect(@instance).to be_instance_of(SwaggerClient::PolicyEdgeCluster)
    end
  end
