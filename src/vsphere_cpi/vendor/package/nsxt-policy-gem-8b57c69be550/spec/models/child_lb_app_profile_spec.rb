...
# Unit tests for SwaggerClient::ChildLBAppProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildLBAppProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildLBAppProfile.new
  end
  ...
  describe 'test an instance of ChildLBAppProfile' do
    it 'should create an instance of ChildLBAppProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildLBAppProfile)
    end
  end
  ...
  describe 'test attribute "lb_app_profile"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
