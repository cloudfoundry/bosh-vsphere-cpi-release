...
# Unit tests for SwaggerClient::CvxConnectionInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CvxConnectionInfo' do
  before do
    # run before each test
    @instance = SwaggerClient::CvxConnectionInfo.new
  end
  ...
  describe 'test an instance of CvxConnectionInfo' do
    it 'should create an instance of CvxConnectionInfo' do
      expect(@instance).to be_instance_of(SwaggerClient::CvxConnectionInfo)
    end
  end
