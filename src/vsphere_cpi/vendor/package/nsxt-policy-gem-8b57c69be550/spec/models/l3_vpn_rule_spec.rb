...
# Unit tests for SwaggerClient::L3VpnRule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'L3VpnRule' do
  before do
    # run before each test
    @instance = SwaggerClient::L3VpnRule.new
  end
  ...
  describe 'test an instance of L3VpnRule' do
    it 'should create an instance of L3VpnRule' do
      expect(@instance).to be_instance_of(SwaggerClient::L3VpnRule)
    end
  end
