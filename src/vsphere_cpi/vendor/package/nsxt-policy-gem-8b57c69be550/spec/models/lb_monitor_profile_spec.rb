...
# Unit tests for SwaggerClient::LBMonitorProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LBMonitorProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::LBMonitorProfile.new
  end
  ...
  describe 'test an instance of LBMonitorProfile' do
    it 'should create an instance of LBMonitorProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::LBMonitorProfile)
    end
  end
