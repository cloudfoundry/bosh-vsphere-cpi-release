...
# Unit tests for SwaggerClient::ChildStaticARPConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildStaticARPConfig' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildStaticARPConfig.new
  end
  ...
  describe 'test an instance of ChildStaticARPConfig' do
    it 'should create an instance of ChildStaticARPConfig' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildStaticARPConfig)
    end
  end
  ...
  describe 'test attribute "static_arp_config"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
