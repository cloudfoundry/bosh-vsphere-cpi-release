...
# Unit tests for SwaggerClient::IPSet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IPSet' do
  before do
    # run before each test
    @instance = SwaggerClient::IPSet.new
  end
  ...
  describe 'test an instance of IPSet' do
    it 'should create an instance of IPSet' do
      expect(@instance).to be_instance_of(SwaggerClient::IPSet)
    end
  end
