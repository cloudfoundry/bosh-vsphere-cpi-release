...
# Unit tests for SwaggerClient::ChildL2VpnContext
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildL2VpnContext' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildL2VpnContext.new
  end
  ...
  describe 'test an instance of ChildL2VpnContext' do
    it 'should create an instance of ChildL2VpnContext' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildL2VpnContext)
    end
  end
  ...
  describe 'test attribute "l2_vpn_context"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
