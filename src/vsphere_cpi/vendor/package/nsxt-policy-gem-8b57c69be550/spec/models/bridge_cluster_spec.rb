...
# Unit tests for SwaggerClient::BridgeCluster
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BridgeCluster' do
  before do
    # run before each test
    @instance = SwaggerClient::BridgeCluster.new
  end
  ...
  describe 'test an instance of BridgeCluster' do
    it 'should create an instance of BridgeCluster' do
      expect(@instance).to be_instance_of(SwaggerClient::BridgeCluster)
    end
  end
  ...
  describe 'test attribute "bridge_nodes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
