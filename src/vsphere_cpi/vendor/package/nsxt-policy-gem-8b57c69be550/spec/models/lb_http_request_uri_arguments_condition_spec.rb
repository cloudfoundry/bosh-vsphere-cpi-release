...
# Unit tests for SwaggerClient::LBHttpRequestUriArgumentsCondition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LBHttpRequestUriArgumentsCondition' do
  before do
    # run before each test
    @instance = SwaggerClient::LBHttpRequestUriArgumentsCondition.new
  end
  ...
  describe 'test an instance of LBHttpRequestUriArgumentsCondition' do
    it 'should create an instance of LBHttpRequestUriArgumentsCondition' do
      expect(@instance).to be_instance_of(SwaggerClient::LBHttpRequestUriArgumentsCondition)
    end
  end
  ...
  describe 'test attribute "uri_arguments"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
