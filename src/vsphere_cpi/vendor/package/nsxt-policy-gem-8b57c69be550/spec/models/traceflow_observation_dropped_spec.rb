...
# Unit tests for SwaggerClient::TraceflowObservationDropped
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TraceflowObservationDropped' do
  before do
    # run before each test
    @instance = SwaggerClient::TraceflowObservationDropped.new
  end
  ...
  describe 'test an instance of TraceflowObservationDropped' do
    it 'should create an instance of TraceflowObservationDropped' do
      expect(@instance).to be_instance_of(SwaggerClient::TraceflowObservationDropped)
    end
  end
