...
# Unit tests for SwaggerClient::ChildTier0
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildTier0' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildTier0.new
  end
  ...
  describe 'test an instance of ChildTier0' do
    it 'should create an instance of ChildTier0' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildTier0)
    end
  end
  ...
  describe 'test attribute "tier0"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
