...
# Unit tests for SwaggerClient::PolicyLabel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PolicyLabel' do
  before do
    # run before each test
    @instance = SwaggerClient::PolicyLabel.new
  end
  ...
  describe 'test an instance of PolicyLabel' do
    it 'should create an instance of PolicyLabel' do
      expect(@instance).to be_instance_of(SwaggerClient::PolicyLabel)
    end
  end
