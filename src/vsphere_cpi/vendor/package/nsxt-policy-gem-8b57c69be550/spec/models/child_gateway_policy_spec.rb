...
# Unit tests for SwaggerClient::ChildGatewayPolicy
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildGatewayPolicy' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildGatewayPolicy.new
  end
  ...
  describe 'test an instance of ChildGatewayPolicy' do
    it 'should create an instance of ChildGatewayPolicy' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildGatewayPolicy)
    end
  end
  ...
  describe 'test attribute "gateway_policy"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
