...
# Unit tests for SwaggerClient::RedistributionRuleList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RedistributionRuleList' do
  before do
    # run before each test
    @instance = SwaggerClient::RedistributionRuleList.new
  end
  ...
  describe 'test an instance of RedistributionRuleList' do
    it 'should create an instance of RedistributionRuleList' do
      expect(@instance).to be_instance_of(SwaggerClient::RedistributionRuleList)
    end
  end
