...
# Unit tests for SwaggerClient::RealizedGroupUIResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RealizedGroupUIResource' do
  before do
    # run before each test
    @instance = SwaggerClient::RealizedGroupUIResource.new
  end
  ...
  describe 'test an instance of RealizedGroupUIResource' do
    it 'should create an instance of RealizedGroupUIResource' do
      expect(@instance).to be_instance_of(SwaggerClient::RealizedGroupUIResource)
    end
  end
  ...
  describe 'test attribute "intent_group"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
