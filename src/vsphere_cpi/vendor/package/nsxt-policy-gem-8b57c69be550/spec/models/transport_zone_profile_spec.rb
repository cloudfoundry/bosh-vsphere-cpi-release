...
# Unit tests for SwaggerClient::TransportZoneProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransportZoneProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::TransportZoneProfile.new
  end
  ...
  describe 'test an instance of TransportZoneProfile' do
    it 'should create an instance of TransportZoneProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::TransportZoneProfile)
    end
  end
