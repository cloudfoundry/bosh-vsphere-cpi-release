...
# Unit tests for SwaggerClient::SecurityPolicy
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SecurityPolicy' do
  before do
    # run before each test
    @instance = SwaggerClient::SecurityPolicy.new
  end
  ...
  describe 'test an instance of SecurityPolicy' do
    it 'should create an instance of SecurityPolicy' do
      expect(@instance).to be_instance_of(SwaggerClient::SecurityPolicy)
    end
  end
