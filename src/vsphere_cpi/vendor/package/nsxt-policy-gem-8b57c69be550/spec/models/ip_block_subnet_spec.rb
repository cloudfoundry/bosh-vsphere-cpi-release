...
# Unit tests for SwaggerClient::IpBlockSubnet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IpBlockSubnet' do
  before do
    # run before each test
    @instance = SwaggerClient::IpBlockSubnet.new
  end
  ...
  describe 'test an instance of IpBlockSubnet' do
    it 'should create an instance of IpBlockSubnet' do
      expect(@instance).to be_instance_of(SwaggerClient::IpBlockSubnet)
    end
  end
