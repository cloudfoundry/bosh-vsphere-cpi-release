...
# Unit tests for SwaggerClient::ChildLBPool
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildLBPool' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildLBPool.new
  end
  ...
  describe 'test an instance of ChildLBPool' do
    it 'should create an instance of ChildLBPool' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildLBPool)
    end
  end
  ...
  describe 'test attribute "lb_pool"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
