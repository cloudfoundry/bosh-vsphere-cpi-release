...
# Unit tests for SwaggerClient::ChildStaticRoutes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildStaticRoutes' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildStaticRoutes.new
  end
  ...
  describe 'test an instance of ChildStaticRoutes' do
    it 'should create an instance of ChildStaticRoutes' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildStaticRoutes)
    end
  end
