...
# Unit tests for SwaggerClient::PolicyResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PolicyResource' do
  before do
    # run before each test
    @instance = SwaggerClient::PolicyResource.new
  end
  ...
  describe 'test an instance of PolicyResource' do
    it 'should create an instance of PolicyResource' do
      expect(@instance).to be_instance_of(SwaggerClient::PolicyResource)
    end
  end
