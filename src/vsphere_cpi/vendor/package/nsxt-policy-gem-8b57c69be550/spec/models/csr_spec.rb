...
# Unit tests for SwaggerClient::Csr
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Csr' do
  before do
    # run before each test
    @instance = SwaggerClient::Csr.new
  end
  ...
  describe 'test an instance of Csr' do
    it 'should create an instance of Csr' do
      expect(@instance).to be_instance_of(SwaggerClient::Csr)
    end
  end
