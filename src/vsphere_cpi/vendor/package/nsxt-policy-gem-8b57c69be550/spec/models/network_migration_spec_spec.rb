...
# Unit tests for SwaggerClient::NetworkMigrationSpec
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NetworkMigrationSpec' do
  before do
    # run before each test
    @instance = SwaggerClient::NetworkMigrationSpec.new
  end
  ...
  describe 'test an instance of NetworkMigrationSpec' do
    it 'should create an instance of NetworkMigrationSpec' do
      expect(@instance).to be_instance_of(SwaggerClient::NetworkMigrationSpec)
    end
  end
