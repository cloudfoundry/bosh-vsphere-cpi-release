...
# Unit tests for SwaggerClient::BfdHealthMonitoringProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BfdHealthMonitoringProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::BfdHealthMonitoringProfile.new
  end
  ...
  describe 'test an instance of BfdHealthMonitoringProfile' do
    it 'should create an instance of BfdHealthMonitoringProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::BfdHealthMonitoringProfile)
    end
  end
  ...
  describe 'test attribute "resource_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["BfdHealthMonitoringProfile"])
  ...
  describe 'test attribute "probe_interval"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
