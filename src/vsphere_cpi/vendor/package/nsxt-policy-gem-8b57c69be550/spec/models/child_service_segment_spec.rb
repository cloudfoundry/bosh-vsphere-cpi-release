...
# Unit tests for SwaggerClient::ChildServiceSegment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildServiceSegment' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildServiceSegment.new
  end
  ...
  describe 'test an instance of ChildServiceSegment' do
    it 'should create an instance of ChildServiceSegment' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildServiceSegment)
    end
  end
  ...
  describe 'test attribute "service_segment"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
