...
# Unit tests for SwaggerClient::QoSProfileBindingMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QoSProfileBindingMap' do
  before do
    # run before each test
    @instance = SwaggerClient::QoSProfileBindingMap.new
  end
  ...
  describe 'test an instance of QoSProfileBindingMap' do
    it 'should create an instance of QoSProfileBindingMap' do
      expect(@instance).to be_instance_of(SwaggerClient::QoSProfileBindingMap)
    end
  end
