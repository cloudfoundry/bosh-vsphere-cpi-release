...
# Unit tests for SwaggerClient::TransportNodeProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransportNodeProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::TransportNodeProfile.new
  end
  ...
  describe 'test an instance of TransportNodeProfile' do
    it 'should create an instance of TransportNodeProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::TransportNodeProfile)
    end
  end
