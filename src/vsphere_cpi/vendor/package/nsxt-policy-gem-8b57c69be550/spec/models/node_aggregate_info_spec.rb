...
# Unit tests for SwaggerClient::NodeAggregateInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NodeAggregateInfo' do
  before do
    # run before each test
    @instance = SwaggerClient::NodeAggregateInfo.new
  end
  ...
  describe 'test an instance of NodeAggregateInfo' do
    it 'should create an instance of NodeAggregateInfo' do
      expect(@instance).to be_instance_of(SwaggerClient::NodeAggregateInfo)
    end
  end
  ...
  describe 'test attribute "tn_details"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
