...
# Unit tests for SwaggerClient::ChildSpoofGuardProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildSpoofGuardProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildSpoofGuardProfile.new
  end
  ...
  describe 'test an instance of ChildSpoofGuardProfile' do
    it 'should create an instance of ChildSpoofGuardProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildSpoofGuardProfile)
    end
  end
  ...
  describe 'test attribute "spoof_guard_profile"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
