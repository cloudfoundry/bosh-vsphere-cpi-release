...
# Unit tests for SwaggerClient::ChildServiceEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildServiceEntry' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildServiceEntry.new
  end
  ...
  describe 'test an instance of ChildServiceEntry' do
    it 'should create an instance of ChildServiceEntry' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildServiceEntry)
    end
  end
  ...
  describe 'test attribute "service_entry"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
