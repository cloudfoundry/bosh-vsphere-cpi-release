...
# Unit tests for SwaggerClient::RoutingConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RoutingConfig' do
  before do
    # run before each test
    @instance = SwaggerClient::RoutingConfig.new
  end
  ...
  describe 'test an instance of RoutingConfig' do
    it 'should create an instance of RoutingConfig' do
      expect(@instance).to be_instance_of(SwaggerClient::RoutingConfig)
    end
  end
  ...
  describe 'test attribute "forwarding_up_timer"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
