...
# Unit tests for SwaggerClient::ChildPrefixList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildPrefixList' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildPrefixList.new
  end
  ...
  describe 'test an instance of ChildPrefixList' do
    it 'should create an instance of ChildPrefixList' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildPrefixList)
    end
  end
  ...
  describe 'test attribute "prefix_list"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
