...
# Unit tests for SwaggerClient::LbMonitor
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LbMonitor' do
  before do
    # run before each test
    @instance = SwaggerClient::LbMonitor.new
  end
  ...
  describe 'test an instance of LbMonitor' do
    it 'should create an instance of LbMonitor' do
      expect(@instance).to be_instance_of(SwaggerClient::LbMonitor)
    end
  end
