...
# Unit tests for SwaggerClient::IPFIXL2Collector
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IPFIXL2Collector' do
  before do
    # run before each test
    @instance = SwaggerClient::IPFIXL2Collector.new
  end
  ...
  describe 'test an instance of IPFIXL2Collector' do
    it 'should create an instance of IPFIXL2Collector' do
      expect(@instance).to be_instance_of(SwaggerClient::IPFIXL2Collector)
    end
  end
