...
# Unit tests for SwaggerClient::ServiceProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::ServiceProfile.new
  end
  ...
  describe 'test an instance of ServiceProfile' do
    it 'should create an instance of ServiceProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::ServiceProfile)
    end
  end
  ...
  describe 'test attribute "resource_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["DhcpRelayProfile"])
