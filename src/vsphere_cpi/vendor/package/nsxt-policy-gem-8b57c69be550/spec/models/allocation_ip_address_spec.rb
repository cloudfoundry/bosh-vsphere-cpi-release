...
# Unit tests for SwaggerClient::AllocationIpAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllocationIpAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::AllocationIpAddress.new
  end
  ...
  describe 'test an instance of AllocationIpAddress' do
    it 'should create an instance of AllocationIpAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::AllocationIpAddress)
    end
  end
