...
# Unit tests for SwaggerClient::IpfixConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IpfixConfig' do
  before do
    # run before each test
    @instance = SwaggerClient::IpfixConfig.new
  end
  ...
  describe 'test an instance of IpfixConfig' do
    it 'should create an instance of IpfixConfig' do
      expect(@instance).to be_instance_of(SwaggerClient::IpfixConfig)
    end
  end
