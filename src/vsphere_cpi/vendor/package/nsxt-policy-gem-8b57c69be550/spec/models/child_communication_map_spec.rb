...
# Unit tests for SwaggerClient::ChildCommunicationMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildCommunicationMap' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildCommunicationMap.new
  end
  ...
  describe 'test an instance of ChildCommunicationMap' do
    it 'should create an instance of ChildCommunicationMap' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildCommunicationMap)
    end
  end
  ...
  describe 'test attribute "communication_map"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
