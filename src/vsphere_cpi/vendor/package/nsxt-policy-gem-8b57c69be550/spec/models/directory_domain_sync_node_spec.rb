...
# Unit tests for SwaggerClient::DirectoryDomainSyncNode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoryDomainSyncNode' do
  before do
    # run before each test
    @instance = SwaggerClient::DirectoryDomainSyncNode.new
  end
  ...
  describe 'test an instance of DirectoryDomainSyncNode' do
    it 'should create an instance of DirectoryDomainSyncNode' do
      expect(@instance).to be_instance_of(SwaggerClient::DirectoryDomainSyncNode)
    end
  end
