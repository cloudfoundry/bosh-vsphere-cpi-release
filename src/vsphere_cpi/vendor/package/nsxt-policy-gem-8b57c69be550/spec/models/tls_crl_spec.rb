...
# Unit tests for SwaggerClient::TlsCrl
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TlsCrl' do
  before do
    # run before each test
    @instance = SwaggerClient::TlsCrl.new
  end
  ...
  describe 'test an instance of TlsCrl' do
    it 'should create an instance of TlsCrl' do
      expect(@instance).to be_instance_of(SwaggerClient::TlsCrl)
    end
  end
