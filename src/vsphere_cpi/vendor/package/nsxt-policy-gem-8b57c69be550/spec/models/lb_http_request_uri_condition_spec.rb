...
# Unit tests for SwaggerClient::LBHttpRequestUriCondition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LBHttpRequestUriCondition' do
  before do
    # run before each test
    @instance = SwaggerClient::LBHttpRequestUriCondition.new
  end
  ...
  describe 'test an instance of LBHttpRequestUriCondition' do
    it 'should create an instance of LBHttpRequestUriCondition' do
      expect(@instance).to be_instance_of(SwaggerClient::LBHttpRequestUriCondition)
    end
  end
