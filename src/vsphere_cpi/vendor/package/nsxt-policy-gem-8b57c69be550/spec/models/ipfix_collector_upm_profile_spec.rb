...
# Unit tests for SwaggerClient::IpfixCollectorUpmProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IpfixCollectorUpmProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::IpfixCollectorUpmProfile.new
  end
  ...
  describe 'test an instance of IpfixCollectorUpmProfile' do
    it 'should create an instance of IpfixCollectorUpmProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::IpfixCollectorUpmProfile)
    end
  end
  ...
  describe 'test attribute "resource_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["IpfixCollectorUpmProfile"])
