...
# Unit tests for SwaggerClient::IpAddressBlock
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IpAddressBlock' do
  before do
    # run before each test
    @instance = SwaggerClient::IpAddressBlock.new
  end
  ...
  describe 'test an instance of IpAddressBlock' do
    it 'should create an instance of IpAddressBlock' do
      expect(@instance).to be_instance_of(SwaggerClient::IpAddressBlock)
    end
  end
