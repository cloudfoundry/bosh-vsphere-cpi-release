...
# Unit tests for SwaggerClient::SegmentQoSProfileBindingMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SegmentQoSProfileBindingMap' do
  before do
    # run before each test
    @instance = SwaggerClient::SegmentQoSProfileBindingMap.new
  end
  ...
  describe 'test an instance of SegmentQoSProfileBindingMap' do
    it 'should create an instance of SegmentQoSProfileBindingMap' do
      expect(@instance).to be_instance_of(SwaggerClient::SegmentQoSProfileBindingMap)
    end
  end
  ...
  describe 'test attribute "qos_profile_path"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
