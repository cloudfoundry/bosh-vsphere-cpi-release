...
# Unit tests for SwaggerClient::TraceflowObservationReceivedLogical
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TraceflowObservationReceivedLogical' do
  before do
    # run before each test
    @instance = SwaggerClient::TraceflowObservationReceivedLogical.new
  end
  ...
  describe 'test an instance of TraceflowObservationReceivedLogical' do
    it 'should create an instance of TraceflowObservationReceivedLogical' do
      expect(@instance).to be_instance_of(SwaggerClient::TraceflowObservationReceivedLogical)
    end
  end
  ...
  describe 'test attribute "src_component_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "src_component_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["PHYSICAL", "LR", "LS", "DFW", "BRIDGE", "EDGE_TUNNEL", "EDGE_HOSTSWITCH", "FW_BRIDGE", "LOAD_BALANCER", "NAT", "IPSEC", "SERVICE_INSERTION", "UNKNOWN"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.src_component_type = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "src_component_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
