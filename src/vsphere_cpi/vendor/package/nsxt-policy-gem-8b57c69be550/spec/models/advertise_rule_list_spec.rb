...
# Unit tests for SwaggerClient::AdvertiseRuleList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdvertiseRuleList' do
  before do
    # run before each test
    @instance = SwaggerClient::AdvertiseRuleList.new
  end
  ...
  describe 'test an instance of AdvertiseRuleList' do
    it 'should create an instance of AdvertiseRuleList' do
      expect(@instance).to be_instance_of(SwaggerClient::AdvertiseRuleList)
    end
  end
