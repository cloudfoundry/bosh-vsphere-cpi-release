...
# Unit tests for SwaggerClient::ServiceReference
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceReference' do
  before do
    # run before each test
    @instance = SwaggerClient::ServiceReference.new
  end
  ...
  describe 'test an instance of ServiceReference' do
    it 'should create an instance of ServiceReference' do
      expect(@instance).to be_instance_of(SwaggerClient::ServiceReference)
    end
  end
