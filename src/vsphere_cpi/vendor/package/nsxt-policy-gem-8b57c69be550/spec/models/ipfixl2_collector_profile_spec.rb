...
# Unit tests for SwaggerClient::IPFIXL2CollectorProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IPFIXL2CollectorProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::IPFIXL2CollectorProfile.new
  end
  ...
  describe 'test an instance of IPFIXL2CollectorProfile' do
    it 'should create an instance of IPFIXL2CollectorProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::IPFIXL2CollectorProfile)
    end
  end
  ...
  describe 'test attribute "ipfix_l2_collectors"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
