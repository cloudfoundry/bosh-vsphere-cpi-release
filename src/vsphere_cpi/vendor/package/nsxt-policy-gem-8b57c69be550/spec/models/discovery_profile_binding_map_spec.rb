...
# Unit tests for SwaggerClient::DiscoveryProfileBindingMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DiscoveryProfileBindingMap' do
  before do
    # run before each test
    @instance = SwaggerClient::DiscoveryProfileBindingMap.new
  end
  ...
  describe 'test an instance of DiscoveryProfileBindingMap' do
    it 'should create an instance of DiscoveryProfileBindingMap' do
      expect(@instance).to be_instance_of(SwaggerClient::DiscoveryProfileBindingMap)
    end
  end
