...
# Unit tests for SwaggerClient::PolicyContextProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PolicyContextProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::PolicyContextProfile.new
  end
  ...
  describe 'test an instance of PolicyContextProfile' do
    it 'should create an instance of PolicyContextProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::PolicyContextProfile)
    end
  end
