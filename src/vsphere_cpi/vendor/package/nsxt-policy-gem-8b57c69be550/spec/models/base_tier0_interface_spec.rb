...
# Unit tests for SwaggerClient::BaseTier0Interface
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BaseTier0Interface' do
  before do
    # run before each test
    @instance = SwaggerClient::BaseTier0Interface.new
  end
  ...
  describe 'test an instance of BaseTier0Interface' do
    it 'should create an instance of BaseTier0Interface' do
      expect(@instance).to be_instance_of(SwaggerClient::BaseTier0Interface)
    end
  end
