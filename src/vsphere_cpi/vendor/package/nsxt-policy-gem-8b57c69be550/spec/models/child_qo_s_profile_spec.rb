...
# Unit tests for SwaggerClient::ChildQoSProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildQoSProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildQoSProfile.new
  end
  ...
  describe 'test an instance of ChildQoSProfile' do
    it 'should create an instance of ChildQoSProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildQoSProfile)
    end
  end
  ...
  describe 'test attribute "qo_s_profile"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
