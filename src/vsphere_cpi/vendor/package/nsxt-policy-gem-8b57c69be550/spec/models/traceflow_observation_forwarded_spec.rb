...
# Unit tests for SwaggerClient::TraceflowObservationForwarded
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TraceflowObservationForwarded' do
  before do
    # run before each test
    @instance = SwaggerClient::TraceflowObservationForwarded.new
  end
  ...
  describe 'test an instance of TraceflowObservationForwarded' do
    it 'should create an instance of TraceflowObservationForwarded' do
      expect(@instance).to be_instance_of(SwaggerClient::TraceflowObservationForwarded)
    end
  end
  ...
  describe 'test attribute "dst_transport_node_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "dst_transport_node_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
