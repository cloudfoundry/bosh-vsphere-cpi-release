...
# Unit tests for SwaggerClient::DirectoryAdGroup
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoryAdGroup' do
  before do
    # run before each test
    @instance = SwaggerClient::DirectoryAdGroup.new
  end
  ...
  describe 'test an instance of DirectoryAdGroup' do
    it 'should create an instance of DirectoryAdGroup' do
      expect(@instance).to be_instance_of(SwaggerClient::DirectoryAdGroup)
    end
  end
  ...
  describe 'test attribute "domain_sync_node_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
