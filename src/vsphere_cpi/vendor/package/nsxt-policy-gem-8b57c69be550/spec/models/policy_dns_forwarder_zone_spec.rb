...
# Unit tests for SwaggerClient::PolicyDnsForwarderZone
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PolicyDnsForwarderZone' do
  before do
    # run before each test
    @instance = SwaggerClient::PolicyDnsForwarderZone.new
  end
  ...
  describe 'test an instance of PolicyDnsForwarderZone' do
    it 'should create an instance of PolicyDnsForwarderZone' do
      expect(@instance).to be_instance_of(SwaggerClient::PolicyDnsForwarderZone)
    end
  end
  ...
  describe 'test attribute "dns_domain_names"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
