...
# Unit tests for SwaggerClient::ChildLocaleServices
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildLocaleServices' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildLocaleServices.new
  end
  ...
  describe 'test an instance of ChildLocaleServices' do
    it 'should create an instance of ChildLocaleServices' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildLocaleServices)
    end
  end
  ...
  describe 'test attribute "locale_services"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
