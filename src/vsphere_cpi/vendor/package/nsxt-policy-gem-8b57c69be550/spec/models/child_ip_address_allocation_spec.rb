...
# Unit tests for SwaggerClient::ChildIpAddressAllocation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildIpAddressAllocation' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildIpAddressAllocation.new
  end
  ...
  describe 'test an instance of ChildIpAddressAllocation' do
    it 'should create an instance of ChildIpAddressAllocation' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildIpAddressAllocation)
    end
  end
  ...
  describe 'test attribute "ip_address_allocation"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
