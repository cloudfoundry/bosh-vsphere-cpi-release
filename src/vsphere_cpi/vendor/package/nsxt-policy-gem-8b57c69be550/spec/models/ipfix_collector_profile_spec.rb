...
# Unit tests for SwaggerClient::IPFIXCollectorProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IPFIXCollectorProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::IPFIXCollectorProfile.new
  end
  ...
  describe 'test an instance of IPFIXCollectorProfile' do
    it 'should create an instance of IPFIXCollectorProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::IPFIXCollectorProfile)
    end
  end
