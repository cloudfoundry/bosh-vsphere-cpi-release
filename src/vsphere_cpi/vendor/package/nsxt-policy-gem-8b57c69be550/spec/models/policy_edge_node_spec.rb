...
# Unit tests for SwaggerClient::PolicyEdgeNode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PolicyEdgeNode' do
  before do
    # run before each test
    @instance = SwaggerClient::PolicyEdgeNode.new
  end
  ...
  describe 'test an instance of PolicyEdgeNode' do
    it 'should create an instance of PolicyEdgeNode' do
      expect(@instance).to be_instance_of(SwaggerClient::PolicyEdgeNode)
    end
  end
  ...
  describe 'test attribute "member_index"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
