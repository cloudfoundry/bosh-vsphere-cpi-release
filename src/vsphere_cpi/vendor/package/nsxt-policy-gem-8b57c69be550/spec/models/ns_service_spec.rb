...
# Unit tests for SwaggerClient::NSService
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NSService' do
  before do
    # run before each test
    @instance = SwaggerClient::NSService.new
  end
  ...
  describe 'test an instance of NSService' do
    it 'should create an instance of NSService' do
      expect(@instance).to be_instance_of(SwaggerClient::NSService)
    end
  end
  ...
  describe 'test attribute "nsservice_element"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
