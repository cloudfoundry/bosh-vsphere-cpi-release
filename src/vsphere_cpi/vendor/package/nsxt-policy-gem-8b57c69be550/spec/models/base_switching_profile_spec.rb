...
# Unit tests for SwaggerClient::BaseSwitchingProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BaseSwitchingProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::BaseSwitchingProfile.new
  end
  ...
  describe 'test an instance of BaseSwitchingProfile' do
    it 'should create an instance of BaseSwitchingProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::BaseSwitchingProfile)
    end
  end
