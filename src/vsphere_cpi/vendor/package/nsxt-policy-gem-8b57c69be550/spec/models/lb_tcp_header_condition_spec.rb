...
# Unit tests for SwaggerClient::LBTcpHeaderCondition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LBTcpHeaderCondition' do
  before do
    # run before each test
    @instance = SwaggerClient::LBTcpHeaderCondition.new
  end
  ...
  describe 'test an instance of LBTcpHeaderCondition' do
    it 'should create an instance of LBTcpHeaderCondition' do
      expect(@instance).to be_instance_of(SwaggerClient::LBTcpHeaderCondition)
    end
  end
