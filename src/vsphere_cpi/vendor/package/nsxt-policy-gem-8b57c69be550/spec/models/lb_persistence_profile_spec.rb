...
# Unit tests for SwaggerClient::LbPersistenceProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LbPersistenceProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::LbPersistenceProfile.new
  end
  ...
  describe 'test an instance of LbPersistenceProfile' do
    it 'should create an instance of LbPersistenceProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::LbPersistenceProfile)
    end
  end
