...
# Unit tests for SwaggerClient::LbPassiveMonitor
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LbPassiveMonitor' do
  before do
    # run before each test
    @instance = SwaggerClient::LbPassiveMonitor.new
  end
  ...
  describe 'test an instance of LbPassiveMonitor' do
    it 'should create an instance of LbPassiveMonitor' do
      expect(@instance).to be_instance_of(SwaggerClient::LbPassiveMonitor)
    end
  end
