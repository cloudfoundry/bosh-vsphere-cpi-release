...
# Unit tests for SwaggerClient::ChildLBVirtualServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildLBVirtualServer' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildLBVirtualServer.new
  end
  ...
  describe 'test an instance of ChildLBVirtualServer' do
    it 'should create an instance of ChildLBVirtualServer' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildLBVirtualServer)
    end
  end
