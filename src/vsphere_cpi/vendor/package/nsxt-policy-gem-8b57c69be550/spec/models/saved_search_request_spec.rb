...
# Unit tests for SwaggerClient::SavedSearchRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SavedSearchRequest' do
  before do
    # run before each test
    @instance = SwaggerClient::SavedSearchRequest.new
  end
  ...
  describe 'test an instance of SavedSearchRequest' do
    it 'should create an instance of SavedSearchRequest' do
      expect(@instance).to be_instance_of(SwaggerClient::SavedSearchRequest)
    end
  end
  ...
  describe 'test attribute "is_saved"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
