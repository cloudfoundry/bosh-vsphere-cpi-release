...
# Unit tests for SwaggerClient::LbActiveMonitor
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LbActiveMonitor' do
  before do
    # run before each test
    @instance = SwaggerClient::LbActiveMonitor.new
  end
  ...
  describe 'test an instance of LbActiveMonitor' do
    it 'should create an instance of LbActiveMonitor' do
      expect(@instance).to be_instance_of(SwaggerClient::LbActiveMonitor)
    end
  end
