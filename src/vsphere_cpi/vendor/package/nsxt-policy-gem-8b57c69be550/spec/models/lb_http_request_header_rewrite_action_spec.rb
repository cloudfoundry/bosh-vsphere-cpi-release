...
# Unit tests for SwaggerClient::LBHttpRequestHeaderRewriteAction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LBHttpRequestHeaderRewriteAction' do
  before do
    # run before each test
    @instance = SwaggerClient::LBHttpRequestHeaderRewriteAction.new
  end
  ...
  describe 'test an instance of LBHttpRequestHeaderRewriteAction' do
    it 'should create an instance of LBHttpRequestHeaderRewriteAction' do
      expect(@instance).to be_instance_of(SwaggerClient::LBHttpRequestHeaderRewriteAction)
    end
  end
