...
# Unit tests for SwaggerClient::DirectoryDomain
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoryDomain' do
  before do
    # run before each test
    @instance = SwaggerClient::DirectoryDomain.new
  end
  ...
  describe 'test an instance of DirectoryDomain' do
    it 'should create an instance of DirectoryDomain' do
      expect(@instance).to be_instance_of(SwaggerClient::DirectoryDomain)
    end
  end
