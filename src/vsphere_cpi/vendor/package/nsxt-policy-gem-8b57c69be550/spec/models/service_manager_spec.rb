...
# Unit tests for SwaggerClient::ServiceManager
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceManager' do
  before do
    # run before each test
    @instance = SwaggerClient::ServiceManager.new
  end
  ...
  describe 'test an instance of ServiceManager' do
    it 'should create an instance of ServiceManager' do
      expect(@instance).to be_instance_of(SwaggerClient::ServiceManager)
    end
  end
