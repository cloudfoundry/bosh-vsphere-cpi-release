...
# Unit tests for SwaggerClient::TlsCertificate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TlsCertificate' do
  before do
    # run before each test
    @instance = SwaggerClient::TlsCertificate.new
  end
  ...
  describe 'test an instance of TlsCertificate' do
    it 'should create an instance of TlsCertificate' do
      expect(@instance).to be_instance_of(SwaggerClient::TlsCertificate)
    end
  end
