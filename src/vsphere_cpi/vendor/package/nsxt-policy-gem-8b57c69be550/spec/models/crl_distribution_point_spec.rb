...
# Unit tests for SwaggerClient::CrlDistributionPoint
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CrlDistributionPoint' do
  before do
    # run before each test
    @instance = SwaggerClient::CrlDistributionPoint.new
  end
  ...
  describe 'test an instance of CrlDistributionPoint' do
    it 'should create an instance of CrlDistributionPoint' do
      expect(@instance).to be_instance_of(SwaggerClient::CrlDistributionPoint)
    end
  end
  ...
  describe 'test attribute "cdp_uri"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
