...
# Unit tests for SwaggerClient::ChildRedirectionRule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildRedirectionRule' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildRedirectionRule.new
  end
  ...
  describe 'test an instance of ChildRedirectionRule' do
    it 'should create an instance of ChildRedirectionRule' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildRedirectionRule)
    end
  end
  ...
  describe 'test attribute "redirection_rule"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
