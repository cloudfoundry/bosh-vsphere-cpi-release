...
# Unit tests for SwaggerClient::GiServiceProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GiServiceProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::GiServiceProfile.new
  end
  ...
  describe 'test an instance of GiServiceProfile' do
    it 'should create an instance of GiServiceProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::GiServiceProfile)
    end
  end
  ...
  describe 'test attribute "vendor_template_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
