...
# Unit tests for SwaggerClient::ChildGroup
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildGroup' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildGroup.new
  end
  ...
  describe 'test an instance of ChildGroup' do
    it 'should create an instance of ChildGroup' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildGroup)
    end
  end
