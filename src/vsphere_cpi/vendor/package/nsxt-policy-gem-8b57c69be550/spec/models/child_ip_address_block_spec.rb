...
# Unit tests for SwaggerClient::ChildIpAddressBlock
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildIpAddressBlock' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildIpAddressBlock.new
  end
  ...
  describe 'test an instance of ChildIpAddressBlock' do
    it 'should create an instance of ChildIpAddressBlock' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildIpAddressBlock)
    end
  end
  ...
  describe 'test attribute "ip_address_block"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
