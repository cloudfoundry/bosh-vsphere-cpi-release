...
# Unit tests for SwaggerClient::EnforcementPoint
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EnforcementPoint' do
  before do
    # run before each test
    @instance = SwaggerClient::EnforcementPoint.new
  end
  ...
  describe 'test an instance of EnforcementPoint' do
    it 'should create an instance of EnforcementPoint' do
      expect(@instance).to be_instance_of(SwaggerClient::EnforcementPoint)
    end
  end
  ...
  describe 'test attribute "auto_enforce"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
