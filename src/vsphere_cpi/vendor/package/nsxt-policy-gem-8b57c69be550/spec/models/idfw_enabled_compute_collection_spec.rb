...
# Unit tests for SwaggerClient::IdfwEnabledComputeCollection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IdfwEnabledComputeCollection' do
  before do
    # run before each test
    @instance = SwaggerClient::IdfwEnabledComputeCollection.new
  end
  ...
  describe 'test an instance of IdfwEnabledComputeCollection' do
    it 'should create an instance of IdfwEnabledComputeCollection' do
      expect(@instance).to be_instance_of(SwaggerClient::IdfwEnabledComputeCollection)
    end
  end
  ...
  describe 'test attribute "compute_collection_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
