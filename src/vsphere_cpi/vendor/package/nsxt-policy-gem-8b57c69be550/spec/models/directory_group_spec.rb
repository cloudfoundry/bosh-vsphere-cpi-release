...
# Unit tests for SwaggerClient::DirectoryGroup
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoryGroup' do
  before do
    # run before each test
    @instance = SwaggerClient::DirectoryGroup.new
  end
  ...
  describe 'test an instance of DirectoryGroup' do
    it 'should create an instance of DirectoryGroup' do
      expect(@instance).to be_instance_of(SwaggerClient::DirectoryGroup)
    end
  end
