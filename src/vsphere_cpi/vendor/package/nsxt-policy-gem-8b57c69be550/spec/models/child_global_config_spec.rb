...
# Unit tests for SwaggerClient::ChildGlobalConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildGlobalConfig' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildGlobalConfig.new
  end
  ...
  describe 'test an instance of ChildGlobalConfig' do
    it 'should create an instance of ChildGlobalConfig' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildGlobalConfig)
    end
  end
