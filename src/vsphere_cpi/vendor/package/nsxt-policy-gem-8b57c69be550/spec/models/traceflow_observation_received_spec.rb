...
# Unit tests for SwaggerClient::TraceflowObservationReceived
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TraceflowObservationReceived' do
  before do
    # run before each test
    @instance = SwaggerClient::TraceflowObservationReceived.new
  end
  ...
  describe 'test an instance of TraceflowObservationReceived' do
    it 'should create an instance of TraceflowObservationReceived' do
      expect(@instance).to be_instance_of(SwaggerClient::TraceflowObservationReceived)
    end
  end
