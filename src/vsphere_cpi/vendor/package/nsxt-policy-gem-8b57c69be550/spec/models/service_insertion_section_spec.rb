...
# Unit tests for SwaggerClient::ServiceInsertionSection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceInsertionSection' do
  before do
    # run before each test
    @instance = SwaggerClient::ServiceInsertionSection.new
  end
  ...
  describe 'test an instance of ServiceInsertionSection' do
    it 'should create an instance of ServiceInsertionSection' do
      expect(@instance).to be_instance_of(SwaggerClient::ServiceInsertionSection)
    end
  end
