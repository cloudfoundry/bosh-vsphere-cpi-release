...
# Unit tests for SwaggerClient::Tier0RouteMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Tier0RouteMap' do
  before do
    # run before each test
    @instance = SwaggerClient::Tier0RouteMap.new
  end
  ...
  describe 'test an instance of Tier0RouteMap' do
    it 'should create an instance of Tier0RouteMap' do
      expect(@instance).to be_instance_of(SwaggerClient::Tier0RouteMap)
    end
  end
