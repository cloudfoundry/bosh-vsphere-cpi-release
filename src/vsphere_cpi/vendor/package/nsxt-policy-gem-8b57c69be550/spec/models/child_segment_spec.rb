...
# Unit tests for SwaggerClient::ChildSegment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildSegment' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildSegment.new
  end
  ...
  describe 'test an instance of ChildSegment' do
    it 'should create an instance of ChildSegment' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildSegment)
    end
  end
