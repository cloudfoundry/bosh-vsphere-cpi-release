...
# Unit tests for SwaggerClient::ChildTier0RouteMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildTier0RouteMap' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildTier0RouteMap.new
  end
  ...
  describe 'test an instance of ChildTier0RouteMap' do
    it 'should create an instance of ChildTier0RouteMap' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildTier0RouteMap)
    end
  end
  ...
  describe 'test attribute "tier0_route_map"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
