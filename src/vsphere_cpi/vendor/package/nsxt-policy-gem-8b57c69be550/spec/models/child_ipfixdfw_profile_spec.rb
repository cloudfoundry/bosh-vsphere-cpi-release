...
# Unit tests for SwaggerClient::ChildIPFIXDFWProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildIPFIXDFWProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildIPFIXDFWProfile.new
  end
  ...
  describe 'test an instance of ChildIPFIXDFWProfile' do
    it 'should create an instance of ChildIPFIXDFWProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildIPFIXDFWProfile)
    end
  end
  ...
  describe 'test attribute "ipfixdfw_profile"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
