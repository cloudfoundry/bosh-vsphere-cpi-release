...
# Unit tests for SwaggerClient::IPAddressExpression
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IPAddressExpression' do
  before do
    # run before each test
    @instance = SwaggerClient::IPAddressExpression.new
  end
  ...
  describe 'test an instance of IPAddressExpression' do
    it 'should create an instance of IPAddressExpression' do
      expect(@instance).to be_instance_of(SwaggerClient::IPAddressExpression)
    end
  end
