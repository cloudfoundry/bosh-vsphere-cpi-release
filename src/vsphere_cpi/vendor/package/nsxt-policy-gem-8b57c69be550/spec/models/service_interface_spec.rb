...
# Unit tests for SwaggerClient::ServiceInterface
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceInterface' do
  before do
    # run before each test
    @instance = SwaggerClient::ServiceInterface.new
  end
  ...
  describe 'test an instance of ServiceInterface' do
    it 'should create an instance of ServiceInterface' do
      expect(@instance).to be_instance_of(SwaggerClient::ServiceInterface)
    end
  end
