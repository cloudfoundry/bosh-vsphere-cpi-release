...
# Unit tests for SwaggerClient::ChildL2VPNSession
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildL2VPNSession' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildL2VPNSession.new
  end
  ...
  describe 'test an instance of ChildL2VPNSession' do
    it 'should create an instance of ChildL2VPNSession' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildL2VPNSession)
    end
  end
  ...
  describe 'test attribute "l2_vpn_session"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
