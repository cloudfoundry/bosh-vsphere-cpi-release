...
# Unit tests for SwaggerClient::RuleState
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RuleState' do
  before do
    # run before each test
    @instance = SwaggerClient::RuleState.new
  end
  ...
  describe 'test an instance of RuleState' do
    it 'should create an instance of RuleState' do
      expect(@instance).to be_instance_of(SwaggerClient::RuleState)
    end
  end
