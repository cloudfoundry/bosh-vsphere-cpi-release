...
# Unit tests for SwaggerClient::SpoofGuardProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SpoofGuardProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::SpoofGuardProfile.new
  end
  ...
  describe 'test an instance of SpoofGuardProfile' do
    it 'should create an instance of SpoofGuardProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::SpoofGuardProfile)
    end
  end
  ...
  describe 'test attribute "address_binding_whitelist"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
