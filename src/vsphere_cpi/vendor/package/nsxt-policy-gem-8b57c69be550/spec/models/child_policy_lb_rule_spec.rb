...
# Unit tests for SwaggerClient::ChildPolicyLbRule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildPolicyLbRule' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildPolicyLbRule.new
  end
  ...
  describe 'test an instance of ChildPolicyLbRule' do
    it 'should create an instance of ChildPolicyLbRule' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildPolicyLbRule)
    end
  end
  ...
  describe 'test attribute "policy_lb_rule"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
