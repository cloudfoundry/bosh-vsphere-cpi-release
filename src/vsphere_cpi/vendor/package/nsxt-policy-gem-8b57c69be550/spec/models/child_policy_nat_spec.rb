...
# Unit tests for SwaggerClient::ChildPolicyNat
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildPolicyNat' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildPolicyNat.new
  end
  ...
  describe 'test an instance of ChildPolicyNat' do
    it 'should create an instance of ChildPolicyNat' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildPolicyNat)
    end
  end
  ...
  describe 'test attribute "policy_nat"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
