...
# Unit tests for SwaggerClient::L2VpnContext
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'L2VpnContext' do
  before do
    # run before each test
    @instance = SwaggerClient::L2VpnContext.new
  end
  ...
  describe 'test an instance of L2VpnContext' do
    it 'should create an instance of L2VpnContext' do
      expect(@instance).to be_instance_of(SwaggerClient::L2VpnContext)
    end
  end
