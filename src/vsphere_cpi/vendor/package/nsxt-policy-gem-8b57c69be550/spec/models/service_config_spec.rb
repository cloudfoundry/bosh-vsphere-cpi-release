...
# Unit tests for SwaggerClient::ServiceConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceConfig' do
  before do
    # run before each test
    @instance = SwaggerClient::ServiceConfig.new
  end
  ...
  describe 'test an instance of ServiceConfig' do
    it 'should create an instance of ServiceConfig' do
      expect(@instance).to be_instance_of(SwaggerClient::ServiceConfig)
    end
  end
  ...
  describe 'test attribute "applied_to"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
