...
# Unit tests for SwaggerClient::TransportNodeCollection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransportNodeCollection' do
  before do
    # run before each test
    @instance = SwaggerClient::TransportNodeCollection.new
  end
  ...
  describe 'test an instance of TransportNodeCollection' do
    it 'should create an instance of TransportNodeCollection' do
      expect(@instance).to be_instance_of(SwaggerClient::TransportNodeCollection)
    end
  end
  ...
  describe 'test attribute "transport_node_profile_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
