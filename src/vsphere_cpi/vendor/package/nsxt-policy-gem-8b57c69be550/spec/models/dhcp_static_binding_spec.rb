...
# Unit tests for SwaggerClient::DhcpStaticBinding
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DhcpStaticBinding' do
  before do
    # run before each test
    @instance = SwaggerClient::DhcpStaticBinding.new
  end
  ...
  describe 'test an instance of DhcpStaticBinding' do
    it 'should create an instance of DhcpStaticBinding' do
      expect(@instance).to be_instance_of(SwaggerClient::DhcpStaticBinding)
    end
  end
