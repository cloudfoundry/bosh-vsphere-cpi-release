...
# Unit tests for SwaggerClient::ICMPTypeNSService
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ICMPTypeNSService' do
  before do
    # run before each test
    @instance = SwaggerClient::ICMPTypeNSService.new
  end
  ...
  describe 'test an instance of ICMPTypeNSService' do
    it 'should create an instance of ICMPTypeNSService' do
      expect(@instance).to be_instance_of(SwaggerClient::ICMPTypeNSService)
    end
  end
