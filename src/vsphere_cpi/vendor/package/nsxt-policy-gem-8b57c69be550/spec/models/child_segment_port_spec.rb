...
# Unit tests for SwaggerClient::ChildSegmentPort
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildSegmentPort' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildSegmentPort.new
  end
  ...
  describe 'test an instance of ChildSegmentPort' do
    it 'should create an instance of ChildSegmentPort' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildSegmentPort)
    end
  end
  ...
  describe 'test attribute "segment_port"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
