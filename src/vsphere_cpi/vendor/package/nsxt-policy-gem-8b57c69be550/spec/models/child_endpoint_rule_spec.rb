...
# Unit tests for SwaggerClient::ChildEndpointRule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildEndpointRule' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildEndpointRule.new
  end
  ...
  describe 'test an instance of ChildEndpointRule' do
    it 'should create an instance of ChildEndpointRule' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildEndpointRule)
    end
  end
  ...
  describe 'test attribute "endpoint_rule"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
