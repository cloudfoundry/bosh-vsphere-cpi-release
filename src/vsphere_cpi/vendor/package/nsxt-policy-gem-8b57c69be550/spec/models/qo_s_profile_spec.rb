...
# Unit tests for SwaggerClient::QoSProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QoSProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::QoSProfile.new
  end
  ...
  describe 'test an instance of QoSProfile' do
    it 'should create an instance of QoSProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::QoSProfile)
    end
  end
  ...
  describe 'test attribute "shaper_configurations"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
