...
# Unit tests for SwaggerClient::ChildTlsCrl
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildTlsCrl' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildTlsCrl.new
  end
  ...
  describe 'test an instance of ChildTlsCrl' do
    it 'should create an instance of ChildTlsCrl' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildTlsCrl)
    end
  end
  ...
  describe 'test attribute "tls_crl"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
