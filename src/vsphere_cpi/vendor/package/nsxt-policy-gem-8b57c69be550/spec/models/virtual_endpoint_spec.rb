...
# Unit tests for SwaggerClient::VirtualEndpoint
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VirtualEndpoint' do
  before do
    # run before each test
    @instance = SwaggerClient::VirtualEndpoint.new
  end
  ...
  describe 'test an instance of VirtualEndpoint' do
    it 'should create an instance of VirtualEndpoint' do
      expect(@instance).to be_instance_of(SwaggerClient::VirtualEndpoint)
    end
  end
