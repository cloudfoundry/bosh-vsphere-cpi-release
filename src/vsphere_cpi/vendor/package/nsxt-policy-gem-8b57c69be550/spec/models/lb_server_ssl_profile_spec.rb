...
# Unit tests for SwaggerClient::LbServerSslProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LbServerSslProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::LbServerSslProfile.new
  end
  ...
  describe 'test an instance of LbServerSslProfile' do
    it 'should create an instance of LbServerSslProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::LbServerSslProfile)
    end
  end
