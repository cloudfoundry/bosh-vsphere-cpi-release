...
# Unit tests for SwaggerClient::GatewayPolicy
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GatewayPolicy' do
  before do
    # run before each test
    @instance = SwaggerClient::GatewayPolicy.new
  end
  ...
  describe 'test an instance of GatewayPolicy' do
    it 'should create an instance of GatewayPolicy' do
      expect(@instance).to be_instance_of(SwaggerClient::GatewayPolicy)
    end
  end
