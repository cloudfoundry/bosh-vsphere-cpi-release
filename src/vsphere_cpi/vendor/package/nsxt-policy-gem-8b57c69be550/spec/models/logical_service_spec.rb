...
# Unit tests for SwaggerClient::LogicalService
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LogicalService' do
  before do
    # run before each test
    @instance = SwaggerClient::LogicalService.new
  end
  ...
  describe 'test an instance of LogicalService' do
    it 'should create an instance of LogicalService' do
      expect(@instance).to be_instance_of(SwaggerClient::LogicalService)
    end
  end
  ...
  describe 'test attribute "resource_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["DhcpRelayService"])
  ...
  describe 'test attribute "dhcp_relay_profile_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
