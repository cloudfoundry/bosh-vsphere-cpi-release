...
# Unit tests for SwaggerClient::IpAllocationBase
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IpAllocationBase' do
  before do
    # run before each test
    @instance = SwaggerClient::IpAllocationBase.new
  end
  ...
  describe 'test an instance of IpAllocationBase' do
    it 'should create an instance of IpAllocationBase' do
      expect(@instance).to be_instance_of(SwaggerClient::IpAllocationBase)
    end
  end
