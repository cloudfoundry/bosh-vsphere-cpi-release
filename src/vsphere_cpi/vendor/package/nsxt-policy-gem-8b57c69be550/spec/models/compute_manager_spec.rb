...
# Unit tests for SwaggerClient::ComputeManager
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ComputeManager' do
  before do
    # run before each test
    @instance = SwaggerClient::ComputeManager.new
  end
  ...
  describe 'test an instance of ComputeManager' do
    it 'should create an instance of ComputeManager' do
      expect(@instance).to be_instance_of(SwaggerClient::ComputeManager)
    end
  end
