...
# Unit tests for SwaggerClient::ActionableResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ActionableResource' do
  before do
    # run before each test
    @instance = SwaggerClient::ActionableResource.new
  end
  ...
  describe 'test an instance of ActionableResource' do
    it 'should create an instance of ActionableResource' do
      expect(@instance).to be_instance_of(SwaggerClient::ActionableResource)
    end
  end
