...
# Unit tests for SwaggerClient::ForwardingPolicy
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ForwardingPolicy' do
  before do
    # run before each test
    @instance = SwaggerClient::ForwardingPolicy.new
  end
  ...
  describe 'test an instance of ForwardingPolicy' do
    it 'should create an instance of ForwardingPolicy' do
      expect(@instance).to be_instance_of(SwaggerClient::ForwardingPolicy)
    end
  end
