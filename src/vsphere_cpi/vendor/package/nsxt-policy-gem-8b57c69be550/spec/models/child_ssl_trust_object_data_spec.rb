...
# Unit tests for SwaggerClient::ChildSslTrustObjectData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildSslTrustObjectData' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildSslTrustObjectData.new
  end
  ...
  describe 'test an instance of ChildSslTrustObjectData' do
    it 'should create an instance of ChildSslTrustObjectData' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildSslTrustObjectData)
    end
  end
  ...
  describe 'test attribute "ssl_trust_object_data"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
