...
# Unit tests for SwaggerClient::BaseFirewallProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BaseFirewallProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::BaseFirewallProfile.new
  end
  ...
  describe 'test an instance of BaseFirewallProfile' do
    it 'should create an instance of BaseFirewallProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::BaseFirewallProfile)
    end
  end
