...
# Unit tests for SwaggerClient::MACSet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MACSet' do
  before do
    # run before each test
    @instance = SwaggerClient::MACSet.new
  end
  ...
  describe 'test an instance of MACSet' do
    it 'should create an instance of MACSet' do
      expect(@instance).to be_instance_of(SwaggerClient::MACSet)
    end
  end
