...
# Unit tests for SwaggerClient::DhcpServerConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DhcpServerConfig' do
  before do
    # run before each test
    @instance = SwaggerClient::DhcpServerConfig.new
  end
  ...
  describe 'test an instance of DhcpServerConfig' do
    it 'should create an instance of DhcpServerConfig' do
      expect(@instance).to be_instance_of(SwaggerClient::DhcpServerConfig)
    end
  end
  ...
  describe 'test attribute "lease_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
