...
# Unit tests for SwaggerClient::ChildPolicyNatRule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildPolicyNatRule' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildPolicyNatRule.new
  end
  ...
  describe 'test an instance of ChildPolicyNatRule' do
    it 'should create an instance of ChildPolicyNatRule' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildPolicyNatRule)
    end
  end
  ...
  describe 'test attribute "policy_nat_rule"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
