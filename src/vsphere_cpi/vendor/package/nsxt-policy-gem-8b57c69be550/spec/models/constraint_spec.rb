...
# Unit tests for SwaggerClient::Constraint
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Constraint' do
  before do
    # run before each test
    @instance = SwaggerClient::Constraint.new
  end
  ...
  describe 'test an instance of Constraint' do
    it 'should create an instance of Constraint' do
      expect(@instance).to be_instance_of(SwaggerClient::Constraint)
    end
  end
  ...
  describe 'test attribute "constraint_expression"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
