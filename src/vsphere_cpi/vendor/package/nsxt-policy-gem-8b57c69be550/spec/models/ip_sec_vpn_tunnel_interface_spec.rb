...
# Unit tests for SwaggerClient::IPSecVpnTunnelInterface
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IPSecVpnTunnelInterface' do
  before do
    # run before each test
    @instance = SwaggerClient::IPSecVpnTunnelInterface.new
  end
  ...
  describe 'test an instance of IPSecVpnTunnelInterface' do
    it 'should create an instance of IPSecVpnTunnelInterface' do
      expect(@instance).to be_instance_of(SwaggerClient::IPSecVpnTunnelInterface)
    end
  end
  ...
  describe 'test attribute "ip_subnets"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
