...
# Unit tests for SwaggerClient::GlobalConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GlobalConfig' do
  before do
    # run before each test
    @instance = SwaggerClient::GlobalConfig.new
  end
  ...
  describe 'test an instance of GlobalConfig' do
    it 'should create an instance of GlobalConfig' do
      expect(@instance).to be_instance_of(SwaggerClient::GlobalConfig)
    end
  end
