...
# Unit tests for SwaggerClient::ChildPolicyConfigResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildPolicyConfigResource' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildPolicyConfigResource.new
  end
  ...
  describe 'test an instance of ChildPolicyConfigResource' do
    it 'should create an instance of ChildPolicyConfigResource' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildPolicyConfigResource)
    end
  end
