...
# Unit tests for SwaggerClient::LbAppProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LbAppProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::LbAppProfile.new
  end
  ...
  describe 'test an instance of LbAppProfile' do
    it 'should create an instance of LbAppProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::LbAppProfile)
    end
  end
