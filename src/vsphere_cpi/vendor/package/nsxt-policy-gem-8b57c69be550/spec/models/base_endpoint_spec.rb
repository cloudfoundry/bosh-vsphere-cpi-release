...
# Unit tests for SwaggerClient::BaseEndpoint
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BaseEndpoint' do
  before do
    # run before each test
    @instance = SwaggerClient::BaseEndpoint.new
  end
  ...
  describe 'test an instance of BaseEndpoint' do
    it 'should create an instance of BaseEndpoint' do
      expect(@instance).to be_instance_of(SwaggerClient::BaseEndpoint)
    end
  end
