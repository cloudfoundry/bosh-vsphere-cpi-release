...
# Unit tests for SwaggerClient::ChildTlsCertificate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildTlsCertificate' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildTlsCertificate.new
  end
  ...
  describe 'test an instance of ChildTlsCertificate' do
    it 'should create an instance of ChildTlsCertificate' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildTlsCertificate)
    end
  end
