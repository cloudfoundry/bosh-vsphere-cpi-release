...
# Unit tests for SwaggerClient::DhcpRelayProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DhcpRelayProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::DhcpRelayProfile.new
  end
  ...
  describe 'test an instance of DhcpRelayProfile' do
    it 'should create an instance of DhcpRelayProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::DhcpRelayProfile)
    end
  end
