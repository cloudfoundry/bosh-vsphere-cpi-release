...
# Unit tests for SwaggerClient::ForwardingRule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ForwardingRule' do
  before do
    # run before each test
    @instance = SwaggerClient::ForwardingRule.new
  end
  ...
  describe 'test an instance of ForwardingRule' do
    it 'should create an instance of ForwardingRule' do
      expect(@instance).to be_instance_of(SwaggerClient::ForwardingRule)
    end
  end
  ...
  describe 'test attribute "action"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ROUTE_TO_UNDERLAY", "ROUTE_TO_OVERLAY", "ROUTE_FROM_UNDERLAY", "ROUTE_FROM_OVERLAY", "NAT_FROM_UNDERLAY", "NAT_TO_UNDERLAY"])
      # validator.allowable_values.each do |value|
