...
# Unit tests for SwaggerClient::PBRSectionRuleList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PBRSectionRuleList' do
  before do
    # run before each test
    @instance = SwaggerClient::PBRSectionRuleList.new
  end
  ...
  describe 'test an instance of PBRSectionRuleList' do
    it 'should create an instance of PBRSectionRuleList' do
      expect(@instance).to be_instance_of(SwaggerClient::PBRSectionRuleList)
    end
  end
