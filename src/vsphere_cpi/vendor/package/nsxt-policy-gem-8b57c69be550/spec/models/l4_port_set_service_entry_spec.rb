...
# Unit tests for SwaggerClient::L4PortSetServiceEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'L4PortSetServiceEntry' do
  before do
    # run before each test
    @instance = SwaggerClient::L4PortSetServiceEntry.new
  end
  ...
  describe 'test an instance of L4PortSetServiceEntry' do
    it 'should create an instance of L4PortSetServiceEntry' do
      expect(@instance).to be_instance_of(SwaggerClient::L4PortSetServiceEntry)
    end
  end
  ...
  describe 'test attribute "resource_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["IPProtocolServiceEntry", "IGMPTypeServiceEntry", "ICMPTypeServiceEntry", "ALGTypeServiceEntry", "L4PortSetServiceEntry", "EtherTypeServiceEntry"])
