...
# Unit tests for SwaggerClient::DSRuleState
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DSRuleState' do
  before do
    # run before each test
    @instance = SwaggerClient::DSRuleState.new
  end
  ...
  describe 'test an instance of DSRuleState' do
    it 'should create an instance of DSRuleState' do
      expect(@instance).to be_instance_of(SwaggerClient::DSRuleState)
    end
  end
