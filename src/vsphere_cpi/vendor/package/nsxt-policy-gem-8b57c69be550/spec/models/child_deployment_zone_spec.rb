...
# Unit tests for SwaggerClient::ChildDeploymentZone
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildDeploymentZone' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildDeploymentZone.new
  end
  ...
  describe 'test an instance of ChildDeploymentZone' do
    it 'should create an instance of ChildDeploymentZone' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildDeploymentZone)
    end
  end
  ...
  describe 'test attribute "deployment_zone"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
