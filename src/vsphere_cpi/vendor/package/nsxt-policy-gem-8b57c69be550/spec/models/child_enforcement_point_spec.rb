...
# Unit tests for SwaggerClient::ChildEnforcementPoint
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildEnforcementPoint' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildEnforcementPoint.new
  end
  ...
  describe 'test an instance of ChildEnforcementPoint' do
    it 'should create an instance of ChildEnforcementPoint' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildEnforcementPoint)
    end
  end
