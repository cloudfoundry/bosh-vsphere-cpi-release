...
# Unit tests for SwaggerClient::ChildMacDiscoveryProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildMacDiscoveryProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildMacDiscoveryProfile.new
  end
  ...
  describe 'test an instance of ChildMacDiscoveryProfile' do
    it 'should create an instance of ChildMacDiscoveryProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildMacDiscoveryProfile)
    end
  end
  ...
  describe 'test attribute "mac_discovery_profile"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
