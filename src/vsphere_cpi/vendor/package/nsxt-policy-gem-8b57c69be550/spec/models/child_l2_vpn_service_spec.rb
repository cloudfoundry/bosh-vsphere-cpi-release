...
# Unit tests for SwaggerClient::ChildL2VPNService
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildL2VPNService' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildL2VPNService.new
  end
  ...
  describe 'test an instance of ChildL2VPNService' do
    it 'should create an instance of ChildL2VPNService' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildL2VPNService)
    end
  end
  ...
  describe 'test attribute "l2_vpn_service"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
