...
# Unit tests for SwaggerClient::ChildIPFIXL2Profile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildIPFIXL2Profile' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildIPFIXL2Profile.new
  end
  ...
  describe 'test an instance of ChildIPFIXL2Profile' do
    it 'should create an instance of ChildIPFIXL2Profile' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildIPFIXL2Profile)
    end
  end
  ...
  describe 'test attribute "ipfixl2_profile"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
