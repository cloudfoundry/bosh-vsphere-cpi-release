...
# Unit tests for SwaggerClient::ChildL2Vpn
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildL2Vpn' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildL2Vpn.new
  end
  ...
  describe 'test an instance of ChildL2Vpn' do
    it 'should create an instance of ChildL2Vpn' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildL2Vpn)
    end
  end
  ...
  describe 'test attribute "l2_vpn"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
