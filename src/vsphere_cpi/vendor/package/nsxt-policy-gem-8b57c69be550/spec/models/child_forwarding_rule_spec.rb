...
# Unit tests for SwaggerClient::ChildForwardingRule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildForwardingRule' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildForwardingRule.new
  end
  ...
  describe 'test an instance of ChildForwardingRule' do
    it 'should create an instance of ChildForwardingRule' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildForwardingRule)
    end
  end
  ...
  describe 'test attribute "forwarding_rule"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
