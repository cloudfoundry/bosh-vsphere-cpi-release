...
# Unit tests for SwaggerClient::ChildResourceReference
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildResourceReference' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildResourceReference.new
  end
  ...
  describe 'test an instance of ChildResourceReference' do
    it 'should create an instance of ChildResourceReference' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildResourceReference)
    end
  end
