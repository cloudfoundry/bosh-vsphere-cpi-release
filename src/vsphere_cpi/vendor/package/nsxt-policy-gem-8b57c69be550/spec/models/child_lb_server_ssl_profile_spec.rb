...
# Unit tests for SwaggerClient::ChildLBServerSslProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildLBServerSslProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildLBServerSslProfile.new
  end
  ...
  describe 'test an instance of ChildLBServerSslProfile' do
    it 'should create an instance of ChildLBServerSslProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildLBServerSslProfile)
    end
  end
  ...
  describe 'test attribute "lb_server_ssl_profile"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
