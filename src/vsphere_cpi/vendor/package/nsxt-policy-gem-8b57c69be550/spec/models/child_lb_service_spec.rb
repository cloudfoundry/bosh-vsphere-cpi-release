...
# Unit tests for SwaggerClient::ChildLBService
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildLBService' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildLBService.new
  end
  ...
  describe 'test an instance of ChildLBService' do
    it 'should create an instance of ChildLBService' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildLBService)
    end
  end
  ...
  describe 'test attribute "lb_service"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
