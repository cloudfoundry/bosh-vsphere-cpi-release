...
# Unit tests for SwaggerClient::TrustObjectData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrustObjectData' do
  before do
    # run before each test
    @instance = SwaggerClient::TrustObjectData.new
  end
  ...
  describe 'test an instance of TrustObjectData' do
    it 'should create an instance of TrustObjectData' do
      expect(@instance).to be_instance_of(SwaggerClient::TrustObjectData)
    end
  end
