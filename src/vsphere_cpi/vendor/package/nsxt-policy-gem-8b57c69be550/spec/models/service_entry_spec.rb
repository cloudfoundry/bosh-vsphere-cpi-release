...
# Unit tests for SwaggerClient::ServiceEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceEntry' do
  before do
    # run before each test
    @instance = SwaggerClient::ServiceEntry.new
  end
  ...
  describe 'test an instance of ServiceEntry' do
    it 'should create an instance of ServiceEntry' do
      expect(@instance).to be_instance_of(SwaggerClient::ServiceEntry)
    end
  end
