...
# Unit tests for SwaggerClient::IPSecVpnRule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IPSecVpnRule' do
  before do
    # run before each test
    @instance = SwaggerClient::IPSecVpnRule.new
  end
  ...
  describe 'test an instance of IPSecVpnRule' do
    it 'should create an instance of IPSecVpnRule' do
      expect(@instance).to be_instance_of(SwaggerClient::IPSecVpnRule)
    end
  end
