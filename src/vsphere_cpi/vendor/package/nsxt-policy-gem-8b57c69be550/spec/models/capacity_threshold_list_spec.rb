...
# Unit tests for SwaggerClient::CapacityThresholdList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CapacityThresholdList' do
  before do
    # run before each test
    @instance = SwaggerClient::CapacityThresholdList.new
  end
  ...
  describe 'test an instance of CapacityThresholdList' do
    it 'should create an instance of CapacityThresholdList' do
      expect(@instance).to be_instance_of(SwaggerClient::CapacityThresholdList)
    end
  end
  ...
  describe 'test attribute "capacity_thresholds"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
