...
# Unit tests for SwaggerClient::ManagedResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ManagedResource' do
  before do
    # run before each test
    @instance = SwaggerClient::ManagedResource.new
  end
  ...
  describe 'test an instance of ManagedResource' do
    it 'should create an instance of ManagedResource' do
      expect(@instance).to be_instance_of(SwaggerClient::ManagedResource)
    end
  end
