...
# Unit tests for SwaggerClient::IpAddressPool
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IpAddressPool' do
  before do
    # run before each test
    @instance = SwaggerClient::IpAddressPool.new
  end
  ...
  describe 'test an instance of IpAddressPool' do
    it 'should create an instance of IpAddressPool' do
      expect(@instance).to be_instance_of(SwaggerClient::IpAddressPool)
    end
  end
