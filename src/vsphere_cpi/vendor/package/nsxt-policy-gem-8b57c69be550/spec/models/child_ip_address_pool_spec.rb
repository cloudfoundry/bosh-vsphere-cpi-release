...
# Unit tests for SwaggerClient::ChildIpAddressPool
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildIpAddressPool' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildIpAddressPool.new
  end
  ...
  describe 'test an instance of ChildIpAddressPool' do
    it 'should create an instance of ChildIpAddressPool' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildIpAddressPool)
    end
  end
  ...
  describe 'test attribute "ip_address_pool"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
