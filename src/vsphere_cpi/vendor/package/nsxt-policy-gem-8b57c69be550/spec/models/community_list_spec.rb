...
# Unit tests for SwaggerClient::CommunityList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommunityList' do
  before do
    # run before each test
    @instance = SwaggerClient::CommunityList.new
  end
  ...
  describe 'test an instance of CommunityList' do
    it 'should create an instance of CommunityList' do
      expect(@instance).to be_instance_of(SwaggerClient::CommunityList)
    end
  end
