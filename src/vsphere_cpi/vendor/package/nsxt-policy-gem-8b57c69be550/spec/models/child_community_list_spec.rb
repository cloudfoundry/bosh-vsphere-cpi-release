...
# Unit tests for SwaggerClient::ChildCommunityList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildCommunityList' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildCommunityList.new
  end
  ...
  describe 'test an instance of ChildCommunityList' do
    it 'should create an instance of ChildCommunityList' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildCommunityList)
    end
  end
  ...
  describe 'test attribute "community_list"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
