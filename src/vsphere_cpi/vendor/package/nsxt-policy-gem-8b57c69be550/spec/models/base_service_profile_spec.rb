...
# Unit tests for SwaggerClient::BaseServiceProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BaseServiceProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::BaseServiceProfile.new
  end
  ...
  describe 'test an instance of BaseServiceProfile' do
    it 'should create an instance of BaseServiceProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::BaseServiceProfile)
    end
  end
