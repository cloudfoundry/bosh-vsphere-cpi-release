...
# Unit tests for SwaggerClient::ChildDhcpServerConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildDhcpServerConfig' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildDhcpServerConfig.new
  end
  ...
  describe 'test an instance of ChildDhcpServerConfig' do
    it 'should create an instance of ChildDhcpServerConfig' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildDhcpServerConfig)
    end
  end
  ...
  describe 'test attribute "dhcp_server_config"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
