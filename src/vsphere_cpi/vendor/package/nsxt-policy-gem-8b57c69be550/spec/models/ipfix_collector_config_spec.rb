...
# Unit tests for SwaggerClient::IpfixCollectorConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IpfixCollectorConfig' do
  before do
    # run before each test
    @instance = SwaggerClient::IpfixCollectorConfig.new
  end
  ...
  describe 'test an instance of IpfixCollectorConfig' do
    it 'should create an instance of IpfixCollectorConfig' do
      expect(@instance).to be_instance_of(SwaggerClient::IpfixCollectorConfig)
    end
  end
