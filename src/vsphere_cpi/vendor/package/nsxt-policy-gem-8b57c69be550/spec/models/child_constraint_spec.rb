...
# Unit tests for SwaggerClient::ChildConstraint
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildConstraint' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildConstraint.new
  end
  ...
  describe 'test an instance of ChildConstraint' do
    it 'should create an instance of ChildConstraint' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildConstraint)
    end
  end
