...
# Unit tests for SwaggerClient::HostAggregateInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HostAggregateInfo' do
  before do
    # run before each test
    @instance = SwaggerClient::HostAggregateInfo.new
  end
  ...
  describe 'test an instance of HostAggregateInfo' do
    it 'should create an instance of HostAggregateInfo' do
      expect(@instance).to be_instance_of(SwaggerClient::HostAggregateInfo)
    end
  end
