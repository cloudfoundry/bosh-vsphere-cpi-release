...
# Unit tests for SwaggerClient::StaticHopBfdPeer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StaticHopBfdPeer' do
  before do
    # run before each test
    @instance = SwaggerClient::StaticHopBfdPeer.new
  end
  ...
  describe 'test an instance of StaticHopBfdPeer' do
    it 'should create an instance of StaticHopBfdPeer' do
      expect(@instance).to be_instance_of(SwaggerClient::StaticHopBfdPeer)
    end
  end
  ...
  describe 'test attribute "peer_ip_address"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
