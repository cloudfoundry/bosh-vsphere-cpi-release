...
# Unit tests for SwaggerClient::VtepLabelPool
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VtepLabelPool' do
  before do
    # run before each test
    @instance = SwaggerClient::VtepLabelPool.new
  end
  ...
  describe 'test an instance of VtepLabelPool' do
    it 'should create an instance of VtepLabelPool' do
      expect(@instance).to be_instance_of(SwaggerClient::VtepLabelPool)
    end
  end
  ...
  describe 'test attribute "pool_usage"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
