...
# Unit tests for SwaggerClient::ChildPolicyEdgeNode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildPolicyEdgeNode' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildPolicyEdgeNode.new
  end
  ...
  describe 'test an instance of ChildPolicyEdgeNode' do
    it 'should create an instance of ChildPolicyEdgeNode' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildPolicyEdgeNode)
    end
  end
  ...
  describe 'test attribute "policy_edge_node"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
