...
# Unit tests for SwaggerClient::ChildVirtualEndpoint
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildVirtualEndpoint' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildVirtualEndpoint.new
  end
  ...
  describe 'test an instance of ChildVirtualEndpoint' do
    it 'should create an instance of ChildVirtualEndpoint' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildVirtualEndpoint)
    end
  end
  ...
  describe 'test attribute "virtual_endpoint"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
