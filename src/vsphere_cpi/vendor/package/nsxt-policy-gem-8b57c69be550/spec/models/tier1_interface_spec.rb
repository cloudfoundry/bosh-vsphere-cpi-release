...
# Unit tests for SwaggerClient::Tier1Interface
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Tier1Interface' do
  before do
    # run before each test
    @instance = SwaggerClient::Tier1Interface.new
  end
  ...
  describe 'test an instance of Tier1Interface' do
    it 'should create an instance of Tier1Interface' do
      expect(@instance).to be_instance_of(SwaggerClient::Tier1Interface)
    end
  end
