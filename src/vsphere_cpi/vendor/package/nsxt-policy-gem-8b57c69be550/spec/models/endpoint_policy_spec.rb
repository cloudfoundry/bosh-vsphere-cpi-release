...
# Unit tests for SwaggerClient::EndpointPolicy
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EndpointPolicy' do
  before do
    # run before each test
    @instance = SwaggerClient::EndpointPolicy.new
  end
  ...
  describe 'test an instance of EndpointPolicy' do
    it 'should create an instance of EndpointPolicy' do
      expect(@instance).to be_instance_of(SwaggerClient::EndpointPolicy)
    end
  end
  ...
  describe 'test attribute "endpoint_rules"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
