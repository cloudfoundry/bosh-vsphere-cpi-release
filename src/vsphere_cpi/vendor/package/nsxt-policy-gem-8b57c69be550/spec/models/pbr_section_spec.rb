...
# Unit tests for SwaggerClient::PBRSection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PBRSection' do
  before do
    # run before each test
    @instance = SwaggerClient::PBRSection.new
  end
  ...
  describe 'test an instance of PBRSection' do
    it 'should create an instance of PBRSection' do
      expect(@instance).to be_instance_of(SwaggerClient::PBRSection)
    end
  end
