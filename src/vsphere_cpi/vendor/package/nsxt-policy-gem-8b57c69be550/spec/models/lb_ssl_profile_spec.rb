...
# Unit tests for SwaggerClient::LbSslProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LbSslProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::LbSslProfile.new
  end
  ...
  describe 'test an instance of LbSslProfile' do
    it 'should create an instance of LbSslProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::LbSslProfile)
    end
  end
