...
# Unit tests for SwaggerClient::ChildServiceReference
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildServiceReference' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildServiceReference.new
  end
  ...
  describe 'test an instance of ChildServiceReference' do
    it 'should create an instance of ChildServiceReference' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildServiceReference)
    end
  end
  ...
  describe 'test attribute "service_reference"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
