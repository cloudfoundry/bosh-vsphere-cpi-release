...
# Unit tests for SwaggerClient::DhcpRelayConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DhcpRelayConfig' do
  before do
    # run before each test
    @instance = SwaggerClient::DhcpRelayConfig.new
  end
  ...
  describe 'test an instance of DhcpRelayConfig' do
    it 'should create an instance of DhcpRelayConfig' do
      expect(@instance).to be_instance_of(SwaggerClient::DhcpRelayConfig)
    end
  end
  ...
  describe 'test attribute "server_addresses"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
