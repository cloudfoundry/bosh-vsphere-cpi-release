...
# Unit tests for SwaggerClient::ChildDomainDeploymentMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildDomainDeploymentMap' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildDomainDeploymentMap.new
  end
  ...
  describe 'test an instance of ChildDomainDeploymentMap' do
    it 'should create an instance of ChildDomainDeploymentMap' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildDomainDeploymentMap)
    end
  end
  ...
  describe 'test attribute "domain_deployment_map"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
