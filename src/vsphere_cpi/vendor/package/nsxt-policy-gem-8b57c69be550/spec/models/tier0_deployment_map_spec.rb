...
# Unit tests for SwaggerClient::Tier0DeploymentMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Tier0DeploymentMap' do
  before do
    # run before each test
    @instance = SwaggerClient::Tier0DeploymentMap.new
  end
  ...
  describe 'test an instance of Tier0DeploymentMap' do
    it 'should create an instance of Tier0DeploymentMap' do
      expect(@instance).to be_instance_of(SwaggerClient::Tier0DeploymentMap)
    end
  end
