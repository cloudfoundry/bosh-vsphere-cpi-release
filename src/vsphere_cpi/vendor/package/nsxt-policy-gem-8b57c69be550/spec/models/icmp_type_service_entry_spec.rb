...
# Unit tests for SwaggerClient::ICMPTypeServiceEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ICMPTypeServiceEntry' do
  before do
    # run before each test
    @instance = SwaggerClient::ICMPTypeServiceEntry.new
  end
  ...
  describe 'test an instance of ICMPTypeServiceEntry' do
    it 'should create an instance of ICMPTypeServiceEntry' do
      expect(@instance).to be_instance_of(SwaggerClient::ICMPTypeServiceEntry)
    end
  end
  ...
  describe 'test attribute "protocol"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ICMPv4", "ICMPv6"])
      # validator.allowable_values.each do |value|
