...
# Unit tests for SwaggerClient::VersionList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VersionList' do
  before do
    # run before each test
    @instance = SwaggerClient::VersionList.new
  end
  ...
  describe 'test an instance of VersionList' do
    it 'should create an instance of VersionList' do
      expect(@instance).to be_instance_of(SwaggerClient::VersionList)
    end
  end
