...
# Unit tests for SwaggerClient::ChildTier1DeploymentMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildTier1DeploymentMap' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildTier1DeploymentMap.new
  end
  ...
  describe 'test an instance of ChildTier1DeploymentMap' do
    it 'should create an instance of ChildTier1DeploymentMap' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildTier1DeploymentMap)
    end
  end
  ...
  describe 'test attribute "tier1_deployment_map"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
