...
# Unit tests for SwaggerClient::ChildRedirectionPolicy
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildRedirectionPolicy' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildRedirectionPolicy.new
  end
  ...
  describe 'test an instance of ChildRedirectionPolicy' do
    it 'should create an instance of ChildRedirectionPolicy' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildRedirectionPolicy)
    end
  end
  ...
  describe 'test attribute "redirection_policy"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
