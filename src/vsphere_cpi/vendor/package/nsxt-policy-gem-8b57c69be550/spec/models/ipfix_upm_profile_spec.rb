...
# Unit tests for SwaggerClient::IpfixUpmProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IpfixUpmProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::IpfixUpmProfile.new
  end
  ...
  describe 'test an instance of IpfixUpmProfile' do
    it 'should create an instance of IpfixUpmProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::IpfixUpmProfile)
    end
  end
