...
# Unit tests for SwaggerClient::IpAddressAllocation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IpAddressAllocation' do
  before do
    # run before each test
    @instance = SwaggerClient::IpAddressAllocation.new
  end
  ...
  describe 'test an instance of IpAddressAllocation' do
    it 'should create an instance of IpAddressAllocation' do
      expect(@instance).to be_instance_of(SwaggerClient::IpAddressAllocation)
    end
  end
  ...
  describe 'test attribute "allocation_ip"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
