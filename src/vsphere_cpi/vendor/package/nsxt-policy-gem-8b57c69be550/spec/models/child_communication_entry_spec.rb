...
# Unit tests for SwaggerClient::ChildCommunicationEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildCommunicationEntry' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildCommunicationEntry.new
  end
  ...
  describe 'test an instance of ChildCommunicationEntry' do
    it 'should create an instance of ChildCommunicationEntry' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildCommunicationEntry)
    end
  end
  ...
  describe 'test attribute "communication_entry"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
