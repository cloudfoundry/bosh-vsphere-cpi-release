...
# Unit tests for SwaggerClient::IPPrefixList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IPPrefixList' do
  before do
    # run before each test
    @instance = SwaggerClient::IPPrefixList.new
  end
  ...
  describe 'test an instance of IPPrefixList' do
    it 'should create an instance of IPPrefixList' do
      expect(@instance).to be_instance_of(SwaggerClient::IPPrefixList)
    end
  end
