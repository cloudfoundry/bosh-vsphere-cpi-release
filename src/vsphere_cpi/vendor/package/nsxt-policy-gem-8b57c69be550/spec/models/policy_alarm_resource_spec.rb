...
# Unit tests for SwaggerClient::PolicyAlarmResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PolicyAlarmResource' do
  before do
    # run before each test
    @instance = SwaggerClient::PolicyAlarmResource.new
  end
  ...
  describe 'test an instance of PolicyAlarmResource' do
    it 'should create an instance of PolicyAlarmResource' do
      expect(@instance).to be_instance_of(SwaggerClient::PolicyAlarmResource)
    end
  end
