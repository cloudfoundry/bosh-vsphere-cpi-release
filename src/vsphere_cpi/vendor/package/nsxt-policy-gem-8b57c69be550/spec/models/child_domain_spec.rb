...
# Unit tests for SwaggerClient::ChildDomain
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildDomain' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildDomain.new
  end
  ...
  describe 'test an instance of ChildDomain' do
    it 'should create an instance of ChildDomain' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildDomain)
    end
  end
