...
# Unit tests for SwaggerClient::CommunicationMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommunicationMap' do
  before do
    # run before each test
    @instance = SwaggerClient::CommunicationMap.new
  end
  ...
  describe 'test an instance of CommunicationMap' do
    it 'should create an instance of CommunicationMap' do
      expect(@instance).to be_instance_of(SwaggerClient::CommunicationMap)
    end
  end
  ...
  describe 'test attribute "communication_entries"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
