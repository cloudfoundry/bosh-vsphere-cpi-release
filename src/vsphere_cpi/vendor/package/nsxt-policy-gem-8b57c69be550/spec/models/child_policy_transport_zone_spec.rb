...
# Unit tests for SwaggerClient::ChildPolicyTransportZone
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildPolicyTransportZone' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildPolicyTransportZone.new
  end
  ...
  describe 'test an instance of ChildPolicyTransportZone' do
    it 'should create an instance of ChildPolicyTransportZone' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildPolicyTransportZone)
    end
  end
  ...
  describe 'test attribute "policy_transport_zone"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
