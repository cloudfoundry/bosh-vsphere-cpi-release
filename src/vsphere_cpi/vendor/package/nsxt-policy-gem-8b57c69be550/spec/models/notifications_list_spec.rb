...
# Unit tests for SwaggerClient::NotificationsList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NotificationsList' do
  before do
    # run before each test
    @instance = SwaggerClient::NotificationsList.new
  end
  ...
  describe 'test an instance of NotificationsList' do
    it 'should create an instance of NotificationsList' do
      expect(@instance).to be_instance_of(SwaggerClient::NotificationsList)
    end
  end
