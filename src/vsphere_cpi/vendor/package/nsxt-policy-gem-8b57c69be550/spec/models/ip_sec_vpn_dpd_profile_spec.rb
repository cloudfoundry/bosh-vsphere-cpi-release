...
# Unit tests for SwaggerClient::IPSecVpnDpdProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IPSecVpnDpdProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::IPSecVpnDpdProfile.new
  end
  ...
  describe 'test an instance of IPSecVpnDpdProfile' do
    it 'should create an instance of IPSecVpnDpdProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::IPSecVpnDpdProfile)
    end
  end
  ...
  describe 'test attribute "dpd_probe_interval"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
