...
# Unit tests for SwaggerClient::PortMirroringInstance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PortMirroringInstance' do
  before do
    # run before each test
    @instance = SwaggerClient::PortMirroringInstance.new
  end
  ...
  describe 'test an instance of PortMirroringInstance' do
    it 'should create an instance of PortMirroringInstance' do
      expect(@instance).to be_instance_of(SwaggerClient::PortMirroringInstance)
    end
  end
