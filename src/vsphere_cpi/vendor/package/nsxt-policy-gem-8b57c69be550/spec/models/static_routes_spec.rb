...
# Unit tests for SwaggerClient::StaticRoutes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StaticRoutes' do
  before do
    # run before each test
    @instance = SwaggerClient::StaticRoutes.new
  end
  ...
  describe 'test an instance of StaticRoutes' do
    it 'should create an instance of StaticRoutes' do
      expect(@instance).to be_instance_of(SwaggerClient::StaticRoutes)
    end
  end
  ...
  describe 'test attribute "next_hops"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
