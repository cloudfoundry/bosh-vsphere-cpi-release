...
# Unit tests for SwaggerClient::StaticRoute
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StaticRoute' do
  before do
    # run before each test
    @instance = SwaggerClient::StaticRoute.new
  end
  ...
  describe 'test an instance of StaticRoute' do
    it 'should create an instance of StaticRoute' do
      expect(@instance).to be_instance_of(SwaggerClient::StaticRoute)
    end
  end
