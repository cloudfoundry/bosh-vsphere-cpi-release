...
# Unit tests for SwaggerClient::MacPool
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MacPool' do
  before do
    # run before each test
    @instance = SwaggerClient::MacPool.new
  end
  ...
  describe 'test an instance of MacPool' do
    it 'should create an instance of MacPool' do
      expect(@instance).to be_instance_of(SwaggerClient::MacPool)
    end
  end
