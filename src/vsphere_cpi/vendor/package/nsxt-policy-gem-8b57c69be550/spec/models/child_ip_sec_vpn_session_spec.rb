...
# Unit tests for SwaggerClient::ChildIPSecVpnSession
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildIPSecVpnSession' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildIPSecVpnSession.new
  end
  ...
  describe 'test an instance of ChildIPSecVpnSession' do
    it 'should create an instance of ChildIPSecVpnSession' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildIPSecVpnSession)
    end
  end
  ...
  describe 'test attribute "ip_sec_vpn_session"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
