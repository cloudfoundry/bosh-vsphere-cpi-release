...
# Unit tests for SwaggerClient::Tier1DeploymentMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Tier1DeploymentMap' do
  before do
    # run before each test
    @instance = SwaggerClient::Tier1DeploymentMap.new
  end
  ...
  describe 'test an instance of Tier1DeploymentMap' do
    it 'should create an instance of Tier1DeploymentMap' do
      expect(@instance).to be_instance_of(SwaggerClient::Tier1DeploymentMap)
    end
  end
