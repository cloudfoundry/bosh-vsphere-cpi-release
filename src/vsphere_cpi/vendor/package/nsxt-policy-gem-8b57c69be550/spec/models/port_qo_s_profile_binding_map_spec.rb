...
# Unit tests for SwaggerClient::PortQoSProfileBindingMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PortQoSProfileBindingMap' do
  before do
    # run before each test
    @instance = SwaggerClient::PortQoSProfileBindingMap.new
  end
  ...
  describe 'test an instance of PortQoSProfileBindingMap' do
    it 'should create an instance of PortQoSProfileBindingMap' do
      expect(@instance).to be_instance_of(SwaggerClient::PortQoSProfileBindingMap)
    end
  end
