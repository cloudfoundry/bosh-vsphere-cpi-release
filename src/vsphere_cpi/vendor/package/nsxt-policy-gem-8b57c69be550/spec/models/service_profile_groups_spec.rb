...
# Unit tests for SwaggerClient::ServiceProfileGroups
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceProfileGroups' do
  before do
    # run before each test
    @instance = SwaggerClient::ServiceProfileGroups.new
  end
  ...
  describe 'test an instance of ServiceProfileGroups' do
    it 'should create an instance of ServiceProfileGroups' do
      expect(@instance).to be_instance_of(SwaggerClient::ServiceProfileGroups)
    end
  end
