...
# Unit tests for SwaggerClient::ComputeCollectionFabricTemplate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ComputeCollectionFabricTemplate' do
  before do
    # run before each test
    @instance = SwaggerClient::ComputeCollectionFabricTemplate.new
  end
  ...
  describe 'test an instance of ComputeCollectionFabricTemplate' do
    it 'should create an instance of ComputeCollectionFabricTemplate' do
      expect(@instance).to be_instance_of(SwaggerClient::ComputeCollectionFabricTemplate)
    end
  end
  ...
  describe 'test attribute "auto_install_nsx"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
