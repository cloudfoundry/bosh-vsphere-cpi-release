...
# Unit tests for SwaggerClient::EndpointRule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EndpointRule' do
  before do
    # run before each test
    @instance = SwaggerClient::EndpointRule.new
  end
  ...
  describe 'test an instance of EndpointRule' do
    it 'should create an instance of EndpointRule' do
      expect(@instance).to be_instance_of(SwaggerClient::EndpointRule)
    end
  end
  ...
  describe 'test attribute "service_profiles"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
