...
# Unit tests for SwaggerClient::PolicyRoot
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PolicyRoot' do
  before do
    # run before each test
    @instance = SwaggerClient::PolicyRoot.new
  end
  ...
  describe 'test an instance of PolicyRoot' do
    it 'should create an instance of PolicyRoot' do
      expect(@instance).to be_instance_of(SwaggerClient::PolicyRoot)
    end
  end
