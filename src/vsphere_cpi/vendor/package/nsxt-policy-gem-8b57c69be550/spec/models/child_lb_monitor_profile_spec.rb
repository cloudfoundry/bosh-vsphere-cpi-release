...
# Unit tests for SwaggerClient::ChildLBMonitorProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildLBMonitorProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildLBMonitorProfile.new
  end
  ...
  describe 'test an instance of ChildLBMonitorProfile' do
    it 'should create an instance of ChildLBMonitorProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildLBMonitorProfile)
    end
  end
