...
# Unit tests for SwaggerClient::ChildIPSecVpnService
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildIPSecVpnService' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildIPSecVpnService.new
  end
  ...
  describe 'test an instance of ChildIPSecVpnService' do
    it 'should create an instance of ChildIPSecVpnService' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildIPSecVpnService)
    end
  end
  ...
  describe 'test attribute "ip_sec_vpn_service"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
