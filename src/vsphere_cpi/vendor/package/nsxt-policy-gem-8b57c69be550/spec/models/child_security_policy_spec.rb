...
# Unit tests for SwaggerClient::ChildSecurityPolicy
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildSecurityPolicy' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildSecurityPolicy.new
  end
  ...
  describe 'test an instance of ChildSecurityPolicy' do
    it 'should create an instance of ChildSecurityPolicy' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildSecurityPolicy)
    end
  end
