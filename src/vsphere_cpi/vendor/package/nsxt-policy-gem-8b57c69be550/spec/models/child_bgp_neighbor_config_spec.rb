...
# Unit tests for SwaggerClient::ChildBgpNeighborConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildBgpNeighborConfig' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildBgpNeighborConfig.new
  end
  ...
  describe 'test an instance of ChildBgpNeighborConfig' do
    it 'should create an instance of ChildBgpNeighborConfig' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildBgpNeighborConfig)
    end
  end
  ...
  describe 'test attribute "bgp_routing_config"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
