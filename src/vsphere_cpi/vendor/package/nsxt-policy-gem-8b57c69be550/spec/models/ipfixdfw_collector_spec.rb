...
# Unit tests for SwaggerClient::IPFIXDFWCollector
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IPFIXDFWCollector' do
  before do
    # run before each test
    @instance = SwaggerClient::IPFIXDFWCollector.new
  end
  ...
  describe 'test an instance of IPFIXDFWCollector' do
    it 'should create an instance of IPFIXDFWCollector' do
      expect(@instance).to be_instance_of(SwaggerClient::IPFIXDFWCollector)
    end
  end
