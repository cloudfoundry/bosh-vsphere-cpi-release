...
# Unit tests for SwaggerClient::ALGTypeServiceEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ALGTypeServiceEntry' do
  before do
    # run before each test
    @instance = SwaggerClient::ALGTypeServiceEntry.new
  end
  ...
  describe 'test an instance of ALGTypeServiceEntry' do
    it 'should create an instance of ALGTypeServiceEntry' do
      expect(@instance).to be_instance_of(SwaggerClient::ALGTypeServiceEntry)
    end
  end
