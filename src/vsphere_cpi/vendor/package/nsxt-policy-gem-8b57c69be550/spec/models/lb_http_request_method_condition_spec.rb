...
# Unit tests for SwaggerClient::LBHttpRequestMethodCondition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LBHttpRequestMethodCondition' do
  before do
    # run before each test
    @instance = SwaggerClient::LBHttpRequestMethodCondition.new
  end
  ...
  describe 'test an instance of LBHttpRequestMethodCondition' do
    it 'should create an instance of LBHttpRequestMethodCondition' do
      expect(@instance).to be_instance_of(SwaggerClient::LBHttpRequestMethodCondition)
    end
  end
