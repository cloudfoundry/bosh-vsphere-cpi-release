...
# Unit tests for SwaggerClient::PathExpression
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PathExpression' do
  before do
    # run before each test
    @instance = SwaggerClient::PathExpression.new
  end
  ...
  describe 'test an instance of PathExpression' do
    it 'should create an instance of PathExpression' do
      expect(@instance).to be_instance_of(SwaggerClient::PathExpression)
    end
  end
