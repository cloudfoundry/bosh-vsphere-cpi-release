...
# Unit tests for SwaggerClient::ChildPolicyDnsForwarder
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildPolicyDnsForwarder' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildPolicyDnsForwarder.new
  end
  ...
  describe 'test an instance of ChildPolicyDnsForwarder' do
    it 'should create an instance of ChildPolicyDnsForwarder' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildPolicyDnsForwarder)
    end
  end
  ...
  describe 'test attribute "policy_dns_forwarder"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
