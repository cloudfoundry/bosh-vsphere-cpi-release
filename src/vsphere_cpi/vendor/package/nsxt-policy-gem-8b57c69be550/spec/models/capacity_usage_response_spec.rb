...
# Unit tests for SwaggerClient::CapacityUsageResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CapacityUsageResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CapacityUsageResponse.new
  end
  ...
  describe 'test an instance of CapacityUsageResponse' do
    it 'should create an instance of CapacityUsageResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CapacityUsageResponse)
    end
  end
