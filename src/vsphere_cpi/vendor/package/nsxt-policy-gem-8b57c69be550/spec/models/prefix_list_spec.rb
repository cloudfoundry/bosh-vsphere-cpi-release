...
# Unit tests for SwaggerClient::PrefixList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PrefixList' do
  before do
    # run before each test
    @instance = SwaggerClient::PrefixList.new
  end
  ...
  describe 'test an instance of PrefixList' do
    it 'should create an instance of PrefixList' do
      expect(@instance).to be_instance_of(SwaggerClient::PrefixList)
    end
  end
