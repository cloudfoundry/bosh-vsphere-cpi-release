...
# Unit tests for SwaggerClient::PolicyConfigResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PolicyConfigResource' do
  before do
    # run before each test
    @instance = SwaggerClient::PolicyConfigResource.new
  end
  ...
  describe 'test an instance of PolicyConfigResource' do
    it 'should create an instance of PolicyConfigResource' do
      expect(@instance).to be_instance_of(SwaggerClient::PolicyConfigResource)
    end
  end
