...
# Unit tests for SwaggerClient::DSSection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DSSection' do
  before do
    # run before each test
    @instance = SwaggerClient::DSSection.new
  end
  ...
  describe 'test an instance of DSSection' do
    it 'should create an instance of DSSection' do
      expect(@instance).to be_instance_of(SwaggerClient::DSSection)
    end
  end
