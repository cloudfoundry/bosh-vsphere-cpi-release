...
# Unit tests for SwaggerClient::SslCertificate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SslCertificate' do
  before do
    # run before each test
    @instance = SwaggerClient::SslCertificate.new
  end
  ...
  describe 'test an instance of SslCertificate' do
    it 'should create an instance of SslCertificate' do
      expect(@instance).to be_instance_of(SwaggerClient::SslCertificate)
    end
  end
