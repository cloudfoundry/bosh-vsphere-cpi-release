...
# Unit tests for SwaggerClient::ChildService
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildService' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildService.new
  end
  ...
  describe 'test an instance of ChildService' do
    it 'should create an instance of ChildService' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildService)
    end
  end
