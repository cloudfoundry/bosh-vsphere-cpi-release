...
# Unit tests for SwaggerClient::ChildRule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildRule' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildRule.new
  end
  ...
  describe 'test an instance of ChildRule' do
    it 'should create an instance of ChildRule' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildRule)
    end
  end
