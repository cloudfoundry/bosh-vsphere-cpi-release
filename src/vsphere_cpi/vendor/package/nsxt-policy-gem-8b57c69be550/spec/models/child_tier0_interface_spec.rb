...
# Unit tests for SwaggerClient::ChildTier0Interface
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildTier0Interface' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildTier0Interface.new
  end
  ...
  describe 'test an instance of ChildTier0Interface' do
    it 'should create an instance of ChildTier0Interface' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildTier0Interface)
    end
  end
  ...
  describe 'test attribute "tier0_interface"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
