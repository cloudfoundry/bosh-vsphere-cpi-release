...
# Unit tests for SwaggerClient::IPFIXDFWProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IPFIXDFWProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::IPFIXDFWProfile.new
  end
  ...
  describe 'test an instance of IPFIXDFWProfile' do
    it 'should create an instance of IPFIXDFWProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::IPFIXDFWProfile)
    end
  end
  ...
  describe 'test attribute "ipfix_dfw_collector_profile_path"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
