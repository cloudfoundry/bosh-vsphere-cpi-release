...
# Unit tests for SwaggerClient::RedistributionConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RedistributionConfig' do
  before do
    # run before each test
    @instance = SwaggerClient::RedistributionConfig.new
  end
  ...
  describe 'test an instance of RedistributionConfig' do
    it 'should create an instance of RedistributionConfig' do
      expect(@instance).to be_instance_of(SwaggerClient::RedistributionConfig)
    end
  end
  ...
  describe 'test attribute "bgp_enabled"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
