...
# Unit tests for SwaggerClient::ChildIPSecVpnDpdProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildIPSecVpnDpdProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildIPSecVpnDpdProfile.new
  end
  ...
  describe 'test an instance of ChildIPSecVpnDpdProfile' do
    it 'should create an instance of ChildIPSecVpnDpdProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildIPSecVpnDpdProfile)
    end
  end
  ...
  describe 'test attribute "ip_sec_vpn_dpd_profile"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
