...
# Unit tests for SwaggerClient::IPSecVpnIkeProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IPSecVpnIkeProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::IPSecVpnIkeProfile.new
  end
  ...
  describe 'test an instance of IPSecVpnIkeProfile' do
    it 'should create an instance of IPSecVpnIkeProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::IPSecVpnIkeProfile)
    end
  end
