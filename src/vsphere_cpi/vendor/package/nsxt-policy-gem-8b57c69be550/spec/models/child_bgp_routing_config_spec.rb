...
# Unit tests for SwaggerClient::ChildBgpRoutingConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildBgpRoutingConfig' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildBgpRoutingConfig.new
  end
  ...
  describe 'test an instance of ChildBgpRoutingConfig' do
    it 'should create an instance of ChildBgpRoutingConfig' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildBgpRoutingConfig)
    end
  end
