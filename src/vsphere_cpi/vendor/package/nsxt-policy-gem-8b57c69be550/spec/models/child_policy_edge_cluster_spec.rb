...
# Unit tests for SwaggerClient::ChildPolicyEdgeCluster
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildPolicyEdgeCluster' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildPolicyEdgeCluster.new
  end
  ...
  describe 'test an instance of ChildPolicyEdgeCluster' do
    it 'should create an instance of ChildPolicyEdgeCluster' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildPolicyEdgeCluster)
    end
  end
  ...
  describe 'test attribute "policy_edge_cluster"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
