...
# Unit tests for SwaggerClient::DomainDeploymentMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DomainDeploymentMap' do
  before do
    # run before each test
    @instance = SwaggerClient::DomainDeploymentMap.new
  end
  ...
  describe 'test an instance of DomainDeploymentMap' do
    it 'should create an instance of DomainDeploymentMap' do
      expect(@instance).to be_instance_of(SwaggerClient::DomainDeploymentMap)
    end
  end
