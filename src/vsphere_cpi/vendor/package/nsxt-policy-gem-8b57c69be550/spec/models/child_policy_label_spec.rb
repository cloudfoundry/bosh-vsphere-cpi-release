...
# Unit tests for SwaggerClient::ChildPolicyLabel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildPolicyLabel' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildPolicyLabel.new
  end
  ...
  describe 'test an instance of ChildPolicyLabel' do
    it 'should create an instance of ChildPolicyLabel' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildPolicyLabel)
    end
  end
  ...
  describe 'test attribute "policy_label"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
