...
# Unit tests for SwaggerClient::NSProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NSProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::NSProfile.new
  end
  ...
  describe 'test an instance of NSProfile' do
    it 'should create an instance of NSProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::NSProfile)
    end
  end
  ...
  describe 'test attribute "nsprofile_attribute"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
