...
# Unit tests for SwaggerClient::DhcpRelayService
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DhcpRelayService' do
  before do
    # run before each test
    @instance = SwaggerClient::DhcpRelayService.new
  end
  ...
  describe 'test an instance of DhcpRelayService' do
    it 'should create an instance of DhcpRelayService' do
      expect(@instance).to be_instance_of(SwaggerClient::DhcpRelayService)
    end
  end
