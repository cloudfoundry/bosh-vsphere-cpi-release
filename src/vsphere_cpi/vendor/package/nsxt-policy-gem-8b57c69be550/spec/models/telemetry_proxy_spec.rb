...
# Unit tests for SwaggerClient::TelemetryProxy
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TelemetryProxy' do
  before do
    # run before each test
    @instance = SwaggerClient::TelemetryProxy.new
  end
  ...
  describe 'test an instance of TelemetryProxy' do
    it 'should create an instance of TelemetryProxy' do
      expect(@instance).to be_instance_of(SwaggerClient::TelemetryProxy)
    end
  end
