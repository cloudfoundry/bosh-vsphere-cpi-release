...
# Unit tests for SwaggerClient::PolicyNat
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PolicyNat' do
  before do
    # run before each test
    @instance = SwaggerClient::PolicyNat.new
  end
  ...
  describe 'test an instance of PolicyNat' do
    it 'should create an instance of PolicyNat' do
      expect(@instance).to be_instance_of(SwaggerClient::PolicyNat)
    end
  end
  ...
  describe 'test attribute "nat_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["INTERNAL", "USER", "DEFAULT"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.nat_type = value }.not_to raise_error
      # end
    end
  end
