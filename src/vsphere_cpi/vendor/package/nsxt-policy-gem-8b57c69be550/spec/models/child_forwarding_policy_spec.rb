...
# Unit tests for SwaggerClient::ChildForwardingPolicy
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildForwardingPolicy' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildForwardingPolicy.new
  end
  ...
  describe 'test an instance of ChildForwardingPolicy' do
    it 'should create an instance of ChildForwardingPolicy' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildForwardingPolicy)
    end
  end
  ...
  describe 'test attribute "forwarding_policy"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
