...
# Unit tests for SwaggerClient::ChildIPDiscoveryProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildIPDiscoveryProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildIPDiscoveryProfile.new
  end
  ...
  describe 'test an instance of ChildIPDiscoveryProfile' do
    it 'should create an instance of ChildIPDiscoveryProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildIPDiscoveryProfile)
    end
  end
  ...
  describe 'test attribute "ip_discovery_profile"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
