...
# Unit tests for SwaggerClient::LBHttpRequestHeaderCondition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LBHttpRequestHeaderCondition' do
  before do
    # run before each test
    @instance = SwaggerClient::LBHttpRequestHeaderCondition.new
  end
  ...
  describe 'test an instance of LBHttpRequestHeaderCondition' do
    it 'should create an instance of LBHttpRequestHeaderCondition' do
      expect(@instance).to be_instance_of(SwaggerClient::LBHttpRequestHeaderCondition)
    end
  end
