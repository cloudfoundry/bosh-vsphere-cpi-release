...
# Unit tests for SwaggerClient::CommunicationEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommunicationEntry' do
  before do
    # run before each test
    @instance = SwaggerClient::CommunicationEntry.new
  end
  ...
  describe 'test an instance of CommunicationEntry' do
    it 'should create an instance of CommunicationEntry' do
      expect(@instance).to be_instance_of(SwaggerClient::CommunicationEntry)
    end
  end
