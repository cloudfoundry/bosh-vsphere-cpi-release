...
# Unit tests for SwaggerClient::LbFastUdpProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LbFastUdpProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::LbFastUdpProfile.new
  end
  ...
  describe 'test an instance of LbFastUdpProfile' do
    it 'should create an instance of LbFastUdpProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::LbFastUdpProfile)
    end
  end
  ...
  describe 'test attribute "flow_mirroring_enabled"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
