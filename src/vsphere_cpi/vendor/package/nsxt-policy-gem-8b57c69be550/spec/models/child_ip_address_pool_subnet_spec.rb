...
# Unit tests for SwaggerClient::ChildIpAddressPoolSubnet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildIpAddressPoolSubnet' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildIpAddressPoolSubnet.new
  end
  ...
  describe 'test an instance of ChildIpAddressPoolSubnet' do
    it 'should create an instance of ChildIpAddressPoolSubnet' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildIpAddressPoolSubnet)
    end
  end
  ...
  describe 'test attribute "ip_address_pool_subnet"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
