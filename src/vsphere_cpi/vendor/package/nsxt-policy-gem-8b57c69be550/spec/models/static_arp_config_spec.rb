...
# Unit tests for SwaggerClient::StaticARPConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StaticARPConfig' do
  before do
    # run before each test
    @instance = SwaggerClient::StaticARPConfig.new
  end
  ...
  describe 'test an instance of StaticARPConfig' do
    it 'should create an instance of StaticARPConfig' do
      expect(@instance).to be_instance_of(SwaggerClient::StaticARPConfig)
    end
  end
