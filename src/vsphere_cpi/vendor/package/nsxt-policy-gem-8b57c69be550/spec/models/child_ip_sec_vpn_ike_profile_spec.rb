...
# Unit tests for SwaggerClient::ChildIPSecVpnIkeProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildIPSecVpnIkeProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildIPSecVpnIkeProfile.new
  end
  ...
  describe 'test an instance of ChildIPSecVpnIkeProfile' do
    it 'should create an instance of ChildIPSecVpnIkeProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildIPSecVpnIkeProfile)
    end
  end
  ...
  describe 'test attribute "ip_sec_vpn_ike_profile"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
