...
# Unit tests for SwaggerClient::ChildTier1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildTier1' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildTier1.new
  end
  ...
  describe 'test an instance of ChildTier1' do
    it 'should create an instance of ChildTier1' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildTier1)
    end
  end
