...
# Unit tests for SwaggerClient::TelemetryAgreement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TelemetryAgreement' do
  before do
    # run before each test
    @instance = SwaggerClient::TelemetryAgreement.new
  end
  ...
  describe 'test an instance of TelemetryAgreement' do
    it 'should create an instance of TelemetryAgreement' do
      expect(@instance).to be_instance_of(SwaggerClient::TelemetryAgreement)
    end
  end
  ...
  describe 'test attribute "telemetry_agreement_displayed"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
