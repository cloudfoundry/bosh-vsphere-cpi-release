...
# Unit tests for SwaggerClient::DeploymentZone
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeploymentZone' do
  before do
    # run before each test
    @instance = SwaggerClient::DeploymentZone.new
  end
  ...
  describe 'test an instance of DeploymentZone' do
    it 'should create an instance of DeploymentZone' do
      expect(@instance).to be_instance_of(SwaggerClient::DeploymentZone)
    end
  end
