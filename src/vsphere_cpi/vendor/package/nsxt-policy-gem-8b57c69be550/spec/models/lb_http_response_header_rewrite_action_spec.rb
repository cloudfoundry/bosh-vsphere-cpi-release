...
# Unit tests for SwaggerClient::LBHttpResponseHeaderRewriteAction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LBHttpResponseHeaderRewriteAction' do
  before do
    # run before each test
    @instance = SwaggerClient::LBHttpResponseHeaderRewriteAction.new
  end
  ...
  describe 'test an instance of LBHttpResponseHeaderRewriteAction' do
    it 'should create an instance of LBHttpResponseHeaderRewriteAction' do
      expect(@instance).to be_instance_of(SwaggerClient::LBHttpResponseHeaderRewriteAction)
    end
  end
