...
# Unit tests for SwaggerClient::VniPool
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VniPool' do
  before do
    # run before each test
    @instance = SwaggerClient::VniPool.new
  end
  ...
  describe 'test an instance of VniPool' do
    it 'should create an instance of VniPool' do
      expect(@instance).to be_instance_of(SwaggerClient::VniPool)
    end
  end
