...
# Unit tests for SwaggerClient::ChildTier0DeploymentMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChildTier0DeploymentMap' do
  before do
    # run before each test
    @instance = SwaggerClient::ChildTier0DeploymentMap.new
  end
  ...
  describe 'test an instance of ChildTier0DeploymentMap' do
    it 'should create an instance of ChildTier0DeploymentMap' do
      expect(@instance).to be_instance_of(SwaggerClient::ChildTier0DeploymentMap)
    end
  end
  ...
  describe 'test attribute "tier0_deployment_map"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
