...
# Unit tests for SwaggerClient::DhcpIpPool
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DhcpIpPool' do
  before do
    # run before each test
    @instance = SwaggerClient::DhcpIpPool.new
  end
  ...
  describe 'test an instance of DhcpIpPool' do
    it 'should create an instance of DhcpIpPool' do
      expect(@instance).to be_instance_of(SwaggerClient::DhcpIpPool)
    end
  end
  ...
  describe 'test attribute "error_threshold"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
