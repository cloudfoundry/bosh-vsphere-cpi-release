...
module SwaggerClient
  class NsxComponentAdministrationNsxAdministrationApi
    ...
    def read_management_config_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NsxComponentAdministrationNsxAdministrationApi.read_management_config ...'
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NsxComponentAdministrationNsxAdministrationApi#read_management_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def update_management_config_with_http_info(management_config, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NsxComponentAdministrationNsxAdministrationApi.update_management_config ...'
      end
      # verify the required parameter 'management_config' is set
      if @api_client.config.client_side_validation && management_config.nil?
        fail ArgumentError, "Missing the required parameter 'management_config' when calling NsxComponentAdministrationNsxAdministrationApi.update_management_config"
      end
      # resource path
      local_var_path = '/configs/management'
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ManagementConfig')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NsxComponentAdministrationNsxAdministrationApi#update_management_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
